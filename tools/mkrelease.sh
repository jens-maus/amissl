...
mkdir -p "release/AmiSSL/Developer/Docs"
...
for os in os3 os4 mos aros-i386 aros-ppc aros-x86_64; do
	...
	cp -a build_$os/amissl_v1$versionname.library "release/AmiSSL/Libs/$fullsys/AmiSSL/"
	mkdir -p "release/AmiSSL/C/$fullsys"
	cp -a build_$os/openssl/apps/openssl "release/AmiSSL/Libs/$fullsys/OpenSSL"
...
cp -a dist/*.doc "release/AmiSSL/Docs/"
cp -a certs/* "release/AmiSSL/Certs/"
cp -a dist/README-SDK "release/AmiSSL/Developer/Docs/README"
cp -a src/https.c "release/AmiSSL/Developer/Examples/"
