...
$lflags='${CFLAG} NOICONS SMALLCODE "LINKOPTS=DEFINE _bsearch=_OBJ_bsearch LIB lib:scm.lib lib:miami.lib AmiSSL:lib/amisslauto.lib"';
$efile='TO ';
$exep='';
$ex_libs="";
