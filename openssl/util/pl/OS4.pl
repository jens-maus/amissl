...
$lib_cflag="\$(ADD) -nostdinc -mbaserel -mcrt=clib2-ts -mcheck68kfuncptr -DAMISSL -DAMISSL_COMPILE -D__USE_INLINE__ -DB_ENDIAN -DTHIRTY_TWO_BITS -DOPENSSL_NO_FP_API -DOPENSSL_NO_ENGINE -I\$(AmiSSL)/include -I\$(AmiSSL)/libcmt/include -g -O2  -Wno-pointer-sign";
$obj='.o';
$ofile='-o ';
$define='-D';
$include='-I';
