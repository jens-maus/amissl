...
#  include <unistd.h>
# elif !defined(OPENSSL_SYS_VXWORKS) && !defined(OPENSSL_SYS_WINDOWS) && !defined(OPENSSL_SYS_TANDEM) && !defined(OPENSSL_SYS_AMIGA)
#  include <sys/file.h>
# endif
#endif
...
#else
        AddPart(new_cert, "z", sizeof(new_cert));
        outdirlen = strlen(new_cert)-1;
        new_cert[outdirlen] = '\0'; // remove z again
#endif
#endif
