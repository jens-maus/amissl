...
__asm __saveds int MD4_Init_AmiSSL(register __a0 MD4_CTX *c)
{
	return(MD4_Init(c));
}

__asm __saveds int MD4_Update_AmiSSL(register __a0 MD4_CTX *c, register __a1 const void *data, register __d0 unsigned long len)
{
	return(MD4_Update(c, data, len));
}

__asm __saveds int MD4_Final_AmiSSL(register __a0 unsigned char *md, register __a1 MD4_CTX *c)
{
