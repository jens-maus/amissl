...
sfdc --mode=gateproto --target ppc-morphos ../include/sfd/amissl_lib.sfd --gateprefix LIBSTUB_ --libprefix LIB_ --libarg first -o amissl_stubs_mos.h
sfdc --mode=gateproto --target ppc-morphos ../include/sfd/amisslmaster_lib.sfd --gateprefix LIBSTUB_ --libprefix LIB_ --libarg first -o amisslmaster_stubs_mos.h
