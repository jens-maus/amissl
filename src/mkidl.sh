...
sfdc --mode=gatestubs --target ppc-morphos ../include/sfd/amisslmaster_lib.sfd --gateprefix LIBSTUB_ --libprefix LIB_ --libarg first --sdi -o amisslmaster_stubs_mos.c
