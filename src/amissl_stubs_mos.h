...
LIBSTUB(EVP_PKEY_set1_tls_encodedpoint, int);
LIBSTUB(EVP_PKEY_get1_tls_encodedpoint, size_t);
...
LIBSTUB(RAND_DRBG_instantiate, int);
LIBSTUB(RAND_DRBG_uninstantiate, int);
LIBSTUB(RAND_DRBG_set, int);
LIBSTUB(RAND_DRBG_set_callbacks, int);
LIBSTUB(RAND_DRBG_new, RAND_DRBG *);
LIBSTUB(RAND_DRBG_set_reseed_interval, int);
LIBSTUB(RAND_DRBG_free, void);
LIBSTUB(RAND_DRBG_generate, int);
LIBSTUB(RAND_DRBG_reseed, int);
LIBSTUB(RAND_DRBG_set_ex_data, int);
LIBSTUB(RAND_DRBG_get_ex_data, void *);
...
LIBSTUB(RAND_DRBG_get0_public, RAND_DRBG *);
...
LIBSTUB(RAND_DRBG_get0_private, RAND_DRBG *);
...
LIBSTUB(RAND_DRBG_get0_master, RAND_DRBG *);
LIBSTUB(RAND_DRBG_set_reseed_time_interval, int);
...
LIBSTUB(RAND_DRBG_set_reseed_defaults, int);
...
LIBSTUB(RAND_DRBG_set_defaults, int);
...
LIBSTUB(EVP_PKEY_set_alias_type, int);
