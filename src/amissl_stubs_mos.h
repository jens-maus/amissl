...
LIBSTUB(OBSOLETE_EVP_PKEY_bits, int);
LIBSTUB(OBSOLETE_EVP_PKEY_size, int);
...
LIBSTUB(OBSOLETE_EVP_CIPHER_type, int);
...
LIBSTUB(OBSOLETE_SSL_get_peer_certificate, X509 *);
...
LIBSTUB(OBSOLETE_EVP_CIPHER_nid, int);
LIBSTUB(OBSOLETE_EVP_MD_type, int);
...
LIBSTUB(OBSOLETE_EVP_CIPHER_iv_length, int);
...
LIBSTUB(OBSOLETE_OCSP_REQ_CTX_free, void);
...
LIBSTUB(OBSOLETE_d2i_EC_PUBKEY, EC_KEY *);
...
LIBSTUB(OBSOLETE_EVP_CIPHER_block_size, int);
LIBSTUB(EVP_CIPHER_CTX_set_app_data, void);
LIBSTUB(BIO_method_type, int);
LIBSTUB(OBSOLETE_EVP_CIPHER_CTX_nid, int);
LIBSTUB(OBSOLETE_EVP_CIPHER_CTX_key_length, int);
LIBSTUB(OBSOLETE_EVP_MD_size, int);
LIBSTUB(EVP_MD_CTX_test_flags, int);
LIBSTUB(BIO_clear_flags, void);
LIBSTUB(OBSOLETE_EVP_MD_pkey_type, int);
LIBSTUB(EVP_MD_CTX_clear_flags, void);
LIBSTUB(OBSOLETE_EVP_CIPHER_flags, unsigned long);
LIBSTUB(BIO_get_callback, BIO_callback_fn);
LIBSTUB(OBSOLETE_EVP_CIPHER_key_length, int);
LIBSTUB(EVP_Cipher, int);
LIBSTUB(OBSOLETE_EVP_CIPHER_CTX_block_size, int);
LIBSTUB(EVP_CIPHER_CTX_cipher, const EVP_CIPHER *);
LIBSTUB(EVP_CIPHER_CTX_get_app_data, void *);
LIBSTUB(OBSOLETE_EVP_MD_block_size, int);
LIBSTUB(EVP_MD_CTX_md, const EVP_MD *);
LIBSTUB(BIO_method_name, const char *);
LIBSTUB(OBSOLETE_EVP_CIPHER_CTX_iv_length, int);
...
LIBSTUB(OBSOLETE_EVP_PKEY_base_id, int);
...
LIBSTUB(OBSOLETE_EVP_PKEY_id, int);
...
LIBSTUB(OBSOLETE_EVP_MD_flags, unsigned long);
LIBSTUB(TS_RESP_CTX_free, void);
LIBSTUB(OBSOLETE_OCSP_REQ_CTX_add1_header, int);
...
LIBSTUB(OBSOLETE_OCSP_REQ_CTX_get0_mem_bio, BIO *);
LIBSTUB(OBSOLETE_OCSP_REQ_CTX_http, int);
LIBSTUB(OBSOLETE_OCSP_REQ_CTX_i2d, int);
LIBSTUB(OBSOLETE_OCSP_REQ_CTX_nbio, int);
LIBSTUB(OBSOLETE_OCSP_REQ_CTX_nbio_d2i, int);
LIBSTUB(OBSOLETE_OCSP_REQ_CTX_new, OCSP_REQ_CTX *);
LIBSTUB(OBSOLETE_OCSP_set_max_response_length, void);
...
LIBSTUB(OBSOLETE_EVP_MD_CTX_md_data, void *);
LIBSTUB(EVP_MD_CTX_new, EVP_MD_CTX *);
LIBSTUB(OBSOLETE_EVP_MD_CTX_pkey_ctx, EVP_PKEY_CTX *);
...
LIBSTUB(OBSOLETE_EVP_PKEY_security_bits, int);
...
LIBSTUB(OBSOLETE_TS_VERIFY_CTS_set_certs, STACK_OF(X509) *);
...
LIBSTUB(OBSOLETE_EVP_PKEY_set1_tls_encodedpoint, int);
LIBSTUB(OBSOLETE_EVP_PKEY_get1_tls_encodedpoint, size_t);
...
LIBSTUB(SSL_set_record_padding_callback, void);
