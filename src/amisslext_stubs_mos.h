...
LIBSTUB(OSSL_CMP_CTX_get0_geninfo_ITAVs, struct stack_st_OSSL_CMP_ITAV *);
LIBSTUB(OSSL_CMP_HDR_get0_geninfo_ITAVs, struct stack_st_OSSL_CMP_ITAV *);
...
LIBSTUB(ERR_pop, int);
LIBSTUB(X509_STORE_get1_objects, struct stack_st_X509_OBJECT *);
