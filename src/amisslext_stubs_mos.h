...
LIBSTUB(SSL_load_client_CA_file_ex, struct stack_st_X509_NAME *);
...
LIBSTUB(TS_VERIFY_CTX_set_certs, struct stack_st_X509 *);
...
LIBSTUB(OSSL_CMP_CTX_get0_untrusted, struct stack_st_X509 *);
...
LIBSTUB(OSSL_CMP_CTX_get1_newChain, struct stack_st_X509 *);
LIBSTUB(OSSL_CMP_CTX_get1_caPubs, struct stack_st_X509 *);
LIBSTUB(OSSL_CMP_CTX_get1_extraCertsIn, struct stack_st_X509 *);
...
LIBSTUB(X509_STORE_get1_all_certs, struct stack_st_X509 *);
...
LIBSTUB(OSSL_CMP_exec_GENM_ses, struct stack_st_OSSL_CMP_ITAV *);
...
LIBSTUB(PEM_X509_INFO_read_bio_ex, struct stack_st_X509_INFO *);
...
LIBSTUB(X509_build_chain, struct stack_st_X509 *);
...
LIBSTUB(EVP_PBE_scrypt_ex_amiga_1, int);
...
LIBSTUB(NCONF_get_section_names, struct stack_st_OPENSSL_CSTRING *);
