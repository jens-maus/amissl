...
__asm __saveds int MD5_Init_AmiSSL(register __a0 MD5_CTX *c)
{
	return(MD5_Init(c));
}

__asm __saveds int MD5_Update_AmiSSL(register __a0 MD5_CTX *c, register __a1 const void *data, register __d0 unsigned long len)
{
	return(MD5_Update(c, data, len));
}

__asm __saveds int MD5_Final_AmiSSL(register __a0 unsigned char *md, register __a1 MD5_CTX *c)
{
