...
extern void *               VARARGS68K _AmiSSL_PEM_ASN1_read(struct AmiSSLIFace *, d2i_of_void * d2i, const char * name, FILE * fp, void ** x, pem_password_cb * cb, void * u);
...
extern int                  VARARGS68K _AmiSSL_PEM_ASN1_write(struct AmiSSLIFace *, i2d_of_void * i2d, const char * name, FILE * fp, char * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * callback, void * u);
...
extern STACK_OF(X509_INFO) * VARARGS68K _AmiSSL_PEM_X509_INFO_read(struct AmiSSLIFace *, FILE * fp, STACK_OF(X509_INFO) * sk, pem_password_cb * cb, void * u);
...
extern int                  VARARGS68K _AmiSSL_PEM_read(struct AmiSSLIFace *, FILE * fp, char ** name, char ** header, unsigned char ** data, long * len);
...
extern int                  VARARGS68K _AmiSSL_PEM_write(struct AmiSSLIFace *, FILE * fp, char * name, char * hdr, unsigned char * data, long len);
...
extern int                  VARARGS68K _AmiSSL_SSL_SESSION_print_fp(struct AmiSSLIFace *, FILE * fp, SSL_SESSION * ses);
...
extern void *               VARARGS68K _AmiSSL_ASN1_d2i_fp(struct AmiSSLIFace *, void *(*xnew)(void), d2i_of_void * d2i, FILE * in, void ** x);
extern int                  VARARGS68K _AmiSSL_ASN1_i2d_fp(struct AmiSSLIFace *, i2d_of_void * i2d, FILE * out, void * x);
extern BIO *                VARARGS68K _AmiSSL_BIO_new_fp(struct AmiSSLIFace *, FILE * stream, int close_flag);
extern int                  VARARGS68K _AmiSSL_BN_print_fp(struct AmiSSLIFace *, FILE * fp, const BIGNUM * a);
extern void                 VARARGS68K _AmiSSL_CRYPTO_mem_leaks_fp(struct AmiSSLIFace *, FILE * fp);
extern int                  VARARGS68K _AmiSSL_DHparams_print_fp(struct AmiSSLIFace *, FILE * fp, const DH * x);
extern int                  VARARGS68K _AmiSSL_DSA_print_fp(struct AmiSSLIFace *, FILE * bp, const DSA * x, int off);
extern int                  VARARGS68K _AmiSSL_DSAparams_print_fp(struct AmiSSLIFace *, FILE * fp, const DSA * x);
extern void                 VARARGS68K _AmiSSL_ERR_print_errors_fp(struct AmiSSLIFace *, FILE * fp);
extern DH *                 VARARGS68K _AmiSSL_PEM_read_DHparams(struct AmiSSLIFace *, FILE * fp, DH ** x, pem_password_cb * cb, void * u);
extern DSA *                VARARGS68K _AmiSSL_PEM_read_DSAPrivateKey(struct AmiSSLIFace *, FILE * fp, DSA ** x, pem_password_cb * cb, void * u);
extern DSA *                VARARGS68K _AmiSSL_PEM_read_DSAparams(struct AmiSSLIFace *, FILE * fp, DSA ** x, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_DHparams(struct AmiSSLIFace *, FILE * fp, DH * x);
extern int                  VARARGS68K _AmiSSL_PEM_write_DSAPrivateKey(struct AmiSSLIFace *, FILE * fp, DSA * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_DSAparams(struct AmiSSLIFace *, FILE * fp, DSA * x);
extern int                  VARARGS68K _AmiSSL_RSA_print_fp(struct AmiSSLIFace *, FILE * fp, const RSA * r, int offset);
extern int                  VARARGS68K _AmiSSL_X509_REQ_print_fp(struct AmiSSLIFace *, FILE * bp, X509_REQ * req);
extern int                  VARARGS68K _AmiSSL_X509_print_fp(struct AmiSSLIFace *, FILE * bp, X509 * x);
extern DSA *                VARARGS68K _AmiSSL_d2i_DSAPrivateKey_fp(struct AmiSSLIFace *, FILE * fp, DSA ** dsa);
extern PKCS7 *              VARARGS68K _AmiSSL_d2i_PKCS7_fp(struct AmiSSLIFace *, FILE * fp, PKCS7 ** p7);
extern RSA *                VARARGS68K _AmiSSL_d2i_RSAPrivateKey_fp(struct AmiSSLIFace *, FILE * fp, RSA ** rsa);
extern X509_CRL *           VARARGS68K _AmiSSL_d2i_X509_CRL_fp(struct AmiSSLIFace *, FILE * fp, X509_CRL ** crl);
extern X509_REQ *           VARARGS68K _AmiSSL_d2i_X509_REQ_fp(struct AmiSSLIFace *, FILE * fp, X509_REQ ** req);
extern X509 *               VARARGS68K _AmiSSL_d2i_X509_fp(struct AmiSSLIFace *, FILE * fp, X509 ** x509);
extern const char *         VARARGS68K _AmiSSL_DES_options(struct AmiSSLIFace *);
extern int                  VARARGS68K _AmiSSL_i2d_DSAPrivateKey_fp(struct AmiSSLIFace *, FILE * fp, DSA * dsa);
extern int                  VARARGS68K _AmiSSL_i2d_PKCS7_fp(struct AmiSSLIFace *, FILE * fp, PKCS7 * p7);
extern int                  VARARGS68K _AmiSSL_i2d_RSAPrivateKey_fp(struct AmiSSLIFace *, FILE * fp, RSA * rsa);
extern int                  VARARGS68K _AmiSSL_i2d_X509_CRL_fp(struct AmiSSLIFace *, FILE * fp, X509_CRL * crl);
extern int                  VARARGS68K _AmiSSL_i2d_X509_REQ_fp(struct AmiSSLIFace *, FILE * fp, X509_REQ * req);
extern int                  VARARGS68K _AmiSSL_i2d_X509_fp(struct AmiSSLIFace *, FILE * fp, X509 * x509);
extern void                 VARARGS68K _AmiSSL_lh_node_stats(struct AmiSSLIFace *, const _LHASH * lh, FILE * out);
extern void                 VARARGS68K _AmiSSL_lh_node_usage_stats(struct AmiSSLIFace *, const _LHASH * lh, FILE * out);
extern void                 VARARGS68K _AmiSSL_lh_stats(struct AmiSSLIFace *, const _LHASH * lh, FILE * out);
extern RSA *                VARARGS68K _AmiSSL_d2i_RSAPublicKey_fp(struct AmiSSLIFace *, FILE * fp, RSA ** rsa);
extern int                  VARARGS68K _AmiSSL_i2d_RSAPublicKey_fp(struct AmiSSLIFace *, FILE * fp, RSA * rsa);
extern int                  VARARGS68K _AmiSSL_X509_CRL_print_fp(struct AmiSSLIFace *, FILE * fp, X509_CRL * x);
extern int                  VARARGS68K _AmiSSL_i2d_PKCS8_fp(struct AmiSSLIFace *, FILE * fp, X509_SIG * p8);
extern PKCS8_PRIV_KEY_INFO * VARARGS68K _AmiSSL_d2i_PKCS8_PRIV_KEY_INFO_fp(struct AmiSSLIFace *, FILE * fp, PKCS8_PRIV_KEY_INFO ** p8inf);
extern X509_SIG *           VARARGS68K _AmiSSL_d2i_PKCS8_fp(struct AmiSSLIFace *, FILE * fp, X509_SIG ** p8);
extern int                  VARARGS68K _AmiSSL_i2d_PKCS8_PRIV_KEY_INFO_fp(struct AmiSSLIFace *, FILE * fp, PKCS8_PRIV_KEY_INFO * p8inf);
extern LHASH_OF(CONF_VALUE) * VARARGS68K _AmiSSL_CONF_load_fp(struct AmiSSLIFace *, LHASH_OF(CONF_VALUE) * conf, FILE * fp, long * eline);
extern RSA *                VARARGS68K _AmiSSL_d2i_RSA_PUBKEY_fp(struct AmiSSLIFace *, FILE * fp, RSA ** rsa);
extern int                  VARARGS68K _AmiSSL_i2d_DSA_PUBKEY_fp(struct AmiSSLIFace *, FILE * fp, DSA * dsa);
extern DSA *                VARARGS68K _AmiSSL_PEM_read_DSA_PUBKEY(struct AmiSSLIFace *, FILE * fp, DSA ** x, pem_password_cb * cb, void * u);
extern DSA *                VARARGS68K _AmiSSL_d2i_DSA_PUBKEY_fp(struct AmiSSLIFace *, FILE * fp, DSA ** dsa);
extern int                  VARARGS68K _AmiSSL_PEM_write_DSA_PUBKEY(struct AmiSSLIFace *, FILE * fp, DSA * x);
extern int                  VARARGS68K _AmiSSL_i2d_RSA_PUBKEY_fp(struct AmiSSLIFace *, FILE * fp, RSA * rsa);
extern int                  VARARGS68K _AmiSSL_i2d_PKCS8PrivateKeyInfo_fp(struct AmiSSLIFace *, FILE * fp, EVP_PKEY * key);
extern int                  VARARGS68K _AmiSSL_i2d_PrivateKey_fp(struct AmiSSLIFace *, FILE * fp, EVP_PKEY * pkey);
extern EVP_PKEY *           VARARGS68K _AmiSSL_d2i_PrivateKey_fp(struct AmiSSLIFace *, FILE * fp, EVP_PKEY ** a);
extern int                  VARARGS68K _AmiSSL_NCONF_load_fp(struct AmiSSLIFace *, CONF * conf, FILE * fp, long * eline);
extern int                  VARARGS68K _AmiSSL_X509_NAME_print_ex_fp(struct AmiSSLIFace *, FILE * fp, X509_NAME * nm, int indent, unsigned long flags);
extern int                  VARARGS68K _AmiSSL_ASN1_STRING_print_ex_fp(struct AmiSSLIFace *, FILE * fp, ASN1_STRING * str, unsigned long flags);
extern int                  VARARGS68K _AmiSSL_i2d_PUBKEY_fp(struct AmiSSLIFace *, FILE * fp, EVP_PKEY * pkey);
extern EVP_PKEY *           VARARGS68K _AmiSSL_d2i_PUBKEY_fp(struct AmiSSLIFace *, FILE * fp, EVP_PKEY ** a);
...
extern void *               VARARGS68K _AmiSSL_ASN1_item_d2i_fp(struct AmiSSLIFace *, const ASN1_ITEM * it, FILE * in, void * x);
...
extern int                  VARARGS68K _AmiSSL_X509_print_ex_fp(struct AmiSSLIFace *, FILE * bp, X509 * x, unsigned long nmflag, unsigned long cflag);
...
extern int                  VARARGS68K _AmiSSL_ASN1_item_i2d_fp(struct AmiSSLIFace *, const ASN1_ITEM * it, FILE * out, void * x);
...
extern int                  VARARGS68K _AmiSSL_BIO_dump_fp(struct AmiSSLIFace *, FILE * fp, const char * s, int len);
...
extern int                  VARARGS68K _AmiSSL_EC_KEY_print_fp(struct AmiSSLIFace *, FILE * fp, const EC_KEY * key, int off);
...
extern int                  VARARGS68K _AmiSSL_ECPKParameters_print_fp(struct AmiSSLIFace *, FILE * fp, const EC_GROUP * x, int off);
...
extern int                  VARARGS68K _AmiSSL_BIO_dump_indent_fp(struct AmiSSLIFace *, FILE * fp, const char * s, int len, int indent);
...
extern int                  VARARGS68K _AmiSSL_PEM_write_EC_PUBKEY(struct AmiSSLIFace *, FILE * fp, EC_KEY * x);
...
extern EC_KEY *             VARARGS68K _AmiSSL_PEM_read_EC_PUBKEY(struct AmiSSLIFace *, FILE * fp, EC_KEY ** x, pem_password_cb * cb, void * u);
...
extern EC_KEY *             VARARGS68K _AmiSSL_PEM_read_ECPrivateKey(struct AmiSSLIFace *, FILE * fp, EC_KEY ** x, pem_password_cb * cb, void * u);
...
extern int                  VARARGS68K _AmiSSL_PEM_write_ECPKParameters(struct AmiSSLIFace *, FILE * fp, const EC_GROUP * x);
extern void                 VARARGS68K _AmiSSL_ENGINE_register_all_ECDH(struct AmiSSLIFace *);
extern int                  VARARGS68K _AmiSSL_i2d_ECPrivateKey_fp(struct AmiSSLIFace *, FILE * fp, EC_KEY * eckey);
...
extern EC_KEY *             VARARGS68K _AmiSSL_d2i_ECPrivateKey_fp(struct AmiSSLIFace *, FILE * fp, EC_KEY ** eckey);
extern void                 VARARGS68K _AmiSSL_SHA512_Transform(struct AmiSSLIFace *, SHA512_CTX * c, const unsigned char * data);
extern int                  VARARGS68K _AmiSSL_PEM_write_ECPrivateKey(struct AmiSSLIFace *, FILE * fp, EC_KEY * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_EC_KEY_set_public_key(struct AmiSSLIFace *, EC_KEY * key, const EC_POINT * pub);
extern EC_GROUP *           VARARGS68K _AmiSSL_PEM_read_ECPKParameters(struct AmiSSLIFace *, FILE * fp, EC_GROUP ** x, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_ENGINE_register_STORE(struct AmiSSLIFace *, ENGINE * e);
extern int                  VARARGS68K _AmiSSL_ECParameters_print_fp(struct AmiSSLIFace *, FILE * fp, const EC_KEY * key);
extern int                  VARARGS68K _AmiSSL_EC_GROUP_get_curve_name(struct AmiSSLIFace *, const EC_GROUP * group);
extern int                  VARARGS68K _AmiSSL_i2d_EC_PUBKEY_fp(struct AmiSSLIFace *, FILE * fp, EC_KEY * eckey);
...
extern EC_KEY *             VARARGS68K _AmiSSL_d2i_EC_PUBKEY_fp(struct AmiSSLIFace *, FILE * fp, EC_KEY ** eckey);
...
extern int                  VARARGS68K _AmiSSL_PEM_write_CMS(struct AmiSSLIFace *, FILE * fp, CMS_ContentInfo * x);
...
extern int                  VARARGS68K _AmiSSL_PEM_read_CMS(struct AmiSSLIFace *, FILE * fp, CMS_ContentInfo ** x, pem_password_cb * cb, void * u);
...
extern SSL_SESSION *        VARARGS68K _AmiSSL_PEM_read_SSL_SESSION(struct AmiSSLIFace *, FILE * fp, SSL_SESSION ** x, pem_password_cb * cb, void * u);
...
extern int                  VARARGS68K _AmiSSL_PEM_write_SSL_SESSION(struct AmiSSLIFace *, FILE * fp, SSL_SESSION * x);
extern PKCS7 *              VARARGS68K _AmiSSL_PEM_read_PKCS7(struct AmiSSLIFace *, FILE * fp, PKCS7 ** x, pem_password_cb * cb, void * u);
extern EVP_PKEY *           VARARGS68K _AmiSSL_PEM_read_PrivateKey(struct AmiSSLIFace *, FILE * fp, EVP_PKEY ** x, pem_password_cb * cb, void * u);
extern RSA *                VARARGS68K _AmiSSL_PEM_read_RSAPrivateKey(struct AmiSSLIFace *, FILE * fp, RSA ** x, pem_password_cb * cb, void * u);
extern X509 *               VARARGS68K _AmiSSL_PEM_read_X509(struct AmiSSLIFace *, FILE * fp, X509 ** x, pem_password_cb * cb, void * u);
extern X509_CRL *           VARARGS68K _AmiSSL_PEM_read_X509_CRL(struct AmiSSLIFace *, FILE * fp, X509_CRL ** x, pem_password_cb * cb, void * u);
extern X509_REQ *           VARARGS68K _AmiSSL_PEM_read_X509_REQ(struct AmiSSLIFace *, FILE * fp, X509_REQ ** x, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_PKCS7(struct AmiSSLIFace *, FILE * fp, PKCS7 * x);
extern int                  VARARGS68K _AmiSSL_PEM_write_PrivateKey(struct AmiSSLIFace *, FILE * fp, EVP_PKEY * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_RSAPrivateKey(struct AmiSSLIFace *, FILE * fp, RSA * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_X509(struct AmiSSLIFace *, FILE * fp, X509 * x);
extern int                  VARARGS68K _AmiSSL_PEM_write_X509_CRL(struct AmiSSLIFace *, FILE * fp, X509_CRL * x);
extern int                  VARARGS68K _AmiSSL_PEM_write_X509_REQ(struct AmiSSLIFace *, FILE * fp, X509_REQ * x);
extern RSA *                VARARGS68K _AmiSSL_PEM_read_RSAPublicKey(struct AmiSSLIFace *, FILE * fp, RSA ** x, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_RSAPublicKey(struct AmiSSLIFace *, FILE * fp, RSA * x);
extern NETSCAPE_CERT_SEQUENCE * VARARGS68K _AmiSSL_PEM_read_NETSCAPE_CERT_SEQUENCE(struct AmiSSLIFace *, FILE * fp, NETSCAPE_CERT_SEQUENCE ** x, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_NETSCAPE_CERT_SEQUENCE(struct AmiSSLIFace *, FILE * fp, NETSCAPE_CERT_SEQUENCE * x);
extern int                  VARARGS68K _AmiSSL_X509V3_EXT_print_fp(struct AmiSSLIFace *, FILE * out, X509_EXTENSION * ext, int flag, int indent);
extern int                  VARARGS68K _AmiSSL_i2d_PKCS12_fp(struct AmiSSLIFace *, FILE * fp, PKCS12 * p12);
extern PKCS12 *             VARARGS68K _AmiSSL_d2i_PKCS12_fp(struct AmiSSLIFace *, FILE * fp, PKCS12 ** p12);
extern X509_SIG *           VARARGS68K _AmiSSL_PEM_read_PKCS8(struct AmiSSLIFace *, FILE * fp, X509_SIG ** x, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_PKCS8(struct AmiSSLIFace *, FILE * fp, X509_SIG * x);
extern PKCS8_PRIV_KEY_INFO * VARARGS68K _AmiSSL_PEM_read_PKCS8_PRIV_KEY_INFO(struct AmiSSLIFace *, FILE * fp, PKCS8_PRIV_KEY_INFO ** x, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_PKCS8_PRIV_KEY_INFO(struct AmiSSLIFace *, FILE * fp, PKCS8_PRIV_KEY_INFO * x);
extern int                  VARARGS68K _AmiSSL_PEM_write_PKCS8PrivateKey(struct AmiSSLIFace *, FILE * fp, EVP_PKEY * x, const EVP_CIPHER * enc, char * kstr, int klen, pem_password_cb * cb, void * u);
extern X509 *               VARARGS68K _AmiSSL_PEM_read_X509_AUX(struct AmiSSLIFace *, FILE * fp, X509 ** x, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_PUBKEY(struct AmiSSLIFace *, FILE * fp, EVP_PKEY * x);
extern RSA *                VARARGS68K _AmiSSL_PEM_read_RSA_PUBKEY(struct AmiSSLIFace *, FILE * fp, RSA ** x, pem_password_cb * cb, void * u);
extern EVP_PKEY *           VARARGS68K _AmiSSL_PEM_read_PUBKEY(struct AmiSSLIFace *, FILE * fp, EVP_PKEY ** x, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_X509_AUX(struct AmiSSLIFace *, FILE * fp, X509 * x);
extern int                  VARARGS68K _AmiSSL_PEM_write_RSA_PUBKEY(struct AmiSSLIFace *, FILE * fp, RSA * x);
extern int                  VARARGS68K _AmiSSL_PEM_write_PKCS8PrivateKey_nid(struct AmiSSLIFace *, FILE * fp, EVP_PKEY * x, int nid, char * kstr, int klen, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_i2d_PKCS8PrivateKey_fp(struct AmiSSLIFace *, FILE * fp, EVP_PKEY * x, const EVP_CIPHER * enc, char * kstr, int klen, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_i2d_PKCS8PrivateKey_nid_fp(struct AmiSSLIFace *, FILE * fp, EVP_PKEY * x, int nid, char * kstr, int klen, pem_password_cb * cb, void * u);
extern EVP_PKEY *           VARARGS68K _AmiSSL_d2i_PKCS8PrivateKey_fp(struct AmiSSLIFace *, FILE * fp, EVP_PKEY ** x, pem_password_cb * cb, void * u);
extern int                  VARARGS68K _AmiSSL_PEM_write_X509_REQ_NEW(struct AmiSSLIFace *, FILE * fp, X509_REQ * x);
extern int                  VARARGS68K _AmiSSL_CONF_dump_fp(struct AmiSSLIFace *, LHASH_OF(CONF_VALUE) * conf, FILE * out);
extern int                  VARARGS68K _AmiSSL_NCONF_dump_fp(struct AmiSSLIFace *, const CONF * conf, FILE * out);
...
extern X509_CERT_PAIR *     VARARGS68K _AmiSSL_PEM_read_X509_CERT_PAIR(struct AmiSSLIFace *, FILE * fp, X509_CERT_PAIR ** x, pem_password_cb * cb, void * u);
...
extern int                  VARARGS68K _AmiSSL_PEM_write_X509_CERT_PAIR(struct AmiSSLIFace *, FILE * fp, X509_CERT_PAIR * x);
...
extern int                  VARARGS68K _AmiSSL_i2d_TS_MSG_IMPRINT_fp(struct AmiSSLIFace *, FILE * fp, TS_MSG_IMPRINT * a);
...
extern int                  VARARGS68K _AmiSSL_i2d_TS_TST_INFO_fp(struct AmiSSLIFace *, FILE * fp, TS_TST_INFO * a);
...
extern TS_RESP *            VARARGS68K _AmiSSL_d2i_TS_RESP_fp(struct AmiSSLIFace *, FILE * fp, TS_RESP ** a);
...
extern int                  VARARGS68K _AmiSSL_i2d_TS_RESP_fp(struct AmiSSLIFace *, FILE * fp, TS_RESP * a);
...
extern TS_TST_INFO *        VARARGS68K _AmiSSL_d2i_TS_TST_INFO_fp(struct AmiSSLIFace *, FILE * fp, TS_TST_INFO ** a);
...
extern TS_REQ *             VARARGS68K _AmiSSL_d2i_TS_REQ_fp(struct AmiSSLIFace *, FILE * fp, TS_REQ ** a);
...
extern TS_MSG_IMPRINT *     VARARGS68K _AmiSSL_d2i_TS_MSG_IMPRINT_fp(struct AmiSSLIFace *, FILE * fp, TS_MSG_IMPRINT ** a);
...
extern int                  VARARGS68K _AmiSSL_i2d_TS_REQ_fp(struct AmiSSLIFace *, FILE * fp, TS_REQ * a);
