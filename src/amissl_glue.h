...
int SAVEDS ASM LIB_EVP_PKEY_size(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_PKEY * pkey));
...
int SAVEDS ASM LIB_RAND_DRBG_set_callbacks(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg), REG(a1, RAND_DRBG_get_entropy_fn get_entropy), REG(a2, RAND_DRBG_cleanup_entropy_fn cleanup_entropy), REG(a3, RAND_DRBG_get_nonce_fn get_nonce), REG(d0, RAND_DRBG_cleanup_nonce_fn cleanup_nonce));
