...
int SAVEDS ASM LIB_CRYPTO_set_mem_functions(REG(a6, __IFACE_OR_BASE), REG(a0, void * (*m)(size_t, const char *, int)), REG(a1, void * (*r)(void *, size_t, const char *, int)), REG(a2, void (*f)(void *)));
void SAVEDS ASM LIB_CRYPTO_get_mem_functions(REG(a6, __IFACE_OR_BASE), REG(a0, void * (**m)(size_t, const char *, int)), REG(a1, void * (**r)(void *, size_t, const char *, int)), REG(a2, void (**f)(void *)));
...
PKCS12 * SAVEDS ASM LIB_PKCS12_create(REG(a6, __IFACE_OR_BASE), REG(a0, char * pass), REG(a1, char * name), REG(a2, EVP_PKEY * pkey), REG(a3, X509 * cert), REG(d0, STACK_OF(X509) * ca), REG(d1, int nid_key), REG(d2, int nid_cert), REG(d3, int iter), REG(d4, int mac_iter), REG(d5, int keytype));
...
int SAVEDS ASM LIB_X509_STORE_get_by_subject(REG(a6, __IFACE_OR_BASE), REG(a0, X509_STORE_CTX * vs), REG(d0, enum X509_LOOKUP_TYPE type), REG(a1, X509_NAME * name), REG(a2, X509_OBJECT * ret));
...
EC_KEY * SAVEDS ASM LIB_EC_KEY_dup(REG(a6, __IFACE_OR_BASE), REG(a0, EC_KEY * ec_key));
...
EC_KEY * SAVEDS ASM LIB_EC_KEY_copy(REG(a6, __IFACE_OR_BASE), REG(a0, EC_KEY * dst), REG(a1, EC_KEY * src));
...
BIGNUM * SAVEDS ASM LIB_SRP_Calc_server_key(REG(a6, __IFACE_OR_BASE), REG(a0, BIGNUM * A), REG(a1, BIGNUM * v), REG(a2, BIGNUM * u), REG(a3, BIGNUM * b), REG(d0, BIGNUM * N));
...
BIGNUM * SAVEDS ASM LIB_SRP_Calc_client_key(REG(a6, __IFACE_OR_BASE), REG(a0, BIGNUM * N), REG(a1, BIGNUM * B), REG(a2, BIGNUM * g), REG(a3, BIGNUM * x), REG(d0, BIGNUM * a), REG(d1, BIGNUM * u));
...
unsigned int * SAVEDS ASM LIB_OPENSSL_ia32cap_loc(REG(a6, __IFACE_OR_BASE));
...
_STACK * SAVEDS ASM LIB_sk_deep_copy(REG(a6, __IFACE_OR_BASE), REG(a0, _STACK * sk), REG(a1, void * (*copy_func)(void *)), REG(a2, void (*free_func)(void *)));
...
void SAVEDS ASM LIB_X509_STORE_set_lookup_crls_cb(REG(a6, __IFACE_OR_BASE), REG(a0, X509_STORE * ctx), REG(a1, STACK_OF(X509_CRL) *(*cb)(X509_STORE_CTX *ctx, X509_NAME *nm)));
...
int SAVEDS ASM LIB_ASN1_buf_print(REG(a6, __IFACE_OR_BASE), REG(a0, BIO * bp), REG(a1, unsigned char * buf), REG(a2, size_t buflen), REG(d0, int indent));
...
void SAVEDS ASM LIB_ASYNC_clear_wake(REG(a6, __IFACE_OR_BASE), REG(a0, ASYNC_JOB * job));
ASYNC_JOB * SAVEDS ASM LIB_ASYNC_get_current_job(REG(a6, __IFACE_OR_BASE));
OSSL_ASYNC_FD SAVEDS ASM LIB_ASYNC_get_wait_fd(REG(a6, __IFACE_OR_BASE), REG(a0, ASYNC_JOB * job));
...
int SAVEDS ASM LIB_ASYNC_start_job(REG(a6, __IFACE_OR_BASE), REG(a0, ASYNC_JOB ** job), REG(a1, int * ret), REG(a2, int (*func)(void *)), REG(a3, void * args), REG(d0, size_t size));
void SAVEDS ASM LIB_ASYNC_unblock_pause(REG(a6, __IFACE_OR_BASE));
void SAVEDS ASM LIB_ASYNC_wake(REG(a6, __IFACE_OR_BASE), REG(a0, ASYNC_JOB * job));
void SAVEDS ASM LIB_ERR_load_ASYNC_strings(REG(a6, __IFACE_OR_BASE));
...
BIO_METHOD * SAVEDS ASM LIB_BIO_s_secmem(REG(a6, __IFACE_OR_BASE));
...
BIGNUM * SAVEDS ASM LIB_BN_nist_mod_func(REG(a6, __IFACE_OR_BASE), REG(a0, const BIGNUM * p));
...
void SAVEDS ASM LIB_CRYPTO_clear_free(REG(a6, __IFACE_OR_BASE), REG(a0, void * str), REG(d0, size_t num));
...
void SAVEDS ASM LIB_CRYPTO_secure_free(REG(a6, __IFACE_OR_BASE), REG(a0, void * ptr));
int SAVEDS ASM LIB_CRYPTO_secure_malloc(REG(a6, __IFACE_OR_BASE), REG(d0, size_t num), REG(a0, const char * file), REG(d1, int line));
void SAVEDS ASM LIB_CRYPTO_secure_malloc_done(REG(a6, __IFACE_OR_BASE));
...
void SAVEDS ASM LIB_OPENSSL_INIT_set_config_filename(REG(a6, __IFACE_OR_BASE), REG(a0, OPENSSL_INIT_SETTINGS * settings), REG(a1, const char * config_file));
...
size_t SAVEDS ASM LIB_EC_KEY_key2buf(REG(a6, __IFACE_OR_BASE), REG(a0, const EC_KEY * key), REG(d0, enum point_conversion_form_t form), REG(a1, unsigned char ** pbuf), REG(a2, BN_CTX * ctx));
void SAVEDS ASM LIB_EC_KEY_METHOD_free(REG(a6, __IFACE_OR_BASE), REG(a0, EC_KEY_METHOD * meth));
void SAVEDS ASM LIB_EC_KEY_METHOD_get_compute_key(REG(a6, __IFACE_OR_BASE), REG(a0, EC_KEY_METHOD * meth), REG(a1, int (**)(void *, size_t, const EC_POINT *, const EC_KEY *, void *(*pck)(const void *, size_t, void *, size_t *))));
...
int SAVEDS ASM LIB_EC_KEY_oct2priv(REG(a6, __IFACE_OR_BASE), REG(a0, EC_KEY * key), REG(a1, unsigned char * buf), REG(d0, size_t len));
...
void SAVEDS ASM LIB_ECDSA_SIG_get0(REG(a6, __IFACE_OR_BASE), REG(a0, BIGNUM ** pr), REG(a1, BIGNUM ** ps), REG(a2, ECDSA_SIG * sig));
...
void * SAVEDS ASM LIB_EVP_CIPHER_CTX_cipher_data(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER_CTX * ctx));
...
int SAVEDS ASM LIB_EVP_MD_meth_get_cleanup(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_MD * md));
...
void SAVEDS ASM LIB_EVP_PKEY_meth_get_ctrl(REG(a6, __IFACE_OR_BASE), REG(a0, EVP_PKEY_METHOD * pmeth), REG(a1, int (**pctrl)(EVP_PKEY_CTX *)), REG(a2, int (**pctrl_str)(EVP_PKEY_CTX *, const char *, const char *)));
...
void SAVEDS ASM LIB_EVP_PKEY_up_ref(REG(a6, __IFACE_OR_BASE), REG(a0, EVP_PKEY * pkey));
...
size_t SAVEDS ASM LIB_HMAC_size(REG(a6, __IFACE_OR_BASE), REG(a0, HMAC_CTX * ctx));
int SAVEDS ASM LIB_lh_error(REG(a6, __IFACE_OR_BASE), REG(a0, _LHASH * lh));
unsigned long SAVEDS ASM LIB_lh_get_down_load(REG(a6, __IFACE_OR_BASE), REG(a0, const _LHASH * lh));
void SAVEDS ASM LIB_lh_set_down_load(REG(a6, __IFACE_OR_BASE), REG(a0, _LHASH * lh), REG(d0, unsigned long down_load));
size_t SAVEDS ASM LIB_CRYPTO_128_unwrap_pad(REG(a6, __IFACE_OR_BASE), REG(a0, void * key), REG(a1, const unsigned char * icv), REG(a2, unsigned char * out), REG(a3, const unsigned char * in), REG(d0, size_t inlen), REG(d1, block128_t block));
size_t SAVEDS ASM LIB_CRYPTO_128_wrap_pad(REG(a6, __IFACE_OR_BASE), REG(a0, void * key), REG(a1, const unsigned char * icv), REG(a2, unsigned char * out), REG(a3, const unsigned char * in), REG(d0, size_t inlen), REG(d1, block128_t block));
...
int SAVEDS ASM LIB_CRYPTO_ocb128_init(REG(a6, __IFACE_OR_BASE), REG(a0, OCB128_CONTEXT * ctx), REG(a1, void * keyenc), REG(a2, void * keydec), REG(d0, block128_t encrypt), REG(d1, block128_t decrypt), REG(d2, ocb128_f stream));
OCB128_CONTEXT * SAVEDS ASM LIB_CRYPTO_ocb128_new(REG(a6, __IFACE_OR_BASE), REG(a0, void * keyenc), REG(a1, void * keydec), REG(d0, block128_t encrypt), REG(d1, block128_t decrypt), REG(d2, ocb128_f stream));
...
int SAVEDS ASM LIB_TS_CONF_set_signer_digest(REG(a6, __IFACE_OR_BASE), REG(a0, CONG * conf), REG(a1, const char * section), REG(a2, const char * md), REG(a3, TS_RESP_CTX * ctx));
...
unsigned char * SAVEDS ASM LIB_TS_VERIFY_CTX_set_flags(REG(a6, __IFACE_OR_BASE), REG(a0, TS_VERIFY_CTX * ctx), REG(a1, unsigned char * hexstr), REG(d0, long len));
...
long SAVEDS ASM LIB_X509_CRL_get_version(REG(a6, __IFACE_OR_BASE), REG(a0, X509_CRL * crl));
void SAVEDS ASM LIB_X509_CRL_up_ref(REG(a6, __IFACE_OR_BASE), REG(a0, X509_CRL * crl));
STACK_OF(X509_EXTENSION) * SAVEDS ASM LIB_X509_get0_extensions(REG(a6, __IFACE_OR_BASE), REG(a0, const X509 * x));
EVP_PKEY * SAVEDS ASM LIB_X509_get0_pubkey(REG(a6, __IFACE_OR_BASE), REG(a0, X509 * x));
...
ASN1_TIME * SAVEDS ASM LIB_X509_get_notAfter(REG(a6, __IFACE_OR_BASE), REG(a0, X509 * x));
ASN1_TIME * SAVEDS ASM LIB_X509_get_notBefore(REG(a6, __IFACE_OR_BASE), REG(a0, X509 * x));
int SAVEDS ASM LIB_X509_get_signature_type(REG(a6, __IFACE_OR_BASE), REG(a0, const X509 * x));
long SAVEDS ASM LIB_X509_get_version(REG(a6, __IFACE_OR_BASE), REG(a0, X509 * x));
...
X509_NAME * SAVEDS ASM LIB_X509_REQ_get_subject_name(REG(a6, __IFACE_OR_BASE), REG(a0, X509_REQ * req));
long SAVEDS ASM LIB_X509_REQ_get_version(REG(a6, __IFACE_OR_BASE), REG(a0, X509_REQ * req));
X509_PUBKEY * SAVEDS ASM LIB_X509_REQ_get_X509_PUBKEY(REG(a6, __IFACE_OR_BASE), REG(a0, X509_REQ * req));
STACK_OF(X509_EXTENSION) * SAVEDS ASM LIB_X509_REVOKED_get0_extensions(REG(a6, __IFACE_OR_BASE), REG(a0, X509_REVOKED * r));
...
void SAVEDS ASM LIB_X509_up_ref(REG(a6, __IFACE_OR_BASE), REG(a0, X509 * x));
int SAVEDS ASM LIB_X509_STORE_CTX_get_num_untrusted(REG(a6, __IFACE_OR_BASE), REG(a0, X509_STORE_CTX * ctx));
void SAVEDS ASM LIB_X509_STORE_CTX_set0_dane(REG(a6, __IFACE_OR_BASE), REG(a0, X509_STORE_CTX * ctx), REG(a1, struct dane_st * dane));
...
int SAVEDS ASM LIB_v3_addr_canonize(REG(a6, __IFACE_OR_BASE), REG(a0, IPAddrBlocks * addr));
unsigned SAVEDS ASM LIB_v3_addr_get_afi(REG(a6, __IFACE_OR_BASE), REG(a0, const IPAddressFamily * f));
int SAVEDS ASM LIB_v3_addr_get_range(REG(a6, __IFACE_OR_BASE), REG(a0, IPAddressOrRange * aor), REG(d0, const unsigned afi), REG(a1, unsigned char * min), REG(a2, unsigned char * max), REG(d1, const int length));
int SAVEDS ASM LIB_v3_addr_inherits(REG(a6, __IFACE_OR_BASE), REG(a0, IPAddrBlocks * addr));
int SAVEDS ASM LIB_v3_addr_is_canonical(REG(a6, __IFACE_OR_BASE), REG(a0, IPAddrBlocks * addr));
int SAVEDS ASM LIB_v3_addr_subset(REG(a6, __IFACE_OR_BASE), REG(a0, IPAddrBlocks * a), REG(a1, IPAddrBlocks * b));
int SAVEDS ASM LIB_v3_addr_validate_path(REG(a6, __IFACE_OR_BASE), REG(a0, X509_STORE_CTX * ctx));
int SAVEDS ASM LIB_v3_asid_add_id_or_range(REG(a6, __IFACE_OR_BASE), REG(a0, ASIdentifiers * asid), REG(d0, int which), REG(a1, ASN1_INTEGER * min), REG(a2, ASN1_INTEGER * max));
int SAVEDS ASM LIB_v3_asid_add_inherit(REG(a6, __IFACE_OR_BASE), REG(a0, ASIdentifiers * asid), REG(d0, int which));
int SAVEDS ASM LIB_v3_asid_canonize(REG(a6, __IFACE_OR_BASE), REG(a0, ASIdentifiers * asid));
int SAVEDS ASM LIB_v3_asid_inherits(REG(a6, __IFACE_OR_BASE), REG(a0, ASIdentifiers * asid));
int SAVEDS ASM LIB_v3_asid_is_canonical(REG(a6, __IFACE_OR_BASE), REG(a0, ASIdentifiers * asid));
int SAVEDS ASM LIB_v3_asid_subset(REG(a6, __IFACE_OR_BASE), REG(a0, ASIdentifiers * a), REG(a1, ASIdentifiers * b));
int SAVEDS ASM LIB_v3_asid_validate_path(REG(a6, __IFACE_OR_BASE), REG(a0, X509_STORE_CTX * ctx));
...
const SSL_METHOD * SAVEDS ASM LIB_TLS_server_method(REG(a6, __IFACE_OR_BASE));
  ...
  #define SDI_LIBVECTOR \
    ...
    LFUNC_FA_(UNIMPLEMENTED) /* lh_node_stats */ \
    LFUNC_FA_(UNIMPLEMENTED) /* lh_node_usage_stats */ \
    LFUNC_FA_(UNIMPLEMENTED) /* lh_stats */ \
    ...
    LFUNC_FA_(UNIMPLEMENTED) /* i2d_ASN1_SET_ANY */ \
    ...
    LFUNC_FA_(UNIMPLEMENTED) /* d2i_ASN1_SET_ANY */ \
    ...
    LFUNC_FA_(OPENSSL_INIT_set_config_filename) \
    ...
    LFUNC_FA_(EVP_CIPHER_CTX_cipher_data) \
    ...
    LFUNC_FA_(HMAC_size) \
    LFUNC_FA_(lh_error) \
    LFUNC_FA_(lh_get_down_load) \
    LFUNC_FA_(lh_set_down_load) \
    ...
    LFUNC_FA_(v3_addr_add_inherit) \
    LFUNC_FA_(v3_addr_add_prefix) \
    LFUNC_FA_(v3_addr_add_range) \
    LFUNC_FA_(v3_addr_canonize) \
    LFUNC_FA_(v3_addr_get_afi) \
    LFUNC_FA_(v3_addr_get_range) \
    LFUNC_FA_(v3_addr_inherits) \
    LFUNC_FA_(v3_addr_is_canonical) \
    LFUNC_FA_(v3_addr_subset) \
    LFUNC_FA_(v3_addr_validate_path) \
    LFUNC_FA_(v3_asid_add_id_or_range) \
    LFUNC_FA_(v3_asid_add_inherit) \
    LFUNC_FA_(v3_asid_canonize) \
    LFUNC_FA_(v3_asid_inherits) \
    LFUNC_FA_(v3_asid_is_canonical) \
    LFUNC_FA_(v3_asid_subset) \
    LFUNC_FA_(v3_asid_validate_path) \
