...
int SAVEDS ASM LIB_X509_STORE_set1_param(REG(a6, __IFACE_OR_BASE), REG(a0, X509_STORE * ctx), REG(a1, const X509_VERIFY_PARAM * pm));
...
STACK_OF(X509) * SAVEDS ASM LIB_X509_STORE_CTX_get1_certs(REG(a6, __IFACE_OR_BASE), REG(a0, X509_STORE_CTX * st), REG(a1, const X509_NAME * nm));
...
STACK_OF(X509_OBJECT) * SAVEDS ASM LIB_X509_STORE_get0_objects(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * v));
X509_VERIFY_PARAM * SAVEDS ASM LIB_X509_STORE_get0_param(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
...
X509_STORE_CTX_verify_fn SAVEDS ASM LIB_X509_STORE_get_verify(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
X509_STORE_CTX_verify_cb SAVEDS ASM LIB_X509_STORE_get_verify_cb(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
...
X509_STORE_CTX_get_issuer_fn SAVEDS ASM LIB_X509_STORE_get_get_issuer(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
...
X509_STORE_CTX_check_issued_fn SAVEDS ASM LIB_X509_STORE_get_check_issued(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
...
X509_STORE_CTX_check_revocation_fn SAVEDS ASM LIB_X509_STORE_get_check_revocation(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
...
X509_STORE_CTX_get_crl_fn SAVEDS ASM LIB_X509_STORE_get_get_crl(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
...
X509_STORE_CTX_check_crl_fn SAVEDS ASM LIB_X509_STORE_get_check_crl(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
...
X509_STORE_CTX_cert_crl_fn SAVEDS ASM LIB_X509_STORE_get_cert_crl(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
...
X509_STORE_CTX_check_policy_fn SAVEDS ASM LIB_X509_STORE_get_check_policy(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
...
X509_STORE_CTX_lookup_certs_fn SAVEDS ASM LIB_X509_STORE_get_lookup_certs(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
...
X509_STORE_CTX_lookup_crls_fn SAVEDS ASM LIB_X509_STORE_get_lookup_crls(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
...
X509_STORE_CTX_cleanup_fn SAVEDS ASM LIB_X509_STORE_get_cleanup(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx));
int SAVEDS ASM LIB_X509_STORE_set_ex_data(REG(a6, __IFACE_OR_BASE), REG(a0, X509_STORE * ctx), REG(d0, int idx), REG(a1, void * data));
void * SAVEDS ASM LIB_X509_STORE_get_ex_data(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_STORE * ctx), REG(d0, int idx));
