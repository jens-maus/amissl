...
void SAVEDS ASM LIB_RAND_add(REG(a6, __IFACE_OR_BASE), REG(a0, const void * buf), REG(d0, int num), REG(d1, double randomness));
...
void SAVEDS ASM LIB_EVP_PKEY_meth_get_copy(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_PKEY_METHOD * pmeth), REG(a1, int (**pcopy)(EVP_PKEY_CTX *, EVP_PKEY_CTX *)));
