...
int SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_type(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER * ctx));
...
int SAVEDS ASM LIB_i2d_PKCS12_bio(REG(a6, __IFACE_OR_BASE), REG(a0, const BIO * bp), REG(a1, PKCS12 * p12));
...
int SAVEDS ASM LIB_i2d_PKCS7_bio(REG(a6, __IFACE_OR_BASE), REG(a0, const BIO * bp), REG(a1, PKCS7 * p7));
...
X509 * SAVEDS ASM LIB_OBSOLETE_SSL_get_peer_certificate(REG(a6, __IFACE_OR_BASE), REG(a0, const SSL * s));
...
int SAVEDS ASM LIB_OBSOLETE_MD2_Init(REG(a6, __IFACE_OR_BASE), REG(a0, MD2_CTX * c));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_nid(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER * cipher));
int SAVEDS ASM LIB_OBSOLETE_EVP_MD_type(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_MD * md));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_iv_length(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER * cipher));
...
int SAVEDS ASM LIB_OBSOLETE_OCSP_sendreq_nbio(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_RESPONSE ** presp), REG(a1, OCSP_REQ_CTX * rctx));
void SAVEDS ASM LIB_OBSOLETE_OCSP_REQ_CTX_free(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_REQ_CTX * rctx));
...
EC_KEY * SAVEDS ASM LIB_OBSOLETE_d2i_EC_PUBKEY(REG(a6, __IFACE_OR_BASE), REG(a0, EC_KEY ** a), REG(a1, const unsigned char ** pp), REG(a2, long length));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_block_size(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER * cipher));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_CTX_nid(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER_CTX * ctx));
int SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_CTX_key_length(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER_CTX * ctx));
int SAVEDS ASM LIB_OBSOLETE_EVP_MD_size(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_MD * md));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_MD_pkey_type(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_MD * md));
void SAVEDS ASM LIB_EVP_MD_CTX_clear_flags(REG(a6, __IFACE_OR_BASE), REG(a0, EVP_MD_CTX * ctx), REG(d0, int flags));
unsigned long SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_flags(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER * cipher));
BIO_callback_fn SAVEDS ASM LIB_BIO_get_callback(REG(a6, __IFACE_OR_BASE), REG(a0, const BIO * b));
int SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_key_length(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER * cipher));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_CTX_block_size(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER_CTX * ctx));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_MD_block_size(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_MD * md));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_CTX_iv_length(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER_CTX * ctx));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_PKEY_base_id(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_PKEY * pkey));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_PKEY_id(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_PKEY * pkey));
...
unsigned long SAVEDS ASM LIB_OBSOLETE_EVP_MD_flags(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_MD * md));
void SAVEDS ASM LIB_TS_RESP_CTX_free(REG(a6, __IFACE_OR_BASE), REG(a0, TS_RESP_CTX * ctx));
int SAVEDS ASM LIB_OBSOLETE_OCSP_REQ_CTX_add1_header(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_REQ_CTX * rctx), REG(a1, const char * name), REG(a2, const char * value));
int SAVEDS ASM LIB_OBSOLETE_OCSP_REQ_CTX_set1_req(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_REQ_CTX * rctx), REG(a1, OCSP_REQUEST * req));
...
BIO * SAVEDS ASM LIB_OBSOLETE_OCSP_REQ_CTX_get0_mem_bio(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_REQ_CTX * rctx));
int SAVEDS ASM LIB_OBSOLETE_OCSP_REQ_CTX_http(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_REQ_CTX * rctx), REG(a1, const char * op), REG(a2, const char * path));
int SAVEDS ASM LIB_OBSOLETE_OCSP_REQ_CTX_i2d(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_REQ_CTX * rctx), REG(a1, const ASN1_ITEM * it), REG(a2, ASN1_VALUE * val));
int SAVEDS ASM LIB_OBSOLETE_OCSP_REQ_CTX_nbio(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_REQ_CTX * rctx));
int SAVEDS ASM LIB_OBSOLETE_OCSP_REQ_CTX_nbio_d2i(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_REQ_CTX * rctx), REG(a1, ASN1_VALUE ** pval), REG(a2, const ASN1_ITEM * it));
OCSP_REQ_CTX * SAVEDS ASM LIB_OBSOLETE_OCSP_REQ_CTX_new(REG(a6, __IFACE_OR_BASE), REG(a0, BIO * io), REG(d0, int maxline));
void SAVEDS ASM LIB_OBSOLETE_OCSP_set_max_response_length(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_REQ_CTX * rctx), REG(d0, unsigned long len));
...
int SAVEDS ASM LIB_OBSOLETE_X509_CRL_http_nbio(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_REQ_CTX * rctx), REG(a1, X509_CRL ** pcrl));
...
int SAVEDS ASM LIB_OBSOLETE_X509_http_nbio(REG(a6, __IFACE_OR_BASE), REG(a0, OCSP_REQ_CTX * rctx), REG(a1, X509 ** pcert));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_CTX_encrypting(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER_CTX * ctx));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_CIPHER_CTX_num(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_CIPHER_CTX * ctx));
...
void * SAVEDS ASM LIB_OBSOLETE_EVP_MD_CTX_md_data(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_MD_CTX * ctx));
EVP_MD_CTX * SAVEDS ASM LIB_EVP_MD_CTX_new(REG(a6, __IFACE_OR_BASE));
EVP_PKEY_CTX * SAVEDS ASM LIB_OBSOLETE_EVP_MD_CTX_pkey_ctx(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_MD_CTX * ctx));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_PKEY_security_bits(REG(a6, __IFACE_OR_BASE), REG(a0, const EVP_PKEY * pkey));
...
STACK_OF(X509) * SAVEDS ASM LIB_OBSOLETE_TS_VERIFY_CTS_set_certs(REG(a6, __IFACE_OR_BASE), REG(a0, TS_VERIFY_CTX * ctx), REG(a1, STACK_OF(X509) * certs));
...
int SAVEDS ASM LIB_OBSOLETE_EVP_PKEY_set1_tls_encodedpoint(REG(a6, __IFACE_OR_BASE), REG(a0, EVP_PKEY * pkey), REG(a1, const unsigned char * pt), REG(d0, size_t ptlen));
size_t SAVEDS ASM LIB_OBSOLETE_EVP_PKEY_get1_tls_encodedpoint(REG(a6, __IFACE_OR_BASE), REG(a0, EVP_PKEY * pkey), REG(a1, unsigned char ** ppt));
...
void * SAVEDS ASM LIB_RSA_X931_derive_ex_amiga_2(REG(a6, __IFACE_OR_BASE), REG(a0, const BIGNUM * Xp2), REG(a1, const BIGNUM * Xp), REG(a2, const BIGNUM * Xq1), REG(d0, const BIGNUM * Xq2), REG(d1, const BIGNUM * Xq), REG(d2, const BIGNUM * e), REG(a3, BN_GENCB * cb));
  ...
  #define SDI_LIBVECTOR \
    ...
    LFUNC_FA_(OBSOLETE_EVP_PKEY_bits) \
    LFUNC_FA_(OBSOLETE_EVP_PKEY_size) \
    ...
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_type) \
    ...
    LFUNC_FA_(OBSOLETE_SSL_get_peer_certificate) \
    ...
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_nid) \
    LFUNC_FA_(OBSOLETE_EVP_MD_type) \
    ...
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_iv_length) \
    ...
    LFUNC_FA_(OBSOLETE_OCSP_REQ_CTX_free) \
    ...
    LFUNC_FA_(OBSOLETE_d2i_EC_PUBKEY) \
    ...
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_block_size) \
    LFUNC_FA_(EVP_CIPHER_CTX_set_app_data) \
    LFUNC_FA_(BIO_method_type) \
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_CTX_nid) \
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_CTX_key_length) \
    LFUNC_FA_(OBSOLETE_EVP_MD_size) \
    LFUNC_FA_(EVP_MD_CTX_test_flags) \
    LFUNC_FA_(BIO_clear_flags) \
    LFUNC_FA_(OBSOLETE_EVP_MD_pkey_type) \
    LFUNC_FA_(EVP_MD_CTX_clear_flags) \
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_flags) \
    LFUNC_FA_(BIO_get_callback) \
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_key_length) \
    LFUNC_FA_(EVP_Cipher) \
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_CTX_block_size) \
    LFUNC_FA_(EVP_CIPHER_CTX_cipher) \
    LFUNC_FA_(EVP_CIPHER_CTX_get_app_data) \
    LFUNC_FA_(OBSOLETE_EVP_MD_block_size) \
    LFUNC_FA_(UNIMPLEMENTED) /* EVP_CIPHER_CTX_flags */ \
    LFUNC_FA_(EVP_MD_CTX_md) \
    LFUNC_FA_(BIO_method_name) \
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_CTX_iv_length) \
    ...
    LFUNC_FA_(OBSOLETE_EVP_PKEY_base_id) \
    ...
    LFUNC_FA_(OBSOLETE_EVP_PKEY_id) \
    ...
    LFUNC_FA_(OBSOLETE_EVP_MD_flags) \
    LFUNC_FA_(TS_RESP_CTX_free) \
    LFUNC_FA_(OBSOLETE_OCSP_REQ_CTX_add1_header) \
    ...
    LFUNC_FA_(OBSOLETE_OCSP_REQ_CTX_get0_mem_bio) \
    LFUNC_FA_(OBSOLETE_OCSP_REQ_CTX_http) \
    LFUNC_FA_(OBSOLETE_OCSP_REQ_CTX_i2d) \
    LFUNC_FA_(OBSOLETE_OCSP_REQ_CTX_nbio) \
    LFUNC_FA_(OBSOLETE_OCSP_REQ_CTX_nbio_d2i) \
    LFUNC_FA_(OBSOLETE_OCSP_REQ_CTX_new) \
    LFUNC_FA_(OBSOLETE_OCSP_set_max_response_length) \
    ...
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_CTX_encrypting) \
    LFUNC_FA_(EVP_CIPHER_CTX_iv) \
    LFUNC_FA_(EVP_CIPHER_CTX_iv_noconst) \
    LFUNC_FA_(OBSOLETE_EVP_CIPHER_CTX_num) \
    ...
    LFUNC_FA_(OBSOLETE_EVP_MD_CTX_md_data) \
    LFUNC_FA_(EVP_MD_CTX_new) \
    LFUNC_FA_(OBSOLETE_EVP_MD_CTX_pkey_ctx) \
    ...
    LFUNC_FA_(OBSOLETE_EVP_PKEY_security_bits) \
    ...
    LFUNC_FA_(OBSOLETE_TS_VERIFY_CTS_set_certs) \
    ...
    LFUNC_FA_(OBSOLETE_EVP_PKEY_set1_tls_encodedpoint) \
    LFUNC_FA_(OBSOLETE_EVP_PKEY_get1_tls_encodedpoint) \
