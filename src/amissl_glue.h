...
void SAVEDS ASM LIB_SSL_CTX_set_keylog_callback(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_CTX * ctx), REG(d0, SSL_CTX_keylog_cb_func cb));
...
int SAVEDS ASM LIB_SSL_get_key_update_type(REG(a6, __IFACE_OR_BASE), REG(a0, SSL * s));
...
void SAVEDS ASM LIB_SSL_CTX_set_client_hello_cb(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_CTX * c), REG(d0, SSL_client_hello_cb_fn cb), REG(a1, void * arg));
...
int SAVEDS ASM LIB_SSL_CTX_add_custom_ext(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_CTX * ctx), REG(d0, unsigned int ext_type), REG(d1, unsigned int context), REG(d2, SSL_custom_ext_add_cb_ex add_cb), REG(d3, SSL_custom_ext_free_cb_ex free_cb), REG(a1, void * add_arg), REG(d4, SSL_custom_ext_parse_cb_ex parse_cb), REG(a2, void * parse_arg));
...
void SAVEDS ASM LIB_SSL_set_record_padding_callback(REG(a6, __IFACE_OR_BASE), REG(a0, SSL * ssl), REG(a1, size_t (*cb)(SSL *ssl, int type, size_t len, void *arg)));
int SAVEDS ASM LIB_SSL_CTX_set_block_padding(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_CTX * ctx), REG(d0, size_t block_size));
void * SAVEDS ASM LIB_SSL_CTX_get_record_padding_callback_arg(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_CTX * ctx));
void * SAVEDS ASM LIB_SSL_get_record_padding_callback_arg(REG(a6, __IFACE_OR_BASE), REG(a0, SSL * ssl));
...
void SAVEDS ASM LIB_SSL_set_psk_find_session_callback(REG(a6, __IFACE_OR_BASE), REG(a0, SSL * s), REG(d0, SSL_psk_find_session_cb_func cb));
void SAVEDS ASM LIB_SSL_set_psk_use_session_callback(REG(a6, __IFACE_OR_BASE), REG(a0, SSL * s), REG(d0, SSL_psk_use_session_cb_func cb));
void SAVEDS ASM LIB_SSL_CTX_set_psk_use_session_callback(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_CTX * ctx), REG(d0, SSL_psk_use_session_cb_func cb));
void SAVEDS ASM LIB_SSL_CTX_set_psk_find_session_callback(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_CTX * ctx), REG(d0, SSL_psk_find_session_cb_func cb));
...
SSL_SESSION * SAVEDS ASM LIB_SSL_SESSION_dup(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_SESSION * src));
...
void SAVEDS ASM LIB_DTLS_set_timer_cb(REG(a6, __IFACE_OR_BASE), REG(a0, SSL * s), REG(d0, DTLS_timer_cb cb));
...
int SAVEDS ASM LIB_SSL_CTX_set_session_ticket_cb(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_CTX * ctx), REG(d0, SSL_CTX_generate_session_ticket_fn gen_cb), REG(d1, SSL_CTX_decrypt_session_ticket_fn dec_cb), REG(a1, void * arg));
...
size_t SAVEDS ASM LIB_SSL_CTX_get_num_tickets(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_CTX * ctx));
size_t SAVEDS ASM LIB_SSL_get_num_tickets(REG(a6, __IFACE_OR_BASE), REG(a0, SSL * s));
int SAVEDS ASM LIB_SSL_CTX_set_num_tickets(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_CTX * ctx), REG(d0, size_t num_tickets));
void SAVEDS ASM LIB_SSL_CTX_set_allow_early_data_cb(REG(a6, __IFACE_OR_BASE), REG(a0, SSL_CTX * ctx), REG(d0, SSL_allow_early_data_cb_fn cb), REG(a1, void * arg));
void SAVEDS ASM LIB_SSL_set_allow_early_data_cb(REG(a6, __IFACE_OR_BASE), REG(a0, SSL * s), REG(d0, SSL_allow_early_data_cb_fn cb), REG(a1, void * arg));
...
void SAVEDS ASM LIB_BIO_set_callback_ex(REG(a6, __IFACE_OR_BASE), REG(a0, BIO * b), REG(d0, BIO_callback_fn_ex callback));
...
int SAVEDS ASM LIB_X509_SIG_INFO_get(REG(a6, __IFACE_OR_BASE), REG(a0, const X509_SIG_INFO * siginf), REG(a1, int * mdnid), REG(a2, int * pknid), REG(a3, int * secbits), REG(a5, uint32_t * flags));
int SAVEDS ASM LIB_X509_get_signature_info(REG(a6, __IFACE_OR_BASE), REG(a0, X509 * x), REG(a1, int * mdnid), REG(a2, int * pknid), REG(a3, int * secbits), REG(a5, uint32_t * flags));
...
ESS_CERT_ID_V2 * SAVEDS ASM LIB_ESS_CERT_ID_V2_dup(REG(a6, __IFACE_OR_BASE), REG(a0, ESS_CERT_ID_V2 * a));
...
ESS_SIGNING_CERT_V2 * SAVEDS ASM LIB_ESS_SIGNING_CERT_V2_dup(REG(a6, __IFACE_OR_BASE), REG(a0, ESS_SIGNING_CERT_V2 * a));
...
int SAVEDS ASM LIB_OSSL_STORE_LOADER_set_error(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_LOADER * loader), REG(d0, OSSL_STORE_error_fn error_function));
...
int SAVEDS ASM LIB_OSSL_STORE_LOADER_set_eof(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_LOADER * loader), REG(d0, OSSL_STORE_eof_fn eof_function));
...
int SAVEDS ASM LIB_OSSL_STORE_LOADER_set_close(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_LOADER * loader), REG(d0, OSSL_STORE_close_fn close_function));
...
int SAVEDS ASM LIB_OSSL_STORE_LOADER_set_load(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_LOADER * loader), REG(d0, OSSL_STORE_load_fn load_function));
const char * SAVEDS ASM LIB_OSSL_STORE_LOADER_get0_scheme(REG(a6, __IFACE_OR_BASE), REG(a0, const OSSL_STORE_LOADER * loader));
OSSL_STORE_CTX * SAVEDS ASM LIB_OSSL_STORE_open(REG(a6, __IFACE_OR_BASE), REG(a0, const char * uri), REG(a1, const UI_METHOD * ui_method), REG(a2, void * ui_data), REG(d0, OSSL_STORE_post_process_info_fn post_process), REG(a3, void * post_process_data));
...
int SAVEDS ASM LIB_OSSL_STORE_LOADER_set_open(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_LOADER * loader), REG(d0, OSSL_STORE_open_fn open_function));
int SAVEDS ASM LIB_OSSL_STORE_LOADER_set_ctrl(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_LOADER * loader), REG(d0, OSSL_STORE_ctrl_fn ctrl_function));
...
int SAVEDS ASM LIB_RAND_DRBG_instantiate(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg), REG(a1, const unsigned char * pers), REG(d0, size_t perslen));
int SAVEDS ASM LIB_RAND_DRBG_uninstantiate(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg));
int SAVEDS ASM LIB_RAND_DRBG_set(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg), REG(d0, int type), REG(d1, unsigned int flags));
int SAVEDS ASM LIB_RAND_DRBG_set_callbacks(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg), REG(d0, RAND_DRBG_get_entropy_fn get_entropy), REG(d1, RAND_DRBG_cleanup_entropy_fn cleanup_entropy), REG(d2, RAND_DRBG_get_nonce_fn get_nonce), REG(d3, RAND_DRBG_cleanup_nonce_fn cleanup_nonce));
RAND_DRBG * SAVEDS ASM LIB_RAND_DRBG_new(REG(a6, __IFACE_OR_BASE), REG(d0, int type), REG(d1, unsigned int flags), REG(a0, RAND_DRBG * parent));
int SAVEDS ASM LIB_RAND_DRBG_set_reseed_interval(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg), REG(d0, unsigned int interval));
void SAVEDS ASM LIB_RAND_DRBG_free(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg));
int SAVEDS ASM LIB_RAND_DRBG_generate(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg), REG(a1, unsigned char * out), REG(d0, size_t outlen), REG(d1, int prediction_resistance), REG(a2, const unsigned char * adin), REG(d2, size_t adinlen));
int SAVEDS ASM LIB_RAND_DRBG_reseed(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg), REG(a1, const unsigned char * adin), REG(d0, size_t adinlen), REG(d1, int prediction_resistance));
int SAVEDS ASM LIB_RAND_DRBG_set_ex_data(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg), REG(d0, int idx), REG(a1, void * arg));
void * SAVEDS ASM LIB_RAND_DRBG_get_ex_data(REG(a6, __IFACE_OR_BASE), REG(a0, const RAND_DRBG * drbg), REG(d0, int idx));
...
int SAVEDS ASM LIB_EVP_PKEY_CTX_ctrl_uint64(REG(a6, __IFACE_OR_BASE), REG(a0, EVP_PKEY_CTX * ctx), REG(d0, int keytype), REG(d1, int optype), REG(d2, int cmd), REG(d3, uint64_t value));
...
RAND_DRBG * SAVEDS ASM LIB_RAND_DRBG_get0_private(REG(a6, __IFACE_OR_BASE));
...
OPENSSL_STACK * SAVEDS ASM LIB_OPENSSL_sk_new_reserve(REG(a6, __IFACE_OR_BASE), REG(d0, OPENSSL_sk_compfunc c), REG(d1, int n));
...
RAND_DRBG * SAVEDS ASM LIB_RAND_DRBG_get0_master(REG(a6, __IFACE_OR_BASE));
int SAVEDS ASM LIB_RAND_DRBG_set_reseed_time_interval(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg), REG(d0, time_t interval));
...
int SAVEDS ASM LIB_i2d_PROFESSION_INFO(REG(a6, __IFACE_OR_BASE), REG(a0, PROFESSION_INFO * a), REG(a1, unsigned char ** out));
...
int SAVEDS ASM LIB_i2d_ADMISSION_SYNTAX(REG(a6, __IFACE_OR_BASE), REG(a0, ADMISSION_SYNTAX * a), REG(a1, unsigned char ** out));
...
int SAVEDS ASM LIB_i2d_NAMING_AUTHORITY(REG(a6, __IFACE_OR_BASE), REG(a0, NAMING_AUTHORITY * a), REG(a1, unsigned char ** out));
...
int SAVEDS ASM LIB_i2d_ADMISSIONS(REG(a6, __IFACE_OR_BASE), REG(a0, ADMISSIONS * a), REG(a1, unsigned char ** out));
...
int SAVEDS ASM LIB_RAND_DRBG_bytes(REG(a6, __IFACE_OR_BASE), REG(a0, RAND_DRBG * drbg), REG(a1, unsigned char * out), REG(d0, size_t outlen));
RAND_DRBG * SAVEDS ASM LIB_RAND_DRBG_secure_new(REG(a6, __IFACE_OR_BASE), REG(d0, int type), REG(d1, unsigned int flags), REG(a0, RAND_DRBG * parent));
#if defined(__amigaos4__)
int SAVEDS ASM LIB_OSSL_STORE_vctrl(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_CTX * ctx), REG(d0, int cmd), REG(d1, long * args));
#else
int SAVEDS ASM LIB_OSSL_STORE_vctrl(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_CTX * ctx), REG(d0, int cmd), REG(d1, va_list args));
#endif
...
int SAVEDS ASM LIB_OSSL_STORE_LOADER_set_expect(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_LOADER * loader), REG(d0, OSSL_STORE_expect_fn expect_function));
...
int SAVEDS ASM LIB_OSSL_STORE_find(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_CTX * ctx), REG(a1, OSSL_STORE_SEARCH * search));
...
X509_NAME * SAVEDS ASM LIB_OSSL_STORE_SEARCH_get0_name(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_SEARCH * criterion));
const ASN1_OCTET_STRING * SAVEDS ASM LIB_X509_get0_authority_key_id(REG(a6, __IFACE_OR_BASE), REG(a0, X509 * x));
int SAVEDS ASM LIB_OSSL_STORE_LOADER_set_find(REG(a6, __IFACE_OR_BASE), REG(a0, OSSL_STORE_LOADER * loader), REG(d0, OSSL_STORE_find_fn find_function));
...
int SAVEDS ASM LIB_RAND_DRBG_set_reseed_defaults(REG(a6, __IFACE_OR_BASE), REG(d0, unsigned int master_reseed_interval), REG(d1, unsigned int slave_reseed_interval), REG(d2, time_t master_reseed_time_interval), REG(d3, time_t slave_reseed_time_interval));
...
int SAVEDS ASM LIB_X509_LOOKUP_meth_set_get_by_alias(REG(a6, __IFACE_OR_BASE), REG(a0, X509_LOOKUP_METHOD * method), REG(d0, X509_LOOKUP_get_by_alias_fn fn));
...
int SAVEDS ASM LIB_X509_LOOKUP_meth_set_get_by_subject(REG(a6, __IFACE_OR_BASE), REG(a0, X509_LOOKUP_METHOD * method), REG(d0, X509_LOOKUP_get_by_subject_fn fn));
...
int SAVEDS ASM LIB_X509_LOOKUP_meth_set_get_by_fingerprint(REG(a6, __IFACE_OR_BASE), REG(a0, X509_LOOKUP_METHOD * method), REG(d0, X509_LOOKUP_get_by_fingerprint_fn fn));
...
void SAVEDS ASM LIB_EVP_PKEY_meth_get_digest_custom(REG(a6, __IFACE_OR_BASE), REG(a0, EVP_PKEY_METHOD * pmeth), REG(a1, int (**pdigest_custom)(EVP_PKEY_CTX *ctx, EVP_MD_CTX *mctx)));
  ...
  #define SDI_LIBVECTOR \
    ...
    LFUNC_FA_(RAND_DRBG_instantiate) \
    LFUNC_FA_(RAND_DRBG_uninstantiate) \
    LFUNC_FA_(RAND_DRBG_set) \
    LFUNC_FA_(RAND_DRBG_set_callbacks) \
    LFUNC_FA_(RAND_DRBG_new) \
    LFUNC_FA_(RAND_DRBG_set_reseed_interval) \
    LFUNC_FA_(RAND_DRBG_free) \
    LFUNC_FA_(RAND_DRBG_generate) \
    LFUNC_FA_(RAND_DRBG_reseed) \
    LFUNC_FA_(RAND_DRBG_set_ex_data) \
    LFUNC_FA_(RAND_DRBG_get_ex_data) \
    ...
    LFUNC_FA_(RAND_DRBG_get0_private) \
    ...
    LFUNC_FA_(RAND_DRBG_get0_master) \
    LFUNC_FA_(RAND_DRBG_set_reseed_time_interval) \
    ...
    LFUNC_FA_(RAND_DRBG_bytes) \
    LFUNC_FA_(RAND_DRBG_secure_new) \
    ...
    LFUNC_FA_(RAND_DRBG_set_reseed_defaults) \
