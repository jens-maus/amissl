...
int SAVEDS ASM LIB_ASN1_OCTET_STRING_set(REG(a6, __IFACE_OR_BASE), REG(a0, ASN1_OCTET_STRING * str), REG(a1, const void * data), REG(d0, int len));
...
OSSL_HTTP_REQ_CTX * SAVEDS ASM LIB_OCSP_sendreq_new(REG(a6, __IFACE_OR_BASE), REG(a0, BIO * io), REG(a1, const char * path), REG(a2, OCSP_REQUEST * req), REG(a3, int maxline));
...
void SAVEDS ASM LIB_CMS_ContentInfo_print_ctx(REG(a6, __IFACE_OR_BASE), REG(a0, BIO * out), REG(a1, const CMS_ContentInfo * x), REG(d0, int indent), REG(a2, const ASN1_PCTX * pctx));
...
void SAVEDS ASM LIB_PKCS7_print_ctx(REG(a6, __IFACE_OR_BASE), REG(a0, BIO * out), REG(a1, const PKCS7 * x), REG(d0, int indent), REG(a2, const ASN1_PCTX * pctx));
