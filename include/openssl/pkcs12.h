...
PKCS12 *PKCS12_create_ex2_amiga_1(const char *pass, const char *name, EVP_PKEY *pkey,
    X509 *cert, STACK_OF(X509) *ca, int nid_key, int nid_cert, void *moreargs);
...
#   define PKCS12_create_ex2(pass,name,pkey,cert,ca,nid_key,nid_cert,iter,mac_iter,keytype,ctx,propq,cb,cbarg) \
     IAmiSSL->PKCS12_create_ex2_amiga_1(pass,name,pkey,cert,ca,nid_key,nid_cert, \
     IAmiSSL->PKCS12_create_ex2_amiga_2(iter,mac_iter,keytype,ctx,propq,cb,cbarg))
#  else
#   define PKCS12_create_ex2(pass,name,pkey,cert,ca,nid_key,nid_cert,iter,mac_iter,keytype,ctx,propq,cb,cbarg) \
     PKCS12_create_ex2_amiga_1(pass,name,pkey,cert,ca,nid_key,nid_cert,	\
     PKCS12_create_ex2_amiga_2(iter,mac_iter,keytype,ctx,propq,cb,cbarg))
#  endif
# else
