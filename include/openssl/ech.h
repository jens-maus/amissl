...
#  define OSSL_ECHSTORE_new_config(es,echversion,max_name_length,public_name,suite) \
     IAmiSSL->OSSL_ECHSTORE_new_config_amiga(es,echversion,max_name_length,public_name,&(suite))
# else
#  define OSSL_ECHSTORE_new_config(es,echversion,max_name_length,public_name,suite) \
     OSSL_ECHSTORE_new_config_amiga(es,echversion,max_name_length,public_name,&(suite))
# endif
#else
