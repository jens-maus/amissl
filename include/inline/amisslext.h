...
#define SSL_CTX_set_tlsext_ticket_key_evp_cb(___ctx, ___fp) \
      ...
      , AMISSLEXT_BASE_NAME, int (*__fpt)(SSL *,unsigned char *,unsigned char *,EVP_CIPHER_CTX *,EVP_MAC_CTX *,int))
...
#define ERR_vset_error(___lib, ___reason, ___fmt, ___args) \
      LP4NR(0x6ae, ERR_vset_error , int, ___lib, d0, int, ___reason, d1, const char *, ___fmt, a0, va_list, ___args, a1,\
      , AMISSLEXT_BASE_NAME)
...
#define EVP_PKEY_Q_vkeygen(___libctx, ___propq, ___type, ___args) \
      LP4(0xd92, EVP_PKEY *, EVP_PKEY_Q_vkeygen , OSSL_LIB_CTX *, ___libctx, a0, const char *, ___propq, a1, const char *, ___type, a2, va_list, ___args, a3,\
      , AMISSLEXT_BASE_NAME)
