...
#define ERR_vset_error(___lib, ___reason, ___fmt, ___args) \
      LP4NR(0x4c2, ERR_vset_error , int, ___lib, d0, int, ___reason, d1, const char *, ___fmt, a0, long *, ___args, a1,\
      , AMISSLEXT_BASE_NAME, 0, 0, 0, 0, 0, 0)
...
#define EVP_PKEY_Q_vkeygen(___libctx, ___propq, ___type, ___args) \
      LP4(0xbb8, EVP_PKEY *, EVP_PKEY_Q_vkeygen , OSSL_LIB_CTX *, ___libctx, a0, const char *, ___propq, a1, const char *, ___type, a2, long *, ___args, a3,\
      , AMISSLEXT_BASE_NAME, 0, 0, 0, 0, 0, 0)
...
#define BIO_meth_set_sendmmsg(___biom, ___f) \
      ...
      , AMISSLEXT_BASE_NAME, int (*__fpt)(BIO *,BIO_MSG *,size_t,size_t,uint64_t,size_t *), 0, 0, 0, 0, 0, 0)

#define BIO_meth_get_sendmmsg(___biom) \
      LP1FR(0x18c0, __fpr, BIO_meth_get_sendmmsg , const BIO_METHOD *, ___biom, a0,\
      , AMISSLEXT_BASE_NAME, int (*__fpr)(BIO *, BIO_MSG *, size_t, size_t, uint64_t, size_t *), 0, 0, 0, 0, 0, 0)
...
#define EVP_SKEYMGMT_do_all_provided(___libctx, ___fn, ___arg) \
      ...
      , AMISSLEXT_BASE_NAME, void (*__fpt)(EVP_SKEYMGMT *keymgmt,void *arg), 0, 0, 0, 0, 0, 0)
