...
#define X509_TRUST_set_default(___trust) \
      ...
      , AMISSL_BASE_NAME, int (*__fpt)(int,const X509 *,int), int (*__fpr)(int, const X509 *, int), 0, 0, 0, 0, 0, 0)
...
#define X509_TRUST_add(___id, ___flags, ___ck, ___name, ___arg1, ___arg2) \
      ...
      , AMISSL_BASE_NAME, int (*__fpt)(X509_TRUST *,const X509 *,int), 0, 0, 0, 0, 0, 0)
...
#define X509_CRL_METHOD_new(___crl_init, ___crl_free, ___crl_lookup, ___crl_verify) \
      ...
      , AMISSL_BASE_NAME, int (*__fpt1)(X509_CRL *crl), int (*__fpt2)(X509_CRL *crl), int (*__fpt3)(X509_CRL *crl,X509_REVOKED **ret,const ASN1_INTEGER *serial,const X509_NAME *issuer), int (*__fpt4)(X509_CRL *crl,EVP_PKEY *pk), 0, 0, 0, 0, 0, 0)
...
#define SSL_CTX_set_tlsext_ticket_key_evp_cb(___ctx, ___fp) \
      ...
      , AMISSL_BASE_NAME, int (*__fpt)(SSL *,unsigned char *,unsigned char *,EVP_CIPHER_CTX *,EVP_MAC_CTX *,int), 0, 0, 0, 0, 0, 0)
