...
#define X509_SIG_INFO_get(___siginf, ___mdnid, ___pknid, ___secbits, ___flags) \
      LP5(0x76c8, int, X509_SIG_INFO_get , const X509_SIG_INFO *, ___siginf, a0, int *, ___mdnid, a1, int *, ___pknid, a2, int *, ___secbits, a3, uint32_t *, ___flags, d7,\
      , AMISSL_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define X509_get_signature_info(___x, ___mdnid, ___pknid, ___secbits, ___flags) \
      LP5(0x76ce, int, X509_get_signature_info , X509 *, ___x, a0, int *, ___mdnid, a1, int *, ___pknid, a2, int *, ___secbits, a3, uint32_t *, ___flags, d7,\
      , AMISSL_BASE_NAME, 0, 0, 0, 0, 0, 0)
...
#define PEM_read_bio_ex(___bp, ___name, ___header, ___data, ___len, ___flags) \
      LP6(0x7722, int, PEM_read_bio_ex , BIO *, ___bp, a0, char **, ___name, a1, char **, ___header, a2, unsigned char **, ___data, a3, long *, ___len, d7, unsigned int, ___flags, d0,\
      , AMISSL_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define PEM_bytes_read_bio_secmem(___pdata, ___plen, ___pnm, ___name, ___bp, ___cb, ___u) \
      LP7(0x7728, int, PEM_bytes_read_bio_secmem , unsigned char **, ___pdata, a0, long *, ___plen, a1, char **, ___pnm, a2, const char *, ___name, a3, BIO *, ___bp, d7, pem_password_cb *, ___cb, d0, void *, ___u, d1,\
      , AMISSL_BASE_NAME, 0, 0, 0, 0, 0, 0)
...
#define OSSL_STORE_vctrl(___ctx, ___cmd, ___args) \
      LP3(0x7b66, int, OSSL_STORE_vctrl , OSSL_STORE_CTX *, ___ctx, a0, int, ___cmd, d0, long *, ___args, d1,\
      , AMISSL_BASE_NAME, 0, 0, 0, 0, 0, 0)
