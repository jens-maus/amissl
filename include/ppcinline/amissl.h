...
#define EVP_PKEY_asn1_set_public(___ameth, ___pub_decode, ___pub_encode, ___pub_cmp, ___pub_print, ___pkey_size, ___pkey_bits) \
      ...
      , AMISSL_BASE_NAME, int (*__fpt1)(EVP_PKEY *pk,const X509_PUBKEY *pub), int (*__fpt2)(X509_PUBKEY *pub,const EVP_PKEY *pk), int (*__fpt3)(const EVP_PKEY *a,const EVP_PKEY *b), int (*__fpt4)(BIO *out,const EVP_PKEY *pkey,int indent,ASN1_PCTX *pctx), int (*__fpt5)(const EVP_PKEY *pk), int (*__fpt6)(const EVP_PKEY *pk), 0, 0, 0, 0, 0, 0)
...
#define EVP_PKEY_meth_set_copy(___pmeth, ___copy) \
      ...
      , AMISSL_BASE_NAME, int (*__fpt)(EVP_PKEY_CTX *dst,const EVP_PKEY_CTX *src), 0, 0, 0, 0, 0, 0)
...
#define EVP_PKEY_asn1_set_item(___ameth, ___item_verify, ___item_sign) \
      ...
      , AMISSL_BASE_NAME, int (*__fpt1)(EVP_MD_CTX *,const ASN1_ITEM *,const void *,const X509_ALGOR *,const ASN1_BIT_STRING *,EVP_PKEY *), int (*__fpt2)(EVP_MD_CTX *,const ASN1_ITEM *,const void *,X509_ALGOR *,X509_ALGOR *,ASN1_BIT_STRING *), 0, 0, 0, 0, 0, 0)
...
#define EVP_PKEY_meth_get_copy(___pmeth, ___pcopy) \
      ...
      , AMISSL_BASE_NAME, int (**__fpt)(EVP_PKEY_CTX *,const EVP_PKEY_CTX *), 0, 0, 0, 0, 0, 0)
...
#define EVP_PKEY_meth_set_digestsign(___pmeth, ___digestsign) \
      ...
      , AMISSL_BASE_NAME, int (*__fpt)(EVP_MD_CTX *ctx,unsigned char *sig,size_t *siglen,const unsigned char *tbs,size_t tbslen), 0, 0, 0, 0, 0, 0)
...
#define EVP_PKEY_meth_set_digestverify(___pmeth, ___digestverify) \
      ...
      , AMISSL_BASE_NAME, int (*__fpt)(EVP_MD_CTX *ctx,const unsigned char *sig,size_t siglen,const unsigned char *tbs,size_t tbslen), 0, 0, 0, 0, 0, 0)
