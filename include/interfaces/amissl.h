...
/*
** This file was machine generated by idltool 53.32.
** Do not edit
*/ 
...
struct AmiSSLIFace
{
	...
	APICALL ASN1_STRING * (*ASN1_STRING_dup)(struct AmiSSLIFace *Self, ASN1_STRING * a);
	APICALL ASN1_STRING * (*ASN1_STRING_type_new)(struct AmiSSLIFace *Self, int type);
	APICALL int (*ASN1_STRING_cmp)(struct AmiSSLIFace *Self, ASN1_STRING * a, ASN1_STRING * b);
	...
	APICALL void (*ASN1_STRING_length_set)(struct AmiSSLIFace *Self, ASN1_STRING * x, int n);
	APICALL int (*ASN1_STRING_type)(struct AmiSSLIFace *Self, const ASN1_STRING * x);
	APICALL unsigned char * (*ASN1_STRING_data)(struct AmiSSLIFace *Self, ASN1_STRING * x);
	...
	APICALL ASN1_INTEGER * (*ASN1_INTEGER_dup)(struct AmiSSLIFace *Self, ASN1_INTEGER * x);
	...
	APICALL int (*ASN1_UTCTIME_set_string)(struct AmiSSLIFace *Self, ASN1_UTCTIME * s, char * str);
	...
	APICALL ASN1_OCTET_STRING * (*ASN1_OCTET_STRING_dup)(struct AmiSSLIFace *Self, ASN1_OCTET_STRING * a);
	APICALL int (*ASN1_OCTET_STRING_cmp)(struct AmiSSLIFace *Self, ASN1_OCTET_STRING * a, ASN1_OCTET_STRING * b);
	APICALL int (*ASN1_OCTET_STRING_set)(struct AmiSSLIFace *Self, ASN1_OCTET_STRING * str, unsigned char * data, int len);
	...
	APICALL void * (*ASN1_dup)(struct AmiSSLIFace *Self, i2d_of_void * i2d, d2i_of_void * d2i, char * x);
	APICALL void * (*ASN1_item_dup)(struct AmiSSLIFace *Self, const ASN1_ITEM * it, void * x);
	...
	APICALL int (*ASN1_i2d_bio)(struct AmiSSLIFace *Self, i2d_of_void * i2d, BIO * out, unsigned char * x);
	APICALL int (*ASN1_item_i2d_bio)(struct AmiSSLIFace *Self, const ASN1_ITEM * it, BIO * out, const void * x);
	APICALL int (*ASN1_UTCTIME_print)(struct AmiSSLIFace *Self, BIO * fp, ASN1_UTCTIME * a);
	APICALL int (*ASN1_GENERALIZEDTIME_print)(struct AmiSSLIFace *Self, BIO * fp, ASN1_GENERALIZEDTIME * a);
	APICALL int (*ASN1_TIME_print)(struct AmiSSLIFace *Self, BIO * fp, const ASN1_TIME * a);
	APICALL int (*ASN1_STRING_print)(struct AmiSSLIFace *Self, BIO * bp, ASN1_STRING * v);
	APICALL int (*ASN1_STRING_print_ex)(struct AmiSSLIFace *Self, BIO * out, const ASN1_STRING * str, unsigned long flags);
	APICALL int (*ASN1_parse)(struct AmiSSLIFace *Self, BIO * bp, unsigned char * pp, long len, int indent);
	...
	APICALL int (*ASN1_STRING_set_default_mask_asc)(struct AmiSSLIFace *Self, char * p);
	...
	APICALL int (*ERR_load_ASN1_strings)(struct AmiSSLIFace *Self);
	...
	APICALL const ASN1_ITEM * (*LONG_it)(struct AmiSSLIFace *Self);
	APICALL const ASN1_ITEM * (*ZLONG_it)(struct AmiSSLIFace *Self);
	...
	APICALL void * (*BIO_get_ex_data)(struct AmiSSLIFace *Self, BIO * bio, int idx);
	...
	APICALL long (*BIO_debug_callback)(struct AmiSSLIFace *Self, BIO * bio, int cmd, const char * argp, int argi, long argl, long ret);
	...
	APICALL int (*BIO_dump)(struct AmiSSLIFace *Self, BIO * b, const char * bytes, int len);
	APICALL int (*BIO_dump_indent)(struct AmiSSLIFace *Self, BIO * b, const char * bytes, int len, int indent);
	APICALL struct hostent * (*BIO_gethostbyname)(struct AmiSSLIFace *Self, const char * name);
	...
	APICALL int (*BIO_get_port)(struct AmiSSLIFace *Self, const char * str, unsigned short * port_ptr);
	APICALL int (*BIO_get_host_ip)(struct AmiSSLIFace *Self, const char * str, unsigned char * ip);
	APICALL int (*BIO_get_accept_socket)(struct AmiSSLIFace *Self, char * host_port, int mode);
	APICALL int (*BIO_accept)(struct AmiSSLIFace *Self, int sock, char ** ip_port);
	...
	APICALL int (*ERR_load_BIO_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*BN_pseudo_rand)(struct AmiSSLIFace *Self, BIGNUM * rnd, int bits, int top, int bottom);
	APICALL int (*BN_rand_range)(struct AmiSSLIFace *Self, BIGNUM * rnd, BIGNUM * range);
	APICALL int (*BN_pseudo_rand_range)(struct AmiSSLIFace *Self, BIGNUM * rnd, BIGNUM * range);
	...
	APICALL BIGNUM * (*BN_generate_prime)(struct AmiSSLIFace *Self, BIGNUM * ret, int bits, int safe, const BIGNUM * add, const BIGNUM * rem, void (*callback)(int, int, void *), void * cb_arg);
	APICALL int (*BN_is_prime)(struct AmiSSLIFace *Self, const BIGNUM * p, int nchecks, void (*callback)(int, int, void *), BN_CTX * ctx, void * cb_arg);
	APICALL int (*BN_is_prime_fasttest)(struct AmiSSLIFace *Self, const BIGNUM * p, int nchecks, void (*callback)(int, int, void *), BN_CTX * ctx, void * cb_arg, int do_trial_division);
	...
	APICALL BN_BLINDING * (*BN_BLINDING_new)(struct AmiSSLIFace *Self, BIGNUM * A, BIGNUM * Ai, BIGNUM * mod);
	...
	APICALL void (*BN_set_params)(struct AmiSSLIFace *Self, int mul, int high, int low, int mont);
	APICALL int (*BN_get_params)(struct AmiSSLIFace *Self, int which);
	...
	APICALL int (*ERR_load_BN_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*ERR_load_BUF_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*ERR_load_COMP_strings)(struct AmiSSLIFace *Self);
	...
	APICALL void (*OPENSSL_config)(struct AmiSSLIFace *Self, const char * config_name);
	...
	APICALL CONF_METHOD * (*NCONF_WIN32)(struct AmiSSLIFace *Self);
	...
	APICALL int (*ERR_load_CONF_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*CRYPTO_set_mem_functions)(struct AmiSSLIFace *Self, void * (*m)(size_t, const char *, int), void * (*r)(void *, size_t, const char *, int), void (*f)(void *, const char *, int));
	...
	APICALL void (*CRYPTO_get_mem_functions)(struct AmiSSLIFace *Self, void * (**m)(size_t, const char *, int), void * (**r)(void *, size_t, const char *, int), void (**f)(void *, const char *, int));
	...
	APICALL int (*ERR_load_CRYPTO_strings)(struct AmiSSLIFace *Self);
	...
	APICALL const EC_METHOD * (*EC_GFp_simple_method)(struct AmiSSLIFace *Self);
	APICALL const EC_METHOD * (*EC_GFp_mont_method)(struct AmiSSLIFace *Self);
	APICALL EC_GROUP * (*EC_GROUP_new)(struct AmiSSLIFace *Self, const EC_METHOD * a);
	APICALL void (*EC_GROUP_free)(struct AmiSSLIFace *Self, EC_GROUP * a);
	APICALL void (*EC_GROUP_clear_free)(struct AmiSSLIFace *Self, EC_GROUP * a);
	APICALL int (*EC_GROUP_copy)(struct AmiSSLIFace *Self, EC_GROUP * a, const EC_GROUP * b);
	APICALL const EC_METHOD * (*EC_GROUP_method_of)(struct AmiSSLIFace *Self, const EC_GROUP * a);
	APICALL int (*EC_GROUP_set_curve_GFp)(struct AmiSSLIFace *Self, EC_GROUP * a1, const BIGNUM * p, const BIGNUM * a, const BIGNUM * b, BN_CTX * a2);
	APICALL int (*EC_GROUP_get_curve_GFp)(struct AmiSSLIFace *Self, const EC_GROUP * a1, BIGNUM * p, BIGNUM * a, BIGNUM * b, BN_CTX * a2);
	...
	APICALL const EC_METHOD * (*EC_POINT_method_of)(struct AmiSSLIFace *Self, const EC_POINT * a);
	APICALL int (*EC_POINT_set_to_infinity)(struct AmiSSLIFace *Self, const EC_GROUP * a, EC_POINT * b);
	APICALL int (*EC_POINT_set_Jprojective_coordinates_GFp)(struct AmiSSLIFace *Self, const EC_GROUP * a1, EC_POINT * a2, const BIGNUM * x, const BIGNUM * y, const BIGNUM * z, BN_CTX * a3);
	APICALL int (*EC_POINT_get_Jprojective_coordinates_GFp)(struct AmiSSLIFace *Self, const EC_GROUP * a1, const EC_POINT * a2, BIGNUM * x, BIGNUM * y, BIGNUM * z, BN_CTX * a3);
	APICALL int (*EC_POINT_set_affine_coordinates_GFp)(struct AmiSSLIFace *Self, const EC_GROUP * a1, EC_POINT * a2, const BIGNUM * x, const BIGNUM * y, BN_CTX * a3);
	APICALL int (*EC_POINT_get_affine_coordinates_GFp)(struct AmiSSLIFace *Self, const EC_GROUP * a1, const EC_POINT * a2, BIGNUM * x, BIGNUM * y, BN_CTX * a3);
	APICALL int (*EC_POINT_set_compressed_coordinates_GFp)(struct AmiSSLIFace *Self, const EC_GROUP * a1, EC_POINT * a2, const BIGNUM * x, int y_bit, BN_CTX * a3);
	...
	APICALL int (*EC_POINT_make_affine)(struct AmiSSLIFace *Self, const EC_GROUP * a, EC_POINT * b, BN_CTX * c);
	APICALL int (*EC_POINTs_make_affine)(struct AmiSSLIFace *Self, const EC_GROUP * a1, size_t num, EC_POINT ** a2, BN_CTX * a3);
	APICALL int (*EC_POINTs_mul)(struct AmiSSLIFace *Self, const EC_GROUP * a1, EC_POINT * r, const BIGNUM * a2, size_t num, const EC_POINT ** a3, const BIGNUM ** a4, BN_CTX * a5);
	...
	APICALL int (*EC_GROUP_precompute_mult)(struct AmiSSLIFace *Self, EC_GROUP * a, BN_CTX * b);
	APICALL int (*ERR_load_EC_strings)(struct AmiSSLIFace *Self);
	APICALL void (*OBSOLETE_ERR_put_error)(struct AmiSSLIFace *Self, int lib, int func, int reason, const char * file, int line);
	...
	APICALL unsigned long (*ERR_get_error_line)(struct AmiSSLIFace *Self, const char ** file, int * line);
	APICALL unsigned long (*ERR_get_error_line_data)(struct AmiSSLIFace *Self, const char ** file, int * line, const char ** data, int * flags);
	...
	APICALL unsigned long (*ERR_peek_error_line_data)(struct AmiSSLIFace *Self, const char ** file, int * line, const char ** data, int * flags);
	...
	APICALL unsigned long (*ERR_peek_last_error_line_data)(struct AmiSSLIFace *Self, const char ** file, int * line, const char ** data, int * flags);
	...
	APICALL const char * (*ERR_func_error_string)(struct AmiSSLIFace *Self, unsigned long e);
	...
	APICALL int (*EVP_Digest)(struct AmiSSLIFace *Self, void * data, unsigned int count, unsigned char * md, unsigned int * size, const EVP_MD * type, ENGINE * impl);
	...
	APICALL void (*EVP_set_pw_prompt)(struct AmiSSLIFace *Self, char * prompt);
	...
	APICALL int (*EVP_VerifyFinal)(struct AmiSSLIFace *Self, EVP_MD_CTX * ctx, unsigned char * sigbuf, unsigned int siglen, EVP_PKEY * pkey);
	APICALL int (*EVP_OpenInit)(struct AmiSSLIFace *Self, EVP_CIPHER_CTX * ctx, const EVP_CIPHER * type, unsigned char * ek, int ekl, unsigned char * iv, EVP_PKEY * priv);
	...
	APICALL int (*EVP_DecodeUpdate)(struct AmiSSLIFace *Self, EVP_ENCODE_CTX * ctx, unsigned char * out, int * outl, unsigned char * in, int inl);
	...
	APICALL struct dsa_st * (*EVP_PKEY_get1_DSA)(struct AmiSSLIFace *Self, EVP_PKEY * pkey);
	APICALL int (*EVP_PKEY_set1_DH)(struct AmiSSLIFace *Self, EVP_PKEY * pkey, struct dh_st * key);
	APICALL struct dh_st * (*EVP_PKEY_get1_DH)(struct AmiSSLIFace *Self, EVP_PKEY * pkey);
	...
	APICALL int (*EVP_PKEY_copy_parameters)(struct AmiSSLIFace *Self, EVP_PKEY * to, EVP_PKEY * from);
	APICALL int (*EVP_PKEY_missing_parameters)(struct AmiSSLIFace *Self, EVP_PKEY * pkey);
	APICALL int (*EVP_PKEY_save_parameters)(struct AmiSSLIFace *Self, EVP_PKEY * pkey, int mode);
	APICALL int (*EVP_PKEY_cmp_parameters)(struct AmiSSLIFace *Self, EVP_PKEY * a, EVP_PKEY * b);
	APICALL int (*OBSOLETE_EVP_CIPHER_type)(struct AmiSSLIFace *Self, const EVP_CIPHER * ctx);
	...
	APICALL int (*PKCS5_PBKDF2_HMAC_SHA1)(struct AmiSSLIFace *Self, const char * pass, int passlen, unsigned char * salt, int saltlen, int iter, int keylen, unsigned char * out);
	...
	APICALL int (*ERR_load_EVP_strings)(struct AmiSSLIFace *Self);
	APTR HMAC_CTX_init_UNIMPLEMENTED;
	APTR HMAC_CTX_cleanup_UNIMPLEMENTED;
	APICALL int (*HMAC_Init)(struct AmiSSLIFace *Self, HMAC_CTX * ctx, const void * key, int len, const EVP_MD * md);
	APICALL int (*HMAC_Init_ex)(struct AmiSSLIFace *Self, HMAC_CTX * ctx, const void * key, int len, const EVP_MD * md, ENGINE * impl);
	APICALL int (*HMAC_Update)(struct AmiSSLIFace *Self, HMAC_CTX * ctx, const unsigned char * data, size_t len);
	APICALL int (*HMAC_Final)(struct AmiSSLIFace *Self, HMAC_CTX * ctx, unsigned char * md, unsigned int * len);
	APICALL unsigned char * (*HMAC)(struct AmiSSLIFace *Self, const EVP_MD * evp_md, const void * key, int key_len, const unsigned char * d, int n, unsigned char * md, unsigned int * md_len);
	...
	APICALL int (*ERR_load_OBJ_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*OCSP_request_set1_name)(struct AmiSSLIFace *Self, OCSP_REQUEST * req, X509_NAME * nm);
	...
	APICALL int (*OCSP_id_issuer_cmp)(struct AmiSSLIFace *Self, OCSP_CERTID * a, OCSP_CERTID * b);
	APICALL int (*OCSP_id_cmp)(struct AmiSSLIFace *Self, OCSP_CERTID * a, OCSP_CERTID * b);
	...
	APICALL X509_EXTENSION * (*OCSP_url_svcloc_new)(struct AmiSSLIFace *Self, X509_NAME * issuer, const char ** urls);
	...
	APICALL int (*ERR_load_OCSP_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*PEM_ASN1_write_bio)(struct AmiSSLIFace *Self, i2d_of_void * i2d, const char * name, BIO * bp, char * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	...
	APICALL int (*PEM_X509_INFO_write_bio)(struct AmiSSLIFace *Self, BIO * bp, X509_INFO * xi, EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cd, void * u);
	...
	APICALL int (*PEM_SignUpdate)(struct AmiSSLIFace *Self, EVP_MD_CTX * ctx, unsigned char * d, unsigned int cnt);
	...
	APICALL void (*PEM_dek_info)(struct AmiSSLIFace *Self, char * buf, const char * type, int len, char * str);
	APICALL X509 * (*PEM_read_bio_X509)(struct AmiSSLIFace *Self, BIO * bp, X509 ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_X509)(struct AmiSSLIFace *Self, BIO * bp, X509 * x);
	APICALL X509 * (*PEM_read_bio_X509_AUX)(struct AmiSSLIFace *Self, BIO * bp, X509 ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_X509_AUX)(struct AmiSSLIFace *Self, BIO * bp, X509 * x);
	APICALL X509_REQ * (*PEM_read_bio_X509_REQ)(struct AmiSSLIFace *Self, BIO * bp, X509_REQ ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_X509_REQ)(struct AmiSSLIFace *Self, BIO * bp, X509_REQ * x);
	APICALL int (*PEM_write_bio_X509_REQ_NEW)(struct AmiSSLIFace *Self, BIO * bp, X509_REQ * x);
	APICALL X509_CRL * (*PEM_read_bio_X509_CRL)(struct AmiSSLIFace *Self, BIO * bp, X509_CRL ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_X509_CRL)(struct AmiSSLIFace *Self, BIO * bp, X509_CRL * x);
	APICALL PKCS7 * (*PEM_read_bio_PKCS7)(struct AmiSSLIFace *Self, BIO * bp, PKCS7 ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_PKCS7)(struct AmiSSLIFace *Self, BIO * bp, PKCS7 * x);
	...
	APICALL int (*PEM_write_bio_NETSCAPE_CERT_SEQUENCE)(struct AmiSSLIFace *Self, BIO * bp, NETSCAPE_CERT_SEQUENCE * x);
	APICALL X509_SIG * (*PEM_read_bio_PKCS8)(struct AmiSSLIFace *Self, BIO * bp, X509_SIG ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_PKCS8)(struct AmiSSLIFace *Self, BIO * bp, X509_SIG * x);
	...
	APICALL int (*PEM_write_bio_PKCS8_PRIV_KEY_INFO)(struct AmiSSLIFace *Self, BIO * bp, PKCS8_PRIV_KEY_INFO * x);
	APICALL RSA * (*PEM_read_bio_RSAPrivateKey)(struct AmiSSLIFace *Self, BIO * bp, RSA ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_RSAPrivateKey)(struct AmiSSLIFace *Self, BIO * bp, RSA * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	APICALL RSA * (*PEM_read_bio_RSAPublicKey)(struct AmiSSLIFace *Self, BIO * bp, RSA ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_RSAPublicKey)(struct AmiSSLIFace *Self, BIO * bp, const RSA * x);
	APICALL RSA * (*PEM_read_bio_RSA_PUBKEY)(struct AmiSSLIFace *Self, BIO * bp, RSA ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_RSA_PUBKEY)(struct AmiSSLIFace *Self, BIO * bp, const RSA * x);
	APICALL DSA * (*PEM_read_bio_DSAPrivateKey)(struct AmiSSLIFace *Self, BIO * bp, DSA ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_DSAPrivateKey)(struct AmiSSLIFace *Self, BIO * bp, DSA * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	APICALL DSA * (*PEM_read_bio_DSA_PUBKEY)(struct AmiSSLIFace *Self, BIO * bp, DSA ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_DSA_PUBKEY)(struct AmiSSLIFace *Self, BIO * bp, DSA * x);
	APICALL DSA * (*PEM_read_bio_DSAparams)(struct AmiSSLIFace *Self, BIO * bp, DSA ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_DSAparams)(struct AmiSSLIFace *Self, BIO * bp, DSA * x);
	APICALL DH * (*PEM_read_bio_DHparams)(struct AmiSSLIFace *Self, BIO * bp, DH ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_DHparams)(struct AmiSSLIFace *Self, BIO * bp, DH * x);
	APICALL EVP_PKEY * (*PEM_read_bio_PrivateKey)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_PrivateKey)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	APICALL EVP_PKEY * (*PEM_read_bio_PUBKEY)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_PUBKEY)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY * x);
	APICALL int (*PEM_write_bio_PKCS8PrivateKey_nid)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY * x, int nid, char * kstr, int klen, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_PKCS8PrivateKey)(struct AmiSSLIFace *Self, BIO * a, EVP_PKEY * b, const EVP_CIPHER * c, char * d, int a1, pem_password_cb * e, void * f);
	APICALL int (*i2d_PKCS8PrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY * x, const EVP_CIPHER * enc, char * kstr, int klen, pem_password_cb * cb, void * u);
	APICALL int (*i2d_PKCS8PrivateKey_nid_bio)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY * x, int nid, char * kstr, int klen, pem_password_cb * cb, void * u);
	APICALL EVP_PKEY * (*d2i_PKCS8PrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY ** x, pem_password_cb * cb, void * u);
	APICALL int (*ERR_load_PEM_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*PKCS7_add_certificate)(struct AmiSSLIFace *Self, PKCS7 * p7, X509 * x509);
	APICALL int (*PKCS7_add_crl)(struct AmiSSLIFace *Self, PKCS7 * p7, X509_CRL * x509);
	...
	APICALL int (*PKCS7_signatureVerify)(struct AmiSSLIFace *Self, BIO * bio, PKCS7 * p7, PKCS7_SIGNER_INFO * si, X509 * x509);
	...
	APICALL ASN1_TYPE * (*PKCS7_get_attribute)(struct AmiSSLIFace *Self, PKCS7_SIGNER_INFO * si, int nid);
	APICALL ASN1_TYPE * (*PKCS7_get_signed_attribute)(struct AmiSSLIFace *Self, PKCS7_SIGNER_INFO * si, int nid);
	...
	APICALL int (*ERR_load_PKCS7_strings)(struct AmiSSLIFace *Self);
	APICALL int (*RAND_set_rand_method)(struct AmiSSLIFace *Self, const RAND_METHOD * meth);
	APICALL const RAND_METHOD * (*RAND_get_rand_method)(struct AmiSSLIFace *Self);
	...
	APICALL int (*RAND_pseudo_bytes)(struct AmiSSLIFace *Self, unsigned char * buf, int num);
	...
	APICALL int (*ERR_load_RAND_strings)(struct AmiSSLIFace *Self);
	...
	APICALL void (*SSL_CTX_flush_sessions)(struct AmiSSLIFace *Self, SSL_CTX * ctx, long tm);
	...
	APICALL int (*SSL_use_RSAPrivateKey)(struct AmiSSLIFace *Self, SSL * ssl, RSA * rsa);
	APICALL int (*SSL_use_RSAPrivateKey_ASN1)(struct AmiSSLIFace *Self, SSL * ssl, const unsigned char * d, long len);
	APICALL int (*SSL_use_PrivateKey)(struct AmiSSLIFace *Self, SSL * ssl, EVP_PKEY * pkey);
	APICALL int (*SSL_use_PrivateKey_ASN1)(struct AmiSSLIFace *Self, int pk, SSL * ssl, unsigned char * d, long len);
	APICALL int (*SSL_use_certificate)(struct AmiSSLIFace *Self, SSL * ssl, X509 * x);
	APICALL int (*SSL_use_certificate_ASN1)(struct AmiSSLIFace *Self, SSL * ssl, unsigned char * d, int len);
	APICALL int (*SSL_use_RSAPrivateKey_file)(struct AmiSSLIFace *Self, SSL * ssl, const char * file, int type);
	...
	APICALL int (*SSL_CTX_use_RSAPrivateKey_file)(struct AmiSSLIFace *Self, SSL_CTX * ctx, const char * file, int type);
	...
	APICALL long (*SSL_SESSION_get_time)(struct AmiSSLIFace *Self, const SSL_SESSION * s);
	APICALL long (*SSL_SESSION_set_time)(struct AmiSSLIFace *Self, SSL_SESSION * s, long t);
	...
	APICALL X509 * (*OBSOLETE_SSL_get_peer_certificate)(struct AmiSSLIFace *Self, const SSL * s);
	...
	APICALL int (*SSL_CTX_use_RSAPrivateKey)(struct AmiSSLIFace *Self, SSL_CTX * ctx, RSA * rsa);
	APICALL int (*SSL_CTX_use_RSAPrivateKey_ASN1)(struct AmiSSLIFace *Self, SSL_CTX * ctx, unsigned char * d, long len);
	APICALL int (*SSL_CTX_use_PrivateKey)(struct AmiSSLIFace *Self, SSL_CTX * ctx, EVP_PKEY * pkey);
	APICALL int (*SSL_CTX_use_PrivateKey_ASN1)(struct AmiSSLIFace *Self, int pk, SSL_CTX * ctx, unsigned char * d, long len);
	APICALL int (*SSL_CTX_use_certificate)(struct AmiSSLIFace *Self, SSL_CTX * ctx, X509 * x);
	APICALL int (*SSL_CTX_use_certificate_ASN1)(struct AmiSSLIFace *Self, SSL_CTX * ctx, int len, unsigned char * d);
	...
	APICALL int (*SSL_CTX_set_ssl_version)(struct AmiSSLIFace *Self, SSL_CTX * ctx, const SSL_METHOD * meth);
	...
	APICALL const SSL_METHOD * (*TLSv1_method)(struct AmiSSLIFace *Self);
	APICALL const SSL_METHOD * (*TLSv1_server_method)(struct AmiSSLIFace *Self);
	APICALL const SSL_METHOD * (*TLSv1_client_method)(struct AmiSSLIFace *Self);
	...
	APICALL int (*SSL_set_ssl_method)(struct AmiSSLIFace *Self, SSL * s, SSL_METHOD * method);
	...
	APICALL void (*SSL_CTX_set_tmp_dh_callback)(struct AmiSSLIFace *Self, SSL_CTX * ctx, DH * (*dh)(SSL *ssl, int is_export, int keylength));
	APICALL void (*SSL_set_tmp_dh_callback)(struct AmiSSLIFace *Self, SSL * ssl, DH * (*dh)(SSL *ssl, int is_export, int keylength));
	APICALL int (*SSL_COMP_add_compression_method)(struct AmiSSLIFace *Self, int id, COMP_METHOD * cm);
	APICALL int (*ERR_load_SSL_strings)(struct AmiSSLIFace *Self);
	...
	APICALL void * (*UI_get_ex_data)(struct AmiSSLIFace *Self, UI * r, int idx);
	...
	APICALL int (*ERR_load_UI_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*i2d_X509_bio)(struct AmiSSLIFace *Self, BIO * bp, X509 * x509);
	APICALL X509_CRL * (*d2i_X509_CRL_bio)(struct AmiSSLIFace *Self, BIO * bp, X509_CRL ** crl);
	APICALL int (*i2d_X509_CRL_bio)(struct AmiSSLIFace *Self, BIO * bp, X509_CRL * crl);
	APICALL X509_REQ * (*d2i_X509_REQ_bio)(struct AmiSSLIFace *Self, BIO * bp, X509_REQ ** req);
	APICALL int (*i2d_X509_REQ_bio)(struct AmiSSLIFace *Self, BIO * bp, X509_REQ * req);
	APICALL RSA * (*d2i_RSAPrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, RSA ** rsa);
	APICALL int (*i2d_RSAPrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, RSA * rsa);
	APICALL RSA * (*d2i_RSAPublicKey_bio)(struct AmiSSLIFace *Self, BIO * bp, RSA ** rsa);
	APICALL int (*i2d_RSAPublicKey_bio)(struct AmiSSLIFace *Self, BIO * bp, const RSA * rsa);
	APICALL RSA * (*d2i_RSA_PUBKEY_bio)(struct AmiSSLIFace *Self, BIO * bp, RSA ** rsa);
	APICALL int (*i2d_RSA_PUBKEY_bio)(struct AmiSSLIFace *Self, BIO * bp, const RSA * rsa);
	APICALL DSA * (*d2i_DSA_PUBKEY_bio)(struct AmiSSLIFace *Self, BIO * bp, DSA ** dsa);
	APICALL int (*i2d_DSA_PUBKEY_bio)(struct AmiSSLIFace *Self, BIO * bp, DSA * dsa);
	APICALL DSA * (*d2i_DSAPrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, DSA ** dsa);
	APICALL int (*i2d_DSAPrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, DSA * dsa);
	APICALL X509_SIG * (*d2i_PKCS8_bio)(struct AmiSSLIFace *Self, BIO * bp, X509_SIG ** p8);
	APICALL int (*i2d_PKCS8_bio)(struct AmiSSLIFace *Self, BIO * bp, X509_SIG * p8);
	APICALL PKCS8_PRIV_KEY_INFO * (*d2i_PKCS8_PRIV_KEY_INFO_bio)(struct AmiSSLIFace *Self, BIO * bp, PKCS8_PRIV_KEY_INFO ** p8inf);
	APICALL int (*i2d_PKCS8_PRIV_KEY_INFO_bio)(struct AmiSSLIFace *Self, BIO * bp, PKCS8_PRIV_KEY_INFO * p8inf);
	APICALL int (*i2d_PKCS8PrivateKeyInfo_bio)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY * key);
	APICALL int (*i2d_PrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY * pkey);
	APICALL EVP_PKEY * (*d2i_PrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY ** a);
	APICALL int (*i2d_PUBKEY_bio)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY * pkey);
	APICALL EVP_PKEY * (*d2i_PUBKEY_bio)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY ** a);
	APICALL X509 * (*X509_dup)(struct AmiSSLIFace *Self, X509 * x509);
	APICALL X509_ATTRIBUTE * (*X509_ATTRIBUTE_dup)(struct AmiSSLIFace *Self, X509_ATTRIBUTE * xa);
	APICALL X509_EXTENSION * (*X509_EXTENSION_dup)(struct AmiSSLIFace *Self, X509_EXTENSION * ex);
	APICALL X509_CRL * (*X509_CRL_dup)(struct AmiSSLIFace *Self, X509_CRL * crl);
	APICALL X509_REQ * (*X509_REQ_dup)(struct AmiSSLIFace *Self, X509_REQ * req);
	APICALL X509_ALGOR * (*X509_ALGOR_dup)(struct AmiSSLIFace *Self, X509_ALGOR * xn);
	APICALL X509_NAME * (*X509_NAME_dup)(struct AmiSSLIFace *Self, X509_NAME * xn);
	APICALL X509_NAME_ENTRY * (*X509_NAME_ENTRY_dup)(struct AmiSSLIFace *Self, X509_NAME_ENTRY * ne);
	APICALL int (*X509_cmp_time)(struct AmiSSLIFace *Self, const ASN1_TIME * s, time_t * t);
	APICALL int (*X509_cmp_current_time)(struct AmiSSLIFace *Self, ASN1_TIME * s);
	...
	APICALL EVP_PKEY * (*X509_PUBKEY_get)(struct AmiSSLIFace *Self, X509_PUBKEY * key);
	...
	APICALL int (*i2d_RSA_PUBKEY)(struct AmiSSLIFace *Self, const RSA * a, unsigned char ** pp);
	APICALL RSA * (*d2i_RSA_PUBKEY)(struct AmiSSLIFace *Self, RSA ** a, const unsigned char ** pp, long length);
	APICALL int (*i2d_DSA_PUBKEY)(struct AmiSSLIFace *Self, const DSA * a, unsigned char ** pp);
	APICALL DSA * (*d2i_DSA_PUBKEY)(struct AmiSSLIFace *Self, DSA ** a, const unsigned char ** pp, long length);
	...
	APICALL int (*X509_NAME_set)(struct AmiSSLIFace *Self, X509_NAME ** xn, X509_NAME * name);
	...
	APICALL void * (*X509_get_ex_data)(struct AmiSSLIFace *Self, X509 * r, int idx);
	...
	APICALL int (*ASN1_verify)(struct AmiSSLIFace *Self, int (*i2d)(), X509_ALGOR * algor1, ASN1_BIT_STRING * signature, char * data, EVP_PKEY * pkey);
	APICALL int (*ASN1_digest)(struct AmiSSLIFace *Self, int (*i2d)(), const EVP_MD * type, char * data, unsigned char * md, unsigned int * len);
	APICALL int (*ASN1_sign)(struct AmiSSLIFace *Self, int (*i2d)(), X509_ALGOR * algor1, X509_ALGOR * algor2, ASN1_BIT_STRING * signature, char * data, EVP_PKEY * pkey, const EVP_MD * type);
	...
	APICALL int (*ASN1_item_verify)(struct AmiSSLIFace *Self, const ASN1_ITEM * it, X509_ALGOR * algor1, ASN1_BIT_STRING * signature, void * data, EVP_PKEY * pkey);
	APICALL int (*ASN1_item_sign)(struct AmiSSLIFace *Self, const ASN1_ITEM * it, X509_ALGOR * algor1, X509_ALGOR * algor2, ASN1_BIT_STRING * signature, void * data, EVP_PKEY * pkey, const EVP_MD * type);
	...
	APICALL int (*X509_set_issuer_name)(struct AmiSSLIFace *Self, X509 * x, X509_NAME * name);
	APICALL X509_NAME * (*X509_get_issuer_name)(struct AmiSSLIFace *Self, const X509 * a);
	APICALL int (*X509_set_subject_name)(struct AmiSSLIFace *Self, X509 * x, X509_NAME * name);
	...
	APICALL int (*X509_certificate_type)(struct AmiSSLIFace *Self, const X509 * x, const EVP_PKEY * pubkey);
	APICALL int (*X509_REQ_set_version)(struct AmiSSLIFace *Self, X509_REQ * x, long version);
	APICALL int (*X509_REQ_set_subject_name)(struct AmiSSLIFace *Self, X509_REQ * req, X509_NAME * name);
	...
	APICALL int (*X509_REQ_add_extensions_nid)(struct AmiSSLIFace *Self, X509_REQ * req, STACK_OF(X509_EXTENSION) * exts, int nid);
	APICALL int (*X509_REQ_add_extensions)(struct AmiSSLIFace *Self, X509_REQ * req, STACK_OF(X509_EXTENSION) * exts);
	...
	APICALL int (*X509_CRL_set_issuer_name)(struct AmiSSLIFace *Self, X509_CRL * x, X509_NAME * name);
	...
	APICALL int (*X509_check_private_key)(struct AmiSSLIFace *Self, const X509 * x509, const EVP_PKEY * pkey);
	...
	APICALL int (*X509_NAME_get_text_by_NID)(struct AmiSSLIFace *Self, X509_NAME * name, int nid, char * buf, int len);
	APICALL int (*X509_NAME_get_text_by_OBJ)(struct AmiSSLIFace *Self, X509_NAME * name, const ASN1_OBJECT * obj, char * buf, int len);
	APICALL int (*X509_NAME_get_index_by_NID)(struct AmiSSLIFace *Self, X509_NAME * name, int nid, int lastpos);
	APICALL int (*X509_NAME_get_index_by_OBJ)(struct AmiSSLIFace *Self, X509_NAME * name, const ASN1_OBJECT * obj, int lastpos);
	...
	APICALL X509 * (*X509_find_by_issuer_and_serial)(struct AmiSSLIFace *Self, STACK_OF(X509) * sk, X509_NAME * name, ASN1_INTEGER * serial);
	APICALL X509 * (*X509_find_by_subject)(struct AmiSSLIFace *Self, STACK_OF(X509) * sk, X509_NAME * name);
	...
	APICALL X509_ALGOR * (*PKCS5_pbe_set)(struct AmiSSLIFace *Self, int alg, int iter, unsigned char * salt, int saltlen);
	...
	APICALL PKCS8_PRIV_KEY_INFO * (*EVP_PKEY2PKCS8)(struct AmiSSLIFace *Self, EVP_PKEY * pkey);
	...
	APICALL int (*ERR_load_X509_strings)(struct AmiSSLIFace *Self);
	APICALL int (*X509_OBJECT_idx_by_subject)(struct AmiSSLIFace *Self, STACK_OF(X509_OBJECT) * h, X509_LOOKUP_TYPE type, X509_NAME * name);
	APICALL X509_OBJECT * (*X509_OBJECT_retrieve_by_subject)(struct AmiSSLIFace *Self, STACK_OF(X509_OBJECT) * h, X509_LOOKUP_TYPE type, X509_NAME * name);
	...
	APICALL void (*X509_STORE_free)(struct AmiSSLIFace *Self, X509_STORE * v);
	APICALL int (*X509_STORE_set_flags)(struct AmiSSLIFace *Self, X509_STORE * ctx, unsigned long flags);
	APICALL int (*X509_STORE_set_purpose)(struct AmiSSLIFace *Self, X509_STORE * ctx, int purpose);
	APICALL int (*X509_STORE_set_trust)(struct AmiSSLIFace *Self, X509_STORE * ctx, int trust);
	...
	APICALL int (*X509_STORE_CTX_init)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx, X509_STORE * store, X509 * x509, STACK_OF(X509) * chain);
	...
	APICALL X509_LOOKUP * (*X509_STORE_add_lookup)(struct AmiSSLIFace *Self, X509_STORE * v, X509_LOOKUP_METHOD * m);
	...
	APICALL int (*X509_STORE_add_cert)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509 * x);
	APICALL int (*X509_STORE_add_crl)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_CRL * x);
	APICALL int (*X509_STORE_CTX_get_by_subject)(struct AmiSSLIFace *Self, X509_STORE_CTX * vs, X509_LOOKUP_TYPE type, X509_NAME * name, X509_OBJECT * ret);
	...
	APICALL int (*X509_LOOKUP_by_subject)(struct AmiSSLIFace *Self, X509_LOOKUP * ctx, X509_LOOKUP_TYPE type, X509_NAME * name, X509_OBJECT * ret);
	APICALL int (*X509_LOOKUP_by_issuer_serial)(struct AmiSSLIFace *Self, X509_LOOKUP * ctx, X509_LOOKUP_TYPE type, X509_NAME * name, ASN1_INTEGER * serial, X509_OBJECT * ret);
	...
	APICALL int (*X509_STORE_load_locations)(struct AmiSSLIFace *Self, X509_STORE * ctx, const char * file, const char * dir);
	APICALL int (*X509_STORE_set_default_paths)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	...
	APICALL void * (*X509_STORE_CTX_get_ex_data)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx, int idx);
	APICALL int (*X509_STORE_CTX_get_error)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL void (*X509_STORE_CTX_set_error)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx, int s);
	APICALL int (*X509_STORE_CTX_get_error_depth)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509 * (*X509_STORE_CTX_get_current_cert)(struct AmiSSLIFace *Self, const X509_STORE_CTX * ctx);
	APICALL STACK_OF(X509) * (*X509_STORE_CTX_get0_chain)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL STACK_OF(X509) * (*X509_STORE_CTX_get1_chain)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	...
	APICALL void (*X509_STORE_CTX_set_flags)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx, long flags);
	APICALL void (*X509_STORE_CTX_set_time)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx, long flags, time_t t);
	...
	APICALL GENERAL_NAMES * (*v2i_GENERAL_NAMES)(struct AmiSSLIFace *Self, X509V3_EXT_METHOD * method, X509V3_CTX * ctx, STACK_OF(CONF_VALUE) * nval);
	...
	APICALL int (*i2d_DIST_POINT)(struct AmiSSLIFace *Self, DIST_POINT * a, unsigned char ** out);
	...
	APICALL int (*i2d_DIST_POINT_NAME)(struct AmiSSLIFace *Self, DIST_POINT_NAME * a, unsigned char ** out);
	...
	APICALL int (*i2d_ACCESS_DESCRIPTION)(struct AmiSSLIFace *Self, ACCESS_DESCRIPTION * a, unsigned char ** out);
	...
	APICALL int (*i2d_AUTHORITY_INFO_ACCESS)(struct AmiSSLIFace *Self, AUTHORITY_INFO_ACCESS * a, unsigned char ** out);
	APICALL const ASN1_ITEM * (*AUTHORITY_INFO_ACCESS_it)(struct AmiSSLIFace *Self);
	APICALL GENERAL_NAME * (*v2i_GENERAL_NAME)(struct AmiSSLIFace *Self, X509V3_EXT_METHOD * method, X509V3_CTX * ctx, CONF_VALUE * cnf);
	APICALL void (*X509V3_conf_free)(struct AmiSSLIFace *Self, CONF_VALUE * val);
	APICALL X509_EXTENSION * (*X509V3_EXT_nconf_nid)(struct AmiSSLIFace *Self, CONF * conf, X509V3_CTX * ctx, int ext_nid, char * value);
	...
	APICALL int (*ERR_load_X509V3_strings)(struct AmiSSLIFace *Self);
	APICALL const char * (*AES_options)(struct AmiSSLIFace *Self);
	APICALL int (*AES_set_encrypt_key)(struct AmiSSLIFace *Self, const unsigned char * userKey, const int bits, AES_KEY * key);
	APICALL int (*AES_set_decrypt_key)(struct AmiSSLIFace *Self, const unsigned char * userKey, const int bits, AES_KEY * key);
	APICALL void (*AES_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const AES_KEY * key);
	APICALL void (*AES_decrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const AES_KEY * key);
	APICALL void (*AES_ecb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const AES_KEY * key, const int enc);
	APICALL void (*AES_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const unsigned long length, const AES_KEY * key, unsigned char * ivec, const int enc);
	APICALL void (*AES_cfb128_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const unsigned long length, const AES_KEY * key, unsigned char * ivec, int * num, const int enc);
	APICALL void (*AES_cfb1_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const unsigned long length, const AES_KEY * key, unsigned char * ivec, int * num, const int enc);
	APICALL void (*AES_cfb8_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const unsigned long length, const AES_KEY * key, unsigned char * ivec, int * num, const int enc);
	APTR AES_cfbr_encrypt_block_UNIMPLEMENTED;
	APICALL void (*AES_ofb128_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const unsigned long length, const AES_KEY * key, unsigned char * ivec, int * num);
	APTR AES_ctr128_encrypt_UNIMPLEMENTED;
	APICALL void (*BF_set_key)(struct AmiSSLIFace *Self, BF_KEY * key, int len, const unsigned char * data);
	APICALL void (*BF_encrypt)(struct AmiSSLIFace *Self, BF_LONG * data, const BF_KEY * key);
	APICALL void (*BF_decrypt)(struct AmiSSLIFace *Self, BF_LONG * data, const BF_KEY * key);
	APICALL void (*BF_ecb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const BF_KEY * key, int enc);
	APICALL void (*BF_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, const BF_KEY * schedule, unsigned char * ivec, int enc);
	APICALL void (*BF_cfb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, const BF_KEY * schedule, unsigned char * ivec, int * num, int enc);
	APICALL void (*BF_ofb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, const BF_KEY * schedule, unsigned char * ivec, int * num);
	APICALL const char * (*BF_options)(struct AmiSSLIFace *Self);
	APICALL void (*CAST_set_key)(struct AmiSSLIFace *Self, CAST_KEY * key, int len, const unsigned char * data);
	APICALL void (*CAST_ecb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, CAST_KEY * key, int enc);
	APICALL void (*CAST_encrypt)(struct AmiSSLIFace *Self, CAST_LONG * data, CAST_KEY * key);
	APICALL void (*CAST_decrypt)(struct AmiSSLIFace *Self, CAST_LONG * data, CAST_KEY * key);
	APICALL void (*CAST_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, CAST_KEY * ks, unsigned char * iv, int enc);
	APICALL void (*CAST_cfb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, CAST_KEY * schedule, unsigned char * ivec, int * num, int enc);
	APICALL void (*CAST_ofb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, CAST_KEY * schedule, unsigned char * ivec, int * num);
	APTR _shadow_DES_check_key_UNIMPLEMENTED;
	APICALL const char * (*DES_options)(struct AmiSSLIFace *Self);
	APICALL void (*DES_ecb3_encrypt)(struct AmiSSLIFace *Self, const_DES_cblock * input, DES_cblock * output, DES_key_schedule * ks1, DES_key_schedule * ks2, DES_key_schedule * ks3, int enc);
	APICALL DES_LONG (*DES_cbc_cksum)(struct AmiSSLIFace *Self, const unsigned char * input, DES_cblock * output, long length, DES_key_schedule * schedule, const_DES_cblock * ivec);
	APICALL void (*DES_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * input, unsigned char * output, long length, DES_key_schedule * schedule, DES_cblock * ivec, int enc);
	APICALL void (*DES_ncbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * input, unsigned char * output, long length, DES_key_schedule * schedule, DES_cblock * ivec, int enc);
	APICALL void (*DES_xcbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * input, unsigned char * output, long length, DES_key_schedule * schedule, DES_cblock * ivec, const_DES_cblock * inw, const_DES_cblock * outw, int enc);
	APICALL void (*DES_cfb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, int numbits, long length, DES_key_schedule * schedule, DES_cblock * ivec, int enc);
	APICALL void (*DES_ecb_encrypt)(struct AmiSSLIFace *Self, const_DES_cblock * input, DES_cblock * output, DES_key_schedule * ks, int enc);
	APICALL void (*DES_encrypt1)(struct AmiSSLIFace *Self, DES_LONG * data, DES_key_schedule * ks, int enc);
	APICALL void (*DES_encrypt2)(struct AmiSSLIFace *Self, DES_LONG * data, DES_key_schedule * ks, int enc);
	APICALL void (*DES_encrypt3)(struct AmiSSLIFace *Self, DES_LONG * data, DES_key_schedule * ks1, DES_key_schedule * ks2, DES_key_schedule * ks3);
	APICALL void (*DES_decrypt3)(struct AmiSSLIFace *Self, DES_LONG * data, DES_key_schedule * ks1, DES_key_schedule * ks2, DES_key_schedule * ks3);
	APICALL void (*DES_ede3_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * input, unsigned char * output, long length, DES_key_schedule * ks1, DES_key_schedule * ks2, DES_key_schedule * ks3, DES_cblock * ivec, int enc);
	APTR DES_ede3_cbcm_encrypt_UNIMPLEMENTED;
	APICALL void (*DES_ede3_cfb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, DES_key_schedule * ks1, DES_key_schedule * ks2, DES_key_schedule * ks3, DES_cblock * ivec, int * num, int enc);
	APICALL void (*DES_ede3_cfb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, int numbits, long length, DES_key_schedule * ks1, DES_key_schedule * ks2, DES_key_schedule * ks3, DES_cblock * ivec, int enc);
	APICALL void (*DES_ede3_ofb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, DES_key_schedule * ks1, DES_key_schedule * ks2, DES_key_schedule * ks3, DES_cblock * ivec, int * num);
	APTR DES_xwhite_in2out_UNIMPLEMENTED;
	APICALL char * (*DES_fcrypt)(struct AmiSSLIFace *Self, const char * buf, const char * salt, char * ret);
	APICALL char * (*DES_crypt)(struct AmiSSLIFace *Self, const char * buf, const char * salt);
	APICALL void (*DES_ofb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, int numbits, long length, DES_key_schedule * schedule, DES_cblock * ivec);
	APICALL void (*DES_pcbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * input, unsigned char * output, long length, DES_key_schedule * schedule, DES_cblock * ivec, int enc);
	APICALL DES_LONG (*DES_quad_cksum)(struct AmiSSLIFace *Self, const unsigned char * input, DES_cblock * output, long length, int out_count, DES_cblock * seed);
	APICALL int (*DES_random_key)(struct AmiSSLIFace *Self, DES_cblock * ret);
	APICALL void (*DES_set_odd_parity)(struct AmiSSLIFace *Self, DES_cblock * key);
	APICALL int (*DES_check_key_parity)(struct AmiSSLIFace *Self, const_DES_cblock * key);
	APICALL int (*DES_is_weak_key)(struct AmiSSLIFace *Self, const_DES_cblock * key);
	APICALL int (*DES_set_key)(struct AmiSSLIFace *Self, const_DES_cblock * key, DES_key_schedule * schedule);
	APICALL int (*DES_key_sched)(struct AmiSSLIFace *Self, const_DES_cblock * key, DES_key_schedule * schedule);
	APICALL int (*DES_set_key_checked)(struct AmiSSLIFace *Self, const_DES_cblock * key, DES_key_schedule * schedule);
	APICALL void (*DES_set_key_unchecked)(struct AmiSSLIFace *Self, const_DES_cblock * key, DES_key_schedule * schedule);
	APICALL void (*DES_string_to_key)(struct AmiSSLIFace *Self, const char * str, DES_cblock * key);
	APICALL void (*DES_string_to_2keys)(struct AmiSSLIFace *Self, const char * str, DES_cblock * key1, DES_cblock * key2);
	APICALL void (*DES_cfb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, DES_key_schedule * schedule, DES_cblock * ivec, int * num, int enc);
	APICALL void (*DES_ofb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, DES_key_schedule * schedule, DES_cblock * ivec, int * num);
	...
	APICALL const DH_METHOD * (*DH_OpenSSL)(struct AmiSSLIFace *Self);
	APICALL void (*DH_set_default_method)(struct AmiSSLIFace *Self, const DH_METHOD * meth);
	APICALL const DH_METHOD * (*DH_get_default_method)(struct AmiSSLIFace *Self);
	APICALL int (*DH_set_method)(struct AmiSSLIFace *Self, DH * dh, const DH_METHOD * meth);
	APICALL DH * (*DH_new_method)(struct AmiSSLIFace *Self, ENGINE * engine);
	APICALL DH * (*DH_new)(struct AmiSSLIFace *Self);
	APICALL void (*DH_free)(struct AmiSSLIFace *Self, DH * dh);
	APICALL int (*DH_up_ref)(struct AmiSSLIFace *Self, DH * dh);
	APICALL int (*DH_size)(struct AmiSSLIFace *Self, const DH * dh);
	APTR DH_get_ex_new_index_UNIMPLEMENTED;
	APICALL int (*DH_set_ex_data)(struct AmiSSLIFace *Self, DH * d, int idx, void * arg);
	APICALL void * (*DH_get_ex_data)(struct AmiSSLIFace *Self, DH * d, int idx);
	APICALL DH * (*DH_generate_parameters)(struct AmiSSLIFace *Self, int prime_len, int generator, void (*callback)(int, int, void *), void * cb_arg);
	APICALL int (*DH_check)(struct AmiSSLIFace *Self, const DH * dh, int * codes);
	APICALL int (*DH_generate_key)(struct AmiSSLIFace *Self, DH * dh);
	APICALL int (*DH_compute_key)(struct AmiSSLIFace *Self, unsigned char * key, const BIGNUM * pub_key, DH * dh);
	APICALL DH * (*d2i_DHparams)(struct AmiSSLIFace *Self, DH ** a, const unsigned char ** pp, long length);
	APICALL int (*i2d_DHparams)(struct AmiSSLIFace *Self, const DH * a, unsigned char ** pp);
	APICALL int (*DHparams_print)(struct AmiSSLIFace *Self, BIO * bp, const DH * x);
	APICALL int (*ERR_load_DH_strings)(struct AmiSSLIFace *Self);
	...
	APICALL DSA_SIG * (*DSA_do_sign)(struct AmiSSLIFace *Self, const unsigned char * dgst, int dlen, DSA * dsa);
	APICALL int (*DSA_do_verify)(struct AmiSSLIFace *Self, const unsigned char * dgst, int dgst_len, DSA_SIG * sig, DSA * dsa);
	APICALL const DSA_METHOD * (*DSA_OpenSSL)(struct AmiSSLIFace *Self);
	APICALL void (*DSA_set_default_method)(struct AmiSSLIFace *Self, const DSA_METHOD * a);
	APICALL const DSA_METHOD * (*DSA_get_default_method)(struct AmiSSLIFace *Self);
	APICALL int (*DSA_set_method)(struct AmiSSLIFace *Self, DSA * dsa, const DSA_METHOD * a);
	APICALL DSA * (*DSA_new)(struct AmiSSLIFace *Self);
	APICALL DSA * (*DSA_new_method)(struct AmiSSLIFace *Self, ENGINE * engine);
	APICALL void (*DSA_free)(struct AmiSSLIFace *Self, DSA * r);
	APICALL int (*DSA_up_ref)(struct AmiSSLIFace *Self, DSA * r);
	APICALL int (*DSA_size)(struct AmiSSLIFace *Self, const DSA * a);
	APICALL int (*DSA_sign_setup)(struct AmiSSLIFace *Self, DSA * dsa, BN_CTX * ctx_in, BIGNUM ** kinvp, BIGNUM ** rp);
	APICALL int (*DSA_sign)(struct AmiSSLIFace *Self, int type, const unsigned char * dgst, int dlen, unsigned char * sig, unsigned int * siglen, DSA * dsa);
	APICALL int (*DSA_verify)(struct AmiSSLIFace *Self, int type, const unsigned char * dgst, int dgst_len, const unsigned char * sigbuf, int siglen, DSA * dsa);
	APTR DSA_get_ex_new_index_UNIMPLEMENTED;
	APICALL int (*DSA_set_ex_data)(struct AmiSSLIFace *Self, DSA * d, int idx, void * arg);
	APICALL void * (*DSA_get_ex_data)(struct AmiSSLIFace *Self, DSA * d, int idx);
	APICALL DSA * (*d2i_DSAPublicKey)(struct AmiSSLIFace *Self, DSA ** a, const unsigned char ** pp, long length);
	APICALL DSA * (*d2i_DSAPrivateKey)(struct AmiSSLIFace *Self, DSA ** a, const unsigned char ** pp, long length);
	APICALL DSA * (*d2i_DSAparams)(struct AmiSSLIFace *Self, DSA ** a, const unsigned char ** pp, long length);
	APICALL DSA * (*DSA_generate_parameters)(struct AmiSSLIFace *Self, int bits, unsigned char * seed, int seed_len, int * counter_ret, unsigned long * h_ret, void (*callback)(int, int, void *), void * cb_arg);
	APICALL int (*DSA_generate_key)(struct AmiSSLIFace *Self, DSA * a);
	APICALL int (*i2d_DSAPublicKey)(struct AmiSSLIFace *Self, const DSA * a, unsigned char ** pp);
	APICALL int (*i2d_DSAPrivateKey)(struct AmiSSLIFace *Self, const DSA * a, unsigned char ** pp);
	APICALL int (*i2d_DSAparams)(struct AmiSSLIFace *Self, const DSA * a, unsigned char ** pp);
	APICALL int (*DSAparams_print)(struct AmiSSLIFace *Self, BIO * bp, const DSA * x);
	APICALL int (*DSA_print)(struct AmiSSLIFace *Self, BIO * bp, const DSA * x, int off);
	APICALL DH * (*DSA_dup_DH)(struct AmiSSLIFace *Self, const DSA * r);
	APICALL int (*ERR_load_DSA_strings)(struct AmiSSLIFace *Self);
	APICALL const char * (*IDEA_options)(struct AmiSSLIFace *Self);
	APICALL void (*IDEA_ecb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, IDEA_KEY_SCHEDULE * ks);
	APICALL void (*IDEA_set_encrypt_key)(struct AmiSSLIFace *Self, const unsigned char * key, IDEA_KEY_SCHEDULE * ks);
	APICALL void (*IDEA_set_decrypt_key)(struct AmiSSLIFace *Self, IDEA_KEY_SCHEDULE * ek, IDEA_KEY_SCHEDULE * dk);
	APICALL void (*IDEA_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, IDEA_KEY_SCHEDULE * ks, unsigned char * iv, int enc);
	APICALL void (*IDEA_cfb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, IDEA_KEY_SCHEDULE * ks, unsigned char * iv, int * num, int enc);
	APICALL void (*IDEA_ofb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, IDEA_KEY_SCHEDULE * ks, unsigned char * iv, int * num);
	APICALL void (*IDEA_encrypt)(struct AmiSSLIFace *Self, unsigned long * in, IDEA_KEY_SCHEDULE * ks);
	APICALL const char * (*MD2_options)(struct AmiSSLIFace *Self);
	APICALL int (*OBSOLETE_MD2_Init)(struct AmiSSLIFace *Self, MD2_CTX * c);
	APICALL int (*MD2_Update)(struct AmiSSLIFace *Self, MD2_CTX * c, const unsigned char * data, unsigned long len);
	APICALL int (*MD2_Final)(struct AmiSSLIFace *Self, unsigned char * md, MD2_CTX * c);
	APICALL unsigned char * (*MD2)(struct AmiSSLIFace *Self, const unsigned char * d, unsigned long n, unsigned char * md);
	APICALL int (*MD4_Init)(struct AmiSSLIFace *Self, MD4_CTX * c);
	APICALL int (*MD4_Update)(struct AmiSSLIFace *Self, MD4_CTX * c, const void * data, unsigned long len);
	APICALL int (*MD4_Final)(struct AmiSSLIFace *Self, unsigned char * md, MD4_CTX * c);
	APICALL unsigned char * (*MD4)(struct AmiSSLIFace *Self, const unsigned char * d, unsigned long n, unsigned char * md);
	APICALL void (*MD4_Transform)(struct AmiSSLIFace *Self, MD4_CTX * c, const unsigned char * b);
	APICALL int (*MD5_Init)(struct AmiSSLIFace *Self, MD5_CTX * c);
	APICALL int (*MD5_Update)(struct AmiSSLIFace *Self, MD5_CTX * c, const void * data, unsigned long len);
	APICALL int (*MD5_Final)(struct AmiSSLIFace *Self, unsigned char * md, MD5_CTX * c);
	APICALL unsigned char * (*MD5)(struct AmiSSLIFace *Self, const unsigned char * d, unsigned long n, unsigned char * md);
	APICALL void (*MD5_Transform)(struct AmiSSLIFace *Self, MD5_CTX * c, const unsigned char * b);
	APICALL int (*MDC2_Init)(struct AmiSSLIFace *Self, MDC2_CTX * c);
	APICALL int (*MDC2_Update)(struct AmiSSLIFace *Self, MDC2_CTX * c, const unsigned char * data, unsigned long len);
	APICALL int (*MDC2_Final)(struct AmiSSLIFace *Self, unsigned char * md, MDC2_CTX * c);
	APICALL unsigned char * (*MDC2)(struct AmiSSLIFace *Self, const unsigned char * d, unsigned long n, unsigned char * md);
	APICALL void (*RC2_set_key)(struct AmiSSLIFace *Self, RC2_KEY * key, int len, const unsigned char * data, int bits);
	APICALL void (*RC2_ecb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, RC2_KEY * key, int enc);
	APICALL void (*RC2_encrypt)(struct AmiSSLIFace *Self, unsigned long * data, RC2_KEY * key);
	APICALL void (*RC2_decrypt)(struct AmiSSLIFace *Self, unsigned long * data, RC2_KEY * key);
	APICALL void (*RC2_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, RC2_KEY * ks, unsigned char * iv, int enc);
	APICALL void (*RC2_cfb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, RC2_KEY * schedule, unsigned char * ivec, int * num, int enc);
	APICALL void (*RC2_ofb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, RC2_KEY * schedule, unsigned char * ivec, int * num);
	APICALL const char * (*RC4_options)(struct AmiSSLIFace *Self);
	APICALL void (*RC4_set_key)(struct AmiSSLIFace *Self, RC4_KEY * key, int len, const unsigned char * data);
	APICALL void (*RC4)(struct AmiSSLIFace *Self, RC4_KEY * key, unsigned long len, const unsigned char * indata, unsigned char * outdata);
	APICALL void (*RC5_32_set_key)(struct AmiSSLIFace *Self, RC5_32_KEY * key, int len, const unsigned char * data, int rounds);
	APICALL void (*RC5_32_ecb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, RC5_32_KEY * key, int enc);
	APICALL void (*RC5_32_encrypt)(struct AmiSSLIFace *Self, unsigned long * data, RC5_32_KEY * key);
	APICALL void (*RC5_32_decrypt)(struct AmiSSLIFace *Self, unsigned long * data, RC5_32_KEY * key);
	APICALL void (*RC5_32_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, RC5_32_KEY * ks, unsigned char * iv, int enc);
	APICALL void (*RC5_32_cfb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, RC5_32_KEY * schedule, unsigned char * ivec, int * num, int enc);
	APICALL void (*RC5_32_ofb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, RC5_32_KEY * schedule, unsigned char * ivec, int * num);
	APICALL int (*RIPEMD160_Init)(struct AmiSSLIFace *Self, RIPEMD160_CTX * c);
	APICALL int (*RIPEMD160_Update)(struct AmiSSLIFace *Self, RIPEMD160_CTX * c, const void * data, unsigned long len);
	APICALL int (*RIPEMD160_Final)(struct AmiSSLIFace *Self, unsigned char * md, RIPEMD160_CTX * c);
	APICALL unsigned char * (*RIPEMD160)(struct AmiSSLIFace *Self, const unsigned char * d, unsigned long n, unsigned char * md);
	APICALL void (*RIPEMD160_Transform)(struct AmiSSLIFace *Self, RIPEMD160_CTX * c, const unsigned char * b);
	APICALL RSA * (*RSA_new)(struct AmiSSLIFace *Self);
	APICALL RSA * (*RSA_new_method)(struct AmiSSLIFace *Self, ENGINE * engine);
	APICALL int (*RSA_size)(struct AmiSSLIFace *Self, const RSA * a);
	APICALL RSA * (*RSA_generate_key)(struct AmiSSLIFace *Self, int bits, unsigned long e, void (*callback)(int, int, void *), void * cb_arg);
	APICALL int (*RSA_check_key)(struct AmiSSLIFace *Self, const RSA * a);
	APICALL int (*RSA_public_encrypt)(struct AmiSSLIFace *Self, int flen, const unsigned char * from, unsigned char * to, RSA * rsa, int padding);
	APICALL int (*RSA_private_encrypt)(struct AmiSSLIFace *Self, int flen, const unsigned char * from, unsigned char * to, RSA * rsa, int padding);
	APICALL int (*RSA_public_decrypt)(struct AmiSSLIFace *Self, int flen, const unsigned char * from, unsigned char * to, RSA * rsa, int padding);
	APICALL int (*RSA_private_decrypt)(struct AmiSSLIFace *Self, int flen, const unsigned char * from, unsigned char * to, RSA * rsa, int padding);
	APICALL void (*RSA_free)(struct AmiSSLIFace *Self, RSA * r);
	APICALL int (*RSA_up_ref)(struct AmiSSLIFace *Self, RSA * r);
	APICALL int (*RSA_flags)(struct AmiSSLIFace *Self, const RSA * r);
	APICALL void (*RSA_set_default_method)(struct AmiSSLIFace *Self, const RSA_METHOD * meth);
	APICALL const RSA_METHOD * (*RSA_get_default_method)(struct AmiSSLIFace *Self);
	APICALL const RSA_METHOD * (*RSA_get_method)(struct AmiSSLIFace *Self, const RSA * rsa);
	APICALL int (*RSA_set_method)(struct AmiSSLIFace *Self, RSA * rsa, const RSA_METHOD * meth);
	APTR RSA_PKCS1_SSLeay_UNIMPLEMENTED;
	APICALL const RSA_METHOD * (*RSA_null_method)(struct AmiSSLIFace *Self);
	APICALL RSA * (*d2i_RSAPublicKey)(struct AmiSSLIFace *Self, RSA ** a, const unsigned char ** in, long len);
	APICALL int (*i2d_RSAPublicKey)(struct AmiSSLIFace *Self, const RSA * a, unsigned char ** out);
	APICALL const ASN1_ITEM * (*RSAPublicKey_it)(struct AmiSSLIFace *Self);
	APICALL RSA * (*d2i_RSAPrivateKey)(struct AmiSSLIFace *Self, RSA ** a, const unsigned char ** in, long len);
	APICALL int (*i2d_RSAPrivateKey)(struct AmiSSLIFace *Self, const RSA * a, unsigned char ** out);
	APICALL const ASN1_ITEM * (*RSAPrivateKey_it)(struct AmiSSLIFace *Self);
	APICALL int (*RSA_print)(struct AmiSSLIFace *Self, BIO * bp, const RSA * r, int offset);
	...
	APICALL int (*RSA_sign)(struct AmiSSLIFace *Self, int type, const unsigned char * m, unsigned int m_length, unsigned char * sigret, unsigned int * siglen, RSA * rsa);
	APICALL int (*RSA_verify)(struct AmiSSLIFace *Self, int type, const unsigned char * m, unsigned int m_length, unsigned char * sigbuf, unsigned int siglen, RSA * rsa);
	APICALL int (*RSA_sign_ASN1_OCTET_STRING)(struct AmiSSLIFace *Self, int type, const unsigned char * m, unsigned int m_length, unsigned char * sigret, unsigned int * siglen, RSA * rsa);
	APICALL int (*RSA_verify_ASN1_OCTET_STRING)(struct AmiSSLIFace *Self, int type, const unsigned char * m, unsigned int m_length, unsigned char * sigbuf, unsigned int siglen, RSA * rsa);
	APICALL int (*RSA_blinding_on)(struct AmiSSLIFace *Self, RSA * rsa, BN_CTX * ctx);
	APICALL void (*RSA_blinding_off)(struct AmiSSLIFace *Self, RSA * rsa);
	APICALL int (*RSA_padding_add_PKCS1_type_1)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * f, int fl);
	APICALL int (*RSA_padding_check_PKCS1_type_1)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * f, int fl, int rsa_len);
	APICALL int (*RSA_padding_add_PKCS1_type_2)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * f, int fl);
	APICALL int (*RSA_padding_check_PKCS1_type_2)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * f, int fl, int rsa_len);
	APICALL int (*RSA_padding_add_PKCS1_OAEP)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * f, int fl, const unsigned char * p, int pl);
	APICALL int (*RSA_padding_check_PKCS1_OAEP)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * f, int fl, int rsa_len, const unsigned char * p, int pl);
	APTR RSA_padding_add_SSLv23_UNIMPLEMENTED;
	APTR RSA_padding_check_SSLv23_UNIMPLEMENTED;
	APICALL int (*RSA_padding_add_none)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * f, int fl);
	APICALL int (*RSA_padding_check_none)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * f, int fl, int rsa_len);
	APTR RSA_get_ex_new_index_UNIMPLEMENTED;
	APICALL int (*RSA_set_ex_data)(struct AmiSSLIFace *Self, RSA * r, int idx, void * arg);
	APICALL void * (*RSA_get_ex_data)(struct AmiSSLIFace *Self, const RSA * r, int idx);
	APICALL RSA * (*RSAPublicKey_dup)(struct AmiSSLIFace *Self, RSA * rsa);
	APICALL RSA * (*RSAPrivateKey_dup)(struct AmiSSLIFace *Self, RSA * rsa);
	APICALL int (*ERR_load_RSA_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*SHA1_Init)(struct AmiSSLIFace *Self, SHA_CTX * c);
	APICALL int (*SHA1_Update)(struct AmiSSLIFace *Self, SHA_CTX * c, const void * data, unsigned long len);
	APICALL int (*SHA1_Final)(struct AmiSSLIFace *Self, unsigned char * md, SHA_CTX * c);
	APICALL unsigned char * (*SHA1)(struct AmiSSLIFace *Self, const unsigned char * d, unsigned long n, unsigned char * md);
	APICALL void (*SHA1_Transform)(struct AmiSSLIFace *Self, SHA_CTX * c, const unsigned char * data);
	APTR UI_read_string_lib_UNIMPLEMENTED;
	APTR UI_write_string_lib_UNIMPLEMENTED;
	APICALL void (*HMAC_CTX_set_flags)(struct AmiSSLIFace *Self, HMAC_CTX * ctx, unsigned long flags);
	...
	APICALL int (*PKCS1_MGF1)(struct AmiSSLIFace *Self, unsigned char * mask, long len, const unsigned char * seed, long seedlen, const EVP_MD * dgst);
	APICALL int (*RSA_padding_add_X931)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * from, int flen);
	APICALL int (*RSA_padding_check_X931)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * from, int flen, int num);
	APICALL int (*RSA_X931_hash_id)(struct AmiSSLIFace *Self, int nid);
	APICALL int (*RSA_verify_PKCS1_PSS)(struct AmiSSLIFace *Self, RSA * rsa, const unsigned char * mHash, const EVP_MD * Hash, const unsigned char * EM, int sLen);
	APICALL int (*RSA_padding_add_PKCS1_PSS)(struct AmiSSLIFace *Self, RSA * rsa, unsigned char * EM, const unsigned char * mHash, const EVP_MD * Hash, int sLen);
	...
	APICALL int (*BN_is_prime_ex)(struct AmiSSLIFace *Self, const BIGNUM * p, int nchecks, BN_CTX * ctx, BN_GENCB * cb);
	...
	APICALL const EC_METHOD * (*EC_GF2m_simple_method)(struct AmiSSLIFace *Self);
	APICALL int (*EC_GROUP_set_curve_GF2m)(struct AmiSSLIFace *Self, EC_GROUP * group, const BIGNUM * p, const BIGNUM * a, const BIGNUM * b, BN_CTX * ctx);
	APICALL int (*EC_GROUP_get_curve_GF2m)(struct AmiSSLIFace *Self, const EC_GROUP * group, BIGNUM * p, BIGNUM * a, BIGNUM * b, BN_CTX * ctx);
	APICALL int (*EC_POINT_set_affine_coordinates_GF2m)(struct AmiSSLIFace *Self, const EC_GROUP * group, EC_POINT * point, const BIGNUM * x, const BIGNUM * y, BN_CTX * ctx);
	APICALL int (*EC_POINT_get_affine_coordinates_GF2m)(struct AmiSSLIFace *Self, const EC_GROUP * group, const EC_POINT * point, BIGNUM * x, BIGNUM * y, BN_CTX * ctx);
	...
	APICALL int (*DSA_generate_parameters_ex)(struct AmiSSLIFace *Self, DSA * dsa, int bits, unsigned char * seed, int seed_len, int * counter_ret, unsigned long * h_ret, BN_GENCB * cb);
	APTR EVP_ecdsa_UNIMPLEMENTED;
	APICALL EC_KEY * (*EC_KEY_new_by_curve_name)(struct AmiSSLIFace *Self, int nid);
	APICALL int (*EC_KEY_generate_key)(struct AmiSSLIFace *Self, EC_KEY * key);
	APICALL void (*EC_KEY_free)(struct AmiSSLIFace *Self, EC_KEY * key);
	APICALL void (*ECDSA_SIG_free)(struct AmiSSLIFace *Self, ECDSA_SIG * a);
	APICALL ECDSA_SIG * (*ECDSA_do_sign)(struct AmiSSLIFace *Self, const unsigned char * dgst, int dlen, EC_KEY * eckey);
	APICALL int (*ECDSA_do_verify)(struct AmiSSLIFace *Self, const unsigned char * dgst, int dgst_len, const ECDSA_SIG * sig, EC_KEY * eckey);
	APICALL EC_KEY * (*EC_KEY_new)(struct AmiSSLIFace *Self);
	APICALL int (*EC_KEY_set_group)(struct AmiSSLIFace *Self, EC_KEY * eckey, const EC_GROUP * group);
	APICALL const EC_GROUP * (*EC_KEY_get0_group)(struct AmiSSLIFace *Self, const EC_KEY * key);
	APICALL int (*EC_KEY_check_key)(struct AmiSSLIFace *Self, const EC_KEY * eckey);
	APICALL int (*ECDSA_size)(struct AmiSSLIFace *Self, const EC_KEY * eckey);
	APICALL int (*ECDSA_sign)(struct AmiSSLIFace *Self, int type, const unsigned char * dgst, int dgstlen, unsigned char * sig, unsigned int * siglen, EC_KEY * eckey);
	APICALL int (*ECDSA_verify)(struct AmiSSLIFace *Self, int type, const unsigned char * dgst, int dgstlen, const unsigned char * sig, int siglen, EC_KEY * eckey);
	...
	APICALL int (*DH_generate_parameters_ex)(struct AmiSSLIFace *Self, DH * ret, int prime_len, int generator, BN_GENCB * cb);
	APICALL int (*EC_METHOD_get_field_type)(struct AmiSSLIFace *Self, const EC_METHOD * meth);
	APICALL const EC_POINT * (*EC_KEY_get0_public_key)(struct AmiSSLIFace *Self, const EC_KEY * eckey);
	APICALL int (*ECDH_compute_key)(struct AmiSSLIFace *Self, void * out, size_t outlen, const EC_POINT * pub_key, const EC_KEY * eckey, void *(*KDF)(const void *, size_t, void *, size_t *));
	APICALL const BIGNUM * (*EC_KEY_get0_private_key)(struct AmiSSLIFace *Self, const EC_KEY * eckey);
	APICALL ENGINE * (*ENGINE_get_first)(struct AmiSSLIFace *Self);
	APICALL const char * (*ENGINE_get_id)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL const char * (*ENGINE_get_name)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL ENGINE * (*ENGINE_get_next)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_free)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL ENGINE * (*ENGINE_new)(struct AmiSSLIFace *Self);
	APICALL int (*ENGINE_set_id)(struct AmiSSLIFace *Self, ENGINE * e, const char * id);
	APICALL int (*ENGINE_set_name)(struct AmiSSLIFace *Self, ENGINE * e, const char * name);
	APICALL int (*ENGINE_add)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_remove)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL void (*ENGINE_load_builtin_engines)(struct AmiSSLIFace *Self);
	APICALL void (*ENGINE_register_all_ciphers)(struct AmiSSLIFace *Self);
	APICALL int (*OBSOLETE_EVP_CIPHER_nid)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher);
	APICALL int (*OBSOLETE_EVP_MD_type)(struct AmiSSLIFace *Self, const EVP_MD * md);
	APICALL void (*ENGINE_register_all_digests)(struct AmiSSLIFace *Self);
	...
	APICALL int (*RSA_generate_key_ex)(struct AmiSSLIFace *Self, RSA * rsa, int bits, BIGNUM * e, BN_GENCB * cb);
	APICALL void (*X509_VERIFY_PARAM_free)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param);
	APICALL int (*X509_STORE_set1_param)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_VERIFY_PARAM * pm);
	APICALL ASN1_TYPE * (*ASN1_generate_nconf)(struct AmiSSLIFace *Self, const char * str, CONF * nconf);
	APICALL EC_GROUP * (*PEM_read_bio_ECPKParameters)(struct AmiSSLIFace *Self, BIO * bp, EC_GROUP ** x, pem_password_cb * cb, void * u);
	APICALL EC_KEY * (*EC_KEY_dup)(struct AmiSSLIFace *Self, const EC_KEY * ec_key);
	APICALL void (*BIO_set_callback)(struct AmiSSLIFace *Self, BIO * b, BIO_callback_fn callback);
	...
	APICALL int (*OBSOLETE_EVP_CIPHER_iv_length)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher);
	APICALL int (*X509_REQ_check_private_key)(struct AmiSSLIFace *Self, X509_REQ * x509, EVP_PKEY * pkey);
	APICALL EC_KEY * (*PEM_read_bio_EC_PUBKEY)(struct AmiSSLIFace *Self, BIO * bp, EC_KEY ** x, pem_password_cb * cb, void * u);
	APICALL EC_KEY * (*PEM_read_bio_ECPrivateKey)(struct AmiSSLIFace *Self, BIO * bp, EC_KEY ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_EC_PUBKEY)(struct AmiSSLIFace *Self, BIO * bp, EC_KEY * x);
	APICALL EC_KEY * (*d2i_EC_PUBKEY_bio)(struct AmiSSLIFace *Self, BIO * bp, EC_KEY ** eckey);
	APICALL void (*EC_KEY_set_asn1_flag)(struct AmiSSLIFace *Self, EC_KEY * key, int flag);
	APICALL void (*EC_KEY_set_conv_form)(struct AmiSSLIFace *Self, EC_KEY * key, point_conversion_form_t cform);
	APICALL int (*EC_KEY_print)(struct AmiSSLIFace *Self, BIO * bp, const EC_KEY * x, int off);
	APICALL EC_KEY * (*d2i_ECPrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, EC_KEY ** eckey);
	APICALL int (*i2d_EC_PUBKEY_bio)(struct AmiSSLIFace *Self, BIO * bp, EC_KEY * eckey);
	APICALL int (*PEM_write_bio_ECPrivateKey)(struct AmiSSLIFace *Self, BIO * bp, EC_KEY * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_ECPKParameters)(struct AmiSSLIFace *Self, BIO * bp, const EC_GROUP * x);
	APICALL int (*i2d_ECPrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, EC_KEY * eckey);
	...
	APICALL int (*ECPKParameters_print)(struct AmiSSLIFace *Self, BIO * bp, const EC_GROUP * x, int off);
	...
	APICALL BIGNUM * (*EC_POINT_point2bn)(struct AmiSSLIFace *Self, const EC_GROUP * group, const EC_POINT * point, point_conversion_form_t form, BIGNUM * ret, BN_CTX * ctx);
	...
	APICALL ENGINE * (*ENGINE_by_id)(struct AmiSSLIFace *Self, const char * id);
	...
	APICALL void (*AES_ige_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const unsigned long length, const AES_KEY * key, unsigned char * ivec, const int enc);
	APICALL int (*EC_KEY_precompute_mult)(struct AmiSSLIFace *Self, EC_KEY * key, BN_CTX * ctx);
	APICALL EVP_PKEY * (*ENGINE_load_private_key)(struct AmiSSLIFace *Self, ENGINE * e, const char * key_id, UI_METHOD * ui_method, void * callback_data);
	APICALL EVP_PKEY * (*ENGINE_load_public_key)(struct AmiSSLIFace *Self, ENGINE * e, const char * key_id, UI_METHOD * ui_method, void * callback_data);
	APICALL int (*ENGINE_ctrl_cmd)(struct AmiSSLIFace *Self, ENGINE * e, const char * cmd_name, long i, void * p, void (*f)(void), int cmd_optional);
	APICALL int (*ENGINE_set_default)(struct AmiSSLIFace *Self, ENGINE * e, unsigned int flags);
	APICALL int (*ENGINE_ctrl)(struct AmiSSLIFace *Self, ENGINE * e, int cmd, long i, void * p, void (*f)(void));
	APICALL int (*ENGINE_register_all_complete)(struct AmiSSLIFace *Self);
	APICALL int (*ENGINE_ctrl_cmd_string)(struct AmiSSLIFace *Self, ENGINE * e, const char * cmd_name, const char * arg, int cmd_optional);
	...
	APICALL X509_POLICY_TREE * (*X509_STORE_CTX_get0_policy_tree)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL int (*X509_STORE_CTX_get_explicit_policy)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	...
	APICALL const RSA_METHOD * (*ENGINE_get_RSA)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL const DSA_METHOD * (*ENGINE_get_DSA)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL const DH_METHOD * (*ENGINE_get_DH)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL const RAND_METHOD * (*ENGINE_get_RAND)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL ENGINE_CIPHERS_PTR (*ENGINE_get_ciphers)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL ENGINE_DIGESTS_PTR (*ENGINE_get_digests)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL int (*ENGINE_init)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_finish)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL OCSP_REQ_CTX * (*OCSP_sendreq_new)(struct AmiSSLIFace *Self, BIO * io, const char * path, OCSP_REQUEST * req, int maxline);
	APICALL int (*OBSOLETE_OCSP_sendreq_nbio)(struct AmiSSLIFace *Self, OCSP_RESPONSE ** presp, OCSP_REQ_CTX * rctx);
	APICALL void (*OBSOLETE_OCSP_REQ_CTX_free)(struct AmiSSLIFace *Self, OCSP_REQ_CTX * rctx);
	...
	APICALL int (*SSL_CTX_set_srp_client_pwd_callback)(struct AmiSSLIFace *Self, SSL_CTX * ctx, char * (*cb)(SSL *, void *));
	APICALL BIGNUM * (*SSL_get_srp_g)(struct AmiSSLIFace *Self, SSL * s);
	APICALL int (*SSL_CTX_set_srp_username_callback)(struct AmiSSLIFace *Self, SSL_CTX * ctx, int (*cb)(SSL *, int *, void *));
	APICALL char * (*SSL_get_srp_userinfo)(struct AmiSSLIFace *Self, SSL * s);
	APICALL int (*SSL_set_srp_server_param)(struct AmiSSLIFace *Self, SSL * s, const BIGNUM * N, const BIGNUM * g, BIGNUM * sa, BIGNUM * v, char * info);
	APICALL int (*SSL_set_srp_server_param_pw)(struct AmiSSLIFace *Self, SSL * s, const char * user, const char * pass, const char * grp);
	APICALL BIGNUM * (*SSL_get_srp_N)(struct AmiSSLIFace *Self, SSL * s);
	APICALL char * (*SSL_get_srp_username)(struct AmiSSLIFace *Self, SSL * s);
	APICALL int (*SSL_CTX_set_srp_password)(struct AmiSSLIFace *Self, SSL_CTX * ctx, char * password);
	APICALL int (*SSL_CTX_set_srp_strength)(struct AmiSSLIFace *Self, SSL_CTX * ctx, int strength);
	APICALL int (*SSL_CTX_set_srp_verify_param_callback)(struct AmiSSLIFace *Self, SSL_CTX * ctx, int (*cb)(SSL *, void *));
	APICALL int (*SSL_CTX_set_srp_cb_arg)(struct AmiSSLIFace *Self, SSL_CTX * ctx, void * arg);
	APICALL int (*SSL_CTX_set_srp_username)(struct AmiSSLIFace *Self, SSL_CTX * ctx, char * name);
	APICALL int (*SSL_CTX_SRP_CTX_init)(struct AmiSSLIFace *Self, SSL_CTX * ctx);
	APICALL int (*SRP_Calc_A_param)(struct AmiSSLIFace *Self, SSL * s);
	APTR SRP_generate_server_master_secret_UNIMPLEMENTED;
	APICALL int (*SSL_CTX_SRP_CTX_free)(struct AmiSSLIFace *Self, SSL_CTX * ctx);
	APTR SRP_generate_client_master_secret_UNIMPLEMENTED;
	APICALL int (*SSL_srp_server_param_with_username)(struct AmiSSLIFace *Self, SSL * s, int * ad);
	APICALL int (*SSL_SRP_CTX_free)(struct AmiSSLIFace *Self, SSL * ctx);
	APICALL void (*SSL_set_debug)(struct AmiSSLIFace *Self, SSL * s, int debug);
	...
	APICALL int (*SSL_SRP_CTX_init)(struct AmiSSLIFace *Self, SSL * s);
	...
	APICALL int (*ERR_load_ENGINE_strings)(struct AmiSSLIFace *Self);
	APICALL int (*ENGINE_set_DSA)(struct AmiSSLIFace *Self, ENGINE * e, const DSA_METHOD * dsa_meth);
	APICALL ENGINE_GEN_INT_FUNC_PTR (*ENGINE_get_finish_function)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL ENGINE * (*ENGINE_get_default_RSA)(struct AmiSSLIFace *Self);
	APICALL int (*ENGINE_set_DH)(struct AmiSSLIFace *Self, ENGINE * e, const DH_METHOD * dh_meth);
	APICALL ENGINE_GEN_INT_FUNC_PTR (*ENGINE_get_init_function)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL int (*ENGINE_set_init_function)(struct AmiSSLIFace *Self, ENGINE * e, ENGINE_GEN_INT_FUNC_PTR init_f);
	APICALL int (*ENGINE_set_default_DSA)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL ENGINE * (*ENGINE_get_last)(struct AmiSSLIFace *Self);
	APICALL ENGINE * (*ENGINE_get_prev)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL ENGINE * (*ENGINE_get_default_DH)(struct AmiSSLIFace *Self);
	APICALL int (*ENGINE_set_finish_function)(struct AmiSSLIFace *Self, ENGINE * e, ENGINE_GEN_INT_FUNC_PTR finish_f);
	APICALL int (*ENGINE_set_RSA)(struct AmiSSLIFace *Self, ENGINE * e, const RSA_METHOD * rsa_meth);
	APICALL int (*ENGINE_set_default_RAND)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL ENGINE * (*ENGINE_get_default_DSA)(struct AmiSSLIFace *Self);
	APICALL int (*ENGINE_set_default_RSA)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL ENGINE * (*ENGINE_get_default_RAND)(struct AmiSSLIFace *Self);
	APICALL int (*ENGINE_set_RAND)(struct AmiSSLIFace *Self, ENGINE * e, const RAND_METHOD * rand_meth);
	APICALL int (*ENGINE_set_default_DH)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL ENGINE_CTRL_FUNC_PTR (*ENGINE_get_ctrl_function)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL int (*ENGINE_set_ctrl_function)(struct AmiSSLIFace *Self, ENGINE * e, ENGINE_CTRL_FUNC_PTR ctrl_f);
	APICALL void (*ENGINE_unregister_ciphers)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL void (*ENGINE_unregister_RSA)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL void (*ENGINE_register_all_RAND)(struct AmiSSLIFace *Self);
	APTR ENGINE_load_dynamic_UNIMPLEMENTED;
	APICALL ENGINE * (*ENGINE_get_digest_engine)(struct AmiSSLIFace *Self, int nid);
	APICALL int (*ENGINE_register_DH)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_register_RAND)(struct AmiSSLIFace *Self, ENGINE * e);
	APTR ENGINE_load_cryptodev_UNIMPLEMENTED;
	APICALL int (*ENGINE_register_ciphers)(struct AmiSSLIFace *Self, ENGINE * e);
	APTR ENGINE_load_ubsec_UNIMPLEMENTED;
	APTR ENGINE_load_openssl_UNIMPLEMENTED;
	APICALL const ENGINE_CMD_DEFN * (*ENGINE_get_cmd_defns)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL int (*ENGINE_set_load_privkey_function)(struct AmiSSLIFace *Self, ENGINE * e, ENGINE_LOAD_KEY_PTR loadpriv_f);
	APICALL int (*ENGINE_set_default_digests)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_register_RSA)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL void (*ENGINE_unregister_DSA)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_set_ciphers)(struct AmiSSLIFace *Self, ENGINE * e, ENGINE_CIPHERS_PTR f);
	APICALL int (*RAND_set_rand_engine)(struct AmiSSLIFace *Self, ENGINE * engine);
	APICALL const EVP_MD * (*ENGINE_get_digest)(struct AmiSSLIFace *Self, ENGINE * e, int nid);
	APICALL const EVP_CIPHER * (*ENGINE_get_cipher)(struct AmiSSLIFace *Self, ENGINE * e, int nid);
	APICALL int (*ENGINE_cmd_is_executable)(struct AmiSSLIFace *Self, ENGINE * e, int cmd);
	APICALL int (*ENGINE_register_DSA)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_set_load_pubkey_function)(struct AmiSSLIFace *Self, ENGINE * e, ENGINE_LOAD_KEY_PTR loadpub_f);
	APICALL ENGINE_LOAD_KEY_PTR (*ENGINE_get_load_pubkey_function)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL void (*ENGINE_register_all_RSA)(struct AmiSSLIFace *Self);
	APICALL void (*ENGINE_unregister_digests)(struct AmiSSLIFace *Self, ENGINE * e);
	APTR ENGINE_get_ex_new_index_UNIMPLEMENTED;
	APICALL void * (*ENGINE_get_ex_data)(struct AmiSSLIFace *Self, const ENGINE * e, int idx);
	APTR ASN1_item_d2i_fp_UNIMPLEMENTED;
	APICALL int (*ENGINE_set_cmd_defns)(struct AmiSSLIFace *Self, ENGINE * e, const ENGINE_CMD_DEFN * defns);
	APICALL int (*ENGINE_register_digests)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL void (*ENGINE_register_all_DH)(struct AmiSSLIFace *Self);
	APICALL int (*ENGINE_get_flags)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL void (*ENGINE_unregister_DH)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL void (*ENGINE_register_all_DSA)(struct AmiSSLIFace *Self);
	APICALL int (*ENGINE_set_digests)(struct AmiSSLIFace *Self, ENGINE * e, ENGINE_DIGESTS_PTR f);
	APICALL int (*ENGINE_register_complete)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_set_ex_data)(struct AmiSSLIFace *Self, ENGINE * e, int idx, void * arg);
	APICALL int (*ENGINE_set_destroy_function)(struct AmiSSLIFace *Self, ENGINE * e, ENGINE_GEN_INT_FUNC_PTR destroy_f);
	APICALL ENGINE * (*ENGINE_get_cipher_engine)(struct AmiSSLIFace *Self, int nid);
	APTR X509_print_ex_fp_UNIMPLEMENTED;
	APTR ENGINE_load_cswift_UNIMPLEMENTED;
	APICALL int (*ENGINE_set_default_ciphers)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL void (*ENGINE_unregister_RAND)(struct AmiSSLIFace *Self, ENGINE * e);
	APTR ENGINE_load_nuron_UNIMPLEMENTED;
	APICALL void (*ENGINE_set_table_flags)(struct AmiSSLIFace *Self, unsigned int flags);
	APTR ENGINE_load_chil_UNIMPLEMENTED;
	APICALL ENGINE_GEN_INT_FUNC_PTR (*ENGINE_get_destroy_function)(struct AmiSSLIFace *Self, const ENGINE * e);
	APTR ASN1_item_i2d_fp_UNIMPLEMENTED;
	APTR ENGINE_load_atalla_UNIMPLEMENTED;
	APICALL unsigned int (*ENGINE_get_table_flags)(struct AmiSSLIFace *Self);
	APICALL int (*ENGINE_set_flags)(struct AmiSSLIFace *Self, ENGINE * e, int flags);
	APICALL ENGINE_LOAD_KEY_PTR (*ENGINE_get_load_privkey_function)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL int (*ENGINE_set_default_string)(struct AmiSSLIFace *Self, ENGINE * e, const char * def_list);
	APICALL void (*ENGINE_add_conf_module)(struct AmiSSLIFace *Self);
	APTR ENGINE_load_aep_UNIMPLEMENTED;
	APTR ENGINE_load_sureware_UNIMPLEMENTED;
	APTR ENGINE_load_4758cca_UNIMPLEMENTED;
	APICALL int (*ENGINE_up_ref)(struct AmiSSLIFace *Self, ENGINE * e);
	...
	APICALL int (*SHA512_Update)(struct AmiSSLIFace *Self, SHA512_CTX * c, const void * data, size_t len);
	APICALL int (*i2d_ECPrivateKey)(struct AmiSSLIFace *Self, const EC_KEY * key, unsigned char ** out);
	...
	APICALL EC_KEY * (*o2i_ECPublicKey)(struct AmiSSLIFace *Self, EC_KEY ** key, const unsigned char ** in, long len);
	APICALL EC_KEY * (*EC_KEY_copy)(struct AmiSSLIFace *Self, EC_KEY * dst, const EC_KEY * src);
	...
	APICALL int (*i2o_ECPublicKey)(struct AmiSSLIFace *Self, const EC_KEY * key, unsigned char ** out);
	...
	APICALL struct ec_key_st * (*EVP_PKEY_get1_EC_KEY)(struct AmiSSLIFace *Self, EVP_PKEY * pkey);
	APTR ENGINE_get_default_ECDH_UNIMPLEMENTED;
	APICALL point_conversion_form_t (*EC_KEY_get_conv_form)(struct AmiSSLIFace *Self, const EC_KEY * key);
	APICALL void * (*ENGINE_get_static_state)(struct AmiSSLIFace *Self);
	APICALL ECDSA_SIG * (*ECDSA_SIG_new)(struct AmiSSLIFace *Self);
	APICALL EC_POINT * (*EC_POINT_bn2point)(struct AmiSSLIFace *Self, const EC_GROUP * g, const BIGNUM * b, EC_POINT * p, BN_CTX * ctx);
	APTR EC_KEY_get_key_method_data_UNIMPLEMENTED;
	APICALL int (*ECDSA_sign_ex)(struct AmiSSLIFace *Self, int type, const unsigned char * dgst, int dgstlen, unsigned char * sig, unsigned int * siglen, const BIGNUM * kinv, const BIGNUM * rp, EC_KEY * eckey);
	...
	APICALL int (*ECDSA_sign_setup)(struct AmiSSLIFace *Self, EC_KEY * eckey, BN_CTX * ctx, BIGNUM ** kinv, BIGNUM ** rp);
	APICALL int (*BN_GF2m_mod_solve_quad_arr)(struct AmiSSLIFace *Self, BIGNUM * r, const BIGNUM * a, const int * p, BN_CTX * ctx);
	APICALL int (*EC_KEY_up_ref)(struct AmiSSLIFace *Self, EC_KEY * key);
	APICALL EC_KEY * (*OBSOLETE_d2i_EC_PUBKEY)(struct AmiSSLIFace *Self, EC_KEY ** a, const unsigned char ** pp, long length);
	APICALL int (*EC_GROUP_have_precompute_mult)(struct AmiSSLIFace *Self, const EC_GROUP * group);
	...
	APICALL int (*EVP_PKEY_set1_EC_KEY)(struct AmiSSLIFace *Self, EVP_PKEY * pkey, struct ec_key_st * key);
	...
	APICALL int (*EC_KEY_set_private_key)(struct AmiSSLIFace *Self, EC_KEY * key, const BIGNUM * prv);
	APICALL int (*BN_GF2m_poly2arr)(struct AmiSSLIFace *Self, const BIGNUM * a, int * p, int max);
	APICALL int (*i2d_ECParameters)(struct AmiSSLIFace *Self, const EC_KEY * key, unsigned char ** out);
	APTR ENGINE_set_ECDH_UNIMPLEMENTED;
	APICALL int (*SHA256_Init)(struct AmiSSLIFace *Self, SHA256_CTX * c);
	...
	APICALL int (*i2d_EC_PUBKEY)(struct AmiSSLIFace *Self, const EC_KEY * a, unsigned char ** pp);
	APTR ECDSA_get_default_method_UNIMPLEMENTED;
	APICALL const EC_METHOD * (*EC_GFp_nist_method)(struct AmiSSLIFace *Self);
	...
	APICALL int (*SHA384_Update)(struct AmiSSLIFace *Self, SHA512_CTX * c, const void * data, size_t len);
	APTR EC_KEY_insert_key_method_data_UNIMPLEMENTED;
	APICALL int (*SHA224_Final)(struct AmiSSLIFace *Self, unsigned char * md, SHA256_CTX * c);
	APICALL int (*SHA224_Update)(struct AmiSSLIFace *Self, SHA256_CTX * c, const void * data, size_t len);
	APICALL EC_KEY * (*d2i_ECPrivateKey)(struct AmiSSLIFace *Self, EC_KEY ** key, const unsigned char ** in, long len);
	APTR ENGINE_register_all_STORE_UNIMPLEMENTED;
	APICALL int (*SHA512_Final)(struct AmiSSLIFace *Self, unsigned char * md, SHA512_CTX * c);
	...
	APICALL unsigned (*EC_KEY_get_enc_flags)(struct AmiSSLIFace *Self, const EC_KEY * key);
	APTR ECDSA_set_default_method_UNIMPLEMENTED;
	APICALL int (*EC_POINT_set_compressed_coordinates_GF2m)(struct AmiSSLIFace *Self, const EC_GROUP * group, EC_POINT * p, const BIGNUM * x, int y_bit, BN_CTX * ctx);
	APICALL int (*EC_GROUP_cmp)(struct AmiSSLIFace *Self, const EC_GROUP * a, const EC_GROUP * b, BN_CTX * ctx);
	APICALL int (*SHA224_Init)(struct AmiSSLIFace *Self, SHA256_CTX * c);
	APTR PEM_read_ECPrivateKey_UNIMPLEMENTED;
	APICALL int (*SHA512_Init)(struct AmiSSLIFace *Self, SHA512_CTX * c);
	...
	APICALL void (*SHA256_Transform)(struct AmiSSLIFace *Self, SHA256_CTX * c, const unsigned char * data);
	APICALL void (*EC_KEY_set_enc_flags)(struct AmiSSLIFace *Self, EC_KEY * eckey, unsigned int flags);
	...
	APICALL ECDSA_SIG * (*ECDSA_do_sign_ex)(struct AmiSSLIFace *Self, const unsigned char * dgst, int dgstlen, const BIGNUM * kinv, const BIGNUM * rp, EC_KEY * eckey);
	APTR d2i_ECPrivateKey_fp_UNIMPLEMENTED;
	APICALL void (*SHA512_Transform)(struct AmiSSLIFace *Self, SHA512_CTX * c, const unsigned char * data);
	APTR PEM_write_ECPrivateKey_UNIMPLEMENTED;
	APICALL int (*EC_KEY_set_public_key)(struct AmiSSLIFace *Self, EC_KEY * key, const EC_POINT * pub);
	...
	APICALL int (*SHA256_Final)(struct AmiSSLIFace *Self, unsigned char * md, SHA256_CTX * c);
	...
	APICALL EC_KEY * (*d2i_ECParameters)(struct AmiSSLIFace *Self, EC_KEY ** key, const unsigned char ** in, long len);
	APICALL int (*SHA384_Init)(struct AmiSSLIFace *Self, SHA512_CTX * c);
	APTR ECDSA_set_ex_data_UNIMPLEMENTED;
	APICALL int (*SHA384_Final)(struct AmiSSLIFace *Self, unsigned char * md, SHA512_CTX * c);
	...
	APICALL int (*SHA256_Update)(struct AmiSSLIFace *Self, SHA256_CTX * c, const void * data, size_t len);
	...
	APICALL int (*DH_check_pub_key)(struct AmiSSLIFace *Self, const DH * dh, const BIGNUM * pub_key, int * codes);
	APICALL void (*Camellia_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const CAMELLIA_KEY * key, unsigned char * ivec, const int enc);
	APICALL void (*Camellia_cfb128_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const CAMELLIA_KEY * key, unsigned char * ivec, int * num, const int enc);
	APICALL void (*Camellia_cfb1_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const CAMELLIA_KEY * key, unsigned char * ivec, int * num, const int enc);
	APICALL void (*Camellia_cfb8_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const CAMELLIA_KEY * key, unsigned char * ivec, int * num, const int enc);
	APICALL void (*Camellia_ctr128_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const CAMELLIA_KEY * key, unsigned char * ivec, unsigned char * ecount_buf, unsigned int * num);
	APICALL void (*Camellia_decrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const CAMELLIA_KEY * key);
	APICALL void (*Camellia_ecb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const CAMELLIA_KEY * key, const int enc);
	APICALL void (*Camellia_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const CAMELLIA_KEY * key);
	APICALL void (*Camellia_ofb128_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const CAMELLIA_KEY * key, unsigned char * ivec, int * num);
	APICALL int (*Camellia_set_key)(struct AmiSSLIFace *Self, const unsigned char * userKey, const int bits, CAMELLIA_KEY * key);
	...
	APICALL void (*AES_bi_ige_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, const AES_KEY * key2, const unsigned char * ivec, const int enc);
	APICALL void (*SEED_decrypt)(struct AmiSSLIFace *Self, const unsigned char * s, unsigned char * d, const SEED_KEY_SCHEDULE * ks);
	APICALL void (*SEED_encrypt)(struct AmiSSLIFace *Self, const unsigned char * s, unsigned char * d, const SEED_KEY_SCHEDULE * ks);
	APICALL void (*SEED_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t len, const SEED_KEY_SCHEDULE * ks, unsigned char * ivec, int enc);
	APICALL const EVP_CIPHER * (*EVP_seed_ofb)(struct AmiSSLIFace *Self);
	APICALL void (*SEED_cfb128_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t len, const SEED_KEY_SCHEDULE * ks, unsigned char * ivec, int * num, int enc);
	APICALL void (*SEED_ofb128_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t len, const SEED_KEY_SCHEDULE * ks, unsigned char * ivec, int * num);
	APICALL const EVP_CIPHER * (*EVP_seed_cbc)(struct AmiSSLIFace *Self);
	APICALL void (*SEED_ecb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const SEED_KEY_SCHEDULE * ks, int enc);
	APICALL const EVP_CIPHER * (*EVP_seed_ecb)(struct AmiSSLIFace *Self);
	APICALL void (*SEED_set_key)(struct AmiSSLIFace *Self, const unsigned char * rawkey, SEED_KEY_SCHEDULE * ks);
	APICALL const EVP_CIPHER * (*EVP_seed_cfb128)(struct AmiSSLIFace *Self);
	APICALL int (*AES_unwrap_key)(struct AmiSSLIFace *Self, AES_KEY * key, const unsigned char * iv, unsigned char * out, const unsigned char * in, unsigned int inlen);
	APICALL int (*AES_wrap_key)(struct AmiSSLIFace *Self, AES_KEY * key, const unsigned char * iv, unsigned char * out, const unsigned char * in, unsigned int inlen);
	...
	APICALL int (*ERR_load_CMS_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*PEM_write_bio_CMS)(struct AmiSSLIFace *Self, BIO * out, CMS_ContentInfo * cms);
	...
	APICALL void * (*CMS_signed_get0_data_by_OBJ)(struct AmiSSLIFace *Self, CMS_SignerInfo * si, const ASN1_OBJECT * oid, int lastpos, int type);
	...
	APICALL int (*ENGINE_set_load_ssl_client_cert_function)(struct AmiSSLIFace *Self, ENGINE * e, ENGINE_SSL_CLIENT_CERT_PTR loadssl_f);
	APICALL ENGINE_SSL_CLIENT_CERT_PTR (*ENGINE_get_ssl_client_cert_function)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL int (*ENGINE_load_ssl_client_cert)(struct AmiSSLIFace *Self, ENGINE * e, SSL * s, STACK_OF(X509_NAME) * ca_dn, X509 ** pcert, EVP_PKEY ** ppkey, STACK_OF(X509) ** pother, UI_METHOD * ui_method, void * callback_data);
	APTR ENGINE_load_capi_UNIMPLEMENTED;
	APICALL int (*ENGINE_register_pkey_meths)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL ENGINE * (*ENGINE_get_pkey_asn1_meth_engine)(struct AmiSSLIFace *Self, int nid);
	APICALL int (*WHIRLPOOL_Init)(struct AmiSSLIFace *Self, WHIRLPOOL_CTX * c);
	APICALL unsigned char * (*WHIRLPOOL)(struct AmiSSLIFace *Self, const void * inp, size_t bytes, unsigned char * md);
	APICALL const EVP_PKEY_ASN1_METHOD * (*ENGINE_get_pkey_asn1_meth)(struct AmiSSLIFace *Self, ENGINE * e, int nid);
	APICALL const EVP_PKEY_METHOD * (*ENGINE_get_pkey_meth)(struct AmiSSLIFace *Self, ENGINE * e, int nid);
	APICALL BIO * (*BIO_new_CMS)(struct AmiSSLIFace *Self, BIO * out, CMS_ContentInfo * cms);
	APICALL int (*ENGINE_set_default_pkey_asn1_meths)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL void (*WHIRLPOOL_BitUpdate)(struct AmiSSLIFace *Self, WHIRLPOOL_CTX * ctx, const void * inp, size_t bits);
	...
	APICALL const EVP_PKEY_ASN1_METHOD * (*ENGINE_pkey_asn1_find_str)(struct AmiSSLIFace *Self, ENGINE ** pe, const char * str, int len);
	APICALL ENGINE_PKEY_METHS_PTR (*ENGINE_get_pkey_meths)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL int (*ENGINE_register_pkey_asn1_meths)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_set_default_pkey_meths)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*HMAC_CTX_copy)(struct AmiSSLIFace *Self, HMAC_CTX * dctx, HMAC_CTX * sctx);
	APICALL ENGINE_PKEY_ASN1_METHS_PTR (*ENGINE_get_pkey_asn1_meths)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL const EVP_MD * (*EVP_whirlpool)(struct AmiSSLIFace *Self);
	APICALL void (*ENGINE_register_all_pkey_meths)(struct AmiSSLIFace *Self);
	APICALL int (*WHIRLPOOL_Final)(struct AmiSSLIFace *Self, unsigned char * md, WHIRLPOOL_CTX * c);
	APICALL const EVP_PKEY_ASN1_METHOD * (*ENGINE_get_pkey_asn1_meth_str)(struct AmiSSLIFace *Self, ENGINE * e, const char * str, int len);
	APICALL void (*ENGINE_register_all_pkey_asn1_meths)(struct AmiSSLIFace *Self);
	APICALL void (*CMS_ContentInfo_print_ctx)(struct AmiSSLIFace *Self, BIO * out, CMS_ContentInfo * cms, int a, void * p);
	APICALL int (*CMS_add1_crl)(struct AmiSSLIFace *Self, CMS_ContentInfo * cms, X509_CRL * crl);
	APICALL int (*ENGINE_set_pkey_asn1_meths)(struct AmiSSLIFace *Self, ENGINE * e, ENGINE_PKEY_ASN1_METHS_PTR f);
	APICALL ENGINE * (*ENGINE_get_pkey_meth_engine)(struct AmiSSLIFace *Self, int nid);
	APICALL int (*WHIRLPOOL_Update)(struct AmiSSLIFace *Self, WHIRLPOOL_CTX * c, const void * inp, size_t bytes);
	APICALL int (*PEM_write_bio_CMS_stream)(struct AmiSSLIFace *Self, BIO * out, CMS_ContentInfo * cms, BIO * in, int flags);
	APICALL void (*ENGINE_unregister_pkey_meths)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL void (*ENGINE_unregister_pkey_asn1_meths)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_set_pkey_meths)(struct AmiSSLIFace *Self, ENGINE * e, ENGINE_PKEY_METHS_PTR f);
	APICALL DSA * (*DSAparams_dup)(struct AmiSSLIFace *Self, DSA * x);
	APICALL DH * (*DHparams_dup)(struct AmiSSLIFace *Self, DH * d);
	...
	APICALL SRP_user_pwd * (*SRP_VBASE_get_by_user)(struct AmiSSLIFace *Self, SRP_VBASE * vb, char * username);
	APICALL BIGNUM * (*SRP_Calc_server_key)(struct AmiSSLIFace *Self, const BIGNUM * A, const BIGNUM * v, const BIGNUM * u, const BIGNUM * b, const BIGNUM * N);
	APICALL char * (*SRP_create_verifier)(struct AmiSSLIFace *Self, const char * user, const char * pass, char ** salt, char ** verifier, const char * N, const char * g);
	APICALL int (*SRP_create_verifier_BN)(struct AmiSSLIFace *Self, const char * user, const char * pass, BIGNUM ** salt, BIGNUM ** verifier, const BIGNUM * N, const BIGNUM * g);
	APICALL BIGNUM * (*SRP_Calc_u)(struct AmiSSLIFace *Self, const BIGNUM * A, const BIGNUM * B, const BIGNUM * N);
	APICALL void (*SRP_VBASE_free)(struct AmiSSLIFace *Self, SRP_VBASE * vb);
	APICALL BIGNUM * (*SRP_Calc_client_key)(struct AmiSSLIFace *Self, const BIGNUM * N, const BIGNUM * B, const BIGNUM * g, const BIGNUM * x, const BIGNUM * a, const BIGNUM * u);
	APICALL SRP_gN * (*SRP_get_default_gN)(struct AmiSSLIFace *Self, const char * id);
	APICALL BIGNUM * (*SRP_Calc_x)(struct AmiSSLIFace *Self, const BIGNUM * s, const char * user, const char * pass);
	APICALL BIGNUM * (*SRP_Calc_B)(struct AmiSSLIFace *Self, const BIGNUM * b, const BIGNUM * N, const BIGNUM * g, const BIGNUM * v);
	APICALL SRP_VBASE * (*SRP_VBASE_new)(struct AmiSSLIFace *Self, char * seed_key);
	APICALL char * (*SRP_check_known_gN_param)(struct AmiSSLIFace *Self, const BIGNUM * g, const BIGNUM * N);
	APICALL BIGNUM * (*SRP_Calc_A)(struct AmiSSLIFace *Self, const BIGNUM * a, const BIGNUM * N, const BIGNUM * g);
	APICALL int (*SRP_Verify_A_mod_N)(struct AmiSSLIFace *Self, const BIGNUM * A, const BIGNUM * N);
	APICALL int (*SRP_VBASE_init)(struct AmiSSLIFace *Self, SRP_VBASE * vb, char * verifier_file);
	APICALL int (*SRP_Verify_B_mod_N)(struct AmiSSLIFace *Self, const BIGNUM * B, const BIGNUM * N);
	APICALL int (*EC_KEY_set_public_key_affine_coordinates)(struct AmiSSLIFace *Self, EC_KEY * key, BIGNUM * x, BIGNUM * y);
	...
	APICALL int (*EC_KEY_get_flags)(struct AmiSSLIFace *Self, const EC_KEY * key);
	...
	APICALL void (*EC_KEY_clear_flags)(struct AmiSSLIFace *Self, EC_KEY * key, int flags);
	APICALL void (*EC_KEY_set_flags)(struct AmiSSLIFace *Self, EC_KEY * key, int flags);
	...
	APICALL int (*ASN1_item_sign_ctx)(struct AmiSSLIFace *Self, const ASN1_ITEM * it, X509_ALGOR * algor1, X509_ALGOR * algor2, ASN1_BIT_STRING * signature, void * asn, EVP_MD_CTX * ctx);
	...
	APICALL int (*PEM_write_bio_SSL_SESSION)(struct AmiSSLIFace *Self, BIO * bp, SSL_SESSION * x);
	...
	APICALL int (*BN_X931_generate_Xpq)(struct AmiSSLIFace *Self, BIGNUM * Xp, BIGNUM * Xq, int nbits, BN_CTX * ctx);
	...
	APICALL int (*EVP_PKEY_cmp)(struct AmiSSLIFace *Self, const EVP_PKEY * a, const EVP_PKEY * b);
	...
	APICALL int (*ECParameters_print)(struct AmiSSLIFace *Self, BIO * bp, const EC_KEY * key);
	...
	APICALL X509_VERIFY_PARAM * (*X509_STORE_CTX_get0_param)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	...
	APICALL BN_BLINDING * (*RSA_setup_blinding)(struct AmiSSLIFace *Self, RSA * rsa, BN_CTX * ctx);
	...
	APICALL int (*ASN1_item_ndef_i2d)(struct AmiSSLIFace *Self, ASN1_VALUE * val, unsigned char ** out, const ASN1_ITEM * it);
	APICALL int (*ERR_pop_to_mark)(struct AmiSSLIFace *Self);
	APICALL X509_POLICY_NODE * (*X509_policy_level_get0_node)(struct AmiSSLIFace *Self, X509_POLICY_LEVEL * level, int i);
	...
	APICALL int (*BIO_dump_indent_cb)(struct AmiSSLIFace *Self, int (*cb)(const void *data, size_t len, void *u), void * u, const char * s, int len, int indent);
	...
	APICALL int (*BN_is_prime_fasttest_ex)(struct AmiSSLIFace *Self, const BIGNUM * p, int nchecks, BN_CTX * ctx, int do_trial_devision, BN_GENCB * cb);
	...
	APICALL int (*BIO_dump_cb)(struct AmiSSLIFace *Self, int (*cb)(const void *data, size_t len, void *u), void * u, const char * s, int len);
	...
	APICALL unsigned long (*X509_VERIFY_PARAM_get_flags)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param);
	...
	APICALL int (*OBSOLETE_EVP_CIPHER_block_size)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher);
	...
	APICALL int (*OBSOLETE_EVP_CIPHER_CTX_nid)(struct AmiSSLIFace *Self, const EVP_CIPHER_CTX * ctx);
	APICALL int (*OBSOLETE_EVP_CIPHER_CTX_key_length)(struct AmiSSLIFace *Self, const EVP_CIPHER_CTX * ctx);
	APICALL int (*OBSOLETE_EVP_MD_size)(struct AmiSSLIFace *Self, const EVP_MD * md);
	...
	APICALL int (*OBSOLETE_EVP_MD_pkey_type)(struct AmiSSLIFace *Self, const EVP_MD * md);
	APICALL void (*EVP_MD_CTX_clear_flags)(struct AmiSSLIFace *Self, EVP_MD_CTX * ctx, int flags);
	APICALL unsigned long (*OBSOLETE_EVP_CIPHER_flags)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher);
	APICALL BIO_callback_fn (*BIO_get_callback)(struct AmiSSLIFace *Self, const BIO * b);
	APICALL int (*OBSOLETE_EVP_CIPHER_key_length)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher);
	...
	APICALL int (*OBSOLETE_EVP_CIPHER_CTX_block_size)(struct AmiSSLIFace *Self, const EVP_CIPHER_CTX * ctx);
	APICALL const EVP_CIPHER * (*EVP_CIPHER_CTX_cipher)(struct AmiSSLIFace *Self, const EVP_CIPHER_CTX * ctx);
	APICALL void * (*EVP_CIPHER_CTX_get_app_data)(struct AmiSSLIFace *Self, const EVP_CIPHER_CTX * ctx);
	APICALL int (*OBSOLETE_EVP_MD_block_size)(struct AmiSSLIFace *Self, const EVP_MD * md);
	APTR EVP_CIPHER_CTX_flags_UNIMPLEMENTED;
	APICALL const EVP_MD * (*EVP_MD_CTX_md)(struct AmiSSLIFace *Self, const EVP_MD_CTX * ctx);
	APICALL const char * (*BIO_method_name)(struct AmiSSLIFace *Self, const BIO * b);
	APICALL int (*OBSOLETE_EVP_CIPHER_CTX_iv_length)(struct AmiSSLIFace *Self, const EVP_CIPHER_CTX * ctx);
	...
	APICALL void * (*X509at_get0_data_by_OBJ)(struct AmiSSLIFace *Self, STACK_OF(X509_ATTRIBUTE) * x, const ASN1_OBJECT * obj, int lastpos, int type);
	...
	APICALL int (*BN_X931_generate_prime_ex)(struct AmiSSLIFace *Self, BIGNUM * p, BIGNUM * p1, BIGNUM * p2, BIGNUM * Xp1, BIGNUM * Xp2, const BIGNUM * Xp, const BIGNUM * e, BN_CTX * ctx, BN_GENCB * cb);
	...
	APICALL int (*BN_X931_derive_prime_ex)(struct AmiSSLIFace *Self, BIGNUM * p, BIGNUM * p1, BIGNUM * p2, const BIGNUM * Xp, const BIGNUM * Xp1, const BIGNUM * Xp2, const BIGNUM * e, BN_CTX * ctx, BN_GENCB * cb);
	...
	APICALL int (*ASN1_item_print)(struct AmiSSLIFace *Self, BIO * out, ASN1_VALUE * ifld, int indent, const ASN1_ITEM * it, const ASN1_PCTX * ctx);
	APICALL int (*TS_TST_INFO_set_nonce)(struct AmiSSLIFace *Self, TS_TST_INFO * a, const ASN1_INTEGER * nonce);
	APICALL TS_RESP * (*TS_RESP_dup)(struct AmiSSLIFace *Self, TS_RESP * a);
	...
	APICALL void (*EVP_PKEY_meth_set_decrypt)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*decrypt_init)(EVP_PKEY_CTX *ctx), int (*decrypt)(EVP_PKEY_CTX *ctx, unsigned char *out, size_t *outlen, const unsigned char *in, size_t inlen));
	...
	APICALL TS_REQ * (*TS_REQ_dup)(struct AmiSSLIFace *Self, TS_REQ * a);
	APICALL GENERAL_NAME * (*GENERAL_NAME_dup)(struct AmiSSLIFace *Self, GENERAL_NAME * a);
	APICALL STACK_OF(X509_CRL) * (*X509_STORE_CTX_get1_crls)(struct AmiSSLIFace *Self, X509_STORE_CTX * st, X509_NAME * nm);
	...
	APICALL int (*i2d_TS_TST_INFO_bio)(struct AmiSSLIFace *Self, BIO * fp, TS_TST_INFO * a);
	...
	APICALL int (*EVP_PKEY_encrypt_old)(struct AmiSSLIFace *Self, unsigned char * enc_key, const unsigned char * key, int key_len, EVP_PKEY * pub_key);
	...
	APICALL ESS_CERT_ID * (*ESS_CERT_ID_dup)(struct AmiSSLIFace *Self, ESS_CERT_ID * a);
	APICALL TS_STATUS_INFO * (*TS_STATUS_INFO_dup)(struct AmiSSLIFace *Self, TS_STATUS_INFO * a);
	...
	APICALL int (*DIST_POINT_set_dpname)(struct AmiSSLIFace *Self, DIST_POINT_NAME * dpn, X509_NAME * iname);
	APICALL int (*i2d_ISSUING_DIST_POINT)(struct AmiSSLIFace *Self, const ISSUING_DIST_POINT * a, unsigned char ** pp);
	APICALL void * (*EVP_PKEY_CTX_get_data)(struct AmiSSLIFace *Self, EVP_PKEY_CTX * ctx);
	...
	APICALL int (*OBSOLETE_EVP_PKEY_base_id)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey);
	...
	APICALL void (*EVP_PKEY_meth_set_ctrl)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*ctrl)(EVP_PKEY_CTX *ctx, int type, int p1, void *p2), int (*ctrl_str)(EVP_PKEY_CTX *ctx, const char *type, const char *value));
	...
	APICALL void (*EVP_PKEY_meth_set_sign)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*sign_init)(EVP_PKEY_CTX *ctx), int (*sign)(EVP_PKEY_CTX *ctx, unsigned char *sig, size_t *siglen, const unsigned char *tbs, size_t tbslen));
	...
	APICALL int (*i2b_PVK_bio)(struct AmiSSLIFace *Self, BIO * out, EVP_PKEY * pk, int enclevel, pem_password_cb * cb, void * u);
	...
	APICALL ASN1_UTCTIME * (*ASN1_UTCTIME_adj)(struct AmiSSLIFace *Self, ASN1_UTCTIME * s, time_t t, int offset_day, int offset_sec);
	...
	APICALL void (*EVP_PKEY_meth_set_init)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*init)(EVP_PKEY_CTX *ctx));
	...
	APICALL ASN1_TIME * (*ASN1_TIME_adj)(struct AmiSSLIFace *Self, ASN1_TIME * s, time_t t, int offset_day, int offset_sec);
	APICALL int (*TS_OBJ_print_bio)(struct AmiSSLIFace *Self, BIO * bio, const ASN1_OBJECT * obj);
	APICALL void (*EVP_PKEY_meth_set_verify_recover)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*verify_recover_init)(EVP_PKEY_CTX *ctx), int (*verify_recover)(EVP_PKEY_CTX *ctx, unsigned char *sig, size_t *siglen, const unsigned char *tbs, size_t tbslen));
	...
	APICALL void (*EVP_PKEY_meth_set_derive)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*derive_init)(EVP_PKEY_CTX *ctx), int (*derive)(EVP_PKEY_CTX *ctx, unsigned char *key, size_t *keylen));
	APTR i2d_TS_RESP_fp_UNIMPLEMENTED;
	APICALL int (*i2d_TS_MSG_IMPRINT_bio)(struct AmiSSLIFace *Self, BIO * fp, TS_MSG_IMPRINT * a);
	...
	APICALL int (*i2b_PrivateKey_bio)(struct AmiSSLIFace *Self, BIO * out, EVP_PKEY * pk);
	...
	APICALL int (*ERR_load_TS_strings)(struct AmiSSLIFace *Self);
	APICALL long (*TS_TST_INFO_get_version)(struct AmiSSLIFace *Self, const TS_TST_INFO * a);
	APICALL EVP_PKEY_CTX * (*EVP_PKEY_CTX_dup)(struct AmiSSLIFace *Self, EVP_PKEY_CTX * ctx);
	APICALL void (*EVP_PKEY_meth_set_verify)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*verify_init)(EVP_PKEY_CTX *ctx), int (*verify)(EVP_PKEY_CTX *ctx, const unsigned char *sig, size_t siglen, const unsigned char *tbs, size_t tbslen));
	APICALL int (*i2b_PublicKey_bio)(struct AmiSSLIFace *Self, BIO * out, EVP_PKEY * pk);
	...
	APICALL void (*EVP_PKEY_meth_set_verifyctx)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*verifyctx_init)(EVP_PKEY_CTX *ctx, EVP_MD_CTX *mctx), int (*verifyctx)(EVP_PKEY_CTX *ctx, const unsigned char *sig,int siglen, EVP_MD_CTX *mctx));
	...
	APICALL OCSP_CERTID * (*OCSP_CERTID_dup)(struct AmiSSLIFace *Self, OCSP_CERTID * a);
	APICALL int (*X509_PUBKEY_get0_param)(struct AmiSSLIFace *Self, ASN1_OBJECT ** ppkalg, const unsigned char ** pk, int * ppklen, X509_ALGOR ** pa, X509_PUBKEY * pub);
	APICALL TS_MSG_IMPRINT * (*TS_MSG_IMPRINT_dup)(struct AmiSSLIFace *Self, TS_MSG_IMPRINT * a);
	APICALL void (*PKCS7_print_ctx)(struct AmiSSLIFace *Self, BIO * out, PKCS7 * x, int indent, const ASN1_PCTX * pctx);
	APICALL int (*i2d_TS_REQ_bio)(struct AmiSSLIFace *Self, BIO * fp, TS_REQ * a);
	...
	APICALL void (*EVP_PKEY_meth_set_encrypt)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*encrypt_init)(EVP_PKEY_CTX *ctx), int (*encryptfn)(EVP_PKEY_CTX *ctx, unsigned char *out, size_t *outlen, const unsigned char *in, size_t inlen));
	...
	APICALL int (*EVP_PKEY_decrypt_old)(struct AmiSSLIFace *Self, unsigned char * dec_key, const unsigned char * enc_key, int enc_key_len, EVP_PKEY * private_key);
	...
	APICALL TS_ACCURACY * (*TS_ACCURACY_dup)(struct AmiSSLIFace *Self, TS_ACCURACY * a);
	...
	APICALL TS_TST_INFO * (*TS_TST_INFO_dup)(struct AmiSSLIFace *Self, TS_TST_INFO * a);
	APICALL int (*PEM_write_bio_Parameters)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY * x);
	APICALL TS_ACCURACY * (*TS_TST_INFO_get_accuracy)(struct AmiSSLIFace *Self, TS_TST_INFO * a);
	APICALL int (*X509_CRL_get0_by_serial)(struct AmiSSLIFace *Self, X509_CRL * crl, X509_REVOKED ** ret, ASN1_INTEGER * serial);
	...
	APICALL void (*EVP_PKEY_meth_set_signctx)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*signctx_init)(EVP_PKEY_CTX *ctx, EVP_MD_CTX *mctx), int (*signctx)(EVP_PKEY_CTX *ctx, unsigned char *sig, size_t *siglen, EVP_MD_CTX *mctx));
	...
	APICALL STACK_OF(X509) * (*X509_STORE_CTX_get1_certs)(struct AmiSSLIFace *Self, X509_STORE_CTX * st, X509_NAME * nm);
	...
	APICALL void * (*EVP_PKEY_get0)(struct AmiSSLIFace *Self, EVP_PKEY * pkey);
	...
	APICALL int (*EVP_PKEY_meth_add0)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth);
	APICALL int (*TS_TST_INFO_set_tsa)(struct AmiSSLIFace *Self, TS_TST_INFO * a, GENERAL_NAME * tsa);
	APICALL EVP_PKEY_METHOD * (*EVP_PKEY_meth_new)(struct AmiSSLIFace *Self, int id, int flags);
	...
	APICALL ESS_SIGNING_CERT * (*ESS_SIGNING_CERT_dup)(struct AmiSSLIFace *Self, ESS_SIGNING_CERT * a);
	...
	APICALL void (*EVP_PKEY_meth_free)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth);
	...
	APICALL int (*i2d_TS_RESP_bio)(struct AmiSSLIFace *Self, BIO * fp, TS_RESP * a);
	...
	APICALL const EVP_PKEY_METHOD * (*EVP_PKEY_meth_find)(struct AmiSSLIFace *Self, int type);
	APICALL int (*OBSOLETE_EVP_PKEY_id)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey);
	...
	APICALL int (*TS_CONF_set_clock_precision_digits)(struct AmiSSLIFace *Self, CONF * conf, const char * section, TS_RESP_CTX * ctx);
	APICALL ESS_ISSUER_SERIAL * (*ESS_ISSUER_SERIAL_dup)(struct AmiSSLIFace *Self, ESS_ISSUER_SERIAL * a);
	...
	APICALL int (*X509_check_akid)(struct AmiSSLIFace *Self, X509 * issuer, AUTHORITY_KEYID * akid);
	...
	APICALL void (*EVP_PKEY_meth_set_cleanup)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, void (*cleanup)(EVP_PKEY_CTX *ctx));
	...
	APICALL void (*EVP_PKEY_meth_set_keygen)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*keygen_init)(EVP_PKEY_CTX *ctx), int (*keygen)(EVP_PKEY_CTX *ctx, EVP_PKEY *pkey));
	...
	APICALL void (*EVP_PKEY_meth_set_paramgen)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*paramgen_init)(EVP_PKEY_CTX *ctx), int (*paramgen)(EVP_PKEY_CTX *ctx, EVP_PKEY *pkey));
	...
	APICALL int (*TS_ext_print_bio)(struct AmiSSLIFace *Self, BIO * bio, STACK_OF(X509_EXTENSION) * extensions);
	...
	APICALL void (*EVP_PKEY_meth_set_copy)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*copy)(EVP_PKEY_CTX *dst, const EVP_PKEY_CTX *src));
	...
	APICALL unsigned long (*X509_NAME_hash_old)(struct AmiSSLIFace *Self, X509_NAME * x);
	APICALL int (*ASN1_TIME_set_string)(struct AmiSSLIFace *Self, ASN1_TIME * s, const char * str);
	APICALL unsigned long (*OBSOLETE_EVP_MD_flags)(struct AmiSSLIFace *Self, const EVP_MD * md);
	APICALL void (*TS_RESP_CTX_free)(struct AmiSSLIFace *Self, TS_RESP_CTX * ctx);
	APICALL int (*OBSOLETE_OCSP_REQ_CTX_add1_header)(struct AmiSSLIFace *Self, OCSP_REQ_CTX * rctx, const char * name, const char * value);
	APICALL int (*OBSOLETE_OCSP_REQ_CTX_set1_req)(struct AmiSSLIFace *Self, OCSP_REQ_CTX * rctx, OCSP_REQUEST * req);
	APICALL void (*X509_STORE_set_verify_cb)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_verify_cb verify_cb);
	APICALL X509_CRL * (*X509_STORE_CTX_get0_current_crl)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509_STORE_CTX * (*X509_STORE_CTX_get0_parent_ctx)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509 * (*X509_STORE_CTX_get0_current_issuer)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	...
	APICALL void (*EVP_PKEY_meth_get0_info)(struct AmiSSLIFace *Self, int * ppkey_id, int * pflags, const EVP_PKEY_METHOD * meth);
	APICALL void (*EVP_PKEY_meth_copy)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * dst, const EVP_PKEY_METHOD * src);
	APICALL int (*RSA_padding_add_PKCS1_PSS_mgf1)(struct AmiSSLIFace *Self, RSA * rsa, unsigned char * EM, const unsigned char * mHash, const EVP_MD * Hash, const EVP_MD * mgf1Hash, int sLen);
	APICALL int (*RSA_verify_PKCS1_PSS_mgf1)(struct AmiSSLIFace *Self, RSA * rsa, const unsigned char * mHash, const EVP_MD * Hash, const EVP_MD * mgf1Hash, const unsigned char * EM, int sLen);
	APICALL void (*X509_ALGOR_set_md)(struct AmiSSLIFace *Self, X509_ALGOR * alg, const EVP_MD * md);
	APICALL int (*CMAC_CTX_copy)(struct AmiSSLIFace *Self, CMAC_CTX * out, const CMAC_CTX * in);
	APICALL void (*CMAC_CTX_free)(struct AmiSSLIFace *Self, CMAC_CTX * ctx);
	APICALL EVP_CIPHER_CTX * (*CMAC_CTX_get0_cipher_ctx)(struct AmiSSLIFace *Self, CMAC_CTX * ctx);
	APICALL void (*CMAC_CTX_cleanup)(struct AmiSSLIFace *Self, CMAC_CTX * ctx);
	APICALL int (*CMAC_Init)(struct AmiSSLIFace *Self, CMAC_CTX * ctx, const void * key, size_t keylen, const EVP_CIPHER * cipher, ENGINE * impl);
	APICALL int (*CMAC_Update)(struct AmiSSLIFace *Self, CMAC_CTX * ctx, const void * data, size_t dlen);
	APICALL int (*CMAC_resume)(struct AmiSSLIFace *Self, CMAC_CTX * ctx);
	APICALL CMAC_CTX * (*CMAC_CTX_new)(struct AmiSSLIFace *Self);
	APICALL int (*CMAC_Final)(struct AmiSSLIFace *Self, CMAC_CTX * ctx, unsigned char * out, size_t * poutlen);
	...
	APICALL int (*CRYPTO_xts128_encrypt)(struct AmiSSLIFace *Self, XTS128_CONTEXT * ctx, const unsigned char * iv, const unsigned char * inp, unsigned char * out, size_t len, int enc);
	...
	APICALL int (*i2d_RSA_PSS_PARAMS)(struct AmiSSLIFace *Self, RSA_PSS_PARAMS * a, unsigned char ** out);
	...
	APICALL int (*PEM_write_bio_DHxparams)(struct AmiSSLIFace *Self, BIO * bp, DH * x);
	...
	APICALL int (*BIO_hex_string)(struct AmiSSLIFace *Self, BIO * out, int indent, int width, unsigned char * data, int datalen);
	...
	APICALL int (*CMS_RecipientInfo_encrypt)(struct AmiSSLIFace *Self, CMS_ContentInfo * cms, CMS_RecipientInfo * ri);
	...
	APICALL DH * (*d2i_DHxparams)(struct AmiSSLIFace *Self, DH ** a, const unsigned char ** pp, long length);
	APICALL int (*i2d_DHxparams)(struct AmiSSLIFace *Self, const DH * dh, unsigned char ** pp);
	APICALL int (*DH_compute_key_padded)(struct AmiSSLIFace *Self, unsigned char * key, const BIGNUM * pub_key, DH * dh);
	APICALL DH * (*DH_get_1024_160)(struct AmiSSLIFace *Self);
	APICALL DH * (*DH_get_2048_224)(struct AmiSSLIFace *Self);
	APICALL DH * (*DH_get_2048_256)(struct AmiSSLIFace *Self);
	APICALL int (*DH_KDF_X9_42)(struct AmiSSLIFace *Self, unsigned char * out, size_t outlen, const unsigned char * Z, size_t Zlen, ASN1_OBJECT * key_oid, const unsigned char * ukm, size_t ukmlen, const EVP_MD * md);
	...
	APICALL int (*ECDH_KDF_X9_62)(struct AmiSSLIFace *Self, unsigned char * out, size_t outlen, const unsigned char * Z, size_t Zlen, const unsigned char * sinfo, size_t sinfolen, const EVP_MD * md);
	...
	APICALL BIO * (*OBSOLETE_OCSP_REQ_CTX_get0_mem_bio)(struct AmiSSLIFace *Self, OCSP_REQ_CTX * rctx);
	APICALL int (*OBSOLETE_OCSP_REQ_CTX_http)(struct AmiSSLIFace *Self, OCSP_REQ_CTX * rctx, const char * op, const char * path);
	APICALL int (*OBSOLETE_OCSP_REQ_CTX_i2d)(struct AmiSSLIFace *Self, OCSP_REQ_CTX * rctx, const ASN1_ITEM * it, ASN1_VALUE * val);
	APICALL int (*OBSOLETE_OCSP_REQ_CTX_nbio)(struct AmiSSLIFace *Self, OCSP_REQ_CTX * rctx);
	APICALL int (*OBSOLETE_OCSP_REQ_CTX_nbio_d2i)(struct AmiSSLIFace *Self, OCSP_REQ_CTX * rctx, ASN1_VALUE ** pval, const ASN1_ITEM * it);
	APICALL OCSP_REQ_CTX * (*OBSOLETE_OCSP_REQ_CTX_new)(struct AmiSSLIFace *Self, BIO * io, int maxline);
	APICALL void (*OBSOLETE_OCSP_set_max_response_length)(struct AmiSSLIFace *Self, OCSP_REQ_CTX * rctx, unsigned long len);
	...
	APICALL int (*RSA_padding_add_PKCS1_OAEP_mgf1)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * from, int flen, const unsigned char * param, int plen, const EVP_MD * md, const EVP_MD * mgf1md);
	APICALL int (*RSA_padding_check_PKCS1_OAEP_mgf1)(struct AmiSSLIFace *Self, unsigned char * to, int tlen, const unsigned char * from, int flen, int num, const unsigned char * param, int plen, const EVP_MD * md, const EVP_MD * mgf1md);
	...
	APICALL int (*OBSOLETE_X509_CRL_http_nbio)(struct AmiSSLIFace *Self, OCSP_REQ_CTX * rctx, X509_CRL ** pcrl);
	...
	APICALL int (*OBSOLETE_X509_http_nbio)(struct AmiSSLIFace *Self, OCSP_REQ_CTX * rctx, X509 ** pcert);
	APICALL X509_REVOKED * (*X509_REVOKED_dup)(struct AmiSSLIFace *Self, X509_REVOKED * rev);
	APICALL X509_STORE * (*X509_STORE_CTX_get0_store)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	...
	APICALL char * (*X509_VERIFY_PARAM_get0_peername)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param);
	...
	APICALL int (*ERR_load_ASYNC_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*CRYPTO_secure_allocated)(struct AmiSSLIFace *Self, void * ptr);
	...
	APICALL int (*CRYPTO_secure_malloc_init)(struct AmiSSLIFace *Self, size_t sz, int minsize);
	...
	APICALL int (*DH_bits)(struct AmiSSLIFace *Self, const DH * dh);
	APICALL int (*DH_security_bits)(struct AmiSSLIFace *Self, const DH * dh);
	APICALL int (*DSA_security_bits)(struct AmiSSLIFace *Self, const DSA * d);
	...
	APICALL const EC_KEY_METHOD * (*EC_KEY_get_default_method)(struct AmiSSLIFace *Self);
	APICALL void * (*EC_KEY_get_ex_data)(struct AmiSSLIFace *Self, const EC_KEY * key, int idx);
	APICALL const EC_KEY_METHOD * (*EC_KEY_get_method)(struct AmiSSLIFace *Self, const EC_KEY * key);
	APICALL size_t (*EC_KEY_key2buf)(struct AmiSSLIFace *Self, const EC_KEY * key, point_conversion_form_t form, unsigned char ** pbuf, BN_CTX * ctx);
	APICALL void (*EC_KEY_METHOD_free)(struct AmiSSLIFace *Self, EC_KEY_METHOD * meth);
	APICALL void (*EC_KEY_METHOD_get_compute_key)(struct AmiSSLIFace *Self, const EC_KEY_METHOD * meth, int (**pck)(unsigned char **, size_t *, const EC_POINT *, const EC_KEY *));
	APICALL void (*EC_KEY_METHOD_get_init)(struct AmiSSLIFace *Self, const EC_KEY_METHOD * meth, int (**pinit)(EC_KEY *), void (**pfinish)(EC_KEY *), int (**pcopy)(EC_KEY *, const EC_KEY *), int (**pset_group)(EC_KEY *, const EC_GROUP *), int (**pset_private)(EC_KEY *, const BIGNUM *), int (**pset_public)(EC_KEY *, const EC_POINT *));
	APICALL void (*EC_KEY_METHOD_get_keygen)(struct AmiSSLIFace *Self, const EC_KEY_METHOD * meth, int (**pkeygen)(EC_KEY *));
	APICALL void (*EC_KEY_METHOD_get_sign)(struct AmiSSLIFace *Self, const EC_KEY_METHOD * meth, int (**psign)(int, const unsigned char *, int, unsigned char *, unsigned int *, const BIGNUM *, const BIGNUM *, EC_KEY *), int (**psign_setup)(EC_KEY *, BN_CTX *, BIGNUM **, BIGNUM **), ECDSA_SIG * (**psign_sig)(const unsigned char *, int, const BIGNUM *, const BIGNUM *, EC_KEY *));
	APICALL void (*EC_KEY_METHOD_get_verify)(struct AmiSSLIFace *Self, const EC_KEY_METHOD * meth, int (**pverify)(int, const unsigned char *, int, const unsigned char *, int, EC_KEY *), int (**pverify_sig)(const unsigned char *, int, const ECDSA_SIG *, EC_KEY *));
	APICALL EC_KEY_METHOD * (*EC_KEY_METHOD_new)(struct AmiSSLIFace *Self, const EC_KEY_METHOD * meth);
	APICALL void (*EC_KEY_METHOD_set_compute_key)(struct AmiSSLIFace *Self, EC_KEY_METHOD * meth, int (*ckey)(unsigned char **, size_t *, const EC_POINT *, const EC_KEY *));
	APICALL void (*EC_KEY_METHOD_set_init)(struct AmiSSLIFace *Self, EC_KEY_METHOD * meth, int (*init)(EC_KEY *), void (*finish)(EC_KEY *), int (*copy)(EC_KEY *, const EC_KEY *), int (*set_group)(EC_KEY *, const EC_GROUP *), int (*set_private)(EC_KEY *, const BIGNUM *), int (*set_public)(EC_KEY *, const EC_POINT *));
	APICALL void (*EC_KEY_METHOD_set_keygen)(struct AmiSSLIFace *Self, EC_KEY_METHOD * meth, int (*keygen)(EC_KEY *));
	APICALL void (*EC_KEY_METHOD_set_sign)(struct AmiSSLIFace *Self, EC_KEY_METHOD * meth, int (*sign)(int, const unsigned char *, int, unsigned char *, unsigned int *, const BIGNUM *, const BIGNUM *, EC_KEY *), int (*sign_setup)(EC_KEY *, BN_CTX *, BIGNUM **, BIGNUM **), ECDSA_SIG * (*sign_sig)(const unsigned char *, int, const BIGNUM *, const BIGNUM *, EC_KEY *));
	APICALL void (*EC_KEY_METHOD_set_verify)(struct AmiSSLIFace *Self, EC_KEY_METHOD * meth, int (*verify)(int, const unsigned char *, int, const unsigned char *, int, EC_KEY *), int (*verify_sig)(const unsigned char *, int, const ECDSA_SIG *, EC_KEY *));
	APICALL EC_KEY * (*EC_KEY_new_method)(struct AmiSSLIFace *Self, ENGINE * engine);
	APICALL int (*EC_KEY_oct2key)(struct AmiSSLIFace *Self, EC_KEY * key, const unsigned char * buf, size_t len, BN_CTX * ctx);
	APICALL int (*EC_KEY_oct2priv)(struct AmiSSLIFace *Self, EC_KEY * key, const unsigned char * buf, size_t len);
	APICALL const EC_KEY_METHOD * (*EC_KEY_OpenSSL)(struct AmiSSLIFace *Self);
	APICALL size_t (*EC_KEY_priv2buf)(struct AmiSSLIFace *Self, const EC_KEY * eckey, unsigned char ** pbuf);
	APICALL size_t (*EC_KEY_priv2oct)(struct AmiSSLIFace *Self, const EC_KEY * eckey, unsigned char * buf, size_t len);
	APICALL void (*EC_KEY_set_default_method)(struct AmiSSLIFace *Self, const EC_KEY_METHOD * meth);
	APICALL int (*EC_KEY_set_ex_data)(struct AmiSSLIFace *Self, EC_KEY * key, int idx, void * arg);
	APICALL int (*EC_KEY_set_method)(struct AmiSSLIFace *Self, EC_KEY * key, const EC_KEY_METHOD * meth);
	...
	APICALL ENGINE * (*ENGINE_get_default_EC)(struct AmiSSLIFace *Self);
	APICALL const EC_KEY_METHOD * (*ENGINE_get_EC)(struct AmiSSLIFace *Self, const ENGINE * e);
	APICALL void (*ENGINE_register_all_EC)(struct AmiSSLIFace *Self);
	APICALL int (*ENGINE_register_EC)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_set_default_EC)(struct AmiSSLIFace *Self, ENGINE * e);
	APICALL int (*ENGINE_set_EC)(struct AmiSSLIFace *Self, ENGINE * e, const EC_KEY_METHOD * ecdsa_meth);
	APICALL void (*ENGINE_unregister_EC)(struct AmiSSLIFace *Self, ENGINE * e);
	...
	APICALL unsigned char * (*EVP_CIPHER_CTX_buf_noconst)(struct AmiSSLIFace *Self, EVP_CIPHER_CTX * ctx);
	...
	APICALL int (*OBSOLETE_EVP_CIPHER_CTX_encrypting)(struct AmiSSLIFace *Self, const EVP_CIPHER_CTX * ctx);
	APICALL const unsigned char * (*EVP_CIPHER_CTX_iv)(struct AmiSSLIFace *Self, const EVP_CIPHER_CTX * ctx);
	APICALL unsigned char * (*EVP_CIPHER_CTX_iv_noconst)(struct AmiSSLIFace *Self, EVP_CIPHER_CTX * ctx);
	APICALL int (*OBSOLETE_EVP_CIPHER_CTX_num)(struct AmiSSLIFace *Self, const EVP_CIPHER_CTX * ctx);
	APICALL const unsigned char * (*EVP_CIPHER_CTX_original_iv)(struct AmiSSLIFace *Self, const EVP_CIPHER_CTX * ctx);
	APICALL int (*EVP_CIPHER_CTX_reset)(struct AmiSSLIFace *Self, EVP_CIPHER_CTX * ctx);
	APICALL void (*EVP_CIPHER_CTX_set_num)(struct AmiSSLIFace *Self, EVP_CIPHER_CTX * ctx, int num);
	APICALL int (*EVP_CIPHER_impl_ctx_size)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher);
	APICALL EVP_CIPHER * (*EVP_CIPHER_meth_dup)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher);
	APICALL void (*EVP_CIPHER_meth_free)(struct AmiSSLIFace *Self, EVP_CIPHER * cipher);
	APICALL int (*(*EVP_CIPHER_meth_get_cleanup)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher))(EVP_CIPHER_CTX *);
	APICALL int (*(*EVP_CIPHER_meth_get_ctrl)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher))(EVP_CIPHER_CTX *, int, int, void *);
	APICALL int (*(*EVP_CIPHER_meth_get_do_cipher)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher))(EVP_CIPHER_CTX *, unsigned char *, const unsigned char *, size_t);
	APICALL int (*(*EVP_CIPHER_meth_get_get_asn1_params)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher))(EVP_CIPHER_CTX *, ASN1_TYPE *);
	APICALL int (*(*EVP_CIPHER_meth_get_init)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher))(EVP_CIPHER_CTX *, const unsigned char *, const unsigned char *, int);
	APICALL int (*(*EVP_CIPHER_meth_get_set_asn1_params)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher))(EVP_CIPHER_CTX *, ASN1_TYPE *);
	APICALL EVP_CIPHER * (*EVP_CIPHER_meth_new)(struct AmiSSLIFace *Self, int cipher_type, int block_size, int key_len);
	APICALL int (*EVP_CIPHER_meth_set_cleanup)(struct AmiSSLIFace *Self, EVP_CIPHER * cipher, int (*cleanup)(EVP_CIPHER_CTX *));
	APICALL int (*EVP_CIPHER_meth_set_ctrl)(struct AmiSSLIFace *Self, EVP_CIPHER * cipher, int (*ctrl)(EVP_CIPHER_CTX *, int, int, void *));
	APICALL int (*EVP_CIPHER_meth_set_do_cipher)(struct AmiSSLIFace *Self, EVP_CIPHER * cipher, int (*do_cipher)(EVP_CIPHER_CTX *, unsigned char *, const unsigned char *, size_t));
	APICALL int (*EVP_CIPHER_meth_set_flags)(struct AmiSSLIFace *Self, EVP_CIPHER * cipher, unsigned long flags);
	APICALL int (*EVP_CIPHER_meth_set_get_asn1_params)(struct AmiSSLIFace *Self, EVP_CIPHER * cipher, int (*get_asn1_parameters)(EVP_CIPHER_CTX *, ASN1_TYPE *));
	APICALL int (*EVP_CIPHER_meth_set_impl_ctx_size)(struct AmiSSLIFace *Self, EVP_CIPHER * cipher, int ctx_size);
	APICALL int (*EVP_CIPHER_meth_set_init)(struct AmiSSLIFace *Self, EVP_CIPHER * cipher, int (*init)(EVP_CIPHER_CTX *, const unsigned char *, const unsigned char *, int));
	APICALL int (*EVP_CIPHER_meth_set_iv_length)(struct AmiSSLIFace *Self, EVP_CIPHER * cipher, int iv_len);
	APICALL int (*EVP_CIPHER_meth_set_set_asn1_params)(struct AmiSSLIFace *Self, EVP_CIPHER * cipher, int (*set_asn1_parameters)(EVP_CIPHER_CTX *, ASN1_TYPE *));
	...
	APICALL void * (*OBSOLETE_EVP_MD_CTX_md_data)(struct AmiSSLIFace *Self, const EVP_MD_CTX * ctx);
	APICALL EVP_MD_CTX * (*EVP_MD_CTX_new)(struct AmiSSLIFace *Self);
	APICALL EVP_PKEY_CTX * (*OBSOLETE_EVP_MD_CTX_pkey_ctx)(struct AmiSSLIFace *Self, const EVP_MD_CTX * ctx);
	APICALL int (*EVP_MD_CTX_reset)(struct AmiSSLIFace *Self, EVP_MD_CTX * ctx);
	APICALL void (*EVP_MD_CTX_set_update_fn)(struct AmiSSLIFace *Self, EVP_MD_CTX * ctx, int (*update)(EVP_MD_CTX *, const void *, size_t));
	APICALL int (*(*EVP_MD_CTX_update_fn)(struct AmiSSLIFace *Self, EVP_MD_CTX * ctx))(EVP_MD_CTX *, const void *, size_t);
	APICALL EVP_MD * (*EVP_MD_meth_dup)(struct AmiSSLIFace *Self, const EVP_MD * md);
	APICALL void (*EVP_MD_meth_free)(struct AmiSSLIFace *Self, EVP_MD * md);
	APICALL int (*EVP_MD_meth_get_app_datasize)(struct AmiSSLIFace *Self, const EVP_MD * md);
	APICALL int (*(*EVP_MD_meth_get_cleanup)(struct AmiSSLIFace *Self, const EVP_MD * md))(EVP_MD_CTX *);
	APICALL int (*(*EVP_MD_meth_get_copy)(struct AmiSSLIFace *Self, const EVP_MD * md))(EVP_MD_CTX *, const EVP_MD_CTX *);
	APICALL int (*(*EVP_MD_meth_get_ctrl)(struct AmiSSLIFace *Self, const EVP_MD * md))(EVP_MD_CTX *, int, int, void *);
	APICALL int (*(*EVP_MD_meth_get_final)(struct AmiSSLIFace *Self, const EVP_MD * md))(EVP_MD_CTX *, unsigned char *);
	APICALL unsigned long (*EVP_MD_meth_get_flags)(struct AmiSSLIFace *Self, const EVP_MD * md);
	APICALL int (*(*EVP_MD_meth_get_init)(struct AmiSSLIFace *Self, const EVP_MD * md))(EVP_MD_CTX *);
	APICALL int (*EVP_MD_meth_get_input_blocksize)(struct AmiSSLIFace *Self, const EVP_MD * md);
	APICALL int (*EVP_MD_meth_get_result_size)(struct AmiSSLIFace *Self, const EVP_MD * md);
	APICALL int (*(*EVP_MD_meth_get_update)(struct AmiSSLIFace *Self, const EVP_MD * md))(EVP_MD_CTX *, const void *, size_t);
	APICALL EVP_MD * (*EVP_MD_meth_new)(struct AmiSSLIFace *Self, int md_type, int pkey_type);
	APICALL int (*EVP_MD_meth_set_app_datasize)(struct AmiSSLIFace *Self, EVP_MD * md, int datasize);
	APICALL int (*EVP_MD_meth_set_cleanup)(struct AmiSSLIFace *Self, EVP_MD * md, int (*cleanup)(EVP_MD_CTX *));
	APICALL int (*EVP_MD_meth_set_copy)(struct AmiSSLIFace *Self, EVP_MD * md, int (*copy)(EVP_MD_CTX *, const EVP_MD_CTX *));
	APICALL int (*EVP_MD_meth_set_ctrl)(struct AmiSSLIFace *Self, EVP_MD * md, int (*ctrl)(EVP_MD_CTX *, int, int, void *));
	APICALL int (*EVP_MD_meth_set_final)(struct AmiSSLIFace *Self, EVP_MD * md, int (*final)(EVP_MD_CTX *, unsigned char *));
	APICALL int (*EVP_MD_meth_set_flags)(struct AmiSSLIFace *Self, EVP_MD * md, unsigned long flags);
	APICALL int (*EVP_MD_meth_set_init)(struct AmiSSLIFace *Self, EVP_MD * md, int (*init)(EVP_MD_CTX *));
	APICALL int (*EVP_MD_meth_set_input_blocksize)(struct AmiSSLIFace *Self, EVP_MD * md, int blocksize);
	APICALL int (*EVP_MD_meth_set_result_size)(struct AmiSSLIFace *Self, EVP_MD * md, int resultsize);
	APICALL int (*EVP_MD_meth_set_update)(struct AmiSSLIFace *Self, EVP_MD * md, int (*update)(EVP_MD_CTX *, const void *, size_t));
	APICALL int (*EVP_PBE_get)(struct AmiSSLIFace *Self, int * ptype, int * ppbe_nid, size_t num);
	APICALL int (*EVP_PBE_scrypt)(struct AmiSSLIFace *Self, const char * pass, size_t passlen, const unsigned char * salt, size_t saltlen, unsigned long N, unsigned long r, unsigned long p, uint64_t maxmem, unsigned char * key, size_t keylen);
	...
	APICALL const DH * (*EVP_PKEY_get0_DH)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey);
	APICALL const DSA * (*EVP_PKEY_get0_DSA)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey);
	APICALL const EC_KEY * (*EVP_PKEY_get0_EC_KEY)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey);
	APICALL const RSA * (*EVP_PKEY_get0_RSA)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey);
	APICALL void (*EVP_PKEY_meth_get_cleanup)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, void (**pcleanup)(EVP_PKEY_CTX *));
	APICALL void (*EVP_PKEY_meth_get_copy)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pcopy)(EVP_PKEY_CTX *, const EVP_PKEY_CTX *));
	APICALL void (*EVP_PKEY_meth_get_ctrl)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pctrl)(EVP_PKEY_CTX *, int, int, void *), int (**pctrl_str)(EVP_PKEY_CTX *, const char *, const char *));
	APICALL void (*EVP_PKEY_meth_get_decrypt)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pdecrypt_init)(EVP_PKEY_CTX *), int (**pdecrypt)(EVP_PKEY_CTX *, unsigned char *, size_t *, const unsigned char *, size_t));
	APICALL void (*EVP_PKEY_meth_get_derive)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pderive_init)(EVP_PKEY_CTX *), int (**pderive)(EVP_PKEY_CTX *, unsigned char *, size_t *));
	APICALL void (*EVP_PKEY_meth_get_encrypt)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pencrypt_init)(EVP_PKEY_CTX *), int (**pencryptfn)(EVP_PKEY_CTX *, unsigned char *, size_t *, const unsigned char *, size_t));
	APICALL void (*EVP_PKEY_meth_get_init)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pinit)(EVP_PKEY_CTX *));
	APICALL void (*EVP_PKEY_meth_get_keygen)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pkeygen_init)(EVP_PKEY_CTX *), int (**pkeygen)(EVP_PKEY_CTX *, EVP_PKEY *));
	APICALL void (*EVP_PKEY_meth_get_paramgen)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pparamgen_init)(EVP_PKEY_CTX *), int (**pparamgen)(EVP_PKEY_CTX *, EVP_PKEY *));
	APICALL void (*EVP_PKEY_meth_get_sign)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**psign_init)(EVP_PKEY_CTX *), int (**psign)(EVP_PKEY_CTX *, unsigned char *, size_t *, const unsigned char *, size_t));
	APICALL void (*EVP_PKEY_meth_get_signctx)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**psignctx_init)(EVP_PKEY_CTX *, EVP_MD_CTX *), int (**psignctx)(EVP_PKEY_CTX *, unsigned char *, size_t *, EVP_MD_CTX *));
	APICALL void (*EVP_PKEY_meth_get_verify)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pverify_init)(EVP_PKEY_CTX *), int (**pverify)(EVP_PKEY_CTX *, const unsigned char *, size_t, const unsigned char *, size_t));
	APICALL void (*EVP_PKEY_meth_get_verify_recover)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pverify_recover_init)(EVP_PKEY_CTX *), int (**pverify_recover)(EVP_PKEY_CTX *, unsigned char *, size_t *, const unsigned char *, size_t));
	APICALL void (*EVP_PKEY_meth_get_verifyctx)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pverifyctx_init)(EVP_PKEY_CTX *, EVP_MD_CTX *), int (**pverifyctx)(EVP_PKEY_CTX *, const unsigned char *, int, EVP_MD_CTX *));
	APICALL int (*OBSOLETE_EVP_PKEY_security_bits)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey);
	...
	APICALL void (*HMAC_CTX_free)(struct AmiSSLIFace *Self, HMAC_CTX * ctx);
	APICALL HMAC_CTX * (*HMAC_CTX_new)(struct AmiSSLIFace *Self);
	APICALL int (*HMAC_CTX_reset)(struct AmiSSLIFace *Self, HMAC_CTX * ctx);
	APICALL size_t (*HMAC_size)(struct AmiSSLIFace *Self, const HMAC_CTX * ctx);
	...
	APICALL RAND_METHOD * (*RAND_OpenSSL)(struct AmiSSLIFace *Self);
	APICALL int (*RSA_bits)(struct AmiSSLIFace *Self, const RSA * r);
	APICALL int (*RSA_check_key_ex)(struct AmiSSLIFace *Self, const RSA * key, BN_GENCB * cb);
	APICALL const RSA_METHOD * (*RSA_PKCS1_OpenSSL)(struct AmiSSLIFace *Self);
	APICALL int (*RSA_security_bits)(struct AmiSSLIFace *Self, const RSA * rsa);
	APICALL int (*OBSOLETE_RSA_X931_derive_ex)(struct AmiSSLIFace *Self, RSA * rsa, BIGNUM * p1, BIGNUM * p2, BIGNUM * q1, BIGNUM * q2, const BIGNUM * Xp1, const BIGNUM * Xp2, const BIGNUM * Xp, const BIGNUM * Xq1, const BIGNUM * Xq2, const BIGNUM * Xq, const BIGNUM * e, BN_GENCB * cb);
	APICALL int (*RSA_X931_generate_key_ex)(struct AmiSSLIFace *Self, RSA * rsa, int bits, const BIGNUM * e, BN_GENCB * cb);
	...
	APICALL BIO * (*TS_VERIFY_CTX_set_data)(struct AmiSSLIFace *Self, TS_VERIFY_CTX * ctx, BIO * b);
	APICALL int (*TS_VERIFY_CTX_set_flags)(struct AmiSSLIFace *Self, TS_VERIFY_CTX * ctx, int f);
	APICALL unsigned char * (*TS_VERIFY_CTX_set_imprint)(struct AmiSSLIFace *Self, TS_VERIFY_CTX * ctx, unsigned char * hexstr, long len);
	APICALL X509_STORE * (*TS_VERIFY_CTX_set_store)(struct AmiSSLIFace *Self, TS_VERIFY_CTX * ctx, X509_STORE * s);
	APICALL STACK_OF(X509) * (*OBSOLETE_TS_VERIFY_CTS_set_certs)(struct AmiSSLIFace *Self, TS_VERIFY_CTX * ctx, STACK_OF(X509) * certs);
	...
	APICALL X509_ALGOR * (*PKCS5_pbe2_set_scrypt)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher, const unsigned char * salt, int saltlen, unsigned char * aiv, unsigned long N, unsigned long r, uint64_t p);
	...
	APICALL ASN1_TIME * (*X509_CRL_get_lastUpdate)(struct AmiSSLIFace *Self, X509_CRL * crl);
	APICALL ASN1_TIME * (*X509_CRL_get_nextUpdate)(struct AmiSSLIFace *Self, X509_CRL * crl);
	...
	APICALL int (*X509_NAME_get0_der)(struct AmiSSLIFace *Self, X509_NAME * nm, const unsigned char ** pder, size_t * pderlen);
	APICALL EVP_PKEY * (*X509_PUBKEY_get0)(struct AmiSSLIFace *Self, X509_PUBKEY * key);
	...
	APICALL int (*X509_STORE_CTX_get_num_untrusted)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	...
	APICALL unsigned long (*SSL_clear_options)(struct AmiSSLIFace *Self, SSL * s, unsigned long op);
	APICALL int (*SSL_config)(struct AmiSSLIFace *Self, SSL * s, const char * name);
	APICALL unsigned long (*SSL_CTX_clear_options)(struct AmiSSLIFace *Self, SSL_CTX * ctx, unsigned long op);
	...
	APICALL unsigned long (*SSL_CTX_get_options)(struct AmiSSLIFace *Self, const SSL_CTX * ctx);
	APICALL int (*(*SSL_CTX_get_security_callback)(struct AmiSSLIFace *Self, SSL_CTX * ctx))(const SSL *, const SSL_CTX *, int, int, int, void *, void *);
	...
	APICALL unsigned long (*SSL_CTX_set_options)(struct AmiSSLIFace *Self, SSL_CTX * ctx, unsigned long op);
	...
	APICALL unsigned long (*SSL_get_options)(struct AmiSSLIFace *Self, const SSL * s);
	...
	APICALL unsigned long (*SSL_set_options)(struct AmiSSLIFace *Self, SSL * s, unsigned long op);
	...
	APICALL int (*ERR_load_CT_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*EC_KEY_can_sign)(struct AmiSSLIFace *Self, const EC_KEY * eckey);
	...
	APICALL int (*ERR_load_KDF_strings)(struct AmiSSLIFace *Self);
	APICALL void (*SRP_user_pwd_free)(struct AmiSSLIFace *Self, SRP_user_pwd * user_pwd);
	APICALL SRP_user_pwd * (*SRP_VBASE_get1_by_user)(struct AmiSSLIFace *Self, SRP_VBASE * vb, char * username);
	...
	APICALL int (*X509_STORE_up_ref)(struct AmiSSLIFace *Self, X509_STORE * v);
	...
	APICALL int (*(*BIO_meth_get_puts)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *, const char *);
	APICALL long (*(*BIO_meth_get_ctrl)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *, int, long, void *);
	APICALL int (*(*BIO_meth_get_gets)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *, char *, int);
	...
	APICALL int (*(*BIO_meth_get_write)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *, const char *, int);
	APICALL int (*BIO_meth_set_callback_ctrl)(struct AmiSSLIFace *Self, BIO_METHOD * biom, long (*callback_ctrl)(BIO *, int, BIO_info_cb *));
	APICALL int (*(*BIO_meth_get_create)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *);
	...
	APICALL int (*BIO_meth_set_gets)(struct AmiSSLIFace *Self, BIO_METHOD * biom, int (*func)(BIO *, char *, int));
	APICALL long (*(*BIO_meth_get_callback_ctrl)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *, int, BIO_info_cb *);
	APICALL int (*(*BIO_meth_get_destroy)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *);
	APICALL int (*(*BIO_meth_get_read)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *, char *, int);
	...
	APICALL int (*DSA_meth_set_bn_mod_exp)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, int (*bn_mod_exp)(DSA *, BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, BN_CTX *, BN_MONT_CTX *));
	APICALL int (*DSA_meth_set_init)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, int (*init)(DSA *));
	APICALL void (*DSA_meth_free)(struct AmiSSLIFace *Self, DSA_METHOD * dsam);
	APICALL int (*DSA_meth_set_mod_exp)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, int (*mod_exp)(DSA *, BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, BN_CTX *, BN_MONT_CTX *));
	APICALL int (*DSA_meth_set_sign)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, DSA_SIG * (*sign)(const unsigned char *, int, DSA *));
	APICALL int (*(*DSA_meth_get_finish)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam))(DSA *);
	APICALL void (*DSA_set_flags)(struct AmiSSLIFace *Self, DSA * d, int flags);
	APICALL void (*DSA_get0_pqg)(struct AmiSSLIFace *Self, const DSA * d, const BIGNUM ** p, const BIGNUM ** q, const BIGNUM ** g);
	APICALL void * (*DSA_meth_get0_app_data)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam);
	APICALL int (*(*DSA_meth_get_keygen)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam))(DSA *);
	APICALL void (*DSA_clear_flags)(struct AmiSSLIFace *Self, DSA * d, int flags);
	APICALL const char * (*DSA_meth_get0_name)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam);
	APICALL int (*(*DSA_meth_get_paramgen)(struct AmiSSLIFace *Self, DSA_METHOD * dsam))(DSA *, int, const unsigned char *, int, int *, unsigned long *, BN_GENCB *);
	APICALL DSA_SIG * (*(*DSA_meth_get_sign)(struct AmiSSLIFace *Self, DSA_METHOD * dsam))(const unsigned char *, int, DSA *);
	APICALL int (*DSA_meth_set_paramgen)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, int (*paramgen)(DSA *, int, const unsigned char *, int, int *, unsigned long *, BN_GENCB *));
	APICALL int (*DSA_test_flags)(struct AmiSSLIFace *Self, const DSA * d, int flags);
	APICALL int (*DSA_meth_set0_app_data)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, void * app_data);
	APICALL int (*DSA_meth_set1_name)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, const char * name);
	APICALL void (*DSA_get0_key)(struct AmiSSLIFace *Self, const DSA * d, const BIGNUM ** pub_key, const BIGNUM ** priv_key);
	APICALL int (*(*DSA_meth_get_mod_exp)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam))(DSA *, BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, BN_CTX *, BN_MONT_CTX *);
	APICALL int (*DSA_set0_pqg)(struct AmiSSLIFace *Self, DSA * d, BIGNUM * p, BIGNUM * q, BIGNUM * g);
	APICALL int (*DSA_meth_get_flags)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam);
	APICALL int (*(*DSA_meth_get_verify)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam))(const unsigned char *, int, DSA_SIG *, DSA *);
	APICALL int (*DSA_meth_set_verify)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, int (*verify)(const unsigned char *, int, DSA_SIG *, DSA *));
	APICALL int (*DSA_meth_set_finish)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, int (*finish)(DSA *));
	APICALL int (*DSA_meth_set_keygen)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, int (*keygen)(DSA *));
	APICALL DSA_METHOD * (*DSA_meth_dup)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam);
	APICALL int (*DSA_set0_key)(struct AmiSSLIFace *Self, DSA * d, BIGNUM * pub_key, BIGNUM * priv_key);
	APICALL int (*(*DSA_meth_get_init)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam))(DSA *);
	APICALL int (*DSA_meth_set_sign_setup)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, int (*sign_setup)(DSA *, BN_CTX *, BIGNUM **, BIGNUM **));
	APICALL int (*(*DSA_meth_get_bn_mod_exp)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam))(DSA *, BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, BN_CTX *, BN_MONT_CTX *);
	APICALL const DSA_METHOD * (*DSA_get_method)(struct AmiSSLIFace *Self, DSA * d);
	APICALL DSA_METHOD * (*DSA_meth_new)(struct AmiSSLIFace *Self, const char * name, int flags);
	APICALL int (*DSA_meth_set_flags)(struct AmiSSLIFace *Self, DSA_METHOD * dsam, int flags);
	APICALL int (*(*DSA_meth_get_sign_setup)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam))(DSA *, BN_CTX *, BIGNUM **, BIGNUM **);
	APICALL ENGINE * (*DSA_get0_engine)(struct AmiSSLIFace *Self, DSA * d);
	...
	APICALL EVP_PKEY * (*X509_REQ_get0_pubkey)(struct AmiSSLIFace *Self, X509_REQ * req);
	APICALL int (*RSA_set0_key)(struct AmiSSLIFace *Self, RSA * r, BIGNUM * n, BIGNUM * e, BIGNUM * d);
	APICALL int (*RSA_meth_get_flags)(struct AmiSSLIFace *Self, const RSA_METHOD * meth);
	APICALL int (*RSA_meth_set_finish)(struct AmiSSLIFace *Self, RSA_METHOD * rsa, int (*finish)(RSA *));
	APICALL int (*(*RSA_meth_get_priv_dec)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(int, const unsigned char *, unsigned char *, RSA *, int);
	APICALL int (*(*RSA_meth_get_sign)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(int, const unsigned char *, unsigned int, unsigned char *, unsigned int *, const RSA *);
	APICALL int (*(*RSA_meth_get_bn_mod_exp)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, BN_CTX *, BN_MONT_CTX *);
	APICALL int (*RSA_test_flags)(struct AmiSSLIFace *Self, const RSA * r, int flags);
	APICALL RSA_METHOD * (*RSA_meth_new)(struct AmiSSLIFace *Self, const char * name, int flags);
	APICALL void * (*RSA_meth_get0_app_data)(struct AmiSSLIFace *Self, const RSA_METHOD * meth);
	APICALL RSA_METHOD * (*RSA_meth_dup)(struct AmiSSLIFace *Self, const RSA_METHOD * meth);
	APICALL int (*RSA_meth_set1_name)(struct AmiSSLIFace *Self, RSA_METHOD * meth, const char * name);
	APICALL int (*RSA_meth_set0_app_data)(struct AmiSSLIFace *Self, RSA_METHOD * meth, void * app_data);
	APICALL void (*RSA_set_flags)(struct AmiSSLIFace *Self, RSA * r, int flags);
	APICALL int (*RSA_meth_set_sign)(struct AmiSSLIFace *Self, RSA_METHOD * rsa, int (*sign)(int, const unsigned char *, unsigned int, unsigned char *, unsigned int *, const RSA *));
	APICALL void (*RSA_clear_flags)(struct AmiSSLIFace *Self, RSA * r, int flags);
	APICALL int (*(*RSA_meth_get_keygen)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(RSA *, int, BIGNUM *, BN_GENCB *);
	APICALL int (*RSA_meth_set_keygen)(struct AmiSSLIFace *Self, RSA_METHOD * rsa, int (*keygen)(RSA *, int, BIGNUM *, BN_GENCB *));
	APICALL int (*RSA_meth_set_pub_dec)(struct AmiSSLIFace *Self, RSA_METHOD * rsa, int (*pub_dec)(int, const unsigned char *, unsigned char *, RSA *, int));
	APICALL int (*(*RSA_meth_get_finish)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(RSA *rsa);
	APICALL void (*RSA_get0_key)(struct AmiSSLIFace *Self, const RSA * r, const BIGNUM ** n, const BIGNUM ** e, const BIGNUM ** d);
	APICALL ENGINE * (*RSA_get0_engine)(struct AmiSSLIFace *Self, const RSA * r);
	APICALL int (*RSA_meth_set_priv_enc)(struct AmiSSLIFace *Self, RSA_METHOD * rsa, int (*priv_enc)(int, const unsigned char *, unsigned char *, RSA *, int));
	APICALL int (*RSA_meth_set_verify)(struct AmiSSLIFace *Self, RSA_METHOD * rsa, int (*verify)(int, const unsigned char *, unsigned int, const unsigned char *, unsigned int, const RSA *));
	APICALL void (*RSA_get0_factors)(struct AmiSSLIFace *Self, const RSA * r, const BIGNUM ** p, const BIGNUM ** q);
	APICALL const char * (*RSA_meth_get0_name)(struct AmiSSLIFace *Self, const RSA_METHOD * meth);
	APICALL int (*(*RSA_meth_get_mod_exp)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(BIGNUM *, const BIGNUM *, RSA *, BN_CTX *);
	APICALL int (*RSA_meth_set_flags)(struct AmiSSLIFace *Self, RSA_METHOD * meth, int flags);
	APICALL int (*(*RSA_meth_get_pub_dec)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(int, const unsigned char *, unsigned char *, RSA *, int);
	APICALL int (*RSA_meth_set_bn_mod_exp)(struct AmiSSLIFace *Self, RSA_METHOD * rsa, int (*bn_mod_exp)(BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, BN_CTX *, BN_MONT_CTX *));
	APICALL int (*(*RSA_meth_get_init)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(RSA *);
	APICALL void (*RSA_meth_free)(struct AmiSSLIFace *Self, RSA_METHOD * meth);
	APICALL int (*(*RSA_meth_get_pub_enc)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(int, const unsigned char *, unsigned char *, RSA *, int);
	APICALL int (*RSA_meth_set_mod_exp)(struct AmiSSLIFace *Self, RSA_METHOD * rsa, int (*mod_exp)(BIGNUM *, const BIGNUM *, RSA *, BN_CTX *));
	APICALL int (*RSA_set0_factors)(struct AmiSSLIFace *Self, RSA * r, BIGNUM * p, BIGNUM * q);
	APICALL int (*RSA_meth_set_pub_enc)(struct AmiSSLIFace *Self, RSA_METHOD * rsa, int (*pub_enc)(int, const unsigned char *, unsigned char *, RSA *, int));
	APICALL int (*RSA_meth_set_priv_dec)(struct AmiSSLIFace *Self, RSA_METHOD * rsa, int (*priv_dec)(int, const unsigned char *, unsigned char *, RSA *, int));
	APICALL int (*(*RSA_meth_get_verify)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(int, const unsigned char *, unsigned int, const unsigned char *, unsigned int, const RSA *);
	APICALL int (*RSA_meth_set_init)(struct AmiSSLIFace *Self, RSA_METHOD * rsa, int (*init)(RSA *));
	APICALL int (*(*RSA_meth_get_priv_enc)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(int, const unsigned char *, unsigned char *, RSA *, int);
	APICALL int (*RSA_set0_crt_params)(struct AmiSSLIFace *Self, RSA * r, BIGNUM * dmp1, BIGNUM * dmq1, BIGNUM * iqmp);
	APICALL void (*RSA_get0_crt_params)(struct AmiSSLIFace *Self, const RSA * r, const BIGNUM ** dmp1, const BIGNUM ** dmq1, const BIGNUM ** iqmp);
	APICALL int (*DH_set0_pqg)(struct AmiSSLIFace *Self, DH * dh, BIGNUM * p, BIGNUM * q, BIGNUM * g);
	APICALL void (*DH_clear_flags)(struct AmiSSLIFace *Self, DH * dh, int flags);
	APICALL void (*DH_get0_key)(struct AmiSSLIFace *Self, const DH * dh, const BIGNUM ** pub_key, const BIGNUM ** priv_key);
	APICALL ENGINE * (*DH_get0_engine)(struct AmiSSLIFace *Self, DH * d);
	APICALL int (*DH_set0_key)(struct AmiSSLIFace *Self, DH * dh, BIGNUM * pub_key, BIGNUM * priv_key);
	APICALL int (*DH_set_length)(struct AmiSSLIFace *Self, DH * dh, long length);
	APICALL int (*DH_test_flags)(struct AmiSSLIFace *Self, const DH * dh, int flags);
	APICALL long (*DH_get_length)(struct AmiSSLIFace *Self, const DH * dh);
	APICALL void (*DH_get0_pqg)(struct AmiSSLIFace *Self, const DH * dh, const BIGNUM ** p, const BIGNUM ** q, const BIGNUM ** g);
	APICALL int (*(*DH_meth_get_compute_key)(struct AmiSSLIFace *Self, const DH_METHOD * dhm))(unsigned char *, const BIGNUM *, DH *);
	APICALL int (*DH_meth_set1_name)(struct AmiSSLIFace *Self, DH_METHOD * dhm, const char * name);
	APICALL int (*DH_meth_set_init)(struct AmiSSLIFace *Self, DH_METHOD * dhm, int (*init)(DH *));
	APICALL int (*(*DH_meth_get_finish)(struct AmiSSLIFace *Self, const DH_METHOD * dhm))(DH *);
	APICALL const char * (*DH_meth_get0_name)(struct AmiSSLIFace *Self, const DH_METHOD * dhm);
	APICALL int (*DH_meth_set_generate_params)(struct AmiSSLIFace *Self, DH_METHOD * dhm, int (*generate_params)(DH *, int, int, BN_GENCB *));
	APICALL int (*DH_meth_set_compute_key)(struct AmiSSLIFace *Self, DH_METHOD * dhm, int (*compute_key)(unsigned char *, const BIGNUM *, DH *));
	APICALL int (*DH_meth_set_flags)(struct AmiSSLIFace *Self, DH_METHOD * dhm, int flags);
	APICALL int (*(*DH_meth_get_generate_params)(struct AmiSSLIFace *Self, const DH_METHOD * dhm))(DH *, int, int, BN_GENCB *);
	APICALL int (*DH_meth_get_flags)(struct AmiSSLIFace *Self, const DH_METHOD * dhm);
	APICALL int (*DH_meth_set_finish)(struct AmiSSLIFace *Self, DH_METHOD * dhm, int (*finish)(DH *));
	APICALL void * (*DH_meth_get0_app_data)(struct AmiSSLIFace *Self, const DH_METHOD * dhm);
	APICALL int (*DH_meth_set0_app_data)(struct AmiSSLIFace *Self, DH_METHOD * dhm, void * app_data);
	APICALL int (*(*DH_meth_get_init)(struct AmiSSLIFace *Self, const DH_METHOD * dhm))(DH *);
	APICALL int (*(*DH_meth_get_bn_mod_exp)(struct AmiSSLIFace *Self, const DH_METHOD * dhm))(const DH *, BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, BN_CTX *, BN_MONT_CTX *);
	APICALL DH_METHOD * (*DH_meth_new)(struct AmiSSLIFace *Self, const char * name, int flags);
	APICALL DH_METHOD * (*DH_meth_dup)(struct AmiSSLIFace *Self, const DH_METHOD * dhm);
	APICALL int (*DH_meth_set_bn_mod_exp)(struct AmiSSLIFace *Self, DH_METHOD * dhm, int (*bn_mod_exp)(const DH *, BIGNUM *, const BIGNUM *, const BIGNUM *, const BIGNUM *, BN_CTX *, BN_MONT_CTX *));
	APICALL int (*DH_meth_set_generate_key)(struct AmiSSLIFace *Self, DH_METHOD * dhm, int (*generate_key)(DH *));
	APICALL void (*DH_meth_free)(struct AmiSSLIFace *Self, DH_METHOD * dhm);
	APICALL int (*(*DH_meth_get_generate_key)(struct AmiSSLIFace *Self, const DH_METHOD * dhm))(DH *);
	APICALL void (*DH_set_flags)(struct AmiSSLIFace *Self, DH * dh, int flags);
	APICALL X509_OBJECT * (*X509_STORE_CTX_get_obj_by_subject)(struct AmiSSLIFace *Self, X509_STORE_CTX * vs, X509_LOOKUP_TYPE type, X509_NAME * name);
	...
	APICALL STACK_OF(X509) * (*X509_STORE_CTX_get0_untrusted)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509 * (*X509_STORE_CTX_get0_cert)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL void (*X509_STORE_CTX_set_verify)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx, X509_STORE_CTX_verify_fn verify);
	APICALL X509_STORE_CTX_verify_fn (*X509_STORE_CTX_get_verify)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509_STORE_CTX_verify_cb (*X509_STORE_CTX_get_verify_cb)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	...
	APICALL int (*DSA_bits)(struct AmiSSLIFace *Self, const DSA * d);
	APICALL int (*ECDSA_SIG_set0)(struct AmiSSLIFace *Self, ECDSA_SIG * sig, BIGNUM * r, BIGNUM * s);
	APICALL int (*EVP_ENCODE_CTX_copy)(struct AmiSSLIFace *Self, EVP_ENCODE_CTX * dctx, EVP_ENCODE_CTX * sctx);
	APICALL const unsigned char * (*EVP_PKEY_get0_hmac)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey, size_t * len);
	APICALL const EVP_MD * (*HMAC_CTX_get_md)(struct AmiSSLIFace *Self, const HMAC_CTX * ctx);
	...
	APICALL int (*PEM_write_bio_PrivateKey_traditional)(struct AmiSSLIFace *Self, BIO * bp, EVP_PKEY * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	...
	APICALL X509_CRL * (*X509_OBJECT_get0_X509_CRL)(struct AmiSSLIFace *Self, X509_OBJECT * a);
	APICALL int (*X509_STORE_lock)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL int (*X509_STORE_unlock)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL STACK_OF(X509_OBJECT) * (*X509_STORE_get0_objects)(struct AmiSSLIFace *Self, X509_STORE * v);
	APICALL X509_VERIFY_PARAM * (*X509_STORE_get0_param)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL void (*X509_STORE_set_verify)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_verify_fn verify);
	APICALL X509_STORE_CTX_verify_fn (*X509_STORE_get_verify)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL X509_STORE_CTX_verify_cb (*X509_STORE_get_verify_cb)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL void (*X509_STORE_set_get_issuer)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_get_issuer_fn get_issuer);
	APICALL X509_STORE_CTX_get_issuer_fn (*X509_STORE_get_get_issuer)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL void (*X509_STORE_set_check_issued)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_check_issued_fn check_issued);
	APICALL X509_STORE_CTX_check_issued_fn (*X509_STORE_get_check_issued)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL void (*X509_STORE_set_check_revocation)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_check_revocation_fn check_revocation);
	APICALL X509_STORE_CTX_check_revocation_fn (*X509_STORE_get_check_revocation)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL void (*X509_STORE_set_get_crl)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_get_crl_fn get_crl);
	APICALL X509_STORE_CTX_get_crl_fn (*X509_STORE_get_get_crl)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL void (*X509_STORE_set_check_crl)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_check_crl_fn check_crl);
	APICALL X509_STORE_CTX_check_crl_fn (*X509_STORE_get_check_crl)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL void (*X509_STORE_set_cert_crl)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_cert_crl_fn cert_crl);
	APICALL X509_STORE_CTX_cert_crl_fn (*X509_STORE_get_cert_crl)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL void (*X509_STORE_set_check_policy)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_check_policy_fn check_policy);
	APICALL X509_STORE_CTX_check_policy_fn (*X509_STORE_get_check_policy)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL void (*X509_STORE_set_lookup_certs)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_lookup_certs_fn lookup_certs);
	APICALL X509_STORE_CTX_lookup_certs_fn (*X509_STORE_get_lookup_certs)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL void (*X509_STORE_set_lookup_crls)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_lookup_crls_fn lookup_crls);
	APICALL X509_STORE_CTX_lookup_crls_fn (*X509_STORE_get_lookup_crls)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL void (*X509_STORE_set_cleanup)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_cleanup_fn cleanup);
	APICALL X509_STORE_CTX_cleanup_fn (*X509_STORE_get_cleanup)(struct AmiSSLIFace *Self, X509_STORE * ctx);
	APICALL int (*X509_STORE_set_ex_data)(struct AmiSSLIFace *Self, X509_STORE * ctx, int idx, void * data);
	APICALL void * (*X509_STORE_get_ex_data)(struct AmiSSLIFace *Self, X509_STORE * ctx, int idx);
	APICALL X509_STORE_CTX_get_issuer_fn (*X509_STORE_CTX_get_get_issuer)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509_STORE_CTX_check_issued_fn (*X509_STORE_CTX_get_check_issued)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509_STORE_CTX_check_revocation_fn (*X509_STORE_CTX_get_check_revocation)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509_STORE_CTX_get_crl_fn (*X509_STORE_CTX_get_get_crl)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509_STORE_CTX_check_crl_fn (*X509_STORE_CTX_get_check_crl)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509_STORE_CTX_cert_crl_fn (*X509_STORE_CTX_get_cert_crl)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509_STORE_CTX_check_policy_fn (*X509_STORE_CTX_get_check_policy)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509_STORE_CTX_lookup_certs_fn (*X509_STORE_CTX_get_lookup_certs)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509_STORE_CTX_lookup_crls_fn (*X509_STORE_CTX_get_lookup_crls)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509_STORE_CTX_cleanup_fn (*X509_STORE_CTX_get_cleanup)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	...
	APICALL int (*OBSOLETE_EVP_PKEY_set1_tls_encodedpoint)(struct AmiSSLIFace *Self, EVP_PKEY * pkey, const unsigned char * pt, size_t ptlen);
	APICALL size_t (*OBSOLETE_EVP_PKEY_get1_tls_encodedpoint)(struct AmiSSLIFace *Self, EVP_PKEY * pkey, unsigned char ** ppt);
	...
	APICALL int (*DH_check_params)(struct AmiSSLIFace *Self, const DH * dh, int * ret);
	...
	APICALL int (*EVP_PKEY_set1_engine)(struct AmiSSLIFace *Self, EVP_PKEY * pkey, ENGINE * e);
	...
	APICALL void (*SSL_set_record_padding_callback)(struct AmiSSLIFace *Self, SSL * ssl, size_t (*cb)(SSL *ssl, int type, size_t len, void *arg));
	...
	APICALL SSL_SESSION * (*SSL_SESSION_dup)(struct AmiSSLIFace *Self, SSL_SESSION * src);
	...
	APICALL ASN1_TYPE * (*PKCS12_get_attr)(struct AmiSSLIFace *Self, const PKCS12_SAFEBAG * bag, int attr_nid);
	...
	APICALL int (*(*BIO_meth_get_read_ex)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *, char *, size_t, size_t *);
	APICALL int (*BIO_write_ex)(struct AmiSSLIFace *Self, BIO * b, const void * data, size_t dlen, size_t * written);
	APICALL int (*(*BIO_meth_get_write_ex)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *, const char *, size_t, size_t *);
	...
	APICALL const unsigned char * (*EVP_PKEY_get0_poly1305)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey, size_t * len);
	APICALL const unsigned char * (*EVP_PKEY_get0_siphash)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey, size_t * len);
	...
	APICALL ENGINE * (*EC_KEY_get0_engine)(struct AmiSSLIFace *Self, const EC_KEY * eckey);
	...
	APICALL ESS_CERT_ID_V2 * (*ESS_CERT_ID_V2_dup)(struct AmiSSLIFace *Self, ESS_CERT_ID_V2 * a);
	...
	APICALL ESS_SIGNING_CERT_V2 * (*ESS_SIGNING_CERT_V2_dup)(struct AmiSSLIFace *Self, ESS_SIGNING_CERT_V2 * a);
	...
	APICALL int (*OSSL_STORE_register_loader)(struct AmiSSLIFace *Self, OSSL_STORE_LOADER * loader);
	APICALL int (*OSSL_STORE_LOADER_set_error)(struct AmiSSLIFace *Self, OSSL_STORE_LOADER * loader, OSSL_STORE_error_fn error_function);
	...
	APICALL int (*ERR_load_OSSL_STORE_strings)(struct AmiSSLIFace *Self);
	...
	APICALL int (*OSSL_STORE_LOADER_set_eof)(struct AmiSSLIFace *Self, OSSL_STORE_LOADER * loader, OSSL_STORE_eof_fn eof_function);
	APICALL OSSL_STORE_LOADER * (*OSSL_STORE_LOADER_new)(struct AmiSSLIFace *Self, ENGINE * e, const char * scheme);
	APICALL X509 * (*OSSL_STORE_INFO_get0_CERT)(struct AmiSSLIFace *Self, const OSSL_STORE_INFO * info);
	APICALL int (*OSSL_STORE_LOADER_set_close)(struct AmiSSLIFace *Self, OSSL_STORE_LOADER * loader, OSSL_STORE_close_fn close_function);
	...
	APICALL int (*OSSL_STORE_LOADER_set_load)(struct AmiSSLIFace *Self, OSSL_STORE_LOADER * loader, OSSL_STORE_load_fn load_function);
	APICALL const char * (*OSSL_STORE_LOADER_get0_scheme)(struct AmiSSLIFace *Self, const OSSL_STORE_LOADER * loader);
	...
	APICALL OSSL_STORE_LOADER * (*OSSL_STORE_unregister_loader)(struct AmiSSLIFace *Self, const char * scheme);
	...
	APICALL int (*OSSL_STORE_LOADER_set_open)(struct AmiSSLIFace *Self, OSSL_STORE_LOADER * loader, OSSL_STORE_open_fn open_function);
	APICALL int (*OSSL_STORE_LOADER_set_ctrl)(struct AmiSSLIFace *Self, OSSL_STORE_LOADER * loader, OSSL_STORE_ctrl_fn ctrl_function);
	APICALL int (*OSSL_STORE_vctrl)(struct AmiSSLIFace *Self, OSSL_STORE_CTX * ctx, int cmd, long * args);
	APICALL int (*OSSL_STORE_ctrl)(struct AmiSSLIFace *Self, OSSL_STORE_CTX * ctx, int cmd, ...);
	...
	APICALL int (*OSSL_STORE_do_all_loaders)(struct AmiSSLIFace *Self, void (*do_function)(const OSSL_STORE_LOADER *loader, void *do_arg), void * do_arg);
	APICALL const ENGINE * (*OSSL_STORE_LOADER_get0_engine)(struct AmiSSLIFace *Self, const OSSL_STORE_LOADER * loader);
	...
	APICALL const EVP_PKEY_METHOD * (*EVP_PKEY_meth_get0)(struct AmiSSLIFace *Self, size_t idx);
	APICALL size_t (*EVP_PKEY_meth_get_count)(struct AmiSSLIFace *Self);
	...
	APICALL void (*EVP_PKEY_meth_set_check)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*check)(EVP_PKEY *pkey));
	APICALL void (*EVP_PKEY_meth_get_check)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pcheck)(EVP_PKEY *pkey));
	APICALL int (*EVP_PKEY_meth_remove)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth);
	APICALL int (*OPENSSL_sk_reserve)(struct AmiSSLIFace *Self, OPENSSL_STACK * st, int n);
	APICALL DH * (*DH_new_by_nid)(struct AmiSSLIFace *Self, int nid);
	APICALL int (*DH_get_nid)(struct AmiSSLIFace *Self, const DH * dh);
	...
	APICALL int (*RSA_get0_multi_prime_factors)(struct AmiSSLIFace *Self, const RSA * r, const BIGNUM ** primes);
	...
	APICALL void (*EVP_PKEY_meth_set_public_check)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*check)(EVP_PKEY *pkey));
	APICALL void (*EVP_PKEY_meth_set_param_check)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*check)(EVP_PKEY *pkey));
	APICALL void (*EVP_PKEY_meth_get_public_check)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pcheck)(EVP_PKEY *pkey));
	APICALL void (*EVP_PKEY_meth_get_param_check)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pcheck)(EVP_PKEY *pkey));
	...
	APICALL int (*DH_check_ex)(struct AmiSSLIFace *Self, const DH * dh);
	APICALL int (*DH_check_pub_key_ex)(struct AmiSSLIFace *Self, const DH * dh, const BIGNUM * pub_key);
	APICALL int (*DH_check_params_ex)(struct AmiSSLIFace *Self, const DH * dh);
	APICALL int (*RSA_generate_multi_prime_key)(struct AmiSSLIFace *Self, RSA * rsa, int bits, int primes, BIGNUM * e, BN_GENCB * cb);
	APICALL int (*RSA_get_multi_prime_extra_count)(struct AmiSSLIFace *Self, const RSA * r);
	APICALL int (*OCSP_resp_get0_signer)(struct AmiSSLIFace *Self, OCSP_BASICRESP * bs, X509 ** signer, STACK_OF(X509) * extra_certs);
	APICALL int (*RSA_get0_multi_prime_crt_params)(struct AmiSSLIFace *Self, const RSA * r, const BIGNUM ** exps, const BIGNUM ** coeffs);
	APICALL int (*RSA_set0_multi_prime_params)(struct AmiSSLIFace *Self, RSA * r, BIGNUM ** primes, BIGNUM ** exps, BIGNUM ** coeffs, int pnum);
	APICALL int (*RSA_get_version)(struct AmiSSLIFace *Self, RSA * r);
	APICALL int (*(*RSA_meth_get_multi_prime_keygen)(struct AmiSSLIFace *Self, const RSA_METHOD * meth))(RSA *rsa, int bits, int primes, BIGNUM *e, BN_GENCB *cb);
	APICALL int (*RSA_meth_set_multi_prime_keygen)(struct AmiSSLIFace *Self, RSA_METHOD * meth, int (*keygen)(RSA *rsa, int bits, int primes, BIGNUM *e, BN_GENCB *cb));
	...
	APICALL int (*OSSL_STORE_LOADER_set_expect)(struct AmiSSLIFace *Self, OSSL_STORE_LOADER * loader, OSSL_STORE_expect_fn expect_function);
	...
	APICALL int (*OSSL_STORE_find)(struct AmiSSLIFace *Self, OSSL_STORE_CTX * ctx, OSSL_STORE_SEARCH * search);
	...
	APICALL X509_NAME * (*OSSL_STORE_SEARCH_get0_name)(struct AmiSSLIFace *Self, OSSL_STORE_SEARCH * criterion);
	APICALL const ASN1_OCTET_STRING * (*X509_get0_authority_key_id)(struct AmiSSLIFace *Self, X509 * x);
	APICALL int (*OSSL_STORE_LOADER_set_find)(struct AmiSSLIFace *Self, OSSL_STORE_LOADER * loader, OSSL_STORE_find_fn find_function);
	...
	APICALL EVP_PKEY * (*EVP_PKEY_new_CMAC_key)(struct AmiSSLIFace *Self, ENGINE * e, const unsigned char * priv, size_t len, const EVP_CIPHER * cipher);
	...
	APICALL const BIGNUM * (*DH_get0_p)(struct AmiSSLIFace *Self, const DH * dh);
	APICALL const BIGNUM * (*DH_get0_q)(struct AmiSSLIFace *Self, const DH * dh);
	APICALL const BIGNUM * (*DH_get0_g)(struct AmiSSLIFace *Self, const DH * dh);
	APICALL const BIGNUM * (*DH_get0_priv_key)(struct AmiSSLIFace *Self, const DH * dh);
	APICALL const BIGNUM * (*DH_get0_pub_key)(struct AmiSSLIFace *Self, const DH * dh);
	APICALL const BIGNUM * (*DSA_get0_priv_key)(struct AmiSSLIFace *Self, const DSA * d);
	APICALL const BIGNUM * (*DSA_get0_pub_key)(struct AmiSSLIFace *Self, const DSA * d);
	APICALL const BIGNUM * (*DSA_get0_q)(struct AmiSSLIFace *Self, const DSA * d);
	APICALL const BIGNUM * (*DSA_get0_p)(struct AmiSSLIFace *Self, const DSA * d);
	APICALL const BIGNUM * (*DSA_get0_g)(struct AmiSSLIFace *Self, const DSA * d);
	APICALL const BIGNUM * (*RSA_get0_dmp1)(struct AmiSSLIFace *Self, const RSA * r);
	APICALL const BIGNUM * (*RSA_get0_d)(struct AmiSSLIFace *Self, const RSA * d);
	APICALL const BIGNUM * (*RSA_get0_n)(struct AmiSSLIFace *Self, const RSA * d);
	APICALL const BIGNUM * (*RSA_get0_dmq1)(struct AmiSSLIFace *Self, const RSA * r);
	APICALL const BIGNUM * (*RSA_get0_e)(struct AmiSSLIFace *Self, const RSA * d);
	APICALL const BIGNUM * (*RSA_get0_q)(struct AmiSSLIFace *Self, const RSA * d);
	APICALL const BIGNUM * (*RSA_get0_p)(struct AmiSSLIFace *Self, const RSA * d);
	APICALL const BIGNUM * (*RSA_get0_iqmp)(struct AmiSSLIFace *Self, const RSA * r);
	...
	APICALL void (*EVP_PKEY_meth_set_digest_custom)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*digest_custom)(EVP_PKEY_CTX *ctx, EVP_MD_CTX *mctx));
	APICALL void (*EVP_PKEY_meth_get_digest_custom)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (**pdigest_custom)(EVP_PKEY_CTX *ctx, EVP_MD_CTX *mctx));
	...
	APICALL ENGINE * (*EVP_PKEY_get0_engine)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey);
	...
	APICALL void (*EVP_PKEY_meth_set_digestsign)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*digestsign)(EVP_MD_CTX *ctx, unsigned char *sig, size_t *siglen, const unsigned char *tbs, size_t tbslen));
	APICALL void (*EVP_PKEY_meth_set_digestverify)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (*digestverify)(EVP_MD_CTX *ctx, const unsigned char *sig, size_t siglen, const unsigned char *tbs, size_t tbslen));
	APICALL void (*EVP_PKEY_meth_get_digestverify)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (**digestverify)(EVP_MD_CTX *ctx, const unsigned char *sig, size_t siglen, const unsigned char *tbs, size_t tbslen));
	APICALL void (*EVP_PKEY_meth_get_digestsign)(struct AmiSSLIFace *Self, EVP_PKEY_METHOD * pmeth, int (**digestsign)(EVP_MD_CTX *ctx, unsigned char *sig, size_t *siglen, const unsigned char *tbs, size_t tbslen));
	APICALL const RSA_PSS_PARAMS * (*RSA_get0_pss_params)(struct AmiSSLIFace *Self, const RSA * r);
	...
	APICALL int (*EC_KEY_decoded_from_explicit_params)(struct AmiSSLIFace *Self, const EC_KEY * key);
	APICALL int (*RSA_X931_derive_ex_amiga_1)(struct AmiSSLIFace *Self, RSA * rsa, BIGNUM * p1, BIGNUM * p2, BIGNUM * q1, BIGNUM * q2, const BIGNUM * Xp1, void * moreargs);
	...
	APICALL int (*SSL_add_store_cert_subjects_to_stack)(struct AmiSSLIFace *Self, struct stack_st_X509_NAME * stackCAs, const char * uri);
	...
	APICALL struct stack_st_X509_NAME * (*SSL_load_client_CA_file_ex)(struct AmiSSLIFace *Self, const char * file, OSSL_LIB_CTX * libctx, const char * propq);
	...
	APICALL struct stack_st_X509 * (*TS_VERIFY_CTX_set_certs)(struct AmiSSLIFace *Self, TS_VERIFY_CTX * ctx, struct stack_st_X509 * certs);
	...
	APICALL int (*EVP_CIPHER_get_type)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher);
	...
	APICALL int (*OSSL_CMP_ITAV_push0_stack_item)(struct AmiSSLIFace *Self, struct stack_st_OSSL_CMP_ITAV ** itav_sk_p, OSSL_CMP_ITAV * itav);
	...
	APICALL int (*OSSL_CMP_CTX_set1_untrusted)(struct AmiSSLIFace *Self, OSSL_CMP_CTX * ctx, struct stack_st_X509 * certs);
	APICALL struct stack_st_X509 * (*OSSL_CMP_CTX_get0_untrusted)(struct AmiSSLIFace *Self, const OSSL_CMP_CTX * ctx);
	...
	APICALL int (*OSSL_CMP_CTX_build_cert_chain)(struct AmiSSLIFace *Self, OSSL_CMP_CTX * ctx, X509_STORE * own_trusted, struct stack_st_X509 * candidates);
	...
	APICALL int (*OSSL_CMP_CTX_set1_extraCertsOut)(struct AmiSSLIFace *Self, OSSL_CMP_CTX * ctx, struct stack_st_X509 * extraCertsOut);
	...
	APICALL struct stack_st_X509 * (*OSSL_CMP_CTX_get1_newChain)(struct AmiSSLIFace *Self, const OSSL_CMP_CTX * ctx);
	APICALL struct stack_st_X509 * (*OSSL_CMP_CTX_get1_caPubs)(struct AmiSSLIFace *Self, const OSSL_CMP_CTX * ctx);
	APICALL struct stack_st_X509 * (*OSSL_CMP_CTX_get1_extraCertsIn)(struct AmiSSLIFace *Self, const OSSL_CMP_CTX * ctx);
	...
	APICALL int (*X509_add_cert)(struct AmiSSLIFace *Self, struct stack_st_X509 * sk, X509 * cert, int flags);
	APICALL int (*X509_add_certs)(struct AmiSSLIFace *Self, struct stack_st_X509 * sk, struct stack_st_X509 * certs, int flags);
	APICALL int (*X509_STORE_load_file)(struct AmiSSLIFace *Self, X509_STORE * ctx, const char * file);
	APICALL int (*X509_STORE_load_path)(struct AmiSSLIFace *Self, X509_STORE * ctx, const char * path);
	APICALL int (*X509_STORE_load_store)(struct AmiSSLIFace *Self, X509_STORE * ctx, const char * store);
	...
	APICALL int (*OSSL_HTTP_set1_request)(struct AmiSSLIFace *Self, OSSL_HTTP_REQ_CTX * rctx, const char * path, const struct stack_st_CONF_VALUE * headers, const char * content_type, BIO * req, const char * expected_content_type, int expect_asn1, size_t max_resp_len, int timeout, int keep_alive);
	...
	APICALL void * (*OSSL_HTTP_get_amiga_2)(struct AmiSSLIFace *Self, void * arg, int buf_size, const struct stack_st_CONF_VALUE * headers, const char * expected_content_type, int expect_asn1, size_t max_resp_len, int timeout);
	...
	APICALL void * (*OSSL_HTTP_transfer_amiga_2)(struct AmiSSLIFace *Self, void * arg, int buf_size, const struct stack_st_CONF_VALUE * headers, const char * content_type, BIO * req, const char * expected_content_type, int expect_asn1, size_t max_resp_len, int timeout, int keep_alive);
	...
	APICALL struct stack_st_X509 * (*X509_STORE_get1_all_certs)(struct AmiSSLIFace *Self, X509_STORE * st);
	...
	APICALL struct stack_st_OSSL_CMP_ITAV * (*OSSL_CMP_exec_GENM_ses)(struct AmiSSLIFace *Self, OSSL_CMP_CTX * ctx);
	...
	APICALL char * (*SRP_create_verifier_ex)(struct AmiSSLIFace *Self, const char * user, const char * pass, char ** salt, char ** verifier, const char * N, const char * g, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL int (*SRP_create_verifier_BN_ex)(struct AmiSSLIFace *Self, const char * user, const char * pass, BIGNUM ** salt, BIGNUM ** verifier, const BIGNUM * N, const BIGNUM * g, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL BIGNUM * (*SRP_Calc_B_ex)(struct AmiSSLIFace *Self, const BIGNUM * b, const BIGNUM * N, const BIGNUM * g, const BIGNUM * v, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL BIGNUM * (*SRP_Calc_u_ex)(struct AmiSSLIFace *Self, const BIGNUM * A, const BIGNUM * B, const BIGNUM * N, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL BIGNUM * (*SRP_Calc_x_ex)(struct AmiSSLIFace *Self, const BIGNUM * s, const char * user, const char * pass, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL BIGNUM * (*SRP_Calc_client_key_ex)(struct AmiSSLIFace *Self, const BIGNUM * N, const BIGNUM * B, const BIGNUM * g, const BIGNUM * x, const BIGNUM * a, const BIGNUM * u, OSSL_LIB_CTX * libctx, const char * propq);
	...
	APICALL struct stack_st_X509_INFO * (*PEM_X509_INFO_read_bio_ex)(struct AmiSSLIFace *Self, BIO * bp, struct stack_st_X509_INFO * sk, pem_password_cb * cb, void * u, OSSL_LIB_CTX * libctx, const char * propq);
	...
	APICALL int (*X509_STORE_load_file_ex)(struct AmiSSLIFace *Self, X509_STORE * ctx, const char * file, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL int (*X509_STORE_load_store_ex)(struct AmiSSLIFace *Self, X509_STORE * ctx, const char * store, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL int (*X509_STORE_load_locations_ex)(struct AmiSSLIFace *Self, X509_STORE * ctx, const char * file, const char * dir, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL int (*X509_STORE_set_default_paths_ex)(struct AmiSSLIFace *Self, X509_STORE * ctx, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL struct stack_st_X509 * (*X509_build_chain)(struct AmiSSLIFace *Self, X509 * target, struct stack_st_X509 * certs, X509_STORE * store, int with_self_signed, OSSL_LIB_CTX * libctx, const char * propq);
	...
	APICALL PKCS12_SAFEBAG * (*PKCS12_add_secret)(struct AmiSSLIFace *Self, struct stack_st_PKCS12_SAFEBAG ** pbags, int nid_type, const unsigned char * value, int len);
	APICALL int (*SMIME_write_ASN1_ex)(struct AmiSSLIFace *Self, BIO * bio, ASN1_VALUE * val, BIO * data, int flags, int ctype_nid, int econt_nid, struct stack_st_X509_ALGOR * mdalgs, const ASN1_ITEM * it, OSSL_LIB_CTX * libctx, const char * propq);
	...
	APICALL CMS_ContentInfo * (*CMS_sign_ex)(struct AmiSSLIFace *Self, X509 * signcert, EVP_PKEY * pkey, struct stack_st_X509 * certs, BIO * data, unsigned int flags, OSSL_LIB_CTX * ctx, const char * propq);
	APICALL CMS_ContentInfo * (*CMS_data_create_ex)(struct AmiSSLIFace *Self, BIO * in, unsigned int flags, OSSL_LIB_CTX * ctx, const char * propq);
	APICALL CMS_ContentInfo * (*CMS_digest_create_ex)(struct AmiSSLIFace *Self, BIO * in, const EVP_MD * md, unsigned int flags, OSSL_LIB_CTX * ctx, const char * propq);
	APICALL CMS_ContentInfo * (*CMS_EncryptedData_encrypt_ex)(struct AmiSSLIFace *Self, BIO * in, const EVP_CIPHER * cipher, const unsigned char * key, size_t keylen, unsigned int flags, OSSL_LIB_CTX * ctx, const char * propq);
	APICALL CMS_ContentInfo * (*CMS_encrypt_ex)(struct AmiSSLIFace *Self, struct stack_st_X509 * certs, BIO * in, const EVP_CIPHER * cipher, unsigned int flags, OSSL_LIB_CTX * ctx, const char * propq);
	APICALL CMS_ContentInfo * (*CMS_EnvelopedData_create_ex)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher, OSSL_LIB_CTX * ctx, const char * propq);
	APICALL CMS_ReceiptRequest * (*CMS_ReceiptRequest_create0_ex)(struct AmiSSLIFace *Self, unsigned char * id, int idlen, int allorfirst, struct stack_st_GENERAL_NAMES * receiptList, struct stack_st_GENERAL_NAMES * receiptsTo, OSSL_LIB_CTX * ctx);
	...
	APICALL PKCS7 * (*PKCS7_sign_ex)(struct AmiSSLIFace *Self, X509 * signcert, EVP_PKEY * pkey, struct stack_st_X509 * certs, BIO * data, int flags, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL PKCS7 * (*PKCS7_encrypt_ex)(struct AmiSSLIFace *Self, struct stack_st_X509 * certs, BIO * in, const EVP_CIPHER * cipher, int flags, OSSL_LIB_CTX * libctx, const char * propq);
	...
	APICALL CMS_ContentInfo * (*CMS_AuthEnvelopedData_create_ex)(struct AmiSSLIFace *Self, const EVP_CIPHER * cipher, OSSL_LIB_CTX * ctx, const char * propq);
	...
	APICALL int (*OSSL_ESS_check_signing_certs)(struct AmiSSLIFace *Self, const ESS_SIGNING_CERT * ss, const ESS_SIGNING_CERT_V2 * ssv2, const struct stack_st_X509 * chain, int require_signing_cert);
	APICALL ESS_SIGNING_CERT * (*OSSL_ESS_signing_cert_new_init)(struct AmiSSLIFace *Self, const X509 * signcert, const struct stack_st_X509 * certs, int set_issuer_serial);
	APICALL ESS_SIGNING_CERT_V2 * (*OSSL_ESS_signing_cert_v2_new_init)(struct AmiSSLIFace *Self, const EVP_MD * hash_alg, const X509 * signcert, const struct stack_st_X509 * certs, int set_issuer_serial);
	...
	APICALL int (*EVP_PBE_scrypt_ex_amiga_1)(struct AmiSSLIFace *Self, const char * pass, size_t passlen, const unsigned char * salt, uint64_t N, uint64_t r, uint64_t p, uint64_t maxmem, void * moreargs);
	...
	APICALL PKCS7 * (*PKCS12_pack_p7encdata_ex)(struct AmiSSLIFace *Self, int pbe_nid, const char * pass, int passlen, unsigned char * salt, int saltlen, int iter, struct stack_st_PKCS12_SAFEBAG * bags, OSSL_LIB_CTX * ctx, const char * propq);
	...
	APICALL PKCS12 * (*PKCS12_create_ex)(struct AmiSSLIFace *Self, const char * pass, const char * name, EVP_PKEY * pkey, X509 * cert, struct stack_st_X509 * ca, int nid_key, int nid_cert, int iter, int mac_iter, int keytype, OSSL_LIB_CTX * ctx, const char * propq);
	APICALL PKCS12_SAFEBAG * (*PKCS12_add_key_ex)(struct AmiSSLIFace *Self, struct stack_st_PKCS12_SAFEBAG ** pbags, EVP_PKEY * key, int key_usage, int iter, int key_nid, const char * pass, OSSL_LIB_CTX * ctx, const char * propq);
	APICALL int (*PKCS12_add_safe_ex)(struct AmiSSLIFace *Self, struct stack_st_PKCS7 ** psafes, struct stack_st_PKCS12_SAFEBAG * bags, int safe_nid, int iter, const char * pass, OSSL_LIB_CTX * ctx, const char * propq);
	APICALL PKCS12 * (*PKCS12_add_safes_ex)(struct AmiSSLIFace *Self, struct stack_st_PKCS7 * safes, int p7_nid, OSSL_LIB_CTX * ctx, const char * propq);
	...
	APICALL struct stack_st_OPENSSL_CSTRING * (*NCONF_get_section_names)(struct AmiSSLIFace *Self, const CONF * conf);
