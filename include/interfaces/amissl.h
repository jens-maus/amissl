...
struct AmiSSLIFace
{
	...
	int APICALL (*CT_verify_no_bad_scts)(struct AmiSSLIFace *Self, const CT_POLICY_EVAL_CTX * ctx, const STACK_OF(SCT) * scts, void * arg);
	int APICALL (*CT_verify_at_least_one_good_sct)(struct AmiSSLIFace *Self, const CT_POLICY_EVAL_CTX * ctx, const STACK_OF(SCT) * scts, void * arg);
	...
	int APICALL (*SSL_set_ct_validation_callback)(struct AmiSSLIFace *Self, SSL * s, ct_validation_cb callback, void * arg);
	int APICALL (*SSL_CTX_set_ct_validation_callback)(struct AmiSSLIFace *Self, SSL_CTX * ctx, ct_validation_cb callback, void * arg);
	ct_validation_cb APICALL (*SSL_get_ct_validation_callback)(struct AmiSSLIFace *Self, const SSL * s);
	ct_validation_cb APICALL (*SSL_CTX_get_ct_validation_callback)(struct AmiSSLIFace *Self, const SSL_CTX * ctx);
