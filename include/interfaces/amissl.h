...
struct AmiSSLIFace
{
	...
	APICALL int (*BN_pseudo_rand_range)(struct AmiSSLIFace *Self, BIGNUM * rnd, const BIGNUM * range);
	...
	APICALL int (*EVP_PKEY_cmp_parameters)(struct AmiSSLIFace *Self, const EVP_PKEY * a, const EVP_PKEY * b);
	...
	APICALL int (*PEM_write_bio_RSAPrivateKey)(struct AmiSSLIFace *Self, BIO * bp, const RSA * x, const EVP_CIPHER * enc, const unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	...
	APICALL int (*PEM_write_bio_DSAPrivateKey)(struct AmiSSLIFace *Self, BIO * bp, const DSA * x, const EVP_CIPHER * enc, const unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	APICALL DSA * (*PEM_read_bio_DSA_PUBKEY)(struct AmiSSLIFace *Self, BIO * bp, DSA ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_DSA_PUBKEY)(struct AmiSSLIFace *Self, BIO * bp, const DSA * x);
	APICALL DSA * (*PEM_read_bio_DSAparams)(struct AmiSSLIFace *Self, BIO * bp, DSA ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_DSAparams)(struct AmiSSLIFace *Self, BIO * bp, const DSA * x);
	APICALL DH * (*PEM_read_bio_DHparams)(struct AmiSSLIFace *Self, BIO * bp, DH ** x, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_DHparams)(struct AmiSSLIFace *Self, BIO * bp, const DH * x);
	...
	APICALL int (*SSL_CTX_use_RSAPrivateKey_ASN1)(struct AmiSSLIFace *Self, SSL_CTX * ctx, const unsigned char * d, long len);
	...
	APICALL int (*i2d_RSAPrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, const RSA * rsa);
	...
	APICALL int (*i2d_DSA_PUBKEY_bio)(struct AmiSSLIFace *Self, BIO * bp, const DSA * dsa);
	APICALL DSA * (*d2i_DSAPrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, DSA ** dsa);
	APICALL int (*i2d_DSAPrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, const DSA * dsa);
	...
	APICALL void (*AES_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, unsigned char * ivec, const int enc);
	APICALL void (*AES_cfb128_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, unsigned char * ivec, int * num, const int enc);
	APICALL void (*AES_cfb1_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, unsigned char * ivec, int * num, const int enc);
	APICALL void (*AES_cfb8_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, unsigned char * ivec, int * num, const int enc);
	APTR AES_cfbr_encrypt_block_UNIMPLEMENTED;
	APICALL void (*AES_ofb128_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, unsigned char * ivec, int * num);
	...
	APICALL void (*CAST_ecb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const CAST_KEY * key, int enc);
	APICALL void (*CAST_encrypt)(struct AmiSSLIFace *Self, CAST_LONG * data, const CAST_KEY * key);
	APICALL void (*CAST_decrypt)(struct AmiSSLIFace *Self, CAST_LONG * data, const CAST_KEY * key);
	APICALL void (*CAST_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, const CAST_KEY * ks, unsigned char * iv, int enc);
	APICALL void (*CAST_cfb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, const CAST_KEY * schedule, unsigned char * ivec, int * num, int enc);
	APICALL void (*CAST_ofb64_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, long length, const CAST_KEY * schedule, unsigned char * ivec, int * num);
	...
	APICALL void * (*DH_get_ex_data)(struct AmiSSLIFace *Self, const DH * d, int idx);
	...
	APICALL void * (*DSA_get_ex_data)(struct AmiSSLIFace *Self, const DSA * d, int idx);
	...
	APICALL int (*MD2_Update)(struct AmiSSLIFace *Self, MD2_CTX * c, const unsigned char * data, size_t len);
	APICALL int (*MD2_Final)(struct AmiSSLIFace *Self, unsigned char * md, MD2_CTX * c);
	APICALL unsigned char * (*MD2)(struct AmiSSLIFace *Self, const unsigned char * d, size_t n, unsigned char * md);
	APICALL int (*MD4_Init)(struct AmiSSLIFace *Self, MD4_CTX * c);
	APICALL int (*MD4_Update)(struct AmiSSLIFace *Self, MD4_CTX * c, const void * data, size_t len);
	APICALL int (*MD4_Final)(struct AmiSSLIFace *Self, unsigned char * md, MD4_CTX * c);
	APICALL unsigned char * (*MD4)(struct AmiSSLIFace *Self, const unsigned char * d, size_t n, unsigned char * md);
	...
	APICALL int (*MD5_Update)(struct AmiSSLIFace *Self, MD5_CTX * c, const void * data, size_t len);
	APICALL int (*MD5_Final)(struct AmiSSLIFace *Self, unsigned char * md, MD5_CTX * c);
	APICALL unsigned char * (*MD5)(struct AmiSSLIFace *Self, const unsigned char * d, size_t n, unsigned char * md);
	...
	APICALL int (*MDC2_Update)(struct AmiSSLIFace *Self, MDC2_CTX * c, const unsigned char * data, size_t len);
	APICALL int (*MDC2_Final)(struct AmiSSLIFace *Self, unsigned char * md, MDC2_CTX * c);
	APICALL unsigned char * (*MDC2)(struct AmiSSLIFace *Self, const unsigned char * d, size_t n, unsigned char * md);
	...
	APICALL void (*RC4)(struct AmiSSLIFace *Self, RC4_KEY * key, size_t len, const unsigned char * indata, unsigned char * outdata);
	APICALL int (*RC5_32_set_key)(struct AmiSSLIFace *Self, RC5_32_KEY * key, int len, const unsigned char * data, int rounds);
	...
	APICALL int (*RIPEMD160_Update)(struct AmiSSLIFace *Self, RIPEMD160_CTX * c, const void * data, size_t len);
	APICALL int (*RIPEMD160_Final)(struct AmiSSLIFace *Self, unsigned char * md, RIPEMD160_CTX * c);
	APICALL unsigned char * (*RIPEMD160)(struct AmiSSLIFace *Self, const unsigned char * d, size_t n, unsigned char * md);
	...
	APICALL int (*RSA_verify)(struct AmiSSLIFace *Self, int type, const unsigned char * m, unsigned int m_length, const unsigned char * sigbuf, unsigned int siglen, RSA * rsa);
	...
	APICALL int (*SHA1_Update)(struct AmiSSLIFace *Self, SHA_CTX * c, const void * data, size_t len);
	...
	APICALL int (*DSA_generate_parameters_ex)(struct AmiSSLIFace *Self, DSA * dsa, int bits, const unsigned char * seed, int seed_len, int * counter_ret, unsigned long * h_ret, BN_GENCB * cb);
	...
	APICALL int (*X509_STORE_set1_param)(struct AmiSSLIFace *Self, X509_STORE * ctx, const X509_VERIFY_PARAM * pm);
	...
	APICALL int (*PEM_write_bio_EC_PUBKEY)(struct AmiSSLIFace *Self, BIO * bp, const EC_KEY * x);
	...
	APICALL int (*i2d_EC_PUBKEY_bio)(struct AmiSSLIFace *Self, BIO * bp, const EC_KEY * eckey);
	APICALL int (*PEM_write_bio_ECPrivateKey)(struct AmiSSLIFace *Self, BIO * bp, const EC_KEY * x, const EVP_CIPHER * enc, const unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	APICALL int (*PEM_write_bio_ECPKParameters)(struct AmiSSLIFace *Self, BIO * bp, const EC_GROUP * x);
	APICALL int (*i2d_ECPrivateKey_bio)(struct AmiSSLIFace *Self, BIO * bp, const EC_KEY * eckey);
	...
	APICALL void (*AES_ige_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, unsigned char * ivec, const int enc);
	...
	APICALL STACK_OF(X509) * (*X509_STORE_CTX_get1_certs)(struct AmiSSLIFace *Self, X509_STORE_CTX * st, const X509_NAME * nm);
	...
	APICALL void * (*EVP_PKEY_get0)(struct AmiSSLIFace *Self, const EVP_PKEY * pkey);
	...
	APICALL int (*PEM_write_bio_DHxparams)(struct AmiSSLIFace *Self, BIO * bp, const DH * x);
	...
	APICALL int (*(*DSA_meth_get_paramgen)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam))(DSA *, int, const unsigned char *, int, int *, unsigned long *, BN_GENCB *);
	APICALL DSA_SIG * (*(*DSA_meth_get_sign)(struct AmiSSLIFace *Self, const DSA_METHOD * dsam))(const unsigned char *, int, DSA *);
	...
	APICALL STACK_OF(X509_OBJECT) * (*X509_STORE_get0_objects)(struct AmiSSLIFace *Self, const X509_STORE * v);
	APICALL X509_VERIFY_PARAM * (*X509_STORE_get0_param)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	APICALL void (*X509_STORE_set_verify)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_verify_fn verify);
	APICALL X509_STORE_CTX_verify_fn (*X509_STORE_get_verify)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	APICALL X509_STORE_CTX_verify_cb (*X509_STORE_get_verify_cb)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	APICALL void (*X509_STORE_set_get_issuer)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_get_issuer_fn get_issuer);
	APICALL X509_STORE_CTX_get_issuer_fn (*X509_STORE_get_get_issuer)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	...
	APICALL X509_STORE_CTX_check_issued_fn (*X509_STORE_get_check_issued)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	...
	APICALL X509_STORE_CTX_check_revocation_fn (*X509_STORE_get_check_revocation)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	APICALL void (*X509_STORE_set_get_crl)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_get_crl_fn get_crl);
	APICALL X509_STORE_CTX_get_crl_fn (*X509_STORE_get_get_crl)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	APICALL void (*X509_STORE_set_check_crl)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_check_crl_fn check_crl);
	APICALL X509_STORE_CTX_check_crl_fn (*X509_STORE_get_check_crl)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	APICALL void (*X509_STORE_set_cert_crl)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_cert_crl_fn cert_crl);
	APICALL X509_STORE_CTX_cert_crl_fn (*X509_STORE_get_cert_crl)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	...
	APICALL X509_STORE_CTX_check_policy_fn (*X509_STORE_get_check_policy)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	...
	APICALL X509_STORE_CTX_lookup_certs_fn (*X509_STORE_get_lookup_certs)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	APICALL void (*X509_STORE_set_lookup_crls)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_lookup_crls_fn lookup_crls);
	APICALL X509_STORE_CTX_lookup_crls_fn (*X509_STORE_get_lookup_crls)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	APICALL void (*X509_STORE_set_cleanup)(struct AmiSSLIFace *Self, X509_STORE * ctx, X509_STORE_CTX_cleanup_fn cleanup);
	APICALL X509_STORE_CTX_cleanup_fn (*X509_STORE_get_cleanup)(struct AmiSSLIFace *Self, const X509_STORE * ctx);
	APICALL int (*X509_STORE_set_ex_data)(struct AmiSSLIFace *Self, X509_STORE * ctx, int idx, void * data);
	APICALL void * (*X509_STORE_get_ex_data)(struct AmiSSLIFace *Self, const X509_STORE * ctx, int idx);
	...
	APICALL void (*EVP_PKEY_meth_get_digest_custom)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**pdigest_custom)(EVP_PKEY_CTX *ctx, EVP_MD_CTX *mctx));
	...
	APICALL void (*EVP_PKEY_meth_get_digestverify)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**digestverify)(EVP_MD_CTX *ctx, const unsigned char *sig, size_t siglen, const unsigned char *tbs, size_t tbslen));
	APICALL void (*EVP_PKEY_meth_get_digestsign)(struct AmiSSLIFace *Self, const EVP_PKEY_METHOD * pmeth, int (**digestsign)(EVP_MD_CTX *ctx, unsigned char *sig, size_t *siglen, const unsigned char *tbs, size_t tbslen));
