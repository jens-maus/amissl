...
/*
** This file was machine generated by idltool 53.20.
** Do not edit
*/ 
...
struct AmiSSLIFace
{
	...
	ASN1_OBJECT * APICALL (*c2i_ASN1_OBJECT)(struct AmiSSLIFace *Self, ASN1_OBJECT ** a, const unsigned char ** pp, long length);
	...
	ASN1_BIT_STRING * APICALL (*c2i_ASN1_BIT_STRING)(struct AmiSSLIFace *Self, ASN1_BIT_STRING ** a, const unsigned char ** pp, long length);
	...
	int APICALL (*d2i_ASN1_BOOLEAN)(struct AmiSSLIFace *Self, int * a, const unsigned char ** pp, long length);
	...
	ASN1_INTEGER * APICALL (*c2i_ASN1_INTEGER)(struct AmiSSLIFace *Self, ASN1_INTEGER ** a, const unsigned char ** pp, long length);
	...
	ASN1_STRING * APICALL (*d2i_ASN1_bytes)(struct AmiSSLIFace *Self, ASN1_STRING ** a, const unsigned char ** pp, long length, int Ptag, int Pclass);
	unsigned long APICALL (*ASN1_tag2bit)(struct AmiSSLIFace *Self, int tag);
	ASN1_STRING * APICALL (*d2i_ASN1_type_bytes)(struct AmiSSLIFace *Self, ASN1_STRING ** a, const unsigned char ** pp, long length, int type);
	...
	void * APICALL (*ASN1_unpack_string)(struct AmiSSLIFace *Self, ASN1_STRING * oct, d2i_of_void * d2i);
	...
	int APICALL (*asn1_GetSequence)(struct AmiSSLIFace *Self, ASN1_const_CTX * c, long * length);
	...
	int APICALL (*ASN1_template_d2i)(struct AmiSSLIFace *Self, ASN1_VALUE ** pval, const unsigned char ** in, long len, const ASN1_TEMPLATE * tt);
	...
	void APICALL (*CRYPTO_mem_leaks_cb)(struct AmiSSLIFace *Self, CRYPTO_MEM_LEAK_CB * cb);
	...
	const char * APICALL (*OBJ_bsearch)(struct AmiSSLIFace *Self, const char * key, const char * base, int num, size size, (*cmp)(const void *, const void *));
	...
	ASN1_STRING * APICALL (*ASN1_STRING_encode)(struct AmiSSLIFace *Self, ASN1_STRING * s, int (*i2d)(void), char * data, STACK_OF(ASN1_OT) * sk);
	...
	X509_PKEY * APICALL (*d2i_X509_PKEY)(struct AmiSSLIFace *Self, X509_PKEY ** a, const unsigned char ** pp, long length);
	...
	void APICALL (*DES_xwhite_in2out)(struct AmiSSLIFace *Self, const_DES_cblock * DES_key, const_DES_cblock * in_white, const_DES_cblock * out_white);
	...
	void APICALL (*private_RC4_set_key)(struct AmiSSLIFace *Self, RC4_KEY * key, int len, const unsigned char * data);
	...
	const EVP_MD * APICALL (*EVP_ecdsa)(struct AmiSSLIFace *Self);
	...
	void * APICALL (*ASN1_d2i_fp)(struct AmiSSLIFace *Self, void *(*xnew)(void), d2i_of_void * d2i, FILE * in, void ** x);
	int APICALL (*ASN1_i2d_fp)(struct AmiSSLIFace *Self, i2d_of_void * i2d, FILE * out, void * x);
	BIO * APICALL (*BIO_new_fp)(struct AmiSSLIFace *Self, FILE * stream, int close_flag);
	int APICALL (*BN_print_fp)(struct AmiSSLIFace *Self, FILE * fp, const BIGNUM * a);
	void APICALL (*CRYPTO_mem_leaks_fp)(struct AmiSSLIFace *Self, FILE * fp);
	int APICALL (*DHparams_print_fp)(struct AmiSSLIFace *Self, FILE * fp, const DH * x);
	int APICALL (*DSA_print_fp)(struct AmiSSLIFace *Self, FILE * bp, const DSA * x, int off);
	int APICALL (*DSAparams_print_fp)(struct AmiSSLIFace *Self, FILE * fp, const DSA * x);
	void APICALL (*ERR_print_errors_fp)(struct AmiSSLIFace *Self, FILE * fp);
	DH * APICALL (*PEM_read_DHparams)(struct AmiSSLIFace *Self, FILE * fp, DH ** x, pem_password_cb * cb, void * u);
	DSA * APICALL (*PEM_read_DSAPrivateKey)(struct AmiSSLIFace *Self, FILE * fp, DSA ** x, pem_password_cb * cb, void * u);
	DSA * APICALL (*PEM_read_DSAparams)(struct AmiSSLIFace *Self, FILE * fp, DSA ** x, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_DHparams)(struct AmiSSLIFace *Self, FILE * fp, DH * x);
	int APICALL (*PEM_write_DSAPrivateKey)(struct AmiSSLIFace *Self, FILE * fp, DSA * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_DSAparams)(struct AmiSSLIFace *Self, FILE * fp, DSA * x);
	int APICALL (*RSA_print_fp)(struct AmiSSLIFace *Self, FILE * fp, const RSA * r, int offset);
	int APICALL (*X509_REQ_print_fp)(struct AmiSSLIFace *Self, FILE * bp, X509_REQ * req);
	int APICALL (*X509_print_fp)(struct AmiSSLIFace *Self, FILE * bp, X509 * x);
	DSA * APICALL (*d2i_DSAPrivateKey_fp)(struct AmiSSLIFace *Self, FILE * fp, DSA ** dsa);
	PKCS7 * APICALL (*d2i_PKCS7_fp)(struct AmiSSLIFace *Self, FILE * fp, PKCS7 ** p7);
	RSA * APICALL (*d2i_RSAPrivateKey_fp)(struct AmiSSLIFace *Self, FILE * fp, RSA ** rsa);
	X509_CRL * APICALL (*d2i_X509_CRL_fp)(struct AmiSSLIFace *Self, FILE * fp, X509_CRL ** crl);
	X509_REQ * APICALL (*d2i_X509_REQ_fp)(struct AmiSSLIFace *Self, FILE * fp, X509_REQ ** req);
	X509 * APICALL (*d2i_X509_fp)(struct AmiSSLIFace *Self, FILE * fp, X509 ** x509);
	const char * APICALL (*DES_options)(struct AmiSSLIFace *Self);
	int APICALL (*i2d_DSAPrivateKey_fp)(struct AmiSSLIFace *Self, FILE * fp, DSA * dsa);
	int APICALL (*i2d_PKCS7_fp)(struct AmiSSLIFace *Self, FILE * fp, PKCS7 * p7);
	int APICALL (*i2d_RSAPrivateKey_fp)(struct AmiSSLIFace *Self, FILE * fp, RSA * rsa);
	int APICALL (*i2d_X509_CRL_fp)(struct AmiSSLIFace *Self, FILE * fp, X509_CRL * crl);
	int APICALL (*i2d_X509_REQ_fp)(struct AmiSSLIFace *Self, FILE * fp, X509_REQ * req);
	int APICALL (*i2d_X509_fp)(struct AmiSSLIFace *Self, FILE * fp, X509 * x509);
	void APICALL (*lh_node_stats)(struct AmiSSLIFace *Self, const _LHASH * lh, FILE * out);
	void APICALL (*lh_node_usage_stats)(struct AmiSSLIFace *Self, const _LHASH * lh, FILE * out);
	void APICALL (*lh_stats)(struct AmiSSLIFace *Self, const _LHASH * lh, FILE * out);
	RSA * APICALL (*d2i_RSAPublicKey_fp)(struct AmiSSLIFace *Self, FILE * fp, RSA ** rsa);
	int APICALL (*i2d_RSAPublicKey_fp)(struct AmiSSLIFace *Self, FILE * fp, RSA * rsa);
	int APICALL (*X509_CRL_print_fp)(struct AmiSSLIFace *Self, FILE * fp, X509_CRL * x);
	int APICALL (*i2d_PKCS8_fp)(struct AmiSSLIFace *Self, FILE * fp, X509_SIG * p8);
	PKCS8_PRIV_KEY_INFO * APICALL (*d2i_PKCS8_PRIV_KEY_INFO_fp)(struct AmiSSLIFace *Self, FILE * fp, PKCS8_PRIV_KEY_INFO ** p8inf);
	X509_SIG * APICALL (*d2i_PKCS8_fp)(struct AmiSSLIFace *Self, FILE * fp, X509_SIG ** p8);
	int APICALL (*i2d_PKCS8_PRIV_KEY_INFO_fp)(struct AmiSSLIFace *Self, FILE * fp, PKCS8_PRIV_KEY_INFO * p8inf);
	LHASH_OF(CONF_VALUE) * APICALL (*CONF_load_fp)(struct AmiSSLIFace *Self, LHASH_OF(CONF_VALUE) * conf, FILE * fp, long * eline);
	RSA * APICALL (*d2i_RSA_PUBKEY_fp)(struct AmiSSLIFace *Self, FILE * fp, RSA ** rsa);
	int APICALL (*i2d_DSA_PUBKEY_fp)(struct AmiSSLIFace *Self, FILE * fp, DSA * dsa);
	DSA * APICALL (*PEM_read_DSA_PUBKEY)(struct AmiSSLIFace *Self, FILE * fp, DSA ** x, pem_password_cb * cb, void * u);
	DSA * APICALL (*d2i_DSA_PUBKEY_fp)(struct AmiSSLIFace *Self, FILE * fp, DSA ** dsa);
	int APICALL (*PEM_write_DSA_PUBKEY)(struct AmiSSLIFace *Self, FILE * fp, DSA * x);
	int APICALL (*i2d_RSA_PUBKEY_fp)(struct AmiSSLIFace *Self, FILE * fp, RSA * rsa);
	int APICALL (*i2d_PKCS8PrivateKeyInfo_fp)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY * key);
	int APICALL (*i2d_PrivateKey_fp)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY * pkey);
	EVP_PKEY * APICALL (*d2i_PrivateKey_fp)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY ** a);
	int APICALL (*NCONF_load_fp)(struct AmiSSLIFace *Self, CONF * conf, FILE * fp, long * eline);
	int APICALL (*X509_NAME_print_ex_fp)(struct AmiSSLIFace *Self, FILE * fp, X509_NAME * nm, int indent, unsigned long flags);
	int APICALL (*ASN1_STRING_print_ex_fp)(struct AmiSSLIFace *Self, FILE * fp, ASN1_STRING * str, unsigned long flags);
	int APICALL (*i2d_PUBKEY_fp)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY * pkey);
	EVP_PKEY * APICALL (*d2i_PUBKEY_fp)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY ** a);
	...
	void APICALL (*ENGINE_load_dynamic)(struct AmiSSLIFace *Self);
	...
	void APICALL (*ENGINE_load_cryptodev)(struct AmiSSLIFace *Self);
	...
	void APICALL (*ENGINE_load_openssl)(struct AmiSSLIFace *Self);
	...
	int APICALL (*ENGINE_get_ex_new_index)(struct AmiSSLIFace *Self, long argl, void * argp, CRYPTO_EX_new * new_func, CRYPTO_EX_dup * dep_func, CRYPTO_EX_free * free_func);
	void * APICALL (*ENGINE_get_ex_data)(struct AmiSSLIFace *Self, const ENGINE * e, int idx);
	void * APICALL (*ASN1_item_d2i_fp)(struct AmiSSLIFace *Self, const ASN1_ITEM * it, FILE * in, void * x);
	...
	int APICALL (*X509_print_ex_fp)(struct AmiSSLIFace *Self, FILE * bp, X509 * x, unsigned long nmflag, unsigned long cflag);
	...
	int APICALL (*ASN1_item_i2d_fp)(struct AmiSSLIFace *Self, const ASN1_ITEM * it, FILE * out, void * x);
	...
	int APICALL (*ENGINE_set_STORE)(struct AmiSSLIFace *Self, ENGINE * e, const STORE_METHOD * store_meth);
	int APICALL (*ENGINE_register_ECDSA)(struct AmiSSLIFace *Self, ENGINE * e);
	...
	const ECDH_METHOD * APICALL (*ECDH_get_default_method)(struct AmiSSLIFace *Self);
	int APICALL (*ENGINE_register_ECDH)(struct AmiSSLIFace *Self, ENGINE * e);
	...
	int APICALL (*BIO_dump_fp)(struct AmiSSLIFace *Self, FILE * fp, const char * s, int len);
	...
	void APICALL (*ENGINE_unregister_STORE)(struct AmiSSLIFace *Self, ENGINE * e);
	struct ec_key_st * APICALL (*EVP_PKEY_get1_EC_KEY)(struct AmiSSLIFace *Self, EVP_PKEY * pkey);
	ENGINE * APICALL (*ENGINE_get_default_ECDH)(struct AmiSSLIFace *Self);
	...
	void * APICALL (*EC_KEY_get_key_method_data)(struct AmiSSLIFace *Self, EC_KEY * key, void *(*dup_func)(void *), void (*free_func)(void *), void (*clear_free_func)(void *));
	...
	int APICALL (*EC_KEY_print_fp)(struct AmiSSLIFace *Self, FILE * fp, const EC_KEY * key, int off);
	int APICALL (*BN_GF2m_mod_arr)(struct AmiSSLIFace *Self, BIGNUM * r, const BIGNUM * a, const int * p);
	void * APICALL (*ECDH_get_ex_data)(struct AmiSSLIFace *Self, EC_KEY * d, int idx);
	void APICALL (*ENGINE_unregister_ECDH)(struct AmiSSLIFace *Self, ENGINE * e);
	const ECDH_METHOD * APICALL (*ECDH_OpenSSL)(struct AmiSSLIFace *Self);
	...
	int APICALL (*ECPKParameters_print_fp)(struct AmiSSLIFace *Self, FILE * fp, const EC_GROUP * x, int off);
	...
	int APICALL (*ENGINE_set_ECDH)(struct AmiSSLIFace *Self, ENGINE * e, const ECDH_METHOD * ecdh_meth);
	int APICALL (*SHA256_Init)(struct AmiSSLIFace *Self, SHA256_CTX * c);
	void * APICALL (*ECDSA_get_ex_data)(struct AmiSSLIFace *Self, EC_KEY * d, int idx);
	unsigned char * APICALL (*SHA224)(struct AmiSSLIFace *Self, const unsigned char * d, size_t n, unsigned char * md);
	int APICALL (*BIO_dump_indent_fp)(struct AmiSSLIFace *Self, FILE * fp, const char * s, int len, int indent);
	...
	const ECDSA_METHOD * APICALL (*ECDSA_get_default_method)(struct AmiSSLIFace *Self);
	...
	int APICALL (*ENGINE_set_default_ECDSA)(struct AmiSSLIFace *Self, ENGINE * e);
	void APICALL (*ECDH_set_default_method)(struct AmiSSLIFace *Self, const ECDH_METHOD * method);
	int APICALL (*SHA384_Update)(struct AmiSSLIFace *Self, SHA512_CTX * c, const void * data, size_t len);
	void * APICALL (*EC_KEY_insert_key_method_data)(struct AmiSSLIFace *Self, EC_KEY * key, void * data, void *(*dup_func)(void *), void (*free_func)(void *), void (*clear_free_func)(void *));
	...
	void APICALL (*ENGINE_register_all_STORE)(struct AmiSSLIFace *Self);
	...
	int APICALL (*ECDH_get_ex_new_index)(struct AmiSSLIFace *Self, long argl, void * argp, CRYPTO_EX_new * new_func, CRYPTO_EX_dup * dup_func, CRYPTO_EX_free * free_func);
	...
	int APICALL (*ENGINE_set_ECDSA)(struct AmiSSLIFace *Self, ENGINE * e, const ECDSA_METHOD * ecdsa_meth);
	int APICALL (*PEM_write_EC_PUBKEY)(struct AmiSSLIFace *Self, FILE * fp, EC_KEY * x);
	int APICALL (*ECDH_set_method)(struct AmiSSLIFace *Self, EC_KEY * key, const ECDH_METHOD * meth);
	int APICALL (*ECDH_set_ex_data)(struct AmiSSLIFace *Self, EC_KEY * d, int idx, void * arg);
	EC_KEY * APICALL (*PEM_read_EC_PUBKEY)(struct AmiSSLIFace *Self, FILE * fp, EC_KEY ** x, pem_password_cb * cb, void * u);
	const ECDSA_METHOD * APICALL (*ECDSA_OpenSSL)(struct AmiSSLIFace *Self);
	unsigned APICALL (*EC_KEY_get_enc_flags)(struct AmiSSLIFace *Self, const EC_KEY * key);
	void APICALL (*ECDSA_set_default_method)(struct AmiSSLIFace *Self, const ECDSA_METHOD * meth);
	...
	EC_KEY * APICALL (*PEM_read_ECPrivateKey)(struct AmiSSLIFace *Self, FILE * fp, EC_KEY ** x, pem_password_cb * cb, void * u);
	int APICALL (*SHA512_Init)(struct AmiSSLIFace *Self, SHA512_CTX * c);
	void APICALL (*ERR_load_ECDSA_strings)(struct AmiSSLIFace *Self);
	int APICALL (*EC_GROUP_get_basis_type)(struct AmiSSLIFace *Self, const EC_GROUP * group);
	int APICALL (*PEM_write_ECPKParameters)(struct AmiSSLIFace *Self, FILE * fp, const EC_GROUP * x);
	void APICALL (*ENGINE_register_all_ECDH)(struct AmiSSLIFace *Self);
	int APICALL (*i2d_ECPrivateKey_fp)(struct AmiSSLIFace *Self, FILE * fp, EC_KEY * eckey);
	void APICALL (*ENGINE_register_all_ECDSA)(struct AmiSSLIFace *Self);
	EC_GROUP * APICALL (*EC_GROUP_dup)(struct AmiSSLIFace *Self, const EC_GROUP * src);
	ENGINE * APICALL (*ENGINE_get_default_ECDSA)(struct AmiSSLIFace *Self);
	...
	const STORE_METHOD * APICALL (*ENGINE_get_STORE)(struct AmiSSLIFace *Self, const ENGINE * e);
	...
	EC_KEY * APICALL (*d2i_ECPrivateKey_fp)(struct AmiSSLIFace *Self, FILE * fp, EC_KEY ** eckey);
	void APICALL (*SHA512_Transform)(struct AmiSSLIFace *Self, SHA512_CTX * c, const unsigned char * data);
	int APICALL (*PEM_write_ECPrivateKey)(struct AmiSSLIFace *Self, FILE * fp, EC_KEY * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	int APICALL (*EC_KEY_set_public_key)(struct AmiSSLIFace *Self, EC_KEY * key, const EC_POINT * pub);
	EC_GROUP * APICALL (*PEM_read_ECPKParameters)(struct AmiSSLIFace *Self, FILE * fp, EC_GROUP ** x, pem_password_cb * cb, void * u);
	int APICALL (*ENGINE_register_STORE)(struct AmiSSLIFace *Self, ENGINE * e);
	int APICALL (*ECParameters_print_fp)(struct AmiSSLIFace *Self, FILE * fp, const EC_KEY * key);
	int APICALL (*EC_GROUP_get_curve_name)(struct AmiSSLIFace *Self, const EC_GROUP * group);
	int APICALL (*i2d_EC_PUBKEY_fp)(struct AmiSSLIFace *Self, FILE * fp, EC_KEY * eckey);
	int APICALL (*SHA256_Final)(struct AmiSSLIFace *Self, unsigned char * md, SHA256_CTX * c);
	const ECDH_METHOD * APICALL (*ENGINE_get_ECDH)(struct AmiSSLIFace *Self, const ENGINE * e);
	const ECDSA_METHOD * APICALL (*ENGINE_get_ECDSA)(struct AmiSSLIFace *Self, const ENGINE * e);
	void APICALL (*ERR_load_ECDH_strings)(struct AmiSSLIFace *Self);
	int APICALL (*ECDSA_set_method)(struct AmiSSLIFace *Self, EC_KEY * eckey, const ECDSA_METHOD * meth);
	...
	int APICALL (*ECDSA_set_ex_data)(struct AmiSSLIFace *Self, EC_KEY * d, int idx, void * arg);
	int APICALL (*SHA384_Final)(struct AmiSSLIFace *Self, unsigned char * md, SHA512_CTX * c);
	int APICALL (*ECDSA_get_ex_new_index)(struct AmiSSLIFace *Self, long argl, void * argp, CRYPTO_EX_new * new_func, CRYPTO_EX_dup * dup_func, CRYPTO_EX_free * free_func);
	unsigned char * APICALL (*SHA384)(struct AmiSSLIFace *Self, const unsigned char * d, size_t n, unsigned char * md);
	EC_KEY * APICALL (*d2i_EC_PUBKEY_fp)(struct AmiSSLIFace *Self, FILE * fp, EC_KEY ** eckey);
	int APICALL (*ENGINE_set_default_ECDH)(struct AmiSSLIFace *Self, ENGINE * e);
	...
	void APICALL (*ENGINE_unregister_ECDSA)(struct AmiSSLIFace *Self, ENGINE * e);
	...
	int APICALL (*PEM_write_CMS)(struct AmiSSLIFace *Self, FILE * fp, CMS_ContentInfo * x);
	...
	int APICALL (*PEM_read_CMS)(struct AmiSSLIFace *Self, FILE * fp, CMS_ContentInfo ** x, pem_password_cb * cb, void * u);
	...
	int APICALL (*private_AES_set_decrypt_key)(struct AmiSSLIFace *Self, const unsigned char * userKey, const int bits, AES_KEY * key);
	...
	int APICALL (*private_AES_set_encrypt_key)(struct AmiSSLIFace *Self, const unsigned char * userKey, const int bits, AES_KEY * key);
	...
	void APICALL (*ENGINE_load_rdrand)(struct AmiSSLIFace *Self);
	void APICALL (*ENGINE_load_rsax)(struct AmiSSLIFace *Self);
	...
	SSL_SESSION * APICALL (*PEM_read_SSL_SESSION)(struct AmiSSLIFace *Self, FILE * fp, SSL_SESSION ** x, pem_password_cb * cb, void * u);
	SSL_SESSION * APICALL (*PEM_read_bio_SSL_SESSION)(struct AmiSSLIFace *Self, BIO * bp, SSL_SESSION ** x, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_SSL_SESSION)(struct AmiSSLIFace *Self, FILE * fp, SSL_SESSION * x);
	PKCS7 * APICALL (*PEM_read_PKCS7)(struct AmiSSLIFace *Self, FILE * fp, PKCS7 ** x, pem_password_cb * cb, void * u);
	EVP_PKEY * APICALL (*PEM_read_PrivateKey)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY ** x, pem_password_cb * cb, void * u);
	RSA * APICALL (*PEM_read_RSAPrivateKey)(struct AmiSSLIFace *Self, FILE * fp, RSA ** x, pem_password_cb * cb, void * u);
	X509 * APICALL (*PEM_read_X509)(struct AmiSSLIFace *Self, FILE * fp, X509 ** x, pem_password_cb * cb, void * u);
	X509_CRL * APICALL (*PEM_read_X509_CRL)(struct AmiSSLIFace *Self, FILE * fp, X509_CRL ** x, pem_password_cb * cb, void * u);
	X509_REQ * APICALL (*PEM_read_X509_REQ)(struct AmiSSLIFace *Self, FILE * fp, X509_REQ ** x, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_PKCS7)(struct AmiSSLIFace *Self, FILE * fp, PKCS7 * x);
	int APICALL (*PEM_write_PrivateKey)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_RSAPrivateKey)(struct AmiSSLIFace *Self, FILE * fp, RSA * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_X509)(struct AmiSSLIFace *Self, FILE * fp, X509 * x);
	int APICALL (*PEM_write_X509_CRL)(struct AmiSSLIFace *Self, FILE * fp, X509_CRL * x);
	int APICALL (*PEM_write_X509_REQ)(struct AmiSSLIFace *Self, FILE * fp, X509_REQ * x);
	RSA * APICALL (*PEM_read_RSAPublicKey)(struct AmiSSLIFace *Self, FILE * fp, RSA ** x, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_RSAPublicKey)(struct AmiSSLIFace *Self, FILE * fp, RSA * x);
	NETSCAPE_CERT_SEQUENCE * APICALL (*PEM_read_NETSCAPE_CERT_SEQUENCE)(struct AmiSSLIFace *Self, FILE * fp, NETSCAPE_CERT_SEQUENCE ** x, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_NETSCAPE_CERT_SEQUENCE)(struct AmiSSLIFace *Self, FILE * fp, NETSCAPE_CERT_SEQUENCE * x);
	int APICALL (*X509V3_EXT_print_fp)(struct AmiSSLIFace *Self, FILE * out, X509_EXTENSION * ext, int flag, int indent);
	int APICALL (*i2d_PKCS12_fp)(struct AmiSSLIFace *Self, FILE * fp, PKCS12 * p12);
	PKCS12 * APICALL (*d2i_PKCS12_fp)(struct AmiSSLIFace *Self, FILE * fp, PKCS12 ** p12);
	X509_SIG * APICALL (*PEM_read_PKCS8)(struct AmiSSLIFace *Self, FILE * fp, X509_SIG ** x, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_PKCS8)(struct AmiSSLIFace *Self, FILE * fp, X509_SIG * x);
	PKCS8_PRIV_KEY_INFO * APICALL (*PEM_read_PKCS8_PRIV_KEY_INFO)(struct AmiSSLIFace *Self, FILE * fp, PKCS8_PRIV_KEY_INFO ** x, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_PKCS8_PRIV_KEY_INFO)(struct AmiSSLIFace *Self, FILE * fp, PKCS8_PRIV_KEY_INFO * x);
	int APICALL (*PEM_write_PKCS8PrivateKey)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY * x, const EVP_CIPHER * enc, char * kstr, int klen, pem_password_cb * cb, void * u);
	X509 * APICALL (*PEM_read_X509_AUX)(struct AmiSSLIFace *Self, FILE * fp, X509 ** x, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_PUBKEY)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY * x);
	RSA * APICALL (*PEM_read_RSA_PUBKEY)(struct AmiSSLIFace *Self, FILE * fp, RSA ** x, pem_password_cb * cb, void * u);
	EVP_PKEY * APICALL (*PEM_read_PUBKEY)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY ** x, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_X509_AUX)(struct AmiSSLIFace *Self, FILE * fp, X509 * x);
	int APICALL (*PEM_write_RSA_PUBKEY)(struct AmiSSLIFace *Self, FILE * fp, RSA * x);
	int APICALL (*PEM_write_PKCS8PrivateKey_nid)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY * x, int nid, char * kstr, int klen, pem_password_cb * cb, void * u);
	int APICALL (*i2d_PKCS8PrivateKey_fp)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY * x, const EVP_CIPHER * enc, char * kstr, int klen, pem_password_cb * cb, void * u);
	int APICALL (*i2d_PKCS8PrivateKey_nid_fp)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY * x, int nid, char * kstr, int klen, pem_password_cb * cb, void * u);
	EVP_PKEY * APICALL (*d2i_PKCS8PrivateKey_fp)(struct AmiSSLIFace *Self, FILE * fp, EVP_PKEY ** x, pem_password_cb * cb, void * u);
	int APICALL (*PEM_write_X509_REQ_NEW)(struct AmiSSLIFace *Self, FILE * fp, X509_REQ * x);
	int APICALL (*CONF_dump_fp)(struct AmiSSLIFace *Self, LHASH_OF(CONF_VALUE) * conf, FILE * out);
	int APICALL (*NCONF_dump_fp)(struct AmiSSLIFace *Self, const CONF * conf, FILE * out);
	...
	pitem * APICALL (*pitem_new)(struct AmiSSLIFace *Self, unsigned char * prio64be, void * data);
	...
	pitem * APICALL (*pqueue_iterator)(struct AmiSSLIFace *Self, pqueue pq);
	...
	void APICALL (*pqueue_print)(struct AmiSSLIFace *Self, pqueue pq);
	...
	pitem * APICALL (*pqueue_find)(struct AmiSSLIFace *Self, pqueue pq, unsigned char * prio64be);
	pitem * APICALL (*pqueue_peek)(struct AmiSSLIFace *Self, pqueue pq);
	...
	void * APICALL (*BUF_memdup)(struct AmiSSLIFace *Self, const void * data, size_t siz);
	...
	X509_CERT_PAIR * APICALL (*PEM_read_X509_CERT_PAIR)(struct AmiSSLIFace *Self, FILE * fp, X509_CERT_PAIR ** x, pem_password_cb * cb, void * u);
	int APICALL (*X509_STORE_set_depth)(struct AmiSSLIFace *Self, X509_STORE * store, int depth);
	char * APICALL (*BUF_strndup)(struct AmiSSLIFace *Self, const char * str, size_t siz);
	...
	pitem * APICALL (*pqueue_pop)(struct AmiSSLIFace *Self, pqueue pq);
	...
	int APICALL (*PEM_write_X509_CERT_PAIR)(struct AmiSSLIFace *Self, FILE * fp, X509_CERT_PAIR * x);
	...
	int APICALL (*asn1_const_Finish)(struct AmiSSLIFace *Self, ASN1_const_CTX * c);
	...
	void APICALL (*pqueue_free)(struct AmiSSLIFace *Self, pqueue pq);
	...
	pitem * APICALL (*pqueue_next)(struct AmiSSLIFace *Self, piterator * iter);
	...
	pqueue APICALL (*pqueue_new)(struct AmiSSLIFace *Self);
	...
	pitem * APICALL (*pqueue_insert)(struct AmiSSLIFace *Self, pqueue pq, pitem * item);
	void APICALL (*pitem_free)(struct AmiSSLIFace *Self, pitem * item);
	...
	unsigned long APICALL (*EVP_CIPHER_CTX_flags)(struct AmiSSLIFace *Self, const EVP_CIPHER_CTX * ctx);
	...
	int APICALL (*pqueue_size)(struct AmiSSLIFace *Self, pqueue pq);
	int APICALL (*i2d_TS_ACCURACY)(struct AmiSSLIFace *Self, const TS_ACCURACY * a, unsigned char ** pp);
	int APICALL (*i2d_TS_MSG_IMPRINT_fp)(struct AmiSSLIFace *Self, FILE * fp, TS_MSG_IMPRINT * a);
	...
	DSO_METHOD * APICALL (*DSO_METHOD_beos)(struct AmiSSLIFace *Self);
	...
	int APICALL (*i2d_TS_TST_INFO_fp)(struct AmiSSLIFace *Self, FILE * fp, TS_TST_INFO * a);
	...
	TS_RESP * APICALL (*d2i_TS_RESP_fp)(struct AmiSSLIFace *Self, FILE * fp, TS_RESP ** a);
	...
	int APICALL (*i2d_TS_RESP_fp)(struct AmiSSLIFace *Self, FILE * fp, TS_RESP * a);
	...
	TS_TST_INFO * APICALL (*d2i_TS_TST_INFO_fp)(struct AmiSSLIFace *Self, FILE * fp, TS_TST_INFO ** a);
	...
	TS_REQ * APICALL (*d2i_TS_REQ_fp)(struct AmiSSLIFace *Self, FILE * fp, TS_REQ ** a);
	...
	TS_MSG_IMPRINT * APICALL (*d2i_TS_MSG_IMPRINT_fp)(struct AmiSSLIFace *Self, FILE * fp, TS_MSG_IMPRINT ** a);
	...
	int APICALL (*i2d_TS_REQ_fp)(struct AmiSSLIFace *Self, FILE * fp, TS_REQ * a);
	...
	size_t APICALL (*BUF_strnlen)(struct AmiSSLIFace *Self, const char * str, size_t maxlen);
	...
	void APICALL (*ECDSA_METHOD_free)(struct AmiSSLIFace *Self, ECDSA_METHOD * ecdsa_method);
	void * APICALL (*ECDSA_METHOD_get_app_data)(struct AmiSSLIFace *Self, ECDSA_METHOD * ecdsa_method);
	ECDSA_METHOD * APICALL (*ECDSA_METHOD_new)(struct AmiSSLIFace *Self, const ECDSA_METHOD * ecdsa_method);
	void APICALL (*ECDSA_METHOD_set_app_data)(struct AmiSSLIFace *Self, ECDSA_METHOD * ecdsa_method, void * app);
	void APICALL (*ECDSA_METHOD_set_flags)(struct AmiSSLIFace *Self, ECDSA_METHOD * ecdsa_method, int flags);
	void APICALL (*ECDSA_METHOD_set_name)(struct AmiSSLIFace *Self, ECDSA_METHOD * ecdsa_method, char * name);
	void APICALL (*ECDSA_METHOD_set_sign)(struct AmiSSLIFace *Self, ECDSA_METHOD * ecdsa_method, ECDSA_SIG * (*ecda_do_sign)(const unsigned char *dgst, int dgst_len, const BIGNUM *inv, const BIGNUM *rp, EC_KEY *eckey));
	void APICALL (*ECDSA_METHOD_set_sign_setup)(struct AmiSSLIFace *Self, ECDSA_METHOD * ecdsa_method, int (*ecdsa_sign_setup)(EC_KEY *eckey, BN_CTX *ctx, BIGNUM **kinv, BIGNUM **r));
	void APICALL (*ECDSA_METHOD_set_verify)(struct AmiSSLIFace *Self, ECDSA_METHOD * ecdsa_method, int (*ecdsa_do_verify)(const unsigned char *dgst, int dgst_len, const ECDSA_SIG *sig, EC_KEY *eckey));
	...
	int APICALL (*X509V3_EXT_free)(struct AmiSSLIFace *Self, int nid, void * ext_data);
