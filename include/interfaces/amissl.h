...
struct AmiSSLIFace
{
	...
	void APICALL (*EC_KEY_METHOD_get_compute_key)(struct AmiSSLIFace *Self, EC_KEY_METHOD * meth, int (**pck)(void *, size_t, const EC_POINT *, const EC_KEY *, void *(*KDF)(const void *, size_t, void *, size_t *)));
