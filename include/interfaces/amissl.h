...
struct AmiSSLIFace
{
	...
	APICALL int (*X509_aux_print)(struct AmiSSLIFace *Self, BIO * out, const X509 * x, int indent);
	...
	APICALL int (*CRYPTO_atomic_store_int)(struct AmiSSLIFace *Self, int * dst, int val, CRYPTO_RWLOCK * lock);
	...
	APTR PLACEHOLDER_UNIMPLEMENTED;
};
