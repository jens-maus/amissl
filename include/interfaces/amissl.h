...
struct AmiSSLIFace
{
	...
	APTR ASN1_STRING_data_UNIMPLEMENTED;
	...
	APICALL OSSL_CRYPTO_ALLOC void * (*CRYPTO_malloc)(struct AmiSSLIFace *Self, size_t num, const char * file, int line);
	...
	APTR ERR_get_state_UNIMPLEMENTED;
	...
	APTR BIO_f_reliable_UNIMPLEMENTED;
	...
	APICALL int (*OCSP_request_sign)(struct AmiSSLIFace *Self, OCSP_REQUEST * req, X509 * signer, EVP_PKEY * key, const EVP_MD * dgst, const STACK_OF(X509) * certs, unsigned long flags);
	...
	APICALL int (*OCSP_request_verify)(struct AmiSSLIFace *Self, OCSP_REQUEST * req, const STACK_OF(X509) * certs, X509_STORE * store, unsigned long flags);
	...
	APICALL int (*OCSP_basic_sign)(struct AmiSSLIFace *Self, OCSP_BASICRESP * brsp, X509 * signer, EVP_PKEY * key, const EVP_MD * dgst, const STACK_OF(X509) * certs, unsigned long flags);
	...
	APICALL const X509_EXTENSION * (*OCSP_REQUEST_get_ext)(struct AmiSSLIFace *Self, OCSP_REQUEST * x, int loc);
	...
	APICALL int (*OCSP_REQUEST_add_ext)(struct AmiSSLIFace *Self, OCSP_REQUEST * x, const X509_EXTENSION * ex, int loc);
	...
	APICALL const X509_EXTENSION * (*OCSP_ONEREQ_get_ext)(struct AmiSSLIFace *Self, OCSP_ONEREQ * x, int loc);
	...
	APICALL int (*OCSP_ONEREQ_add_ext)(struct AmiSSLIFace *Self, OCSP_ONEREQ * x, const X509_EXTENSION * ex, int loc);
	...
	APICALL const X509_EXTENSION * (*OCSP_BASICRESP_get_ext)(struct AmiSSLIFace *Self, OCSP_BASICRESP * x, int loc);
	...
	APICALL int (*OCSP_BASICRESP_add_ext)(struct AmiSSLIFace *Self, OCSP_BASICRESP * x, const X509_EXTENSION * ex, int loc);
	...
	APICALL const X509_EXTENSION * (*OCSP_SINGLERESP_get_ext)(struct AmiSSLIFace *Self, OCSP_SINGLERESP * x, int loc);
	...
	APICALL int (*OCSP_SINGLERESP_add_ext)(struct AmiSSLIFace *Self, OCSP_SINGLERESP * x, const X509_EXTENSION * ex, int loc);
	...
	APICALL int (*OCSP_basic_verify)(struct AmiSSLIFace *Self, OCSP_BASICRESP * bs, const STACK_OF(X509) * certs, X509_STORE * st, unsigned long flags);
	...
	APICALL int (*PKCS12_add_localkeyid)(struct AmiSSLIFace *Self, PKCS12_SAFEBAG * bag, const unsigned char * name, int namelen);
	...
	APICALL const ASN1_TYPE * (*PKCS12_get_attr_gen)(struct AmiSSLIFace *Self, const STACK_OF(X509_ATTRIBUTE) * attrs, int attr_nid);
	...
	APICALL int (*PKCS7_signatureVerify)(struct AmiSSLIFace *Self, BIO * bio, PKCS7 * p7, PKCS7_SIGNER_INFO * si, const X509 * signer);
	...
	APICALL const ASN1_OCTET_STRING * (*PKCS7_digest_from_attributes)(struct AmiSSLIFace *Self, STACK_OF(X509_ATTRIBUTE) * sk);
	...
	APICALL const ASN1_TYPE * (*PKCS7_get_attribute)(struct AmiSSLIFace *Self, const PKCS7_SIGNER_INFO * si, int nid);
	APICALL const ASN1_TYPE * (*PKCS7_get_signed_attribute)(struct AmiSSLIFace *Self, const PKCS7_SIGNER_INFO * si, int nid);
	...
	APICALL PKCS7 * (*PKCS7_sign)(struct AmiSSLIFace *Self, X509 * signcert, EVP_PKEY * pkey, const STACK_OF(X509) * certs, BIO * data, int flags);
	APICALL int (*PKCS7_verify)(struct AmiSSLIFace *Self, PKCS7 * p7, const STACK_OF(X509) * certs, X509_STORE * store, BIO * indata, BIO * out, int flags);
	APICALL STACK_OF(X509) * (*PKCS7_get0_signers)(struct AmiSSLIFace *Self, PKCS7 * p7, const STACK_OF(X509) * certs, int flags);
	APICALL PKCS7 * (*PKCS7_encrypt)(struct AmiSSLIFace *Self, const STACK_OF(X509) * certs, BIO * in, const EVP_CIPHER * cipher, int flags);
	...
	APTR TLSv1_method_UNIMPLEMENTED;
	APTR TLSv1_server_method_UNIMPLEMENTED;
	APTR TLSv1_client_method_UNIMPLEMENTED;
	...
	APICALL void (*OPENSSL_sk_pop_free)(struct AmiSSLIFace *Self, OPENSSL_STACK * st, OPENSSL_sk_freefunc func);
	...
	APICALL int (*OPENSSL_sk_find)(struct AmiSSLIFace *Self, const OPENSSL_STACK * st, const void * data);
	...
	APICALL int (*X509_verify)(struct AmiSSLIFace *Self, const X509 * a, EVP_PKEY * r);
	...
	APICALL int (*NETSCAPE_SPKI_print)(struct AmiSSLIFace *Self, BIO * out, const NETSCAPE_SPKI * spki);
	...
	APICALL int (*X509_cmp_time)(struct AmiSSLIFace *Self, const ASN1_TIME * s, const time_t * t);
	APICALL int (*X509_cmp_current_time)(struct AmiSSLIFace *Self, const ASN1_TIME * s);
	APICALL ASN1_TIME * (*X509_time_adj)(struct AmiSSLIFace *Self, ASN1_TIME * s, long adj, const time_t * t);
	...
	APICALL X509_REQ * (*X509_to_X509_REQ)(struct AmiSSLIFace *Self, const X509 * x, EVP_PKEY * pkey, const EVP_MD * md);
	APICALL X509 * (*X509_REQ_to_X509)(struct AmiSSLIFace *Self, const X509_REQ * r, int days, EVP_PKEY * pkey);
	...
	APICALL int (*X509_get_pubkey_parameters)(struct AmiSSLIFace *Self, EVP_PKEY * pkey, const STACK_OF(X509) * chain);
	...
	APICALL const unsigned char * (*X509_alias_get0)(struct AmiSSLIFace *Self, const X509 * x, int * len);
	APICALL int (*(*X509_TRUST_set_default)(struct AmiSSLIFace *Self, int (*trust)(int, const X509 *, int)))(int, const X509 *, int);
	...
	APICALL const X509_NAME * (*X509_get_issuer_name)(struct AmiSSLIFace *Self, const X509 * a);
	APICALL int (*X509_set_subject_name)(struct AmiSSLIFace *Self, X509 * x, const X509_NAME * name);
	APICALL const X509_NAME * (*X509_get_subject_name)(struct AmiSSLIFace *Self, const X509 * a);
	...
	DEPRECATED APICALL EVP_PKEY * (*X509_get_pubkey)(struct AmiSSLIFace *Self, const X509 * x);
	APICALL const ASN1_BIT_STRING * (*X509_get0_pubkey_bitstr)(struct AmiSSLIFace *Self, const X509 * x);
	...
	DEPRECATED APICALL EVP_PKEY * (*X509_REQ_get_pubkey)(struct AmiSSLIFace *Self, X509_REQ * req);
	...
	APICALL STACK_OF(X509_EXTENSION) * (*X509_REQ_get_extensions)(struct AmiSSLIFace *Self, const X509_REQ * req);
	...
	APICALL unsigned long (*X509_issuer_and_serial_hash)(struct AmiSSLIFace *Self, const X509 * a);
	APICALL int (*X509_issuer_name_cmp)(struct AmiSSLIFace *Self, const X509 * a, const X509 * b);
	APICALL unsigned long (*X509_issuer_name_hash)(struct AmiSSLIFace *Self, const X509 * a);
	APICALL int (*X509_subject_name_cmp)(struct AmiSSLIFace *Self, const X509 * a, const X509 * b);
	APICALL unsigned long (*X509_subject_name_hash)(struct AmiSSLIFace *Self, const X509 * x);
	...
	APICALL int (*X509_print_ex)(struct AmiSSLIFace *Self, BIO * bp, const X509 * x, unsigned long nmflag, unsigned long cflag);
	APICALL int (*X509_print)(struct AmiSSLIFace *Self, BIO * bp, const X509 * x);
	APICALL int (*X509_ocspid_print)(struct AmiSSLIFace *Self, BIO * bp, const X509 * x);
	APTR X509_CERT_AUX_print_UNIMPLEMENTED;
	APICALL int (*X509_CRL_print)(struct AmiSSLIFace *Self, BIO * bp, const X509_CRL * x);
	APICALL int (*X509_REQ_print_ex)(struct AmiSSLIFace *Self, BIO * bp, const X509_REQ * x, unsigned long nmflag, unsigned long cflag);
	APICALL int (*X509_REQ_print)(struct AmiSSLIFace *Self, BIO * bp, const X509_REQ * req);
	...
	APICALL const X509_NAME_ENTRY * (*X509_NAME_get_entry)(struct AmiSSLIFace *Self, const X509_NAME * name, int loc);
	...
	APICALL const ASN1_OBJECT * (*X509_NAME_ENTRY_get_object)(struct AmiSSLIFace *Self, const X509_NAME_ENTRY * ne);
	APICALL const ASN1_STRING * (*X509_NAME_ENTRY_get_data)(struct AmiSSLIFace *Self, const X509_NAME_ENTRY * ne);
	...
	APICALL const X509_EXTENSION * (*X509v3_get_ext)(struct AmiSSLIFace *Self, const STACK_OF(X509_EXTENSION) * x, int loc);
	APICALL X509_EXTENSION * (*X509v3_delete_ext)(struct AmiSSLIFace *Self, STACK_OF(X509_EXTENSION) * x, int loc);
	APICALL STACK_OF(X509_EXTENSION) * (*X509v3_add_ext)(struct AmiSSLIFace *Self, STACK_OF(X509_EXTENSION) ** x, const X509_EXTENSION * ex, int loc);
	...
	APICALL const X509_EXTENSION * (*X509_get_ext)(struct AmiSSLIFace *Self, const X509 * x, int loc);
	APICALL X509_EXTENSION * (*X509_delete_ext)(struct AmiSSLIFace *Self, X509 * x, int loc);
	APICALL int (*X509_add_ext)(struct AmiSSLIFace *Self, X509 * x, const X509_EXTENSION * ex, int loc);
	...
	APICALL const X509_EXTENSION * (*X509_CRL_get_ext)(struct AmiSSLIFace *Self, const X509_CRL * x, int loc);
	APICALL X509_EXTENSION * (*X509_CRL_delete_ext)(struct AmiSSLIFace *Self, X509_CRL * x, int loc);
	APICALL int (*X509_CRL_add_ext)(struct AmiSSLIFace *Self, X509_CRL * x, const X509_EXTENSION * ex, int loc);
	...
	APICALL const X509_EXTENSION * (*X509_REVOKED_get_ext)(struct AmiSSLIFace *Self, const X509_REVOKED * x, int loc);
	...
	APICALL int (*X509_EXTENSION_set_data)(struct AmiSSLIFace *Self, X509_EXTENSION * ex, const ASN1_OCTET_STRING * data);
	APICALL const ASN1_OBJECT * (*X509_EXTENSION_get_object)(struct AmiSSLIFace *Self, const X509_EXTENSION * ex);
	APICALL const ASN1_OCTET_STRING * (*X509_EXTENSION_get_data)(struct AmiSSLIFace *Self, const X509_EXTENSION * ne);
	...
	APICALL const void * (*X509_ATTRIBUTE_get0_data)(struct AmiSSLIFace *Self, const X509_ATTRIBUTE * attr, int idx, int atrtype, void * data);
	APICALL int (*X509_ATTRIBUTE_count)(struct AmiSSLIFace *Self, const X509_ATTRIBUTE * attr);
	APICALL const ASN1_OBJECT * (*X509_ATTRIBUTE_get0_object)(struct AmiSSLIFace *Self, const X509_ATTRIBUTE * attr);
	APICALL const ASN1_TYPE * (*X509_ATTRIBUTE_get0_type)(struct AmiSSLIFace *Self, const X509_ATTRIBUTE * attr, int idx);
	APICALL int (*X509_verify_cert)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL X509 * (*X509_find_by_issuer_and_serial)(struct AmiSSLIFace *Self, const STACK_OF(X509) * sk, const X509_NAME * name, const ASN1_INTEGER * serial);
	APICALL X509 * (*X509_find_by_subject)(struct AmiSSLIFace *Self, const STACK_OF(X509) * sk, const X509_NAME * name);
	...
	APICALL int (*X509_check_trust)(struct AmiSSLIFace *Self, const X509 * x, int id, int flags);
	...
	APICALL int (*X509_TRUST_add)(struct AmiSSLIFace *Self, int id, int flags, int (*ck)(X509_TRUST *, const X509 *, int), const char * name, int arg1, void * arg2);
	...
	APICALL int (*X509_STORE_CTX_get1_issuer)(struct AmiSSLIFace *Self, X509 ** issuer, X509_STORE_CTX * ctx, const X509 * x);
	APICALL void (*X509_STORE_CTX_free)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx);
	APICALL int (*X509_STORE_CTX_init)(struct AmiSSLIFace *Self, X509_STORE_CTX * ctx, X509_STORE * trust_store, const X509 * target, STACK_OF(X509) * untrusted);
	...
	APICALL int (*X509_STORE_add_cert)(struct AmiSSLIFace *Self, X509_STORE * xs, const X509 * x);
	...
	APICALL const X509V3_EXT_METHOD * (*X509V3_EXT_get)(struct AmiSSLIFace *Self, const X509_EXTENSION * ext);
	...
	APICALL void * (*X509V3_EXT_d2i)(struct AmiSSLIFace *Self, const X509_EXTENSION * ext);
	...
	APICALL int (*X509V3_EXT_print)(struct AmiSSLIFace *Self, BIO * out, const X509_EXTENSION * ext, unsigned long flag, int indent);
	...
	APICALL int (*X509_check_purpose)(struct AmiSSLIFace *Self, const X509 * x, int id, int ca);
	APICALL int (*X509_supported_extension)(struct AmiSSLIFace *Self, const X509_EXTENSION * ex);
	APICALL int (*X509_PURPOSE_set)(struct AmiSSLIFace *Self, int * p, int purpose);
	APICALL int (*X509_check_issued)(struct AmiSSLIFace *Self, const X509 * issuer, const X509 * subject);
	...
	APICALL STACK_OF(OPENSSL_STRING) * (*X509_get1_email)(struct AmiSSLIFace *Self, const X509 * x);
	APICALL STACK_OF(OPENSSL_STRING) * (*X509_REQ_get1_email)(struct AmiSSLIFace *Self, const X509_REQ * x);
	...
	DEPRECATED APICALL int (*AES_set_encrypt_key)(struct AmiSSLIFace *Self, const unsigned char * userKey, int bits, AES_KEY * key);
	DEPRECATED APICALL int (*AES_set_decrypt_key)(struct AmiSSLIFace *Self, const unsigned char * userKey, int bits, AES_KEY * key);
	...
	DEPRECATED APICALL void (*AES_ecb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const AES_KEY * key, int enc);
	DEPRECATED APICALL void (*AES_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, unsigned char * ivec, int enc);
	DEPRECATED APICALL void (*AES_cfb128_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, unsigned char * ivec, int * num, int enc);
	DEPRECATED APICALL void (*AES_cfb1_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, unsigned char * ivec, int * num, int enc);
	DEPRECATED APICALL void (*AES_cfb8_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, unsigned char * ivec, int * num, int enc);
	...
	APICALL int (*X509_check_ca)(struct AmiSSLIFace *Self, const X509 * x);
	...
	APTR ENGINE_get_first_UNIMPLEMENTED;
	APTR ENGINE_get_id_UNIMPLEMENTED;
	APTR ENGINE_get_name_UNIMPLEMENTED;
	APTR ENGINE_get_next_UNIMPLEMENTED;
	APTR ENGINE_free_UNIMPLEMENTED;
	APTR ENGINE_new_UNIMPLEMENTED;
	APTR ENGINE_set_id_UNIMPLEMENTED;
	APTR ENGINE_set_name_UNIMPLEMENTED;
	APTR ENGINE_add_UNIMPLEMENTED;
	APTR ENGINE_remove_UNIMPLEMENTED;
	APTR ENGINE_load_builtin_engines_UNIMPLEMENTED;
	APTR ENGINE_register_all_ciphers_UNIMPLEMENTED;
	...
	APTR ENGINE_register_all_digests_UNIMPLEMENTED;
	...
	APICALL STACK_OF(OPENSSL_STRING) * (*X509_get1_ocsp)(struct AmiSSLIFace *Self, const X509 * x);
	APICALL const char * (*SSL_get_servername)(struct AmiSSLIFace *Self, const SSL * s, int type);
	...
	APTR ENGINE_by_id_UNIMPLEMENTED;
	APTR SSL_CTX_set_client_cert_engine_UNIMPLEMENTED;
	...
	DEPRECATED APICALL void (*AES_ige_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, unsigned char * ivec, int enc);
	DEPRECATED APICALL int (*EC_KEY_precompute_mult)(struct AmiSSLIFace *Self, EC_KEY * key, BN_CTX * ctx);
	APTR ENGINE_load_private_key_UNIMPLEMENTED;
	APTR ENGINE_load_public_key_UNIMPLEMENTED;
	APTR ENGINE_ctrl_cmd_UNIMPLEMENTED;
	APTR ENGINE_set_default_UNIMPLEMENTED;
	APTR ENGINE_ctrl_UNIMPLEMENTED;
	APTR ENGINE_register_all_complete_UNIMPLEMENTED;
	APTR ENGINE_ctrl_cmd_string_UNIMPLEMENTED;
	...
	APTR ENGINE_get_RSA_UNIMPLEMENTED;
	APTR ENGINE_get_DSA_UNIMPLEMENTED;
	APTR ENGINE_get_DH_UNIMPLEMENTED;
	APTR ENGINE_get_RAND_UNIMPLEMENTED;
	APTR ENGINE_get_ciphers_UNIMPLEMENTED;
	APTR ENGINE_get_digests_UNIMPLEMENTED;
	APTR ENGINE_init_UNIMPLEMENTED;
	APTR ENGINE_finish_UNIMPLEMENTED;
	...
	APTR ERR_load_ENGINE_strings_UNIMPLEMENTED;
	APTR ENGINE_set_DSA_UNIMPLEMENTED;
	APTR ENGINE_get_finish_function_UNIMPLEMENTED;
	APTR ENGINE_get_default_RSA_UNIMPLEMENTED;
	APTR ENGINE_set_DH_UNIMPLEMENTED;
	APTR ENGINE_get_init_function_UNIMPLEMENTED;
	APTR ENGINE_set_init_function_UNIMPLEMENTED;
	APTR ENGINE_set_default_DSA_UNIMPLEMENTED;
	APTR ENGINE_get_last_UNIMPLEMENTED;
	APTR ENGINE_get_prev_UNIMPLEMENTED;
	APTR ENGINE_get_default_DH_UNIMPLEMENTED;
	APTR ENGINE_set_finish_function_UNIMPLEMENTED;
	APTR ENGINE_set_RSA_UNIMPLEMENTED;
	APTR ENGINE_set_default_RAND_UNIMPLEMENTED;
	APTR ENGINE_get_default_DSA_UNIMPLEMENTED;
	APTR ENGINE_set_default_RSA_UNIMPLEMENTED;
	APTR ENGINE_get_default_RAND_UNIMPLEMENTED;
	APTR ENGINE_set_RAND_UNIMPLEMENTED;
	APTR ENGINE_set_default_DH_UNIMPLEMENTED;
	APTR ENGINE_get_ctrl_function_UNIMPLEMENTED;
	APTR ENGINE_set_ctrl_function_UNIMPLEMENTED;
	APTR ENGINE_unregister_ciphers_UNIMPLEMENTED;
	APTR ENGINE_unregister_RSA_UNIMPLEMENTED;
	APTR ENGINE_register_all_RAND_UNIMPLEMENTED;
	APTR OBSOLETE_ENGINE_load_dynamic_UNIMPLEMENTED;
	APTR ENGINE_get_digest_engine_UNIMPLEMENTED;
	APTR ENGINE_register_DH_UNIMPLEMENTED;
	APTR ENGINE_register_RAND_UNIMPLEMENTED;
	APTR OBSOLETE_ENGINE_load_cryptodev_UNIMPLEMENTED;
	APTR ENGINE_register_ciphers_UNIMPLEMENTED;
	APTR ENGINE_load_ubsec_UNIMPLEMENTED;
	APTR OBSOLETE_ENGINE_load_openssl_UNIMPLEMENTED;
	APTR ENGINE_get_cmd_defns_UNIMPLEMENTED;
	APTR ENGINE_set_load_privkey_function_UNIMPLEMENTED;
	APTR ENGINE_set_default_digests_UNIMPLEMENTED;
	APTR ENGINE_register_RSA_UNIMPLEMENTED;
	APTR ENGINE_unregister_DSA_UNIMPLEMENTED;
	APTR ENGINE_set_ciphers_UNIMPLEMENTED;
	APTR RAND_set_rand_engine_UNIMPLEMENTED;
	APTR ENGINE_get_digest_UNIMPLEMENTED;
	APTR ENGINE_get_cipher_UNIMPLEMENTED;
	APTR ENGINE_cmd_is_executable_UNIMPLEMENTED;
	APTR ENGINE_register_DSA_UNIMPLEMENTED;
	APTR ENGINE_set_load_pubkey_function_UNIMPLEMENTED;
	APTR ENGINE_get_load_pubkey_function_UNIMPLEMENTED;
	APTR ENGINE_register_all_RSA_UNIMPLEMENTED;
	APTR ENGINE_unregister_digests_UNIMPLEMENTED;
	APTR OBSOLETE_ENGINE_get_ex_new_index_UNIMPLEMENTED;
	APTR ENGINE_get_ex_data_UNIMPLEMENTED;
	APTR ASN1_item_d2i_fp_UNIMPLEMENTED;
	APTR ENGINE_set_cmd_defns_UNIMPLEMENTED;
	APTR ENGINE_register_digests_UNIMPLEMENTED;
	APTR ENGINE_register_all_DH_UNIMPLEMENTED;
	APTR ENGINE_get_flags_UNIMPLEMENTED;
	APTR ENGINE_unregister_DH_UNIMPLEMENTED;
	APTR ENGINE_register_all_DSA_UNIMPLEMENTED;
	APTR ENGINE_set_digests_UNIMPLEMENTED;
	APTR ENGINE_register_complete_UNIMPLEMENTED;
	APTR ENGINE_set_ex_data_UNIMPLEMENTED;
	APTR ENGINE_set_destroy_function_UNIMPLEMENTED;
	APTR ENGINE_get_cipher_engine_UNIMPLEMENTED;
	APTR X509_print_ex_fp_UNIMPLEMENTED;
	APTR ENGINE_load_cswift_UNIMPLEMENTED;
	APTR ENGINE_set_default_ciphers_UNIMPLEMENTED;
	APTR ENGINE_unregister_RAND_UNIMPLEMENTED;
	APTR ENGINE_load_nuron_UNIMPLEMENTED;
	APTR ENGINE_set_table_flags_UNIMPLEMENTED;
	APTR ENGINE_load_chil_UNIMPLEMENTED;
	APTR ENGINE_get_destroy_function_UNIMPLEMENTED;
	APTR ASN1_item_i2d_fp_UNIMPLEMENTED;
	APTR ENGINE_load_atalla_UNIMPLEMENTED;
	APTR ENGINE_get_table_flags_UNIMPLEMENTED;
	APTR ENGINE_set_flags_UNIMPLEMENTED;
	APTR ENGINE_get_load_privkey_function_UNIMPLEMENTED;
	APTR ENGINE_set_default_string_UNIMPLEMENTED;
	APTR ENGINE_add_conf_module_UNIMPLEMENTED;
	APTR ENGINE_load_aep_UNIMPLEMENTED;
	APTR ENGINE_load_sureware_UNIMPLEMENTED;
	APTR ENGINE_load_4758cca_UNIMPLEMENTED;
	APTR ENGINE_up_ref_UNIMPLEMENTED;
	...
	APTR ENGINE_get_static_state_UNIMPLEMENTED;
	...
	APTR OBSOLETE_ENGINE_load_padlock_UNIMPLEMENTED;
	...
	DEPRECATED APICALL void (*Camellia_cbc_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const CAMELLIA_KEY * key, unsigned char * ivec, int enc);
	DEPRECATED APICALL void (*Camellia_cfb128_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const CAMELLIA_KEY * key, unsigned char * ivec, int * num, int enc);
	DEPRECATED APICALL void (*Camellia_cfb1_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const CAMELLIA_KEY * key, unsigned char * ivec, int * num, int enc);
	DEPRECATED APICALL void (*Camellia_cfb8_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const CAMELLIA_KEY * key, unsigned char * ivec, int * num, int enc);
	...
	DEPRECATED APICALL void (*Camellia_ecb_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, const CAMELLIA_KEY * key, int enc);
	...
	DEPRECATED APICALL void (*AES_bi_ige_encrypt)(struct AmiSSLIFace *Self, const unsigned char * in, unsigned char * out, size_t length, const AES_KEY * key, const AES_KEY * key2, const unsigned char * ivec, int enc);
	...
	APICALL CMS_ContentInfo * (*CMS_sign_receipt)(struct AmiSSLIFace *Self, CMS_SignerInfo * si, X509 * signcert, EVP_PKEY * pkey, const STACK_OF(X509) * certs, unsigned int flags);
	...
	APICALL int (*CMS_verify)(struct AmiSSLIFace *Self, CMS_ContentInfo * cms, const STACK_OF(X509) * certs, X509_STORE * store, BIO * dcont, BIO * out, unsigned int flags);
	...
	APICALL CMS_ContentInfo * (*CMS_encrypt)(struct AmiSSLIFace *Self, const STACK_OF(X509) * certs, BIO * in, const EVP_CIPHER * cipher, unsigned int flags);
	...
	APICALL const void * (*CMS_unsigned_get0_data_by_OBJ)(struct AmiSSLIFace *Self, CMS_SignerInfo * si, ASN1_OBJECT * oid, int lastpos, int type);
	...
	APICALL CMS_ContentInfo * (*CMS_sign)(struct AmiSSLIFace *Self, X509 * signcert, EVP_PKEY * pkey, const STACK_OF(X509) * certs, BIO * data, unsigned int flags);
	...
	APICALL const void * (*CMS_signed_get0_data_by_OBJ)(struct AmiSSLIFace *Self, const CMS_SignerInfo * si, const ASN1_OBJECT * oid, int lastpos, int type);
	...
	APICALL int (*CMS_set1_signers_certs)(struct AmiSSLIFace *Self, CMS_ContentInfo * cms, const STACK_OF(X509) * certs, unsigned int flags);
	...
	APICALL int (*CMS_verify_receipt)(struct AmiSSLIFace *Self, CMS_ContentInfo * rcms, CMS_ContentInfo * ocms, const STACK_OF(X509) * certs, X509_STORE * store, unsigned int flags);
	...
	APTR ENGINE_set_load_ssl_client_cert_function_UNIMPLEMENTED;
	APTR ENGINE_get_ssl_client_cert_function_UNIMPLEMENTED;
	APTR ENGINE_load_ssl_client_cert_UNIMPLEMENTED;
	APTR OBSOLETE_ENGINE_load_capi_UNIMPLEMENTED;
	APTR ENGINE_register_pkey_meths_UNIMPLEMENTED;
	APTR ENGINE_get_pkey_asn1_meth_engine_UNIMPLEMENTED;
	...
	APTR ENGINE_get_pkey_asn1_meth_UNIMPLEMENTED;
	APTR ENGINE_get_pkey_meth_UNIMPLEMENTED;
	APICALL BIO * (*BIO_new_CMS)(struct AmiSSLIFace *Self, BIO * out, CMS_ContentInfo * cms);
	APTR ENGINE_set_default_pkey_asn1_meths_UNIMPLEMENTED;
	...
	APTR ENGINE_pkey_asn1_find_str_UNIMPLEMENTED;
	APTR ENGINE_get_pkey_meths_UNIMPLEMENTED;
	APTR ENGINE_register_pkey_asn1_meths_UNIMPLEMENTED;
	APTR ENGINE_set_default_pkey_meths_UNIMPLEMENTED;
	DEPRECATED APICALL int (*HMAC_CTX_copy)(struct AmiSSLIFace *Self, HMAC_CTX * dctx, HMAC_CTX * sctx);
	APTR ENGINE_get_pkey_asn1_meths_UNIMPLEMENTED;
	APICALL const EVP_MD * (*EVP_whirlpool)(struct AmiSSLIFace *Self);
	APTR ENGINE_register_all_pkey_meths_UNIMPLEMENTED;
	DEPRECATED APICALL int (*WHIRLPOOL_Final)(struct AmiSSLIFace *Self, unsigned char * md, WHIRLPOOL_CTX * c);
	APTR ENGINE_get_pkey_asn1_meth_str_UNIMPLEMENTED;
	APTR ENGINE_register_all_pkey_asn1_meths_UNIMPLEMENTED;
	...
	APTR ENGINE_set_pkey_asn1_meths_UNIMPLEMENTED;
	APTR ENGINE_get_pkey_meth_engine_UNIMPLEMENTED;
	...
	APTR ENGINE_unregister_pkey_meths_UNIMPLEMENTED;
	APTR ENGINE_unregister_pkey_asn1_meths_UNIMPLEMENTED;
	APTR ENGINE_set_pkey_meths_UNIMPLEMENTED;
	...
	APICALL unsigned long (*X509_issuer_name_hash_old)(struct AmiSSLIFace *Self, const X509 * a);
	APICALL unsigned long (*X509_subject_name_hash_old)(struct AmiSSLIFace *Self, const X509 * x);
	...
	APTR OBSOLETE_ENGINE_load_rdrand_UNIMPLEMENTED;
	...
	APICALL const unsigned char * (*X509_keyid_get0)(struct AmiSSLIFace *Self, const X509 * x, int * len);
	...
	APICALL int (*OPENSSL_sk_find_ex)(struct AmiSSLIFace *Self, const OPENSSL_STACK * st, const void * data);
	...
	APICALL const void * (*X509at_get0_data_by_OBJ)(struct AmiSSLIFace *Self, const STACK_OF(X509_ATTRIBUTE) * x, const ASN1_OBJECT * obj, int lastpos, int type);
	...
	APTR EVP_PKEY_asn1_find_UNIMPLEMENTED;
	APTR DSO_METHOD_beos_UNIMPLEMENTED;
	APICALL X509 * (*TS_CONF_load_cert)(struct AmiSSLIFace *Self, const char * file);
	APICALL const X509_EXTENSION * (*TS_REQ_get_ext)(struct AmiSSLIFace *Self, TS_REQ * a, int loc);
	...
	APTR EVP_PKEY_asn1_add0_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_decrypt_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_new_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_set_public_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_set_free_UNIMPLEMENTED;
	APTR EVP_PKEY_get0_asn1_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_add_alias_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_ctrl_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_sign_UNIMPLEMENTED;
	...
	APTR TS_CONF_set_default_engine_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_get0_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_init_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_verify_recover_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_derive_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_get_count_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_set_private_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_verify_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_get0_info_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_verifyctx_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_set_param_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_set_encrypt_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_find_str_UNIMPLEMENTED;
	...
	APICALL int (*X509_CRL_get0_by_cert)(struct AmiSSLIFace *Self, X509_CRL * crl, X509_REVOKED ** ret, const X509 * x);
	...
	APICALL int (*TS_RESP_verify_signature)(struct AmiSSLIFace *Self, PKCS7 * token, const STACK_OF(X509) * certs, X509_STORE * store, X509 ** signer_out);
	...
	APTR EVP_PKEY_meth_set_signctx_UNIMPLEMENTED;
	APTR EVP_PKEY_asn1_copy_UNIMPLEMENTED;
	...
	APICALL STACK_OF(X509) * (*X509_STORE_CTX_get1_certs)(struct AmiSSLIFace *Self, const X509_STORE_CTX * xs, const X509_NAME * nm);
	...
	APICALL ASN1_TIME * (*X509_time_adj_ex)(struct AmiSSLIFace *Self, ASN1_TIME * s, int offset_day, long offset_sec, const time_t * t);
	...
	APTR EVP_PKEY_meth_free_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_find_UNIMPLEMENTED;
	...
	APTR TS_CONF_set_crypto_device_UNIMPLEMENTED;
	...
	APICALL int (*NAME_CONSTRAINTS_check)(struct AmiSSLIFace *Self, const X509 * x, NAME_CONSTRAINTS * nc);
	...
	APTR EVP_PKEY_meth_set_cleanup_UNIMPLEMENTED;
	APTR EVP_PKEY_asn1_free_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_keygen_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_paramgen_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_copy_UNIMPLEMENTED;
	APICALL void (*ASN1_PCTX_set_cert_flags)(struct AmiSSLIFace *Self, ASN1_PCTX * p, unsigned long flags);
	APICALL const X509_EXTENSION * (*TS_TST_INFO_get_ext)(struct AmiSSLIFace *Self, TS_TST_INFO * a, int loc);
	APTR EVP_PKEY_asn1_set_ctrl_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_get0_info_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_copy_UNIMPLEMENTED;
	...
	APICALL int (*X509_ALGOR_set_md)(struct AmiSSLIFace *Self, X509_ALGOR * alg, const EVP_MD * md);
	...
	APICALL int (*X509_chain_check_suiteb)(struct AmiSSLIFace *Self, int * perror_depth, const X509 * x, STACK_OF(X509) * chain, unsigned long flags);
	...
	APICALL int (*X509_VERIFY_PARAM_set1_ip)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param, const uint8_t * ip, size_t iplen);
	...
	APICALL int (*X509_check_email)(struct AmiSSLIFace *Self, const X509 * x, const char * chk, size_t chklen, unsigned int flags);
	APICALL int (*X509_check_host)(struct AmiSSLIFace *Self, const X509 * x, const char * chk, size_t chklen, unsigned int flags, char ** peername);
	APICALL int (*X509_check_ip)(struct AmiSSLIFace *Self, const X509 * x, const unsigned char * chk, size_t chklen, unsigned int flags);
	APICALL int (*X509_check_ip_asc)(struct AmiSSLIFace *Self, const X509 * x, const char * ipasc, unsigned int flags);
	APTR X509V3_EXT_free_UNIMPLEMENTED;
	APTR EVP_PKEY_asn1_set_item_UNIMPLEMENTED;
	...
	APICALL OSSL_CRYPTO_ALLOC void * (*CRYPTO_secure_malloc)(struct AmiSSLIFace *Self, size_t num, const char * file, int line);
	...
	APICALL OSSL_CRYPTO_ALLOC void * (*CRYPTO_secure_zalloc)(struct AmiSSLIFace *Self, size_t num, const char * file, int line);
	...
	APICALL OSSL_CRYPTO_ALLOC void * (*CRYPTO_zalloc)(struct AmiSSLIFace *Self, size_t num, const char * file, int line);
	APTR OPENSSL_atexit_UNIMPLEMENTED;
	...
	APTR ENGINE_get_default_EC_UNIMPLEMENTED;
	APTR ENGINE_get_EC_UNIMPLEMENTED;
	APTR ENGINE_register_all_EC_UNIMPLEMENTED;
	APTR ENGINE_register_EC_UNIMPLEMENTED;
	APTR ENGINE_set_default_EC_UNIMPLEMENTED;
	APTR ENGINE_set_EC_UNIMPLEMENTED;
	APTR ENGINE_unregister_EC_UNIMPLEMENTED;
	...
	APTR EVP_CIPHER_meth_dup_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_free_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_get_cleanup_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_get_ctrl_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_get_do_cipher_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_get_get_asn1_params_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_get_init_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_get_set_asn1_params_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_new_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_set_cleanup_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_set_ctrl_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_set_do_cipher_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_set_flags_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_set_get_asn1_params_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_set_impl_ctx_size_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_set_init_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_set_iv_length_UNIMPLEMENTED;
	APTR EVP_CIPHER_meth_set_set_asn1_params_UNIMPLEMENTED;
	...
	APTR EVP_MD_CTX_set_update_fn_UNIMPLEMENTED;
	APTR EVP_MD_CTX_update_fn_UNIMPLEMENTED;
	APTR EVP_MD_meth_dup_UNIMPLEMENTED;
	APTR EVP_MD_meth_free_UNIMPLEMENTED;
	APTR EVP_MD_meth_get_app_datasize_UNIMPLEMENTED;
	APTR EVP_MD_meth_get_cleanup_UNIMPLEMENTED;
	APTR EVP_MD_meth_get_copy_UNIMPLEMENTED;
	APTR EVP_MD_meth_get_ctrl_UNIMPLEMENTED;
	APTR EVP_MD_meth_get_final_UNIMPLEMENTED;
	APTR EVP_MD_meth_get_flags_UNIMPLEMENTED;
	APTR EVP_MD_meth_get_init_UNIMPLEMENTED;
	APTR EVP_MD_meth_get_input_blocksize_UNIMPLEMENTED;
	APTR EVP_MD_meth_get_result_size_UNIMPLEMENTED;
	APTR EVP_MD_meth_get_update_UNIMPLEMENTED;
	APTR EVP_MD_meth_new_UNIMPLEMENTED;
	APTR EVP_MD_meth_set_app_datasize_UNIMPLEMENTED;
	APTR EVP_MD_meth_set_cleanup_UNIMPLEMENTED;
	APTR EVP_MD_meth_set_copy_UNIMPLEMENTED;
	APTR EVP_MD_meth_set_ctrl_UNIMPLEMENTED;
	APTR EVP_MD_meth_set_final_UNIMPLEMENTED;
	APTR EVP_MD_meth_set_flags_UNIMPLEMENTED;
	APTR EVP_MD_meth_set_init_UNIMPLEMENTED;
	APTR EVP_MD_meth_set_input_blocksize_UNIMPLEMENTED;
	APTR EVP_MD_meth_set_result_size_UNIMPLEMENTED;
	APTR EVP_MD_meth_set_update_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_set_security_bits_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_get_cleanup_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_copy_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_ctrl_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_decrypt_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_derive_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_encrypt_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_init_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_keygen_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_paramgen_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_sign_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_signctx_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_verify_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_verify_recover_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_verifyctx_UNIMPLEMENTED;
	...
	APICALL const ASN1_TYPE * (*PKCS8_get_attr)(struct AmiSSLIFace *Self, PKCS8_PRIV_KEY_INFO * p8, int attr_nid);
	...
	APICALL const X509_NAME * (*X509_CRL_get_issuer)(struct AmiSSLIFace *Self, const X509_CRL * crl);
	...
	APICALL STACK_OF(X509_REVOKED) * (*X509_CRL_get_REVOKED)(struct AmiSSLIFace *Self, const X509_CRL * crl);
	...
	APICALL const STACK_OF(ASN1_OBJECT) * (*X509_get0_reject_objects)(struct AmiSSLIFace *Self, const X509 * x);
	APICALL const X509_ALGOR * (*X509_get0_tbs_sigalg)(struct AmiSSLIFace *Self, const X509 * x);
	APICALL const STACK_OF(ASN1_OBJECT) * (*X509_get0_trust_objects)(struct AmiSSLIFace *Self, const X509 * x);
	APICALL void (*X509_get0_uids)(struct AmiSSLIFace *Self, const X509 * x, const ASN1_BIT_STRING ** piuid, const ASN1_BIT_STRING ** psuid);
	APICALL ASN1_TIME * (*X509_getm_notAfter)(struct AmiSSLIFace *Self, X509 * x);
	APICALL ASN1_TIME * (*X509_getm_notBefore)(struct AmiSSLIFace *Self, X509 * x);
	...
	APICALL const X509_PUBKEY * (*X509_get_X509_PUBKEY)(struct AmiSSLIFace *Self, const X509 * x);
	...
	APICALL const X509_NAME * (*X509_REQ_get_subject_name)(struct AmiSSLIFace *Self, const X509_REQ * req);
	APICALL long (*X509_REQ_get_version)(struct AmiSSLIFace *Self, const X509_REQ * req);
	APICALL X509_PUBKEY * (*X509_REQ_get_X509_PUBKEY)(struct AmiSSLIFace *Self, const X509_REQ * req);
	...
	APICALL int (*X509v3_addr_add_inherit)(struct AmiSSLIFace *Self, IPAddrBlocks * addr, unsigned afi, const unsigned * safi);
	APICALL int (*X509v3_addr_add_prefix)(struct AmiSSLIFace *Self, IPAddrBlocks * addr, unsigned afi, const unsigned * safi, unsigned char * a, const int prefixlen);
	APICALL int (*X509v3_addr_add_range)(struct AmiSSLIFace *Self, IPAddrBlocks * addr, unsigned afi, const unsigned * safi, unsigned char * min, unsigned char * max);
	...
	APICALL int (*X509v3_addr_get_range)(struct AmiSSLIFace *Self, IPAddressOrRange * aor, const unsigned afi, unsigned char * min, unsigned char * max, int length);
	...
	APICALL int (*X509v3_addr_validate_resource_set)(struct AmiSSLIFace *Self, const STACK_OF(X509) * chain, IPAddrBlocks * ext, int allow_inheritance);
	...
	APICALL int (*X509v3_asid_validate_resource_set)(struct AmiSSLIFace *Self, const STACK_OF(X509) * chain, ASIdentifiers * ext, int allow_inheritance);
	APICALL const ASN1_OCTET_STRING * (*X509_get0_subject_key_id)(struct AmiSSLIFace *Self, const X509 * x);
	APICALL uint32_t (*X509_get_extended_key_usage)(struct AmiSSLIFace *Self, const X509 * x);
	APICALL uint32_t (*X509_get_extension_flags)(struct AmiSSLIFace *Self, const X509 * x);
	APICALL uint32_t (*X509_get_key_usage)(struct AmiSSLIFace *Self, const X509 * x);
	...
	APTR DSA_get0_engine_UNIMPLEMENTED;
	...
	APTR RSA_get0_engine_UNIMPLEMENTED;
	...
	APTR DH_get0_engine_UNIMPLEMENTED;
	...
	APICALL long (*X509_get_pathlen)(struct AmiSSLIFace *Self, const X509 * x);
	...
	APICALL int (*NAME_CONSTRAINTS_check_CN)(struct AmiSSLIFace *Self, const X509 * x, NAME_CONSTRAINTS * nc);
	...
	APICALL long (*X509_get_proxy_pathlen)(struct AmiSSLIFace *Self, const X509 * x);
	...
	APTR EVP_PKEY_set1_engine_UNIMPLEMENTED;
	...
	DEPRECATED APICALL const ASN1_TYPE * (*PKCS12_get_attr)(struct AmiSSLIFace *Self, const PKCS12_SAFEBAG * bag, int attr_nid);
	...
	APTR EC_KEY_get0_engine_UNIMPLEMENTED;
	...
	APICALL int (*X509_CRL_print_ex)(struct AmiSSLIFace *Self, BIO * out, const X509_CRL * x, unsigned long nmflag);
	...
	APICALL int (*X509_get_signature_info)(struct AmiSSLIFace *Self, const X509 * x, int * mdnid, int * pknid, int * secbits, uint32_t * flags);
	...
	APTR OSSL_STORE_LOADER_get0_engine_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_get0_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_count_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_check_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_check_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_remove_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_set_check_UNIMPLEMENTED;
	APTR EVP_PKEY_asn1_set_siginf_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_public_check_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_set_param_check_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_public_check_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_param_check_UNIMPLEMENTED;
	APTR EVP_PKEY_asn1_set_public_check_UNIMPLEMENTED;
	APTR EVP_PKEY_asn1_set_param_check_UNIMPLEMENTED;
	...
	APICALL int (*OCSP_resp_get0_signer)(struct AmiSSLIFace *Self, OCSP_BASICRESP * bs, X509 ** signer, const STACK_OF(X509) * extra_certs);
	...
	APICALL int (*OCSP_basic_sign_ctx)(struct AmiSSLIFace *Self, OCSP_BASICRESP * brsp, X509 * signer, EVP_MD_CTX * ctx, const STACK_OF(X509) * certs, unsigned long flags);
	...
	APICALL OSSL_STORE_SEARCH * (*OSSL_STORE_SEARCH_by_name)(struct AmiSSLIFace *Self, const X509_NAME * name);
	...
	APICALL OSSL_STORE_SEARCH * (*OSSL_STORE_SEARCH_by_issuer_serial)(struct AmiSSLIFace *Self, const X509_NAME * name, const ASN1_INTEGER * serial);
	APICALL const X509_NAME * (*OSSL_STORE_SEARCH_get0_name)(struct AmiSSLIFace *Self, const OSSL_STORE_SEARCH * criterion);
	APICALL const ASN1_OCTET_STRING * (*X509_get0_authority_key_id)(struct AmiSSLIFace *Self, const X509 * x);
	...
	APTR EVP_PKEY_asn1_set_set_priv_key_UNIMPLEMENTED;
	APTR EVP_PKEY_asn1_set_set_pub_key_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_asn1_set_get_priv_key_UNIMPLEMENTED;
	APTR EVP_PKEY_asn1_set_get_pub_key_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_meth_set_digest_custom_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_digest_custom_UNIMPLEMENTED;
	...
	APTR EVP_PKEY_get0_engine_UNIMPLEMENTED;
	APICALL const ASN1_INTEGER * (*X509_get0_authority_serial)(struct AmiSSLIFace *Self, const X509 * x);
	APICALL const GENERAL_NAMES * (*X509_get0_authority_issuer)(struct AmiSSLIFace *Self, const X509 * x);
	APTR EVP_PKEY_meth_set_digestsign_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_set_digestverify_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_digestverify_UNIMPLEMENTED;
	APTR EVP_PKEY_meth_get_digestsign_UNIMPLEMENTED;
	...
	APICALL const ASN1_OCTET_STRING * (*X509_get0_distinguishing_id)(struct AmiSSLIFace *Self, const X509 * x);
	...
	APICALL int (*X509_self_signed)(struct AmiSSLIFace *Self, const X509 * cert, int verify_signature);
	...
	APICALL int (*X509_add_cert)(struct AmiSSLIFace *Self, STACK_OF(X509) * sk, const X509 * cert, int flags);
	APICALL int (*X509_add_certs)(struct AmiSSLIFace *Self, STACK_OF(X509) * sk, const STACK_OF(X509) * certs, int flags);
	...
	APICALL STACK_OF(X509) * (*X509_build_chain)(struct AmiSSLIFace *Self, const X509 * target, STACK_OF(X509) * certs, X509_STORE * store, int with_self_signed, OSSL_LIB_CTX * libctx, const char * propq);
	...
	APICALL CMS_ContentInfo * (*CMS_sign_ex)(struct AmiSSLIFace *Self, X509 * signcert, EVP_PKEY * pkey, const STACK_OF(X509) * certs, BIO * data, unsigned int flags, OSSL_LIB_CTX * libctx, const char * propq);
	...
	APICALL CMS_ContentInfo * (*CMS_encrypt_ex)(struct AmiSSLIFace *Self, const STACK_OF(X509) * certs, BIO * in, const EVP_CIPHER * cipher, unsigned int flags, OSSL_LIB_CTX * libctx, const char * propq);
	...
	APICALL PKCS7 * (*PKCS7_sign_ex)(struct AmiSSLIFace *Self, X509 * signcert, EVP_PKEY * pkey, const STACK_OF(X509) * certs, BIO * data, int flags, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL PKCS7 * (*PKCS7_encrypt_ex)(struct AmiSSLIFace *Self, const STACK_OF(X509) * certs, BIO * in, const EVP_CIPHER * cipher, int flags, OSSL_LIB_CTX * libctx, const char * propq);
	...
	APICALL int (*OPENSSL_sk_find_all)(struct AmiSSLIFace *Self, const OPENSSL_STACK * st, const void * data, int * pnum);
	...
	APICALL BIO * (*CMS_SignedData_verify)(struct AmiSSLIFace *Self, CMS_SignedData * sd, BIO * detached_data, const STACK_OF(X509) * scerts, X509_STORE * store, const STACK_OF(X509) * extra, const STACK_OF(X509_CRL) * crls, unsigned int flags, OSSL_LIB_CTX * libctx, const char * propq);
	...
	APICALL OSSL_CRYPTO_ALLOC void * (*CRYPTO_aligned_alloc)(struct AmiSSLIFace *Self, size_t num, size_t align, void ** freeptr, const char * file, int line);
	...
	APICALL OSSL_CRYPTO_ALLOC void * (*CRYPTO_malloc_array)(struct AmiSSLIFace *Self, size_t num, size_t size, const char * file, int line);
	APICALL OSSL_CRYPTO_ALLOC void * (*CRYPTO_calloc)(struct AmiSSLIFace *Self, size_t num, size_t size, const char * file, int line);
	APICALL OSSL_CRYPTO_ALLOC void * (*CRYPTO_aligned_alloc_array)(struct AmiSSLIFace *Self, size_t num, size_t size, size_t align, void ** freeptr, const char * file, int line);
	...
	APICALL OSSL_CRYPTO_ALLOC void * (*CRYPTO_secure_malloc_array)(struct AmiSSLIFace *Self, size_t num, size_t size, const char * file, int line);
	APICALL OSSL_CRYPTO_ALLOC void * (*CRYPTO_secure_calloc)(struct AmiSSLIFace *Self, size_t num, size_t size, const char * file, int line);
	APICALL void (*SSL_CTX_get0_alpn_protos)(struct AmiSSLIFace *Self, SSL_CTX * ctx, const unsigned char ** protos, unsigned int * protos_len);
	APICALL void (*SSL_get0_alpn_protos)(struct AmiSSLIFace *Self, SSL * ssl, const unsigned char ** protos, unsigned int * protos_len);
	APICALL int (*SSL_set1_dnsname)(struct AmiSSLIFace *Self, SSL * s, const char * dnsname);
	APICALL int (*SSL_add1_dnsname)(struct AmiSSLIFace *Self, SSL * s, const char * dnsname);
	APICALL int (*SSL_set1_ipaddr)(struct AmiSSLIFace *Self, SSL * s, const char * ipaddr);
	APICALL int (*SSL_add1_ipaddr)(struct AmiSSLIFace *Self, SSL * s, const char * ipaddr);
	APICALL int (*SSL_get_peer_addr)(struct AmiSSLIFace *Self, SSL * ssl, BIO_ADDR * peer_addr);
	APICALL int (*SSL_CTX_is_quic)(struct AmiSSLIFace *Self, const SSL_CTX * c);
	APICALL int (*SSL_CTX_is_server)(struct AmiSSLIFace *Self, const SSL_CTX * c);
	APICALL const SSL_METHOD * (*OSSL_QUIC_method)(struct AmiSSLIFace *Self);
	APICALL int (*SSL_listen_ex)(struct AmiSSLIFace *Self, SSL * listener, SSL * new_conn);
	APICALL OSSL_ECHSTORE * (*OSSL_ECHSTORE_new)(struct AmiSSLIFace *Self, OSSL_LIB_CTX * libctx, const char * propq);
	APICALL void (*OSSL_ECHSTORE_free)(struct AmiSSLIFace *Self, OSSL_ECHSTORE * es);
	APICALL int (*OSSL_ECHSTORE_new_config_amiga)(struct AmiSSLIFace *Self, OSSL_ECHSTORE * es, uint16_t echversion, uint8_t max_name_length, const char * public_name, OSSL_HPKE_SUITE * suite);
	APICALL int (*OSSL_ECHSTORE_write_pem)(struct AmiSSLIFace *Self, OSSL_ECHSTORE * es, int index, BIO * out);
	APICALL int (*OSSL_ECHSTORE_read_echconfiglist)(struct AmiSSLIFace *Self, OSSL_ECHSTORE * es, BIO * in);
	APICALL int (*OSSL_ECHSTORE_get1_info)(struct AmiSSLIFace *Self, OSSL_ECHSTORE * es, int index, time_t * loaded_secs, char ** public_name, char ** echconfig, int * has_private, int * for_retry);
	APICALL int (*OSSL_ECHSTORE_downselect)(struct AmiSSLIFace *Self, OSSL_ECHSTORE * es, int index);
	APICALL int (*OSSL_ECHSTORE_set1_key_and_read_pem)(struct AmiSSLIFace *Self, OSSL_ECHSTORE * es, EVP_PKEY * priv, BIO * in, int for_retry);
	APICALL int (*OSSL_ECHSTORE_read_pem)(struct AmiSSLIFace *Self, OSSL_ECHSTORE * es, BIO * in, int for_retry);
	APICALL int (*OSSL_ECHSTORE_num_keys)(struct AmiSSLIFace *Self, OSSL_ECHSTORE * es, int * numkeys);
	APICALL int (*OSSL_ECHSTORE_flush_keys)(struct AmiSSLIFace *Self, OSSL_ECHSTORE * es, time_t age);
	APICALL int (*SSL_CTX_set1_echstore)(struct AmiSSLIFace *Self, SSL_CTX * ctx, OSSL_ECHSTORE * es);
	APICALL int (*SSL_set1_echstore)(struct AmiSSLIFace *Self, SSL * s, OSSL_ECHSTORE * es);
	APICALL OSSL_ECHSTORE * (*SSL_CTX_get1_echstore)(struct AmiSSLIFace *Self, const SSL_CTX * ctx);
	APICALL OSSL_ECHSTORE * (*SSL_get1_echstore)(struct AmiSSLIFace *Self, const SSL * s);
	APICALL int (*SSL_ech_get1_status)(struct AmiSSLIFace *Self, SSL * s, char ** inner_sni, char ** outer_sni);
	APICALL int (*SSL_ech_set_grease_type)(struct AmiSSLIFace *Self, SSL * s, uint16_t type);
	APICALL void (*SSL_ech_set_callback)(struct AmiSSLIFace *Self, SSL * s, SSL_ech_cb_func f);
	APICALL void (*SSL_CTX_ech_set_callback)(struct AmiSSLIFace *Self, SSL_CTX * ctx, SSL_ech_cb_func f);
	APICALL int (*OSSL_ECHSTORE_num_entries)(struct AmiSSLIFace *Self, const OSSL_ECHSTORE * es, int * numentries);
	APICALL int (*SSL_ech_set1_server_names)(struct AmiSSLIFace *Self, SSL * s, const char * inner_name, const char * outer_name, int no_outer);
	APICALL int (*SSL_ech_set1_outer_server_name)(struct AmiSSLIFace *Self, SSL * s, const char * outer_name, int no_outer);
	APICALL int (*SSL_ech_set1_outer_alpn_protos)(struct AmiSSLIFace *Self, SSL * s, const unsigned char * protos, const size_t protos_len);
	APICALL int (*SSL_ech_set1_grease_suite)(struct AmiSSLIFace *Self, SSL * s, const char * suite);
	APICALL int (*SSL_ech_get1_retry_config)(struct AmiSSLIFace *Self, SSL * s, unsigned char ** ec, size_t * eclen);
	APICALL int (*SSL_CTX_ech_set1_outer_alpn_protos)(struct AmiSSLIFace *Self, SSL_CTX * s, const unsigned char * protos, const size_t protos_len);
	APICALL int (*SSL_set1_ech_config_list)(struct AmiSSLIFace *Self, SSL * ssl, const uint8_t * ecl, size_t ecl_len);
	APICALL int (*SSL_get0_sigalg)(struct AmiSSLIFace *Self, SSL * s, int idx, unsigned int * codepoint, const char ** name);
	APICALL int (*SSL_get0_shared_sigalg)(struct AmiSSLIFace *Self, SSL * s, int idx, unsigned int * codepoint, const char ** name);
	APICALL int (*EC_GROUP_security_bits)(struct AmiSSLIFace *Self, const EC_GROUP * group);
	APICALL int (*ASN1_BIT_STRING_get_length)(struct AmiSSLIFace *Self, const ASN1_BIT_STRING * abs, size_t * length, int * unused_bits);
	APICALL long (*BIO_set_send_flags)(struct AmiSSLIFace *Self, BIO * b, int flags);
	APICALL int (*BIO_eof)(struct AmiSSLIFace *Self, BIO * b);
	APTR CRYPTO_atomic_store_int_UNIMPLEMENTED;
	APICALL int (*X509_check_certificate_times)(struct AmiSSLIFace *Self, const X509_VERIFY_PARAM * vpm, const X509 * x, int * error);
	APICALL void (*X509_VERIFY_PARAM_set1_host_input_validation)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param, int (*validate_host)(const char *name, size_t len));
	APICALL int (*X509_VERIFY_PARAM_set1_rfc822)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param, const char * email, size_t emaillen);
	APICALL int (*X509_VERIFY_PARAM_add1_rfc822)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param, const char * email, size_t len);
	APICALL void (*X509_VERIFY_PARAM_set1_rfc822_input_validation)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param, int (*validate_rfc822)(const char *name, size_t len));
	APICALL int (*X509_VERIFY_PARAM_set1_smtputf8)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param, const char * email, size_t emaillen);
	APICALL int (*X509_VERIFY_PARAM_add1_smtputf8)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param, const char * email, size_t len);
	APICALL void (*X509_VERIFY_PARAM_set1_smtputf8_input_validation)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param, int (*validate_smtputf8)(const char *name, size_t len));
	APICALL int (*X509_VERIFY_PARAM_add1_ip)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param, const uint8_t * ip, size_t len);
	APICALL int (*X509_VERIFY_PARAM_add1_ip_asc)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param, const char * ipasc);
	APICALL void (*X509_VERIFY_PARAM_set1_ip_input_validation)(struct AmiSSLIFace *Self, X509_VERIFY_PARAM * param, int (*validate_ip)(const uint8_t *name, size_t len));
	APICALL OSSL_STORE_INFO * (*OSSL_STORE_INFO_new_SKEY)(struct AmiSSLIFace *Self, EVP_SKEY * skey);
	APICALL EVP_SKEY * (*OSSL_STORE_INFO_get0_SKEY)(struct AmiSSLIFace *Self, const OSSL_STORE_INFO * info);
	APICALL EVP_SKEY * (*OSSL_STORE_INFO_get1_SKEY)(struct AmiSSLIFace *Self, const OSSL_STORE_INFO * info);
	APICALL int (*OPENSSL_posix_to_tm)(struct AmiSSLIFace *Self, int64_t time, struct tm * out_tm);
	APICALL int (*OPENSSL_tm_to_posix)(struct AmiSSLIFace *Self, const struct tm * tm, int64_t * out);
	APICALL int (*OPENSSL_timegm)(struct AmiSSLIFace *Self, const struct tm * tm, time_t * out);
	APICALL void (*OSSL_PARAM_clear_free)(struct AmiSSLIFace *Self, OSSL_PARAM * p);
	APICALL int (*CMS_dataFinal_ex)(struct AmiSSLIFace *Self, CMS_ContentInfo * cms, BIO * bio, BIO * data);
	APICALL int (*CMS_SignerInfo_verify_ex)(struct AmiSSLIFace *Self, CMS_SignerInfo * si, BIO * chain, BIO * data);
	APICALL int (*EVP_SIGNATURE_has_message_update)(struct AmiSSLIFace *Self, const EVP_SIGNATURE * sig);
	APICALL int (*EVP_MD_CTX_serialize)(struct AmiSSLIFace *Self, EVP_MD_CTX * ctx, unsigned char * out, size_t * outlen);
	APICALL int (*EVP_MD_CTX_deserialize)(struct AmiSSLIFace *Self, EVP_MD_CTX * ctx, const unsigned char * in, size_t inlen);
	APICALL int (*OSSL_ENCODER_CTX_ctrl_string)(struct AmiSSLIFace *Self, OSSL_ENCODER_CTX * ctx, const char * name, const char * val);
	APICALL OPENSSL_STACK * (*OPENSSL_sk_set_cmp_thunks)(struct AmiSSLIFace *Self, OPENSSL_STACK * st, int (*c_thunk)(int (*)(const void *, const void *), const void *, const void *));
	APICALL int (*ASN1_BIT_STRING_set1)(struct AmiSSLIFace *Self, ASN1_BIT_STRING * abs, const uint8_t * data, size_t length, int unused_bits);
	APICALL int (*OSSL_ESS_check_signing_certs_ex)(struct AmiSSLIFace *Self, const ESS_SIGNING_CERT * ss, const ESS_SIGNING_CERT_V2 * ssv2, const STACK_OF(X509) * chain, OSSL_LIB_CTX * libctx, const char * propq, int require_signing_cert);
	APICALL X509_EXTENSION * (*X509v3_delete_extension)(struct AmiSSLIFace *Self, STACK_OF(X509_EXTENSION) ** x, int loc);
};
