...
/*
** This file was machine generated by idltool 53.8.
** Do not edit
*/ 
...
struct AmiSSLIFace
{
	...
	void (*)(int mode, int type, const char *file, int line) APICALL (*CRYPTO_get_locking_callback)(struct AmiSSLIFace *Self);
	...
	int (*)(int *num, int mount, int type, const char *file, int line) APICALL (*CRYPTO_get_add_lock_callback)(struct AmiSSLIFace *Self);
	void APICALL (*CRYPTO_set_id_callback)(struct AmiSSLIFace *Self, unsigned long (*func)(void));
	unsigned long (*)(void) APICALL (*CRYPTO_get_id_callback)(struct AmiSSLIFace *Self);
	...
	struct CRYPTO_dynlock_value * (*)(const char *file, int line) APICALL (*CRYPTO_get_dynlock_create_callback)(struct AmiSSLIFace *Self);
	void (*)(int mode, struct CRYPTO_dynlock_value *l, const char *file, int line) APICALL (*CRYPTO_get_dynlock_lock_callback)(struct AmiSSLIFace *Self);
	void (*)(struct CRYPTO_dynlock_value *l, const char *file, int line) APICALL (*CRYPTO_get_dynlock_destroy_callback)(struct AmiSSLIFace *Self);
	...
	int APICALL (*PEM_write)(struct AmiSSLIFace *Self, FILE * fp, char * name, char * hdr, unsigned char * data, long len);
	...
	int (*)(int, X509_STORE_CTX *) APICALL (*SSL_get_verify_callback)(struct AmiSSLIFace *Self, const SSL * s);
	...
	int (*)(int, X509_STORE_CTX *) APICALL (*SSL_CTX_get_verify_callback)(struct AmiSSLIFace *Self, const SSL_CTX * ctx);
	...
	void (*)(const SSL *ssl, int type, int val) APICALL (*SSL_get_info_callback)(struct AmiSSLIFace *Self, const SSL * ssl);
	...
	int (*)(const void *, const void *) APICALL (*sk_set_cmp_func)(struct AmiSSLIFace *Self, _STACK * sk, int (*c)(const void *, const void *));
	...
	int (*)(UI *) APICALL (*UI_method_get_opener)(struct AmiSSLIFace *Self, UI_METHOD * method);
	int (*)(UI *, UI_STRING *) APICALL (*UI_method_get_writer)(struct AmiSSLIFace *Self, UI_METHOD * method);
	int (*)(UI *) APICALL (*UI_method_get_flusher)(struct AmiSSLIFace *Self, UI_METHOD * method);
	int (*)(UI *, UI_STRING *) APICALL (*UI_method_get_reader)(struct AmiSSLIFace *Self, UI_METHOD * method);
	int (*)(UI *) APICALL (*UI_method_get_closer)(struct AmiSSLIFace *Self, UI_METHOD * method);
	...
	int (*)(int, X509 *, int) APICALL (*X509_TRUST_set_default)(struct AmiSSLIFace *Self, int (*trust)(int, X509 *, int));
	...
	OCSP_REQ_CTX * APICALL (*OCSP_sendreq_new)(struct AmiSSLIFace *Self, BIO * io, char * path, OCSP_REQUEST * req, int maxline);
	...
	SSL_SESSION *(*)(struct ssl_st *ssl, unsigned char *Data, int len, int *copy) APICALL (*SSL_CTX_sess_get_get_cb)(struct AmiSSLIFace *Self, SSL_CTX * ctx);
	...
	void (*)(const SSL *ssl,int type,int val) APICALL (*SSL_CTX_get_info_callback)(struct AmiSSLIFace *Self, SSL_CTX * ctx);
	...
	int (*)(struct ssl_st *ssl, SSL_SESSION *sess) APICALL (*SSL_CTX_sess_get_new_cb)(struct AmiSSLIFace *Self, SSL_CTX * ctx);
	int (*)(SSL *ssl, X509 **x509, EVP_PKEY **pkey) APICALL (*SSL_CTX_get_client_cert_cb)(struct AmiSSLIFace *Self, SSL_CTX * ctx);
	void (*)(struct ssl_ctx_st *ctx, SSL_SESSION *sess) APICALL (*SSL_CTX_sess_get_remove_cb)(struct AmiSSLIFace *Self, SSL_CTX * ctx);
	...
	long (*)(struct bio_st *,int,const char *,int, long,long) APICALL (*BIO_get_callback)(struct AmiSSLIFace *Self, const BIO * b);
	...
	int APICALL (*EVP_DigestVerifyFinal)(struct AmiSSLIFace *Self, EVP_MD_CTX * ctx, unsigned char * sig, size_t siglen);
	...
	void (*)(CRYPTO_THREADID *) APICALL (*CRYPTO_THREADID_get_callback)(struct AmiSSLIFace *Self);
	...
	int (*)(EVP_PKEY_CTX *ctx) APICALL (*EVP_PKEY_CTX_get_cb)(struct AmiSSLIFace *Self, EVP_PKEY_CTX * ctx);
	...
	char *(*)(UI*, const char*, const char*) APICALL (*UI_method_get_prompt_constructor)(struct AmiSSLIFace *Self, UI_METHOD * method);
