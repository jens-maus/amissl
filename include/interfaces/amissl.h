...
struct AmiSSLIFace
{
	...
	STACK * APICALL (*d2i_ASN1_SET)(struct AmiSSLIFace *Self, STACK ** a, const unsigned char ** pp, long length, d2i_of_void * d2i, void (*free_func)(void *), int ex_tag, int ex_class);
	...
	ASN1_HEADER * APICALL (*d2i_ASN1_HEADER)(struct AmiSSLIFace *Self, ASN1_HEADER ** a, const unsigned char ** pp, long length);
	...
	STACK * APICALL (*ASN1_seq_unpack)(struct AmiSSLIFace *Self, const unsigned char * buf, int len, d2i_of_void * d2i, void (*free_func)(void *));
	...
	void * APICALL (*lh_insert)(struct AmiSSLIFace *Self, LHASH * lh, void * data);
	...
	int APICALL (*PEM_ASN1_write_bio)(struct AmiSSLIFace *Self, int (*i2d)(), const char * name, BIO * bp, char * x, const EVP_CIPHER * enc, unsigned char * kstr, int klen, pem_password_cb * cb, void * u);
	...
	MS_TM * APICALL (*ms_time_new)(struct AmiSSLIFace *Self);
	void APICALL (*ms_time_free)(struct AmiSSLIFace *Self, MS_TM * a);
	void APICALL (*ms_time_get)(struct AmiSSLIFace *Self, MS_TM * a);
	double APICALL (*ms_time_diff)(struct AmiSSLIFace *Self, MS_TM * start, MS_TM * end);
	int APICALL (*ms_time_cmp)(struct AmiSSLIFace *Self, MS_TM * ap, MS_TM * bp);
	...
	void APICALL (*CRYPTO_malloc_debug_init)(struct AmiSSLIFace *Self);
	...
	STACK * APICALL (*X509_get1_ocsp)(struct AmiSSLIFace *Self, X509 * x);
	...
	SSL_METHOD * APICALL (*DTLSv1_server_method)(struct AmiSSLIFace *Self);
	...
	SSL_METHOD * APICALL (*DTLSv1_client_method)(struct AmiSSLIFace *Self);
