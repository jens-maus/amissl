...
struct AmiSSLIFace
{
	...
	APICALL int (*(*BIO_meth_get_sendmmsg)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *, BIO_MSG *, size_t, size_t, uint64_t, size_t *);
	...
	APICALL int (*(*BIO_meth_get_recvmmsg)(struct AmiSSLIFace *Self, const BIO_METHOD * biom))(BIO *, BIO_MSG *, size_t, size_t, uint64_t, size_t *);
