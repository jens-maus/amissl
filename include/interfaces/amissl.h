...
struct AmiSSLIFace
{
	...
	APICALL int (*ASN1_OCTET_STRING_set)(struct AmiSSLIFace *Self, ASN1_OCTET_STRING * str, const void * data, int len);
	...
	APICALL void (*OBSOLETE_OPENSSL_no_config)(struct AmiSSLIFace *Self);
	...
	APICALL void (*OBSOLETE_ERR_load_crypto_strings)(struct AmiSSLIFace *Self);
	...
	APICALL void (*OBSOLETE_OPENSSL_add_all_algorithms_noconf)(struct AmiSSLIFace *Self);
	APICALL void (*OBSOLETE_OPENSSL_add_all_algorithms_conf)(struct AmiSSLIFace *Self);
	APICALL void (*OBSOLETE_OpenSSL_add_all_ciphers)(struct AmiSSLIFace *Self);
	APICALL void (*OBSOLETE_OpenSSL_add_all_digests)(struct AmiSSLIFace *Self);
	...
	APICALL int (*MD2_Init)(struct AmiSSLIFace *Self, MD2_CTX * c);
	...
	APICALL RSA * (*RSAPublicKey_dup)(struct AmiSSLIFace *Self, const RSA * rsa);
	APICALL RSA * (*RSAPrivateKey_dup)(struct AmiSSLIFace *Self, const RSA * rsa);
	...
	APICALL OSSL_HTTP_REQ_CTX * (*OCSP_sendreq_new)(struct AmiSSLIFace *Self, BIO * io, const char * path, OCSP_REQUEST * req, int maxline);
	...
	APICALL EC_KEY * (*d2i_EC_PUBKEY)(struct AmiSSLIFace *Self, EC_KEY ** a, const unsigned char ** pp, long length);
	...
	APICALL void (*CMS_ContentInfo_print_ctx)(struct AmiSSLIFace *Self, BIO * out, const CMS_ContentInfo * x, int indent, const ASN1_PCTX * pctx);
	...
	APICALL DSA * (*DSAparams_dup)(struct AmiSSLIFace *Self, const DSA * x);
	APICALL DH * (*DHparams_dup)(struct AmiSSLIFace *Self, const DH * d);
	...
	APICALL void (*PKCS7_print_ctx)(struct AmiSSLIFace *Self, BIO * out, const PKCS7 * x, int indent, const ASN1_PCTX * pctx);
	...
	APICALL STACK_OF(X509) * (*TS_VERIFY_CTX_set_certs)(struct AmiSSLIFace *Self, TS_VERIFY_CTX * ctx, STACK_OF(X509) * certs);
	...
	APICALL int (*SRP_VBASE_add0_user)(struct AmiSSLIFace *Self, SRP_VBASE * vb, SRP_user_pwd * user_pwd);
	APICALL SRP_user_pwd * (*SRP_user_pwd_new)(struct AmiSSLIFace *Self);
	APICALL void (*SRP_user_pwd_set_gN)(struct AmiSSLIFace *Self, SRP_user_pwd * user_pwd, const BIGNUM * g, const BIGNUM * N);
	APICALL int (*SRP_user_pwd_set1_ids)(struct AmiSSLIFace *Self, SRP_user_pwd * user_pwd, const char * id, const char * info);
	APICALL int (*SRP_user_pwd_set0_sv)(struct AmiSSLIFace *Self, SRP_user_pwd * user_pwd, BIGNUM * s, BIGNUM * v);
	...
	APICALL STACK_OF(X509) * (*X509_STORE_get1_all_certs)(struct AmiSSLIFace *Self, X509_STORE * st);
	...
	APICALL int (*EVP_PKEY_CTX_get0_ecdh_kdf_ukm)(struct AmiSSLIFace *Self, EVP_PKEY_CTX * ctx, unsigned char ** ukm);
	...
	APICALL int (*EVP_PKEY_CTX_set_rsa_keygen_pubexp)(struct AmiSSLIFace *Self, EVP_PKEY_CTX * ctx, BIGNUM * pubexp);
	...
	APICALL int (*OSSL_STORE_LOADER_set_attach)(struct AmiSSLIFace *Self, OSSL_STORE_LOADER * loader, OSSL_STORE_attach_fn attach_function);
	...
	APICALL EC_KEY * (*EC_KEY_new_ex)(struct AmiSSLIFace *Self, OSSL_LIB_CTX * ctx, const char * propq);
	APICALL EC_KEY * (*EC_KEY_new_by_curve_name_ex)(struct AmiSSLIFace *Self, OSSL_LIB_CTX * ctx, const char * propq, int nid);
	...
	APICALL CMS_ContentInfo * (*CMS_sign_ex)(struct AmiSSLIFace *Self, X509 * signcert, EVP_PKEY * pkey, STACK_OF(X509) * certs, BIO * data, unsigned int flags, OSSL_LIB_CTX * ctx, const char * propq);
	...
	APICALL CMS_ContentInfo * (*CMS_encrypt_ex)(struct AmiSSLIFace *Self, STACK_OF(X509) * certs, BIO * in, const EVP_CIPHER * cipher, unsigned int flags, OSSL_LIB_CTX * ctx, const char * propq);
	...
	APICALL CMS_ReceiptRequest * (*CMS_ReceiptRequest_create0_ex)(struct AmiSSLIFace *Self, unsigned char * id, int idlen, int allorfirst, STACK_OF(GENERAL_NAMES) * receiptList, STACK_OF(GENERAL_NAMES) * receiptsTo, OSSL_LIB_CTX * ctx);
	...
	APICALL int (*EVP_PKEY_CTX_get0_dh_kdf_ukm)(struct AmiSSLIFace *Self, EVP_PKEY_CTX * ctx, unsigned char ** ukm);
	...
	APICALL int (*OSSL_STORE_LOADER_set_open_ex)(struct AmiSSLIFace *Self, OSSL_STORE_LOADER * loader, OSSL_STORE_open_ex_fn open_ex_function);
