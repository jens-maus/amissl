...
#define ERR_remove_thread_state() IAmiSSL->ERR_remove_thread_state()
...
#define sk_deep_copy(sk, copy_func, free_func) IAmiSSL->sk_deep_copy((sk), (copy_func), (free_func))
...
#define X509_STORE_set_lookup_crls_cb(ctx, cb) IAmiSSL->X509_STORE_set_lookup_crls_cb((ctx), (cb))
...
#define SSL_COMP_free_compression_methods() IAmiSSL->SSL_COMP_free_compression_methods()
...
#define ASN1_buf_print(bp, buf, buflen, indent) IAmiSSL->ASN1_buf_print((bp), (buf), (buflen), (indent))
...
#define ECDSA_SIG_get0(pr, ps, sig) IAmiSSL->ECDSA_SIG_get0((pr), (ps), (sig))
...
#define lh_error(lh) IAmiSSL->lh_error((lh))
#define lh_get_down_load(lh) IAmiSSL->lh_get_down_load((lh))
#define lh_set_down_load(lh, down_load) IAmiSSL->lh_set_down_load((lh), (down_load))
...
#define v3_addr_add_inherit(addr, afi, safi) IAmiSSL->v3_addr_add_inherit((addr), (afi), (safi))
#define v3_addr_add_prefix(addr, afi, safi, a, prefixlen) IAmiSSL->v3_addr_add_prefix((addr), (afi), (safi), (a), (prefixlen))
#define v3_addr_add_range(addr, afi, safi, min, max) IAmiSSL->v3_addr_add_range((addr), (afi), (safi), (min), (max))
#define v3_addr_canonize(addr) IAmiSSL->v3_addr_canonize((addr))
#define v3_addr_get_afi(f) IAmiSSL->v3_addr_get_afi((f))
#define v3_addr_get_range(aor, afi, min, max, length) IAmiSSL->v3_addr_get_range((aor), (afi), (min), (max), (length))
#define v3_addr_inherits(addr) IAmiSSL->v3_addr_inherits((addr))
#define v3_addr_is_canonical(addr) IAmiSSL->v3_addr_is_canonical((addr))
#define v3_addr_subset(a, b) IAmiSSL->v3_addr_subset((a), (b))
#define v3_addr_validate_path(ctx) IAmiSSL->v3_addr_validate_path((ctx))
#define v3_asid_add_id_or_range(asid, which, min, max) IAmiSSL->v3_asid_add_id_or_range((asid), (which), (min), (max))
#define v3_asid_add_inherit(asid, which) IAmiSSL->v3_asid_add_inherit((asid), (which))
#define v3_asid_canonize(asid) IAmiSSL->v3_asid_canonize((asid))
#define v3_asid_inherits(asid) IAmiSSL->v3_asid_inherits((asid))
#define v3_asid_is_canonical(asid) IAmiSSL->v3_asid_is_canonical((asid))
#define v3_asid_subset(a, b) IAmiSSL->v3_asid_subset((a), (b))
#define v3_asid_validate_path(ctx) IAmiSSL->v3_asid_validate_path((ctx))
...
#define SSL_set_rbio(s, rbio) IAmiSSL->SSL_set_rbio((s), (rbio))
...
#define SSL_set_wbio(s, wbio) IAmiSSL->SSL_set_wbio((s), (wbio))
...
#define CT_verify_no_bad_scts(ctx, scts, arg) IAmiSSL->CT_verify_no_bad_scts((ctx), (scts), (arg))
#define CT_verify_at_least_one_good_sct(ctx, scts, arg) IAmiSSL->CT_verify_at_least_one_good_sct((ctx), (scts), (arg))
...
#define CTLOG_new_from_base64(pkey_base64, name) IAmiSSL->CTLOG_new_from_base64((pkey_base64), (name))
...
#define DSA_SIG_get0(pr, ps, sig) IAmiSSL->DSA_SIG_get0((pr), (ps), (sig))
...
#define SSL_get_ct_validation_callback(s) IAmiSSL->SSL_get_ct_validation_callback((s))
#define SSL_CTX_get_ct_validation_callback(ctx) IAmiSSL->SSL_CTX_get_ct_validation_callback((ctx))
