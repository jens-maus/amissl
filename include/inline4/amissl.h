...
#define err_free_strings_int() IAmiSSL->err_free_strings_int()
...
#define X509_STORE_get_X509_by_subject(vs, type, name) IAmiSSL->X509_STORE_get_X509_by_subject((vs), (type), (name))
