...
#define PEM_ASN1_read(d2i, name, fp, x, cb, u) IAmiSSL->PEM_ASN1_read((d2i), (name), (fp), (x), (cb), (u)) 
#define PEM_ASN1_read_bio(d2i, name, bp, x, cb, u) IAmiSSL->PEM_ASN1_read_bio((d2i), (name), (bp), (x), (cb), (u)) 
#define PEM_ASN1_write(i2d, name, fp, x, enc, kstr, klen, callback, u) IAmiSSL->PEM_ASN1_write((i2d), (name), (fp), (x), (enc), (kstr), (klen), (callback), (u)) 
#define PEM_ASN1_write_bio(i2d, name, bp, x, enc, kstr, klen, cb, u) IAmiSSL->PEM_ASN1_write_bio((i2d), (name), (bp), (x), (enc), (kstr), (klen), (cb), (u)) 
#define PEM_X509_INFO_read(fp, sk, cb, u) IAmiSSL->PEM_X509_INFO_read((fp), (sk), (cb), (u)) 
...
#define PEM_read(fp, name, header, data, len) IAmiSSL->PEM_read((fp), (name), (header), (data), (len)) 
...
#define PEM_write(fp, name, hdr, data, len) IAmiSSL->PEM_write((fp), (name), (hdr), (data), (len)) 
...
#define SSL_SESSION_print_fp(fp, ses) IAmiSSL->SSL_SESSION_print_fp((fp), (ses)) 
...
#define ASN1_d2i_fp(xnew, d2i, in, x) IAmiSSL->ASN1_d2i_fp((xnew), (d2i), (in), (x)) 
#define ASN1_i2d_fp(i2d, out, x) IAmiSSL->ASN1_i2d_fp((i2d), (out), (x)) 
#define BIO_new_fp(stream, close_flag) IAmiSSL->BIO_new_fp((stream), (close_flag)) 
#define BN_print_fp(fp, a) IAmiSSL->BN_print_fp((fp), (a)) 
#define CRYPTO_mem_leaks_fp(fp) IAmiSSL->CRYPTO_mem_leaks_fp((fp)) 
#define DHparams_print_fp(fp, x) IAmiSSL->DHparams_print_fp((fp), (x)) 
#define DSA_print_fp(bp, x, off) IAmiSSL->DSA_print_fp((bp), (x), (off)) 
#define DSAparams_print_fp(fp, x) IAmiSSL->DSAparams_print_fp((fp), (x)) 
#define ERR_print_errors_fp(fp) IAmiSSL->ERR_print_errors_fp((fp)) 
#define PEM_read_DHparams(fp, x, cb, u) IAmiSSL->PEM_read_DHparams((fp), (x), (cb), (u)) 
#define PEM_read_DSAPrivateKey(fp, x, cb, u) IAmiSSL->PEM_read_DSAPrivateKey((fp), (x), (cb), (u)) 
#define PEM_read_DSAparams(fp, x, cb, u) IAmiSSL->PEM_read_DSAparams((fp), (x), (cb), (u)) 
#define PEM_write_DHparams(fp, x) IAmiSSL->PEM_write_DHparams((fp), (x)) 
#define PEM_write_DSAPrivateKey(fp, x, enc, kstr, klen, cb, u) IAmiSSL->PEM_write_DSAPrivateKey((fp), (x), (enc), (kstr), (klen), (cb), (u)) 
#define PEM_write_DSAparams(fp, x) IAmiSSL->PEM_write_DSAparams((fp), (x)) 
#define RSA_print_fp(fp, r, offset) IAmiSSL->RSA_print_fp((fp), (r), (offset)) 
#define X509_REQ_print_fp(bp, req) IAmiSSL->X509_REQ_print_fp((bp), (req)) 
#define X509_print_fp(bp, x) IAmiSSL->X509_print_fp((bp), (x)) 
#define d2i_DSAPrivateKey_fp(fp, dsa) IAmiSSL->d2i_DSAPrivateKey_fp((fp), (dsa)) 
#define d2i_PKCS7_fp(fp, p7) IAmiSSL->d2i_PKCS7_fp((fp), (p7)) 
#define d2i_RSAPrivateKey_fp(fp, rsa) IAmiSSL->d2i_RSAPrivateKey_fp((fp), (rsa)) 
#define d2i_X509_CRL_fp(fp, crl) IAmiSSL->d2i_X509_CRL_fp((fp), (crl)) 
#define d2i_X509_REQ_fp(fp, req) IAmiSSL->d2i_X509_REQ_fp((fp), (req)) 
#define d2i_X509_fp(fp, x509) IAmiSSL->d2i_X509_fp((fp), (x509)) 
#define DES_options() IAmiSSL->DES_options() 
#define i2d_DSAPrivateKey_fp(fp, dsa) IAmiSSL->i2d_DSAPrivateKey_fp((fp), (dsa)) 
#define i2d_PKCS7_fp(fp, p7) IAmiSSL->i2d_PKCS7_fp((fp), (p7)) 
#define i2d_RSAPrivateKey_fp(fp, rsa) IAmiSSL->i2d_RSAPrivateKey_fp((fp), (rsa)) 
#define i2d_X509_CRL_fp(fp, crl) IAmiSSL->i2d_X509_CRL_fp((fp), (crl)) 
#define i2d_X509_REQ_fp(fp, req) IAmiSSL->i2d_X509_REQ_fp((fp), (req)) 
#define i2d_X509_fp(fp, x509) IAmiSSL->i2d_X509_fp((fp), (x509)) 
#define lh_node_stats(lh, out) IAmiSSL->lh_node_stats((lh), (out)) 
#define lh_node_usage_stats(lh, out) IAmiSSL->lh_node_usage_stats((lh), (out)) 
#define lh_stats(lh, out) IAmiSSL->lh_stats((lh), (out)) 
#define d2i_RSAPublicKey_fp(fp, rsa) IAmiSSL->d2i_RSAPublicKey_fp((fp), (rsa)) 
#define i2d_RSAPublicKey_fp(fp, rsa) IAmiSSL->i2d_RSAPublicKey_fp((fp), (rsa)) 
#define X509_CRL_print_fp(fp, x) IAmiSSL->X509_CRL_print_fp((fp), (x)) 
#define i2d_PKCS8_fp(fp, p8) IAmiSSL->i2d_PKCS8_fp((fp), (p8)) 
#define d2i_PKCS8_PRIV_KEY_INFO_fp(fp, p8inf) IAmiSSL->d2i_PKCS8_PRIV_KEY_INFO_fp((fp), (p8inf)) 
#define d2i_PKCS8_fp(fp, p8) IAmiSSL->d2i_PKCS8_fp((fp), (p8)) 
#define i2d_PKCS8_PRIV_KEY_INFO_fp(fp, p8inf) IAmiSSL->i2d_PKCS8_PRIV_KEY_INFO_fp((fp), (p8inf)) 
#define CONF_load_fp(conf, fp, eline) IAmiSSL->CONF_load_fp((conf), (fp), (eline)) 
#define d2i_RSA_PUBKEY_fp(fp, rsa) IAmiSSL->d2i_RSA_PUBKEY_fp((fp), (rsa)) 
#define i2d_DSA_PUBKEY_fp(fp, dsa) IAmiSSL->i2d_DSA_PUBKEY_fp((fp), (dsa)) 
#define PEM_read_DSA_PUBKEY(fp, x, cb, u) IAmiSSL->PEM_read_DSA_PUBKEY((fp), (x), (cb), (u)) 
#define d2i_DSA_PUBKEY_fp(fp, dsa) IAmiSSL->d2i_DSA_PUBKEY_fp((fp), (dsa)) 
#define PEM_write_DSA_PUBKEY(fp, x) IAmiSSL->PEM_write_DSA_PUBKEY((fp), (x)) 
#define i2d_RSA_PUBKEY_fp(fp, rsa) IAmiSSL->i2d_RSA_PUBKEY_fp((fp), (rsa)) 
#define i2d_PKCS8PrivateKeyInfo_fp(fp, key) IAmiSSL->i2d_PKCS8PrivateKeyInfo_fp((fp), (key)) 
#define i2d_PrivateKey_fp(fp, pkey) IAmiSSL->i2d_PrivateKey_fp((fp), (pkey)) 
#define d2i_PrivateKey_fp(fp, a) IAmiSSL->d2i_PrivateKey_fp((fp), (a)) 
#define NCONF_load_fp(conf, fp, eline) IAmiSSL->NCONF_load_fp((conf), (fp), (eline)) 
#define X509_NAME_print_ex_fp(fp, nm, indent, flags) IAmiSSL->X509_NAME_print_ex_fp((fp), (nm), (indent), (flags)) 
#define ASN1_STRING_print_ex_fp(fp, str, flags) IAmiSSL->ASN1_STRING_print_ex_fp((fp), (str), (flags)) 
#define i2d_PUBKEY_fp(fp, pkey) IAmiSSL->i2d_PUBKEY_fp((fp), (pkey)) 
#define d2i_PUBKEY_fp(fp, a) IAmiSSL->d2i_PUBKEY_fp((fp), (a)) 
...
#define ASN1_item_d2i_fp(it, in, x) IAmiSSL->ASN1_item_d2i_fp((it), (in), (x)) 
...
#define X509_print_ex_fp(bp, x, nmflag, cflag) IAmiSSL->X509_print_ex_fp((bp), (x), (nmflag), (cflag)) 
...
#define ASN1_item_i2d_fp(it, out, x) IAmiSSL->ASN1_item_i2d_fp((it), (out), (x)) 
...
#define BIO_dump_fp(fp, s, len) IAmiSSL->BIO_dump_fp((fp), (s), (len)) 
...
#define EC_KEY_print_fp(fp, key, off) IAmiSSL->EC_KEY_print_fp((fp), (key), (off)) 
...
#define ECPKParameters_print_fp(fp, x, off) IAmiSSL->ECPKParameters_print_fp((fp), (x), (off)) 
...
#define BIO_dump_indent_fp(fp, s, len, indent) IAmiSSL->BIO_dump_indent_fp((fp), (s), (len), (indent)) 
...
#define PEM_write_EC_PUBKEY(fp, x) IAmiSSL->PEM_write_EC_PUBKEY((fp), (x)) 
...
#define PEM_read_EC_PUBKEY(fp, x, cb, u) IAmiSSL->PEM_read_EC_PUBKEY((fp), (x), (cb), (u)) 
...
#define PEM_read_ECPrivateKey(fp, x, cb, u) IAmiSSL->PEM_read_ECPrivateKey((fp), (x), (cb), (u)) 
...
#define PEM_write_ECPKParameters(fp, x) IAmiSSL->PEM_write_ECPKParameters((fp), (x)) 
#define ENGINE_register_all_ECDH() IAmiSSL->ENGINE_register_all_ECDH() 
#define i2d_ECPrivateKey_fp(fp, eckey) IAmiSSL->i2d_ECPrivateKey_fp((fp), (eckey)) 
...
#define d2i_ECPrivateKey_fp(fp, eckey) IAmiSSL->d2i_ECPrivateKey_fp((fp), (eckey)) 
#define SHA512_Transform(c, data) IAmiSSL->SHA512_Transform((c), (data)) 
#define PEM_write_ECPrivateKey(fp, x, enc, kstr, klen, cb, u) IAmiSSL->PEM_write_ECPrivateKey((fp), (x), (enc), (kstr), (klen), (cb), (u)) 
#define EC_KEY_set_public_key(key, pub) IAmiSSL->EC_KEY_set_public_key((key), (pub)) 
#define PEM_read_ECPKParameters(fp, x, cb, u) IAmiSSL->PEM_read_ECPKParameters((fp), (x), (cb), (u)) 
#define ENGINE_register_STORE(e) IAmiSSL->ENGINE_register_STORE((e)) 
#define ECParameters_print_fp(fp, key) IAmiSSL->ECParameters_print_fp((fp), (key)) 
#define EC_GROUP_get_curve_name(group) IAmiSSL->EC_GROUP_get_curve_name((group)) 
#define i2d_EC_PUBKEY_fp(fp, eckey) IAmiSSL->i2d_EC_PUBKEY_fp((fp), (eckey)) 
...
#define d2i_EC_PUBKEY_fp(fp, eckey) IAmiSSL->d2i_EC_PUBKEY_fp((fp), (eckey)) 
...
#define PEM_write_CMS(fp, x) IAmiSSL->PEM_write_CMS((fp), (x)) 
...
#define PEM_read_CMS(fp, x, cb, u) IAmiSSL->PEM_read_CMS((fp), (x), (cb), (u)) 
...
#define PEM_read_SSL_SESSION(fp, x, cb, u) IAmiSSL->PEM_read_SSL_SESSION((fp), (x), (cb), (u)) 
#define PEM_read_bio_SSL_SESSION(bp, x, cb, u) IAmiSSL->PEM_read_bio_SSL_SESSION((bp), (x), (cb), (u)) 
#define PEM_write_SSL_SESSION(fp, x) IAmiSSL->PEM_write_SSL_SESSION((fp), (x)) 
#define PEM_read_PKCS7(fp, x, cb, u) IAmiSSL->PEM_read_PKCS7((fp), (x), (cb), (u)) 
#define PEM_read_PrivateKey(fp, x, cb, u) IAmiSSL->PEM_read_PrivateKey((fp), (x), (cb), (u)) 
#define PEM_read_RSAPrivateKey(fp, x, cb, u) IAmiSSL->PEM_read_RSAPrivateKey((fp), (x), (cb), (u)) 
#define PEM_read_X509(fp, x, cb, u) IAmiSSL->PEM_read_X509((fp), (x), (cb), (u)) 
#define PEM_read_X509_CRL(fp, x, cb, u) IAmiSSL->PEM_read_X509_CRL((fp), (x), (cb), (u)) 
#define PEM_read_X509_REQ(fp, x, cb, u) IAmiSSL->PEM_read_X509_REQ((fp), (x), (cb), (u)) 
#define PEM_write_PKCS7(fp, x) IAmiSSL->PEM_write_PKCS7((fp), (x)) 
#define PEM_write_PrivateKey(fp, x, enc, kstr, klen, cb, u) IAmiSSL->PEM_write_PrivateKey((fp), (x), (enc), (kstr), (klen), (cb), (u)) 
#define PEM_write_RSAPrivateKey(fp, x, enc, kstr, klen, cb, u) IAmiSSL->PEM_write_RSAPrivateKey((fp), (x), (enc), (kstr), (klen), (cb), (u)) 
#define PEM_write_X509(fp, x) IAmiSSL->PEM_write_X509((fp), (x)) 
#define PEM_write_X509_CRL(fp, x) IAmiSSL->PEM_write_X509_CRL((fp), (x)) 
#define PEM_write_X509_REQ(fp, x) IAmiSSL->PEM_write_X509_REQ((fp), (x)) 
#define PEM_read_RSAPublicKey(fp, x, cb, u) IAmiSSL->PEM_read_RSAPublicKey((fp), (x), (cb), (u)) 
#define PEM_write_RSAPublicKey(fp, x) IAmiSSL->PEM_write_RSAPublicKey((fp), (x)) 
#define PEM_read_NETSCAPE_CERT_SEQUENCE(fp, x, cb, u) IAmiSSL->PEM_read_NETSCAPE_CERT_SEQUENCE((fp), (x), (cb), (u)) 
#define PEM_write_NETSCAPE_CERT_SEQUENCE(fp, x) IAmiSSL->PEM_write_NETSCAPE_CERT_SEQUENCE((fp), (x)) 
#define X509V3_EXT_print_fp(out, ext, flag, indent) IAmiSSL->X509V3_EXT_print_fp((out), (ext), (flag), (indent)) 
#define i2d_PKCS12_fp(fp, p12) IAmiSSL->i2d_PKCS12_fp((fp), (p12)) 
#define d2i_PKCS12_fp(fp, p12) IAmiSSL->d2i_PKCS12_fp((fp), (p12)) 
#define PEM_read_PKCS8(fp, x, cb, u) IAmiSSL->PEM_read_PKCS8((fp), (x), (cb), (u)) 
#define PEM_write_PKCS8(fp, x) IAmiSSL->PEM_write_PKCS8((fp), (x)) 
#define PEM_read_PKCS8_PRIV_KEY_INFO(fp, x, cb, u) IAmiSSL->PEM_read_PKCS8_PRIV_KEY_INFO((fp), (x), (cb), (u)) 
#define PEM_write_PKCS8_PRIV_KEY_INFO(fp, x) IAmiSSL->PEM_write_PKCS8_PRIV_KEY_INFO((fp), (x)) 
#define PEM_write_PKCS8PrivateKey(fp, x, enc, kstr, klen, cb, u) IAmiSSL->PEM_write_PKCS8PrivateKey((fp), (x), (enc), (kstr), (klen), (cb), (u)) 
#define PEM_read_X509_AUX(fp, x, cb, u) IAmiSSL->PEM_read_X509_AUX((fp), (x), (cb), (u)) 
#define PEM_write_PUBKEY(fp, x) IAmiSSL->PEM_write_PUBKEY((fp), (x)) 
#define PEM_read_RSA_PUBKEY(fp, x, cb, u) IAmiSSL->PEM_read_RSA_PUBKEY((fp), (x), (cb), (u)) 
#define PEM_read_PUBKEY(fp, x, cb, u) IAmiSSL->PEM_read_PUBKEY((fp), (x), (cb), (u)) 
#define PEM_write_X509_AUX(fp, x) IAmiSSL->PEM_write_X509_AUX((fp), (x)) 
#define PEM_write_RSA_PUBKEY(fp, x) IAmiSSL->PEM_write_RSA_PUBKEY((fp), (x)) 
#define PEM_write_PKCS8PrivateKey_nid(fp, x, nid, kstr, klen, cb, u) IAmiSSL->PEM_write_PKCS8PrivateKey_nid((fp), (x), (nid), (kstr), (klen), (cb), (u)) 
#define i2d_PKCS8PrivateKey_fp(fp, x, enc, kstr, klen, cb, u) IAmiSSL->i2d_PKCS8PrivateKey_fp((fp), (x), (enc), (kstr), (klen), (cb), (u)) 
#define i2d_PKCS8PrivateKey_nid_fp(fp, x, nid, kstr, klen, cb, u) IAmiSSL->i2d_PKCS8PrivateKey_nid_fp((fp), (x), (nid), (kstr), (klen), (cb), (u)) 
#define d2i_PKCS8PrivateKey_fp(fp, x, cb, u) IAmiSSL->d2i_PKCS8PrivateKey_fp((fp), (x), (cb), (u)) 
#define PEM_write_X509_REQ_NEW(fp, x) IAmiSSL->PEM_write_X509_REQ_NEW((fp), (x)) 
#define CONF_dump_fp(conf, out) IAmiSSL->CONF_dump_fp((conf), (out)) 
#define NCONF_dump_fp(conf, out) IAmiSSL->NCONF_dump_fp((conf), (out)) 
...
#define PEM_read_X509_CERT_PAIR(fp, x, cb, u) IAmiSSL->PEM_read_X509_CERT_PAIR((fp), (x), (cb), (u)) 
...
#define PEM_write_X509_CERT_PAIR(fp, x) IAmiSSL->PEM_write_X509_CERT_PAIR((fp), (x)) 
...
#define i2d_TS_MSG_IMPRINT_fp(fp, a) IAmiSSL->i2d_TS_MSG_IMPRINT_fp((fp), (a)) 
...
#define i2d_TS_TST_INFO_fp(fp, a) IAmiSSL->i2d_TS_TST_INFO_fp((fp), (a)) 
...
#define d2i_TS_RESP_fp(fp, a) IAmiSSL->d2i_TS_RESP_fp((fp), (a)) 
...
#define i2d_TS_RESP_fp(fp, a) IAmiSSL->i2d_TS_RESP_fp((fp), (a)) 
...
#define d2i_TS_TST_INFO_fp(fp, a) IAmiSSL->d2i_TS_TST_INFO_fp((fp), (a)) 
...
#define d2i_TS_REQ_fp(fp, a) IAmiSSL->d2i_TS_REQ_fp((fp), (a)) 
...
#define d2i_TS_MSG_IMPRINT_fp(fp, a) IAmiSSL->d2i_TS_MSG_IMPRINT_fp((fp), (a)) 
...
#define i2d_TS_REQ_fp(fp, a) IAmiSSL->i2d_TS_REQ_fp((fp), (a)) 
