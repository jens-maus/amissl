...
#define SSL_SESSION_get_master_key(ssl, out, outlen) IAmiSSL->SSL_SESSION_get_master_key((ssl), (out), (outlen))
...
#define X509_LOOKUP_meth_set_shutdown(method, shutdown) IAmiSSL->X509_LOOKUP_meth_set_shutdown((method), (shutdown))
