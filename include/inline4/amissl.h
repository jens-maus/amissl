...
#define DTLSv1_2_client_method() IAmiSSL->DTLSv1_2_client_method()
#define DTLSv1_2_method() IAmiSSL->DTLSv1_2_method()
#define DTLSv1_2_server_method() IAmiSSL->DTLSv1_2_server_method()
...
#define ASYNC_clear_wake(job) IAmiSSL->ASYNC_clear_wake((job))
#define ASYNC_get_current_job() IAmiSSL->ASYNC_get_current_job()
#define ASYNC_get_wait_fd(job) IAmiSSL->ASYNC_get_wait_fd((job))
...
#define ASYNC_start_job(job, ret, func, args, size) IAmiSSL->ASYNC_start_job((job), (ret), (func), (args), (size))
#define ASYNC_unblock_pause() IAmiSSL->ASYNC_unblock_pause()
#define ASYNC_wake(job) IAmiSSL->ASYNC_wake((job))
...
#define CRYPTO_clear_free(str, num) IAmiSSL->CRYPTO_clear_free((str), (num))
...
#define CRYPTO_secure_free(ptr) IAmiSSL->CRYPTO_secure_free((ptr))
...
#define OPENSSL_INIT_set_config_filename(settings, config_file) IAmiSSL->OPENSSL_INIT_set_config_filename((settings), (config_file))
...
#define EVP_CIPHER_CTX_cipher_data(ctx) IAmiSSL->EVP_CIPHER_CTX_cipher_data((ctx))
...
#define SSL_get_async_wait_fd(s) IAmiSSL->SSL_get_async_wait_fd((s))
