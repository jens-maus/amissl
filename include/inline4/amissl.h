...
/*
** This file was auto generated by idltool 53.32.
**
...
#define OBSOLETE_EVP_PKEY_bits(pkey) IAmiSSL->OBSOLETE_EVP_PKEY_bits((pkey))
#define OBSOLETE_EVP_PKEY_size(pkey) IAmiSSL->OBSOLETE_EVP_PKEY_size((pkey))
...
#define OBSOLETE_EVP_CIPHER_type(ctx) IAmiSSL->OBSOLETE_EVP_CIPHER_type((ctx))
...
#define OBSOLETE_SSL_get_peer_certificate(s) IAmiSSL->OBSOLETE_SSL_get_peer_certificate((s))
...
#define OBSOLETE_MD2_Init(c) IAmiSSL->OBSOLETE_MD2_Init((c))
...
#define OBSOLETE_EVP_CIPHER_nid(cipher) IAmiSSL->OBSOLETE_EVP_CIPHER_nid((cipher))
#define OBSOLETE_EVP_MD_type(md) IAmiSSL->OBSOLETE_EVP_MD_type((md))
...
#define OBSOLETE_EVP_CIPHER_iv_length(cipher) IAmiSSL->OBSOLETE_EVP_CIPHER_iv_length((cipher))
...
#define OBSOLETE_OCSP_REQ_CTX_free(rctx) IAmiSSL->OBSOLETE_OCSP_REQ_CTX_free((rctx))
...
#define OBSOLETE_d2i_EC_PUBKEY(a, pp, length) IAmiSSL->OBSOLETE_d2i_EC_PUBKEY((a), (pp), (length))
...
#define OBSOLETE_EVP_CIPHER_block_size(cipher) IAmiSSL->OBSOLETE_EVP_CIPHER_block_size((cipher))
...
#define OBSOLETE_EVP_CIPHER_CTX_nid(ctx) IAmiSSL->OBSOLETE_EVP_CIPHER_CTX_nid((ctx))
#define OBSOLETE_EVP_CIPHER_CTX_key_length(ctx) IAmiSSL->OBSOLETE_EVP_CIPHER_CTX_key_length((ctx))
#define OBSOLETE_EVP_MD_size(md) IAmiSSL->OBSOLETE_EVP_MD_size((md))
...
#define OBSOLETE_EVP_MD_pkey_type(md) IAmiSSL->OBSOLETE_EVP_MD_pkey_type((md))
#define EVP_MD_CTX_clear_flags(ctx, flags) IAmiSSL->EVP_MD_CTX_clear_flags((ctx), (flags))
#define OBSOLETE_EVP_CIPHER_flags(cipher) IAmiSSL->OBSOLETE_EVP_CIPHER_flags((cipher))
#define BIO_get_callback(b) IAmiSSL->BIO_get_callback((b))
#define OBSOLETE_EVP_CIPHER_key_length(cipher) IAmiSSL->OBSOLETE_EVP_CIPHER_key_length((cipher))
#define EVP_Cipher(c, out, in, inl) IAmiSSL->EVP_Cipher((c), (out), (in), (inl))
#define OBSOLETE_EVP_CIPHER_CTX_block_size(ctx) IAmiSSL->OBSOLETE_EVP_CIPHER_CTX_block_size((ctx))
...
#define OBSOLETE_EVP_MD_block_size(md) IAmiSSL->OBSOLETE_EVP_MD_block_size((md))
#define EVP_MD_CTX_md(ctx) IAmiSSL->EVP_MD_CTX_md((ctx))
#define BIO_method_name(b) IAmiSSL->BIO_method_name((b))
#define OBSOLETE_EVP_CIPHER_CTX_iv_length(ctx) IAmiSSL->OBSOLETE_EVP_CIPHER_CTX_iv_length((ctx))
...
#define OBSOLETE_EVP_PKEY_base_id(pkey) IAmiSSL->OBSOLETE_EVP_PKEY_base_id((pkey))
...
#define OBSOLETE_EVP_PKEY_id(pkey) IAmiSSL->OBSOLETE_EVP_PKEY_id((pkey))
...
#define OBSOLETE_EVP_MD_flags(md) IAmiSSL->OBSOLETE_EVP_MD_flags((md))
#define TS_RESP_CTX_free(ctx) IAmiSSL->TS_RESP_CTX_free((ctx))
#define OBSOLETE_OCSP_REQ_CTX_add1_header(rctx, name, value) IAmiSSL->OBSOLETE_OCSP_REQ_CTX_add1_header((rctx), (name), (value))
...
#define OBSOLETE_OCSP_REQ_CTX_get0_mem_bio(rctx) IAmiSSL->OBSOLETE_OCSP_REQ_CTX_get0_mem_bio((rctx))
...
#define OBSOLETE_OCSP_REQ_CTX_nbio(rctx) IAmiSSL->OBSOLETE_OCSP_REQ_CTX_nbio((rctx))
#define OBSOLETE_OCSP_REQ_CTX_nbio_d2i(rctx, pval, it) IAmiSSL->OBSOLETE_OCSP_REQ_CTX_nbio_d2i((rctx), (pval), (it))
#define OBSOLETE_OCSP_REQ_CTX_new(io, maxline) IAmiSSL->OBSOLETE_OCSP_REQ_CTX_new((io), (maxline))
#define OBSOLETE_OCSP_set_max_response_length(rctx, len) IAmiSSL->OBSOLETE_OCSP_set_max_response_length((rctx), (len))
...
#define OBSOLETE_EVP_CIPHER_CTX_encrypting(ctx) IAmiSSL->OBSOLETE_EVP_CIPHER_CTX_encrypting((ctx))
...
#define OBSOLETE_EVP_CIPHER_CTX_num(ctx) IAmiSSL->OBSOLETE_EVP_CIPHER_CTX_num((ctx))
...
#define OBSOLETE_EVP_MD_CTX_md_data(ctx) IAmiSSL->OBSOLETE_EVP_MD_CTX_md_data((ctx))
#define EVP_MD_CTX_new() IAmiSSL->EVP_MD_CTX_new()
#define OBSOLETE_EVP_MD_CTX_pkey_ctx(ctx) IAmiSSL->OBSOLETE_EVP_MD_CTX_pkey_ctx((ctx))
...
#define OBSOLETE_EVP_PKEY_security_bits(pkey) IAmiSSL->OBSOLETE_EVP_PKEY_security_bits((pkey))
...
#define OBSOLETE_TS_VERIFY_CTS_set_certs(ctx, certs) IAmiSSL->OBSOLETE_TS_VERIFY_CTS_set_certs((ctx), (certs))
...
#define OBSOLETE_EVP_PKEY_set1_tls_encodedpoint(pkey, pt, ptlen) IAmiSSL->OBSOLETE_EVP_PKEY_set1_tls_encodedpoint((pkey), (pt), (ptlen))
#define OBSOLETE_EVP_PKEY_get1_tls_encodedpoint(pkey, ppt) IAmiSSL->OBSOLETE_EVP_PKEY_get1_tls_encodedpoint((pkey), (ppt))
...
#define EVP_CIPHER_get_type(cipher) IAmiSSL->EVP_CIPHER_get_type((cipher))
...
#define X509_STORE_load_file(ctx, file) IAmiSSL->X509_STORE_load_file((ctx), (file))
#define X509_STORE_load_path(ctx, path) IAmiSSL->X509_STORE_load_path((ctx), (path))
#define X509_STORE_load_store(ctx, store) IAmiSSL->X509_STORE_load_store((ctx), (store))
...
#define X509_STORE_get1_all_certs(st) IAmiSSL->X509_STORE_get1_all_certs((st))
...
#define X509_STORE_load_file_ex(ctx, file, libctx, propq) IAmiSSL->X509_STORE_load_file_ex((ctx), (file), (libctx), (propq))
#define X509_STORE_load_store_ex(ctx, store, libctx, propq) IAmiSSL->X509_STORE_load_store_ex((ctx), (store), (libctx), (propq))
#define X509_STORE_load_locations_ex(ctx, file, dir, libctx, propq) IAmiSSL->X509_STORE_load_locations_ex((ctx), (file), (dir), (libctx), (propq))
#define X509_STORE_set_default_paths_ex(ctx, libctx, propq) IAmiSSL->X509_STORE_set_default_paths_ex((ctx), (libctx), (propq))
...
#define CMS_sign_ex(signcert, pkey, certs, data, flags, ctx, propq) IAmiSSL->CMS_sign_ex((signcert), (pkey), (certs), (data), (flags), (ctx), (propq))
#define CMS_data_create_ex(in, flags, ctx, propq) IAmiSSL->CMS_data_create_ex((in), (flags), (ctx), (propq))
#define CMS_digest_create_ex(in, md, flags, ctx, propq) IAmiSSL->CMS_digest_create_ex((in), (md), (flags), (ctx), (propq))
#define CMS_EncryptedData_encrypt_ex(in, cipher, key, keylen, flags, ctx, propq) IAmiSSL->CMS_EncryptedData_encrypt_ex((in), (cipher), (key), (keylen), (flags), (ctx), (propq))
#define CMS_encrypt_ex(certs, in, cipher, flags, ctx, propq) IAmiSSL->CMS_encrypt_ex((certs), (in), (cipher), (flags), (ctx), (propq))
#define CMS_EnvelopedData_create_ex(cipher, ctx, propq) IAmiSSL->CMS_EnvelopedData_create_ex((cipher), (ctx), (propq))
#define CMS_ReceiptRequest_create0_ex(id, idlen, allorfirst, receiptList, receiptsTo, ctx) IAmiSSL->CMS_ReceiptRequest_create0_ex((id), (idlen), (allorfirst), (receiptList), (receiptsTo), (ctx))
...
#define CMS_AuthEnvelopedData_create_ex(cipher, ctx, propq) IAmiSSL->CMS_AuthEnvelopedData_create_ex((cipher), (ctx), (propq))
...
#define EVP_PBE_scrypt_ex_amiga_1(pass, passlen, salt, N, r, p, maxmem, moreargs) IAmiSSL->EVP_PBE_scrypt_ex_amiga_1((pass), (passlen), (salt), (N), (r), (p), (maxmem), (moreargs))
