...
#define X509_CRL_get0_signature(psig, palg, crl) IAmiSSL->X509_CRL_get0_signature((psig), (palg), (crl))
...
#define X509_get0_uids(piuid, psuid, x) IAmiSSL->X509_get0_uids((piuid), (psuid), (x))
#define X509_get_notAfter(x) IAmiSSL->X509_get_notAfter((x))
#define X509_get_notBefore(x) IAmiSSL->X509_get_notBefore((x))
...
#define X509_NAME_get0_der(pder, pderlen, nm) IAmiSSL->X509_NAME_get0_der((pder), (pderlen), (nm))
#define X509_PUBKEY_get0(key) IAmiSSL->X509_PUBKEY_get0((key))
#define X509_REQ_get0_signature(psig, palg, req) IAmiSSL->X509_REQ_get0_signature((psig), (palg), (req))
...
#define CT_POLICY_EVAL_CTX_set0_cert(ctx, cert) IAmiSSL->CT_POLICY_EVAL_CTX_set0_cert((ctx), (cert))
#define CT_POLICY_EVAL_CTX_get0_issuer(ctx) IAmiSSL->CT_POLICY_EVAL_CTX_get0_issuer((ctx))
#define CT_POLICY_EVAL_CTX_set0_issuer(ctx, issuer) IAmiSSL->CT_POLICY_EVAL_CTX_set0_issuer((ctx), (issuer))
#define CT_POLICY_EVAL_CTX_get0_log_store(ctx) IAmiSSL->CT_POLICY_EVAL_CTX_get0_log_store((ctx))
#define CT_POLICY_EVAL_CTX_set0_log_store(ctx, log_store) IAmiSSL->CT_POLICY_EVAL_CTX_set0_log_store((ctx), (log_store))
...
#define SCT_verify(sctx, sct) IAmiSSL->SCT_verify((sctx), (sct))
#define SCT_verify_v1(sct, cert, preissuer, log_pubkey, issuer_cert) IAmiSSL->SCT_verify_v1((sct), (cert), (preissuer), (log_pubkey), (issuer_cert))
...
#define i2o_SCT_signature(sct, out) IAmiSSL->i2o_SCT_signature((sct), (out))
#define o2i_SCT_signature(sct, in, len) IAmiSSL->o2i_SCT_signature((sct), (in), (len))
#define CTLOG_new(public_key, name) IAmiSSL->CTLOG_new((public_key), (name))
#define CTLOG_new_null() IAmiSSL->CTLOG_new_null()
...
#define X509_SIG_get0(palg, pdigest, sig) IAmiSSL->X509_SIG_get0((palg), (pdigest), (sig))
