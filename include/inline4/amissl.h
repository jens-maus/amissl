...
/*
** This file was auto generated by idltool 51.5.
**
...
#define read_string_lib(ui,uis) IAmiSSL->read_string_lib(ui, uis)
#define write_string_lib(ui,uis) IAmiSSL->write_string_lib(ui, uis)
