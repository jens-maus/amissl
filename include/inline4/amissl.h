...
/*
** This file was auto generated by idltool 53.18.
**
...
#define BUF_strnlen(str, maxlen) IAmiSSL->BUF_strnlen((str), (maxlen))
...
#define ECDSA_METHOD_free(ecdsa_method) IAmiSSL->ECDSA_METHOD_free((ecdsa_method))
#define ECDSA_METHOD_get_app_data(ecdsa_method) IAmiSSL->ECDSA_METHOD_get_app_data((ecdsa_method))
#define ECDSA_METHOD_new(ecdsa_method) IAmiSSL->ECDSA_METHOD_new((ecdsa_method))
#define ECDSA_METHOD_set_app_data(ecdsa_method, app) IAmiSSL->ECDSA_METHOD_set_app_data((ecdsa_method), (app))
#define ECDSA_METHOD_set_flags(ecdsa_method, flags) IAmiSSL->ECDSA_METHOD_set_flags((ecdsa_method), (flags))
#define ECDSA_METHOD_set_name(ecdsa_method, name) IAmiSSL->ECDSA_METHOD_set_name((ecdsa_method), (name))
#define ECDSA_METHOD_set_sign(ecdsa_method, ecda_do_sign) IAmiSSL->ECDSA_METHOD_set_sign((ecdsa_method), (ecda_do_sign))
#define ECDSA_METHOD_set_sign_setup(ecdsa_method, ecdsa_sign_setup) IAmiSSL->ECDSA_METHOD_set_sign_setup((ecdsa_method), (ecdsa_sign_setup))
#define ECDSA_METHOD_set_verify(ecdsa_method, ecdsa_do_verify) IAmiSSL->ECDSA_METHOD_set_verify((ecdsa_method), (ecdsa_do_verify))
...
#define X509V3_EXT_free(nid, ext_data) IAmiSSL->X509V3_EXT_free((nid), (ext_data))
