...
VERSIONNAME=097f
AMISSLREVISION=2
AMISSLMASTERREVISION=2
AMISSLDATE=31.3.2005
AMISSLMASTERDATE=31.3.2005

LFLAGS=-nostdlib
OPT= -O2
INCLUDE = -I$(AmiSSL)/include -I$(AmiSSL)/libcmt/include
CFLAGS=$(INCLUDE) -mbaserel $(OPT) -DAMISSL_COMPILE -DVERSION=$(VERSION) \
       -DVERSIONNAME=$(VERSIONNAME) -DAMISSLREVISION=$(AMISSLREVISION) \
       -DAMISSLDATE=$(AMISSLDATE) -DAMISSLMASTERREVISION=$(AMISSLMASTERREVISION) \
